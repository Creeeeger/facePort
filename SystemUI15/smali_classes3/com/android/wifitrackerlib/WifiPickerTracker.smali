...
.method public final conditionallyCreateConnectedWifiEntry(Landroid/net/wifi/WifiInfo;)V
    ...
    invoke-direct/range {v2 .. v8}, Lcom/android/wifitrackerlib/PasspointWifiEntry;-><init>(Lcom/android/wifitrackerlib/WifiTrackerInjector;Landroid/content/Context;Landroid/os/Handler;Landroid/net/wifi/WifiConfiguration;Landroid/net/wifi/WifiManager;Z)V
...
.method public final handleConfiguredNetworksChangedAction(Landroid/content/Intent;)V
    ...
    new-instance v3, Lcom/android/wifitrackerlib/WifiPickerTracker$$ExternalSyntheticLambda38;

    invoke-direct {v3, v2}, Lcom/android/wifitrackerlib/WifiPickerTracker$$ExternalSyntheticLambda38;-><init>(Lcom/android/wifitrackerlib/WifiPickerTracker$WifiPickerTrackerCallback;)V
...
.method public final handleDefaultNetworkLost()V
    ...
    :try_start_0
    iput-object v2, v1, Lcom/android/wifitrackerlib/WifiEntry;->mDefaultNetwork:Landroid/net/Network;

    iput-object v2, v1, Lcom/android/wifitrackerlib/WifiEntry;->mDefaultNetworkCapabilities:Landroid/net/NetworkCapabilities;
    ...
    invoke-virtual {p0, v0}, Lcom/android/wifitrackerlib/WifiPickerTracker;->notifyOnWifiEntriesChanged(I)V
...
.method public final handleHotspotNetworkConnectionStatusChanged(Landroid/net/wifi/sharedconnectivity/app/HotspotNetworkConnectionStatus;)V
    ...
    invoke-direct {v0, p1, v1}, Lcom/android/wifitrackerlib/WifiPickerTracker$$ExternalSyntheticLambda13;-><init>(Ljava/lang/Object;I)V
...
.method public final handleNetworkCapabilitiesChanged(Landroid/net/Network;Landroid/net/NetworkCapabilities;)V
    ...
    invoke-virtual {p0, p2}, Lcom/android/wifitrackerlib/WifiPickerTracker;->notifyOnWifiEntriesChanged(I)V
...
.method public final handleNetworkLost(Landroid/net/Network;)V
    ...
    :try_start_0
    iget-object v2, v1, Lcom/android/wifitrackerlib/WifiEntry;->mNetwork:Landroid/net/Network;
...
.method public final handleOnStart()V
    ...
    const-string/jumbo v4, "safe_wifi"
    ...
    const-string/jumbo v7, "set EasySetup filter - minRssi : "

    invoke-direct {v6, v7}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget v5, v5, Lcom/samsung/android/wifi/SemEasySetupWifiScanSettings;->minRssi:I

    invoke-static {v5, v4, v6}, Landroidx/recyclerview/widget/RecyclerView$$ExternalSyntheticOutline0;->m(ILjava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    :cond_6
    invoke-virtual {p0, v2}, Lcom/android/wifitrackerlib/WifiPickerTracker;->conditionallyUpdateScanResults(Z)V
    ...
    new-instance v2, Lcom/android/wifitrackerlib/WifiPickerTracker$$ExternalSyntheticLambda38;

    invoke-direct {v2, v1}, Lcom/android/wifitrackerlib/WifiPickerTracker$$ExternalSyntheticLambda38;-><init>(Lcom/android/wifitrackerlib/WifiPickerTracker$WifiPickerTrackerCallback;)V
...
.method public final updateHotspotNetworkEntries()V
    ...
    invoke-direct {v3, v4, v1}, Lcom/android/wifitrackerlib/WifiPickerTracker$$ExternalSyntheticLambda23;-><init>(ILjava/util/Set;)V
...
.method public final updateOsuWifiEntryScans(Ljava/util/List;)V
    ...
    invoke-direct {v1, p0, v0, v2}, Lcom/android/wifitrackerlib/WifiPickerTracker$$ExternalSyntheticLambda19;-><init>(Lcom/android/wifitrackerlib/WifiPickerTracker;Ljava/util/Map;I)V
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/wifitrackerlib/WifiPickerTracker$$ExternalSyntheticLambda45;-><init>(Lcom/android/wifitrackerlib/WifiPickerTracker;I)V
...
.method public final updatePasspointConfigurations(Ljava/util/Map;Ljava/util/List;)V
    ...
    invoke-direct {v0, p0, p1, v1}, Lcom/android/wifitrackerlib/WifiPickerTracker$$ExternalSyntheticLambda20;-><init>(Lcom/android/wifitrackerlib/WifiPickerTracker;Ljava/util/Map;I)V
...
.method public final updatePasspointWifiEntryScans(Ljava/util/List;)V
    ...
    iget-object v6, v4, Landroid/net/wifi/WifiConfiguration;->providerFriendlyName:Ljava/lang/String;
    ...
    invoke-virtual {v15, v14, v12}, Landroid/util/ArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :try_start_0
    iput-object v4, v5, Lcom/android/wifitrackerlib/PasspointWifiEntry;->mWifiConfig:Landroid/net/wifi/WifiConfiguration;

    iget-object v4, v5, Lcom/android/wifitrackerlib/PasspointWifiEntry;->mCurrentHomeScanResults:Ljava/util/List;

    check-cast v4, Ljava/util/ArrayList;

    invoke-virtual {v4}, Ljava/util/ArrayList;->clear()V

    iget-object v4, v5, Lcom/android/wifitrackerlib/PasspointWifiEntry;->mCurrentRoamingScanResults:Ljava/util/List;
    ...
    :cond_5
    iget-object v4, v5, Lcom/android/wifitrackerlib/PasspointWifiEntry;->mWifiConfig:Landroid/net/wifi/WifiConfiguration;

    const/4 v6, -0x1

    if-eqz v4, :cond_c

    iget-object v4, v5, Lcom/android/wifitrackerlib/WifiEntry;->mSemFlags:Lcom/samsung/android/wifitrackerlib/SemWifiEntryFlags;

    const/4 v7, 0x0

    iput v7, v4, Lcom/samsung/android/wifitrackerlib/SemWifiEntryFlags;->wifiStandard:I

    iput-boolean v7, v4, Lcom/samsung/android/wifitrackerlib/SemWifiEntryFlags;->has6EStandard:Z

    iput v6, v4, Lcom/samsung/android/wifitrackerlib/SemWifiEntryFlags;->staCount:I

    invoke-virtual {v5}, Lcom/android/wifitrackerlib/PasspointWifiEntry;->updateSecurityTypes()V
    ...
    invoke-virtual {v5, v7}, Lcom/android/wifitrackerlib/WifiEntry;->semUpdateFlags(Landroid/net/wifi/ScanResult;)V

    iget v8, v7, Landroid/net/wifi/ScanResult;->frequency:I

    if-ge v12, v8, :cond_6

    invoke-virtual {v5, v8}, Lcom/android/wifitrackerlib/WifiEntry;->setBand(I)V

    iget v7, v7, Landroid/net/wifi/ScanResult;->frequency:I

    iput v7, v5, Lcom/android/wifitrackerlib/WifiEntry;->mFrequency:I
    ...
    invoke-virtual {v5, v7}, Lcom/android/wifitrackerlib/WifiEntry;->setBand(I)V
    ...
    invoke-virtual {v5, v3}, Lcom/android/wifitrackerlib/WifiEntry;->updateBestRssi(Landroid/net/wifi/ScanResult;)V

    iget-object v4, v3, Landroid/net/wifi/ScanResult;->BSSID:Ljava/lang/String;

    iput-object v4, v5, Lcom/android/wifitrackerlib/WifiEntry;->mBssid:Ljava/lang/String;

    :cond_a
    invoke-virtual {v5}, Lcom/android/wifitrackerlib/PasspointWifiEntry;->getConnectedState()I
    ...
    iget v3, v5, Lcom/android/wifitrackerlib/WifiEntry;->mRssi:I

    invoke-static {v3}, Lcom/samsung/android/wifitrackerlib/SemWifiUtils;->calculateSignalLevel(I)I
    ...
    :goto_5
    iput v3, v5, Lcom/android/wifitrackerlib/WifiEntry;->mLevel:I

    if-ne v3, v6, :cond_d

    const/16 v3, -0x7f

    iput v3, v5, Lcom/android/wifitrackerlib/WifiEntry;->mRssi:I

    goto :goto_6

    :cond_c
    iput v6, v5, Lcom/android/wifitrackerlib/WifiEntry;->mLevel:I

    :cond_d
    :goto_6
    invoke-virtual {v5}, Lcom/android/wifitrackerlib/WifiEntry;->notifyOnUpdated()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-direct {v3, v4, v2}, Lcom/android/wifitrackerlib/WifiPickerTracker$$ExternalSyntheticLambda23;-><init>(ILjava/util/Set;)V
    ...
    invoke-direct {v2, v0, v3}, Lcom/android/wifitrackerlib/WifiPickerTracker$$ExternalSyntheticLambda45;-><init>(Lcom/android/wifitrackerlib/WifiPickerTracker;I)V
...
.method public final updateSuggestedWifiEntryScans(Ljava/util/List;)V
    ...
    invoke-direct {v3, v1, p1, v0}, Lcom/android/wifitrackerlib/WifiPickerTracker$$ExternalSyntheticLambda43;-><init>(Ljava/util/Set;Ljava/util/Map;Ljava/util/Set;)V
...
.method public final updateWifiEntries(ILjava/lang/String;Z)V
    ...
    const-string/jumbo v7, "updateWifiEntries "
    ...
    iget-object v8, v0, Lcom/android/wifitrackerlib/WifiPickerTracker;->mStandardWifiEntryCache:Ljava/util/List;
    ...
    iget-object v8, v0, Lcom/android/wifitrackerlib/WifiPickerTracker;->mPasspointWifiEntryCache:Ljava/util/Map;
    ...
    :cond_0
    iget-object v8, v0, Lcom/android/wifitrackerlib/WifiPickerTracker;->mNetworkRequestEntry:Lcom/android/wifitrackerlib/NetworkRequestEntry;
    ...
    invoke-direct {v8, v3}, Lcom/android/wifitrackerlib/WifiPickerTracker$$ExternalSyntheticLambda0;-><init>(I)V
    ...
    iget-object v10, v10, Lcom/android/wifitrackerlib/HotspotNetworkEntry;->mKey:Lcom/android/wifitrackerlib/HotspotNetworkEntry$HotspotNetworkEntryKey;

    iget-object v10, v10, Lcom/android/wifitrackerlib/HotspotNetworkEntry$HotspotNetworkEntryKey;->mScanResultKey:Lcom/android/wifitrackerlib/StandardWifiEntry$ScanResultKey;
    ...
    :cond_3
    new-instance v9, Lcom/android/wifitrackerlib/WifiPickerTracker$$ExternalSyntheticLambda23;

    invoke-direct {v9, v2, v8}, Lcom/android/wifitrackerlib/WifiPickerTracker$$ExternalSyntheticLambda23;-><init>(ILjava/util/Set;)V

    invoke-virtual {v6, v9}, Ljava/util/ArrayList;->removeIf(Ljava/util/function/Predicate;)Z

    sget-object v8, Lcom/android/wifitrackerlib/WifiEntry;->WIFI_PICKER_COMPARATOR:Ljava/util/Comparator;
    ...
    new-instance v9, Lcom/android/wifitrackerlib/WifiPickerTracker$$ExternalSyntheticLambda13;

    invoke-direct {v9, v6, v5}, Lcom/android/wifitrackerlib/WifiPickerTracker$$ExternalSyntheticLambda13;-><init>(Ljava/lang/Object;I)V

    invoke-interface {v8, v9}, Ljava/util/stream/Stream;->filter(Ljava/util/function/Predicate;)Ljava/util/stream/Stream;

    move-result-object v8

    new-instance v9, Lcom/android/wifitrackerlib/WifiPickerTracker$$ExternalSyntheticLambda1;

    invoke-direct {v9, v4}, Lcom/android/wifitrackerlib/WifiPickerTracker$$ExternalSyntheticLambda1;-><init>(I)V
    ...
    iget-object v10, v0, Lcom/android/wifitrackerlib/WifiPickerTracker;->mPasspointWifiEntryCache:Ljava/util/Map;
    ...
    check-cast v11, Lcom/android/wifitrackerlib/PasspointWifiEntry;
    ...
    iget-object v13, v11, Lcom/android/wifitrackerlib/PasspointWifiEntry;->mCurrentHomeScanResults:Ljava/util/List;
    ...
    :cond_4
    iget-object v13, v11, Lcom/android/wifitrackerlib/PasspointWifiEntry;->mCurrentRoamingScanResults:Ljava/util/List;
    ...
    invoke-virtual {v9, v12}, Landroid/util/ArraySet;->addAll(Ljava/util/Collection;)Z
    ...
    iget-object v11, v0, Lcom/android/wifitrackerlib/WifiPickerTracker;->mKnownNetworkEntryCache:Ljava/util/List;
    ...
    check-cast v12, Lcom/android/wifitrackerlib/KnownNetworkEntry;

    iget-object v12, v12, Lcom/android/wifitrackerlib/StandardWifiEntry;->mKey:Lcom/android/wifitrackerlib/StandardWifiEntry$StandardWifiEntryKey;
    ...
    iget-object v12, v0, Lcom/android/wifitrackerlib/WifiPickerTracker;->mHotspotNetworkEntryCache:Ljava/util/List;
    ...
    check-cast v13, Lcom/android/wifitrackerlib/HotspotNetworkEntry;

    iget-object v13, v13, Lcom/android/wifitrackerlib/HotspotNetworkEntry;->mKey:Lcom/android/wifitrackerlib/HotspotNetworkEntry$HotspotNetworkEntryKey;

    iget-boolean v14, v13, Lcom/android/wifitrackerlib/HotspotNetworkEntry$HotspotNetworkEntryKey;->mIsVirtualEntry:Z

    if-nez v14, :cond_8

    iget-object v13, v13, Lcom/android/wifitrackerlib/HotspotNetworkEntry$HotspotNetworkEntryKey;->mScanResultKey:Lcom/android/wifitrackerlib/StandardWifiEntry$ScanResultKey;
    ...
    :cond_9
    iget-boolean v12, v0, Lcom/android/wifitrackerlib/WifiPickerTracker;->mIsSupportEasySetup:Z

    if-eqz v12, :cond_f

    iget-object v12, v0, Lcom/android/wifitrackerlib/WifiPickerTracker;->mEasySetupCandidateEntries:Ljava/util/List;

    check-cast v12, Ljava/util/ArrayList;

    invoke-virtual {v12}, Ljava/util/ArrayList;->clear()V

    iget-object v12, v0, Lcom/android/wifitrackerlib/WifiPickerTracker;->mLockEasySetup:Ljava/lang/Object;

    monitor-enter v12

    :try_start_1
    iget-object v13, v0, Lcom/android/wifitrackerlib/WifiPickerTracker;->mEasySetupEntries:Ljava/util/List;
    ...
    iget-object v12, v0, Lcom/android/wifitrackerlib/WifiPickerTracker;->mSemEasySetupScanSettings:Ljava/util/List;
    ...
    check-cast v13, Lcom/samsung/android/wifi/SemEasySetupWifiScanSettings;

    iget-object v14, v13, Lcom/samsung/android/wifi/SemEasySetupWifiScanSettings;->ssidPatterns:Ljava/util/List;
    ...
    :cond_a
    iget-object v2, v0, Lcom/android/wifitrackerlib/WifiPickerTracker;->mStandardWifiEntryCache:Ljava/util/List;
    ...
    iget-object v5, v0, Lcom/android/wifitrackerlib/WifiPickerTracker;->mActiveWifiEntries:Ljava/util/List;
    ...
    iget v5, v3, Lcom/android/wifitrackerlib/WifiEntry;->mRssi:I

    iget v1, v13, Lcom/samsung/android/wifi/SemEasySetupWifiScanSettings;->minRssi:I

    if-lt v5, v1, :cond_b

    iget-object v1, v0, Lcom/android/wifitrackerlib/WifiPickerTracker;->mEasySetupCandidateEntries:Ljava/util/List;

    check-cast v1, Ljava/util/ArrayList;

    invoke-virtual {v1, v3}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v1, v0, Lcom/android/wifitrackerlib/WifiPickerTracker;->mLockEasySetup:Ljava/lang/Object;

    monitor-enter v1

    :try_start_2
    iget-object v5, v0, Lcom/android/wifitrackerlib/WifiPickerTracker;->mEasySetupEntries:Ljava/util/List;
    ...
    iget-object v5, v3, Lcom/android/wifitrackerlib/StandardWifiEntry;->mKey:Lcom/android/wifitrackerlib/StandardWifiEntry$StandardWifiEntryKey;

    iget-object v5, v5, Lcom/android/wifitrackerlib/StandardWifiEntry$StandardWifiEntryKey;->mScanResultKey:Lcom/android/wifitrackerlib/StandardWifiEntry$ScanResultKey;
    ...
    invoke-virtual {v5}, Lcom/android/wifitrackerlib/WifiTrackerInjector;->isSharedConnectivityFeatureEnabled()Z
    ...
    :cond_15
    iget-object v5, v0, Lcom/android/wifitrackerlib/WifiPickerTracker;->mEasySetupCandidateEntries:Ljava/util/List;
    ...
    :cond_17
    iget-object v2, v0, Lcom/android/wifitrackerlib/WifiPickerTracker;->mSuggestedWifiEntryCache:Ljava/util/List;
    ...
    iget-object v2, v0, Lcom/android/wifitrackerlib/WifiPickerTracker;->mPasspointWifiEntryCache:Ljava/util/Map;
    ...
    iget-object v2, v0, Lcom/android/wifitrackerlib/WifiPickerTracker;->mOsuWifiEntryCache:Ljava/util/Map;
    ...
    iget-object v2, v0, Lcom/android/wifitrackerlib/BaseWifiTracker;->mInjector:Lcom/android/wifitrackerlib/WifiTrackerInjector;
    ...
    iget-object v2, v0, Lcom/android/wifitrackerlib/WifiPickerTracker;->mKnownNetworkEntryCache:Ljava/util/List;
    ...
    invoke-direct {v3, v5, v1}, Lcom/android/wifitrackerlib/WifiPickerTracker$$ExternalSyntheticLambda23;-><init>(ILjava/util/Set;)V
    ...
    iget-object v1, v0, Lcom/android/wifitrackerlib/WifiPickerTracker;->mHotspotNetworkEntryCache:Ljava/util/List;
    ...
    :cond_18
    iget-object v1, v0, Lcom/android/wifitrackerlib/BaseWifiTracker;->mContext:Landroid/content/Context;

    invoke-static {v1}, Lcom/samsung/android/wifitrackerlib/SemWifiEntryFlags;->isWifiDeveloperOptionOn(Landroid/content/Context;)Z
    ...
    :cond_19
    sget v2, Lcom/samsung/android/wifitrackerlib/SemWifiUtils;->$r8$clinit:I

    invoke-virtual {v1}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v1

    const-string/jumbo v2, "sec_wifi_developer_sorting_style"
    ...
    :cond_1a
    sget-object v1, Lcom/android/wifitrackerlib/WifiEntry;->WIFI_PICKER_COMPARATOR_HIGH_FREQUENCY:Ljava/util/Comparator;

    goto :goto_d

    :cond_1b
    sget-object v1, Lcom/android/wifitrackerlib/WifiEntry;->WIFI_PICKER_COMPARATOR_RSSI:Ljava/util/Comparator;

    goto :goto_d

    :cond_1c
    sget-object v1, Lcom/android/wifitrackerlib/WifiEntry;->WIFI_PICKER_COMPARATOR_ALPHABETICAL:Ljava/util/Comparator;
    ...
    const-string v2, "------ Dumping WifiEntries that were seen top of 5 scan ------"
    ...
    invoke-virtual {v2, v5}, Lcom/android/wifitrackerlib/WifiEntry;->getSummary(Z)Ljava/lang/String;
    ...
    invoke-virtual {v3, v9}, Lcom/android/wifitrackerlib/WifiEntry;->getSummary(Z)Ljava/lang/String;
    ...
    iget-object v3, v0, Lcom/android/wifitrackerlib/WifiPickerTracker;->mEasySetupCandidateEntries:Ljava/util/List;
    ...
    const-string v2, "---- Done dumping WifiEntries ----"
    ...
    :goto_15
    iput-object v2, v0, Lcom/android/wifitrackerlib/WifiPickerTracker;->mConnectedWifiEntry:Lcom/android/wifitrackerlib/WifiEntry;

    iput-object v6, v0, Lcom/android/wifitrackerlib/WifiPickerTracker;->mActiveWifiEntries:Ljava/util/List;

    iput-object v7, v0, Lcom/android/wifitrackerlib/WifiPickerTracker;->mWifiEntries:Ljava/util/List;
    ...
    iget-object v1, v0, Lcom/android/wifitrackerlib/BaseWifiTracker;->mSemWifiManager:Lcom/samsung/android/wifi/SemWifiManager;
    ...
    const-string/jumbo v4, "update AutoHotspot Entries() : bleAccessPoints -> "
    ...
    :try_start_4
    iget-object v2, v0, Lcom/android/wifitrackerlib/WifiPickerTracker;->mAutoHotspotEntries:Ljava/util/List;
    ...
    invoke-static {v3, v1, v2}, Lcom/android/settingslib/satellite/SatelliteDialogUtils$requestIsEnabled$2$1$1$$ExternalSyntheticOutline0;->m(Ljava/lang/String;Ljava/lang/String;Z)V

    :goto_1a
    invoke-virtual/range {p0 .. p1}, Lcom/android/wifitrackerlib/WifiPickerTracker;->notifyOnWifiEntriesChanged(I)V
