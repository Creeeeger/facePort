...
# virtual methods
.method public final addVolumeRows$1(Lcom/samsung/systemui/splugins/volume/VolumePanelState;)V
    .locals 10
    ...
    iget-object v3, v2, Lkotlin/collections/ReversedListReadOnly$listIterator$1;->delegateIterator:Ljava/util/ListIterator;
    ...
    iget-object v2, v2, Lkotlin/collections/ReversedListReadOnly$listIterator$1;->delegateIterator:Ljava/util/ListIterator;
    ...
    iget-object v3, p0, Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelView;->store:Lcom/android/systemui/volume/store/VolumePanelStore;
    ...
    :goto_2
    iget-object v3, p0, Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelView;->handlerWrapper:Lcom/android/systemui/volume/util/HandlerWrapper;
    ...
    :goto_3
    iget-object v3, p0, Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelView;->volumePanelMotion:Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelMotion;
    ...
    iget-object v3, p0, Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelView;->rowContainer:Landroid/view/ViewGroup;
    ...
    invoke-virtual {v9, v3}, Landroid/widget/FrameLayout;->requireViewById(I)Landroid/view/View;
...
.method public final dispatchTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    iget-object p1, p0, Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelView;->panelState:Lcom/samsung/systemui/splugins/volume/VolumePanelState;
    ...
    iget-object v5, p0, Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelView;->panelState:Lcom/samsung/systemui/splugins/volume/VolumePanelState;
    ...
    :cond_c
    iget-boolean v4, p0, Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelView;->isSwipe:Z

    if-nez v4, :cond_e

    iget-boolean v4, p0, Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelView;->isSeekBarTouching:Z
    ...
    iget-object v0, p0, Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelView;->panelState:Lcom/samsung/systemui/splugins/volume/VolumePanelState;
...
.method public final initViewVisibility$1(Lcom/samsung/systemui/splugins/volume/VolumePanelState;)V
    .locals 4
...
.method public final onChanged(Ljava/lang/Object;)V
    ...
    :cond_1
    iget-object v3, p0, Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelView;->keyUpRunnable:Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelView$keyUpRunnable$1;
    ...
    invoke-virtual {p0, p1}, Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelView;->addVolumeRows$1(Lcom/samsung/systemui/splugins/volume/VolumePanelState;)V

    invoke-virtual {p0, p1}, Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelView;->initViewVisibility$1(Lcom/samsung/systemui/splugins/volume/VolumePanelState;)V
    ...
    invoke-virtual {p0, p1, v3}, Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelView;->updateVolumeTitleView$1(Lcom/samsung/systemui/splugins/volume/VolumePanelState;Z)V
    ...
    invoke-virtual {p0, p1, v2}, Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelView;->updateVolumeTitleView$1(Lcom/samsung/systemui/splugins/volume/VolumePanelState;Z)V
    ...
    invoke-static {v0, v1, v3}, Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelMotion;->startSeekBarTouchDownAnimation(Landroidx/dynamicanimation/animation/SpringAnimation;Landroidx/dynamicanimation/animation/SpringAnimation;Z)V
...
.method public final startDismissAnimation()V
    ...
    new-instance v3, Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelView$startDismissAnimation$dismissRunnable$1;

    invoke-direct {v3, p0}, Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelView$startDismissAnimation$dismissRunnable$1;-><init>(Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelView;)V

    iget-object v4, p0, Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelView;->panelState:Lcom/samsung/systemui/splugins/volume/VolumePanelState;
    ...
    sget-object v1, Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelMotion;->HIDE_INTERPOLATOR:Landroid/view/animation/PathInterpolator;
    ...
    new-instance v1, Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelMotion$startAODHideAnimation$1;

    invoke-direct {v1, v0, v3}, Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelMotion$startAODHideAnimation$1;-><init>(Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelMotion;Ljava/lang/Runnable;)V
    ...
    iget-object v4, p0, Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelView;->volumePanelMotion:Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelMotion;
    ...
    invoke-static {v9, v6, v10, v11, v5}, Lcom/android/keyguard/KeyguardSecPatternViewController$$ExternalSyntheticOutline0;->m(FFFFLandroid/animation/ObjectAnimator;)V
    ...
    invoke-static {p0, v12, v0}, Landroid/animation/ObjectAnimator;->ofFloat(Ljava/lang/Object;Ljava/lang/String;[F)Landroid/animation/ObjectAnimator;

    move-result-object v0

    new-instance v12, Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelMotion$startVolumeDualViewHideAnimation$scaleAnimator$1$1;

    invoke-direct {v12, p0}, Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelMotion$startVolumeDualViewHideAnimation$scaleAnimator$1$1;-><init>(Landroid/view/View;)V

    invoke-virtual {v0, v12}, Landroid/animation/ObjectAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    invoke-virtual {v0, v7, v8}, Landroid/animation/ObjectAnimator;->setDuration(J)Landroid/animation/ObjectAnimator;

    new-instance p0, Landroid/view/animation/PathInterpolator;

    invoke-direct {p0, v9, v6, v10, v11}, Landroid/view/animation/PathInterpolator;-><init>(FFFF)V
    ...
    new-instance v0, Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelMotion$startVolumeDualViewHideAnimation$1$1;

    invoke-direct {v0, v4, v3}, Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelMotion$startVolumeDualViewHideAnimation$1$1;-><init>(Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelMotion;Ljava/lang/Runnable;)V
    ...
    iget-object v1, v0, Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelMotion;->singleShowSpringAnimation:Landroidx/dynamicanimation/animation/SpringAnimation;
    ...
    new-instance v1, Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelMotion$startVolumePanelDismissAnimation$2;

    invoke-direct {v1, v0, v3}, Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelMotion$startVolumePanelDismissAnimation$2;-><init>(Lcom/android/systemui/volume/view/subscreen/full/SubFullLayoutVolumePanelMotion;Ljava/lang/Runnable;)V
...
.method public final updateVolumeTitleView$1(Lcom/samsung/systemui/splugins/volume/VolumePanelState;Z)V
    .locals 3
