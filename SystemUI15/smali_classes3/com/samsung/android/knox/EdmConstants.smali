...
.field public static final ACTIVATE_KNOX_ANALYTICS_DEVICE_STATUS:Ljava/lang/String; = "com.samsung.android.knox.intent.action.ACTIVATE_KNOX_ANALYTICS_DEVICE_STATUS"

.field public static final AI_APP_RESTRICTIONS_PACKAGES:Ljava/util/List;
...
.field public static final AI_TOP_LEVEL_KEYS:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
.field public static final DEACTIVATE_KNOX_ANALYTICS_DEVICE_STATUS:Ljava/lang/String; = "com.samsung.android.knox.intent.action.DEACTIVATE_KNOX_ANALYTICS_DEVICE_STATUS"
...
.field public static final NON_AI_MANAGEMENT_SERVICE_PACKAGES:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/samsung/android/knox/EdmConstants;->AI_APP_RESTRICTIONS_PACKAGES:Ljava/util/List;

    new-instance v0, Lcom/samsung/android/knox/EdmConstants$3;

    invoke-direct {v0}, Lcom/samsung/android/knox/EdmConstants$3;-><init>()V
    ...
    new-instance v0, Lcom/samsung/android/knox/EdmConstants$4;

    invoke-direct {v0}, Lcom/samsung/android/knox/EdmConstants$4;-><init>()V

    invoke-static {v0}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object v0

    sput-object v0, Lcom/samsung/android/knox/EdmConstants;->NON_AI_MANAGEMENT_SERVICE_PACKAGES:Ljava/util/List;

    new-instance v0, Lcom/samsung/android/knox/EdmConstants$5;

    invoke-direct {v0}, Lcom/samsung/android/knox/EdmConstants$5;-><init>()V

    invoke-static {v0}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object v0

    sput-object v0, Lcom/samsung/android/knox/EdmConstants;->AI_TOP_LEVEL_KEYS:Ljava/util/List;
...
.method public static getEnterpriseKnoxSdkVersion()Lcom/samsung/android/knox/EdmConstants$EnterpriseKnoxSdkVersion;
    ...
    :pswitch_0
    sget-object v0, Lcom/samsung/android/knox/EdmConstants$EnterpriseKnoxSdkVersion;->KNOX_ENTERPRISE_SDK_VERSION_3_11:Lcom/samsung/android/knox/EdmConstants$EnterpriseKnoxSdkVersion;
...
.method public static getEnterpriseSdkVerInternal()Lcom/samsung/android/knox/EdmConstants$EnterpriseSdkVersion;
    ...
    sget-object v0, Lcom/samsung/android/knox/EdmConstants$EnterpriseSdkVersion;->ENTERPRISE_SDK_VERSION_6_11:Lcom/samsung/android/knox/EdmConstants$EnterpriseSdkVersion;
