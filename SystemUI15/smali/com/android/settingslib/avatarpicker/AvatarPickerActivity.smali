...
.method public final onActivityResult(IILandroid/content/Intent;)V
    ...
    :pswitch_0
    iget-object p0, p0, Lcom/android/settingslib/avatarpicker/AvatarPhotoController;->mAvatarUi:Lcom/android/settingslib/avatarpicker/AvatarPhotoController$AvatarUi;

    check-cast p0, Lcom/android/settingslib/avatarpicker/AvatarPhotoController$AvatarUiImpl;

    iget-object p0, p0, Lcom/android/settingslib/avatarpicker/AvatarPhotoController$AvatarUiImpl;->mActivity:Lcom/android/settingslib/avatarpicker/AvatarPickerActivity;
...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    sget-object v3, Lcom/google/android/setupcompat/partnerconfig/PartnerConfigHelper;->applyDynamicColorBundle:Landroid/os/Bundle;
    ...
    const-string v7, "isDynamicColorEnabled"
    ...
    invoke-virtual {v3, v8, v7, v5, v5}, Landroid/content/ContentResolver;->call(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    :catch_0
    const-string v3, "SetupWizard dynamic color supporting status unknown; return as false."

    invoke-static {v6, v3}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;)I

    sput-object v5, Lcom/google/android/setupcompat/partnerconfig/PartnerConfigHelper;->applyDynamicColorBundle:Landroid/os/Bundle;
    ...
    invoke-static {v7}, Lcom/google/android/setupcompat/util/WizardManagerHelper;->isAnySetupWizard(Landroid/content/Intent;)Z
    ...
    sget-object v9, Lcom/google/android/setupcompat/partnerconfig/PartnerConfigHelper;->applyFullDynamicColorBundle:Landroid/os/Bundle;

    const-string v10, "isFullDynamicColorEnabled"
    ...
    invoke-virtual {v9, v11, v10, v5, v5}, Landroid/content/ContentResolver;->call(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;

    move-result-object v9

    sput-object v9, Lcom/google/android/setupcompat/partnerconfig/PartnerConfigHelper;->applyFullDynamicColorBundle:Landroid/os/Bundle;
    :try_end_3
    ...
    :catch_1
    const-string v9, "SetupWizard full dynamic color supporting status unknown; return as false."
    ...
    :cond_2
    :goto_1
    sget-object v6, Lcom/google/android/setupcompat/partnerconfig/PartnerConfigHelper;->applyFullDynamicColorBundle:Landroid/os/Bundle;

    if-eqz v6, :cond_1

    invoke-virtual {v6, v10, v2}, Landroid/os/Bundle;->getBoolean(Ljava/lang/String;Z)Z
    ...
    :cond_9
    const-string v3, "Error occurred on getting dynamic color theme."

    invoke-virtual {v4, v3}, Lcom/google/android/setupcompat/util/Logger;->w(Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v3}, Lcom/google/android/setupcompat/util/Logger;->e(Ljava/lang/String;)V

    goto :goto_9

    :cond_a
    :goto_8
    const-string v3, "SetupWizard does not support the dynamic color or supporting status unknown."
    ...
    iput-object v3, p0, Lcom/android/settingslib/avatarpicker/AvatarPickerActivity;->mSaveButton:Landroid/widget/Button;

    if-eqz v3, :cond_b

    invoke-virtual {p0, v2}, Lcom/android/settingslib/avatarpicker/AvatarPickerActivity;->saveButtonSetEnabled(Z)V

    iget-object v3, p0, Lcom/android/settingslib/avatarpicker/AvatarPickerActivity;->mSaveButton:Landroid/widget/Button;

    new-instance v4, Lcom/android/settingslib/avatarpicker/AvatarPickerActivity$$ExternalSyntheticLambda1;

    const/4 v6, 0x2

    invoke-direct {v4, p0, v6}, Lcom/android/settingslib/avatarpicker/AvatarPickerActivity$$ExternalSyntheticLambda1;-><init>(Lcom/android/settingslib/avatarpicker/AvatarPickerActivity;I)V
    ...
    invoke-direct {v4, p0, v0}, Lcom/android/settingslib/avatarpicker/AvatarPickerActivity$$ExternalSyntheticLambda1;-><init>(Lcom/android/settingslib/avatarpicker/AvatarPickerActivity;I)V
    ...
    new-instance v3, Lcom/android/settingslib/avatarpicker/AvatarPickerActivity$AvatarAdapter;

    invoke-direct {v3, p0}, Lcom/android/settingslib/avatarpicker/AvatarPickerActivity$AvatarAdapter;-><init>(Lcom/android/settingslib/avatarpicker/AvatarPickerActivity;)V

    iput-object v3, p0, Lcom/android/settingslib/avatarpicker/AvatarPickerActivity;->mAdapter:Lcom/android/settingslib/avatarpicker/AvatarPickerActivity$AvatarAdapter;

    invoke-virtual {v0, v3}, Landroidx/recyclerview/widget/RecyclerView;->setAdapter(Landroidx/recyclerview/widget/RecyclerView$Adapter;)V

    new-instance v3, Lcom/android/settingslib/avatarpicker/AvatarPickerActivity$AutoFitGridLayoutManager;
    ...
    invoke-direct {v3, p0, p0, v4}, Lcom/android/settingslib/avatarpicker/AvatarPickerActivity$AutoFitGridLayoutManager;-><init>(Lcom/android/settingslib/avatarpicker/AvatarPickerActivity;Landroid/content/Context;I)V

    invoke-virtual {v0, v3}, Landroidx/recyclerview/widget/RecyclerView;->setLayoutManager(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;)V

    new-instance v3, Lcom/android/settingslib/avatarpicker/AvatarPickerActivity$GridItemDecoration;

    invoke-direct {v3, p0, p0, v1}, Lcom/android/settingslib/avatarpicker/AvatarPickerActivity$GridItemDecoration;-><init>(Lcom/android/settingslib/avatarpicker/AvatarPickerActivity;Landroid/content/Context;Z)V

    invoke-virtual {v0, v3}, Landroidx/recyclerview/widget/RecyclerView;->addItemDecoration(Landroidx/recyclerview/widget/RecyclerView$ItemDecoration;)V

    iput-boolean v1, v0, Landroidx/recyclerview/widget/RecyclerView;->mHasFixedSize:Z
    ...
    invoke-direct {v3, p0, v2}, Lcom/android/settingslib/avatarpicker/AvatarPickerActivity$$ExternalSyntheticLambda1;-><init>(Lcom/android/settingslib/avatarpicker/AvatarPickerActivity;I)V
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/settingslib/avatarpicker/AvatarPickerActivity$$ExternalSyntheticLambda1;-><init>(Lcom/android/settingslib/avatarpicker/AvatarPickerActivity;I)V
    ...
    new-instance v0, Lcom/android/settingslib/avatarpicker/AvatarPhotoController$AvatarUiImpl;

    invoke-direct {v0, p0}, Lcom/android/settingslib/avatarpicker/AvatarPhotoController$AvatarUiImpl;-><init>(Lcom/android/settingslib/avatarpicker/AvatarPickerActivity;)V
    ...
    invoke-direct {p1, v0, v1, v2}, Lcom/android/settingslib/avatarpicker/AvatarPhotoController;-><init>(Lcom/android/settingslib/avatarpicker/AvatarPhotoController$AvatarUi;Lcom/android/settingslib/avatarpicker/AvatarPhotoController$ContextInjector;Z)V
