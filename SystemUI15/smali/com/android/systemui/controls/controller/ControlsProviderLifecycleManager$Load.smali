...
.method public final callWrapper$frameworks__base__packages__SystemUI__android_common__SystemUI_core()Z
    ...
    const-string v1, "ServiceWrapper"
    ...
    iget-object v3, v2, Lcom/android/systemui/controls/controller/ControlsProviderLifecycleManager;->TAG:Ljava/lang/String;

    iget-object v4, v2, Lcom/android/systemui/controls/controller/ControlsProviderLifecycleManager;->componentName:Landroid/content/ComponentName;

    const-string v5, "load "

    invoke-static {v5, v4, v3}, Landroidx/core/app/NotificationManagerCompat$SideChannelManager$$ExternalSyntheticOutline0;->m(Ljava/lang/String;Landroid/content/ComponentName;Ljava/lang/String;)V

    iget-object v2, v2, Lcom/android/systemui/controls/controller/ControlsProviderLifecycleManager;->wrapper:Lcom/android/systemui/controls/controller/ServiceWrapper;
    ...
    :try_start_0
    iget-object v5, v2, Lcom/android/systemui/controls/controller/ServiceWrapper;->service:Landroid/service/controls/IControlsProvider;

    invoke-interface {v5, v4}, Landroid/service/controls/IControlsProvider;->load(Landroid/service/controls/IControlsSubscriber;)V
    :try_end_0
    ...
    :try_start_1
    iget-object v2, v2, Lcom/android/systemui/controls/controller/ServiceWrapper;->service:Landroid/service/controls/IControlsProvider;

    invoke-interface {v2, p0}, Landroid/service/controls/IControlsProvider;->loadControlsProviderInfo(Landroid/service/controls/IControlsProviderInfoSubscriber;)V
    :try_end_1
