...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    new-instance v1, Lcom/android/keyguard/ClockEventController$listenForAnyStateToLockscreenTransition$1$invokeSuspend$$inlined$filter$1;

    invoke-direct {v1, p1}, Lcom/android/keyguard/ClockEventController$listenForAnyStateToLockscreenTransition$1$invokeSuspend$$inlined$filter$1;-><init>(Lkotlinx/coroutines/flow/Flow;)V

    new-instance p1, Lcom/android/keyguard/ClockEventController$listenForAnyStateToLockscreenTransition$1$invokeSuspend$$inlined$filter$2;

    invoke-direct {p1, v1}, Lcom/android/keyguard/ClockEventController$listenForAnyStateToLockscreenTransition$1$invokeSuspend$$inlined$filter$2;-><init>(Lkotlinx/coroutines/flow/Flow;)V

    new-instance v1, Lcom/android/keyguard/ClockEventController$listenForAnyStateToLockscreenTransition$1$3;

    iget-object v3, p0, Lcom/android/keyguard/ClockEventController$listenForAnyStateToLockscreenTransition$1;->this$0:Lcom/android/keyguard/ClockEventController;

    invoke-direct {v1, v3}, Lcom/android/keyguard/ClockEventController$listenForAnyStateToLockscreenTransition$1$3;-><init>(Lcom/android/keyguard/ClockEventController;)V

    iput v2, p0, Lcom/android/keyguard/ClockEventController$listenForAnyStateToLockscreenTransition$1;->label:I

    invoke-virtual {p1, v1, p0}, Lcom/android/keyguard/ClockEventController$listenForAnyStateToLockscreenTransition$1$invokeSuspend$$inlined$filter$2;->collect(Lkotlinx/coroutines/flow/FlowCollector;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
