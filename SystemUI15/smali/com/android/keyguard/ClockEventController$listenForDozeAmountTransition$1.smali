...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v1, v3, v4}, Lcom/android/systemui/keyguard/shared/model/Edge$StateToState;-><init>(Lcom/android/systemui/keyguard/shared/model/KeyguardState;Lcom/android/systemui/keyguard/shared/model/KeyguardState;)V
    ...
    new-instance v1, Lcom/android/keyguard/ClockEventController$listenForDozeAmountTransition$1$invokeSuspend$$inlined$map$1;

    invoke-direct {v1, p1}, Lcom/android/keyguard/ClockEventController$listenForDozeAmountTransition$1$invokeSuspend$$inlined$map$1;-><init>(Lkotlinx/coroutines/flow/Flow;)V
    ...
    new-instance v1, Lcom/android/keyguard/ClockEventController$listenForDozeAmountTransition$1$invokeSuspend$$inlined$filter$1;

    invoke-direct {v1, p1}, Lcom/android/keyguard/ClockEventController$listenForDozeAmountTransition$1$invokeSuspend$$inlined$filter$1;-><init>(Lkotlinx/coroutines/flow/Flow;)V

    new-instance p1, Lcom/android/keyguard/ClockEventController$listenForDozeAmountTransition$1$3;

    iget-object v3, p0, Lcom/android/keyguard/ClockEventController$listenForDozeAmountTransition$1;->this$0:Lcom/android/keyguard/ClockEventController;

    invoke-direct {p1, v3}, Lcom/android/keyguard/ClockEventController$listenForDozeAmountTransition$1$3;-><init>(Lcom/android/keyguard/ClockEventController;)V

    iput v2, p0, Lcom/android/keyguard/ClockEventController$listenForDozeAmountTransition$1;->label:I

    invoke-virtual {v1, p1, p0}, Lcom/android/keyguard/ClockEventController$listenForDozeAmountTransition$1$invokeSuspend$$inlined$filter$1;->collect(Lkotlinx/coroutines/flow/FlowCollector;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
