...
.field public final mAutoHide:Landroidx/core/widget/NestedScrollView$3;
...
.field public final mGoToTopFadeInRunnable:Landroidx/core/widget/NestedScrollView$2;
...
.method public final computeScroll()V
    ...
    invoke-static {v1, v0}, Landroidx/reflect/view/SeslViewReflector;->setFrameContentVelocity(FLandroid/view/View;)V
...
.method public final dispatchTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    new-instance p1, Landroidx/core/widget/NestedScrollView$8;

    invoke-direct {p1, p0}, Landroidx/core/widget/NestedScrollView$8;-><init>(Landroidx/core/widget/NestedScrollView;)V
...
.method public final fling(I)V
    ...
    invoke-static {p1, p0}, Landroidx/reflect/view/SeslViewReflector;->setFrameContentVelocity(FLandroid/view/View;)V
...
.method public final onGenericMotionEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-static {v1, v3}, Landroidx/core/view/MotionEventCompat;->isFromSource(Landroid/view/MotionEvent;I)Z
    ...
    invoke-static {v1, v10}, Landroidx/core/view/MotionEventCompat;->isFromSource(Landroid/view/MotionEvent;I)Z
    ...
    invoke-static {v8, v7, v11}, Landroidx/core/widget/EdgeEffectCompat;->onPullDistance(Landroid/widget/EdgeEffect;FF)F
    ...
    invoke-static {v10, v7, v11}, Landroidx/core/widget/EdgeEffectCompat;->onPullDistance(Landroid/widget/EdgeEffect;FF)F
    ...
    iget v14, v10, Landroidx/core/view/DifferentialMotionFlingController;->mLastProcessedSource:I

    iget-object v15, v10, Landroidx/core/view/DifferentialMotionFlingController;->mFlingVelocityThresholds:[I

    if-ne v14, v12, :cond_7

    iget v14, v10, Landroidx/core/view/DifferentialMotionFlingController;->mLastProcessedDeviceId:I

    if-ne v14, v13, :cond_7

    iget v14, v10, Landroidx/core/view/DifferentialMotionFlingController;->mLastProcessedAxis:I
    ...
    :cond_7
    :goto_3
    iget-object v14, v10, Landroidx/core/view/DifferentialMotionFlingController;->mContext:Landroid/content/Context;

    iget-object v11, v10, Landroidx/core/view/DifferentialMotionFlingController;->mVelocityThresholdCalculator:Landroidx/core/view/DifferentialMotionFlingController$FlingVelocityThresholdCalculator;

    check-cast v11, Landroidx/core/view/DifferentialMotionFlingController$$ExternalSyntheticLambda0;
    ...
    invoke-virtual {v11, v14, v4, v6}, Landroid/view/ViewConfiguration;->getScaledMinimumFlingVelocity(III)I
    ...
    invoke-virtual {v11, v6, v4, v14}, Landroid/view/ViewConfiguration;->getScaledMaximumFlingVelocity(III)I

    move-result v6

    aput v6, v15, v2

    iput v12, v10, Landroidx/core/view/DifferentialMotionFlingController;->mLastProcessedSource:I

    iput v13, v10, Landroidx/core/view/DifferentialMotionFlingController;->mLastProcessedDeviceId:I
    ...
    :cond_9
    iget-object v11, v10, Landroidx/core/view/DifferentialMotionFlingController;->mVelocityTracker:Landroid/view/VelocityTracker;
    ...
    iput-object v11, v10, Landroidx/core/view/DifferentialMotionFlingController;->mVelocityTracker:Landroid/view/VelocityTracker;

    :cond_a
    iget-object v11, v10, Landroidx/core/view/DifferentialMotionFlingController;->mVelocityTracker:Landroid/view/VelocityTracker;

    iget-object v12, v10, Landroidx/core/view/DifferentialMotionFlingController;->mVelocityProvider:Landroidx/core/view/DifferentialMotionFlingController$DifferentialVelocityProvider;

    check-cast v12, Landroidx/core/view/DifferentialMotionFlingController$$ExternalSyntheticLambda0;
    ...
    invoke-virtual {v11, v1, v12}, Landroid/view/VelocityTracker;->computeCurrentVelocity(IF)V

    sget-object v13, Landroidx/core/view/VelocityTrackerCompat;->sFallbackTrackers:Ljava/util/Map;

    invoke-interface {v13, v11}, Ljava/util/Map;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v13

    check-cast v13, Landroidx/core/view/VelocityTrackerFallback;

    if-eqz v13, :cond_16

    iget v14, v13, Landroidx/core/view/VelocityTrackerFallback;->mDataPointsBufferSize:I
    ...
    :cond_b
    iget v5, v13, Landroidx/core/view/VelocityTrackerFallback;->mDataPointsBufferLastUsedIndex:I
    ...
    iget-object v14, v13, Landroidx/core/view/VelocityTrackerFallback;->mEventTimes:[J

    aget-wide v19, v14, v5
    ...
    iget v5, v13, Landroidx/core/view/VelocityTrackerFallback;->mDataPointsBufferSize:I

    sub-int/2addr v5, v2

    iput v5, v13, Landroidx/core/view/VelocityTrackerFallback;->mDataPointsBufferSize:I
    ...
    :cond_d
    iget-object v12, v13, Landroidx/core/view/VelocityTrackerFallback;->mMovements:[F
    ...
    aget-wide v24, v14, v24

    add-int/lit8 v5, v5, 0x1

    rem-int/lit8 v26, v5, 0x14
    ...
    iput v1, v13, Landroidx/core/view/VelocityTrackerFallback;->mLastComputedVelocity:F
    ...
    :cond_15
    iget v1, v13, Landroidx/core/view/VelocityTrackerFallback;->mLastComputedVelocity:F
    ...
    :cond_17
    :goto_b
    invoke-virtual {v11, v4}, Landroid/view/VelocityTracker;->getAxisVelocity(I)F

    move-result v1

    iget-object v2, v10, Landroidx/core/view/DifferentialMotionFlingController;->mTarget:Landroidx/core/view/DifferentialMotionFlingTarget;

    check-cast v2, Landroidx/core/widget/NestedScrollView$DifferentialMotionFlingTargetImpl;

    iget-object v3, v2, Landroidx/core/widget/NestedScrollView$DifferentialMotionFlingTargetImpl;->this$0:Landroidx/core/widget/NestedScrollView;
    ...
    :goto_c
    iput v6, v10, Landroidx/core/view/DifferentialMotionFlingController;->mLastFlingVelocity:F
    ...
    invoke-super {v0, v1, v7}, Landroid/widget/FrameLayout;->scrollTo(II)V

    const/4 v1, 0x1

    invoke-virtual {v0, v7, v1}, Landroidx/core/widget/NestedScrollView;->startNestedScroll(II)V
