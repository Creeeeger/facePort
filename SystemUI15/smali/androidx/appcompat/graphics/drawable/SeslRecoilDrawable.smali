...
# static fields
.field public static final PRESS_INTERPOLATOR:Landroid/view/animation/Interpolator;

.field public static final RELEASE_INTERPOLATOR:Landroid/view/animation/Interpolator;


# instance fields
.field public final mAnimator:Landroid/animation/ValueAnimator;

.field public mHotspotPointX:F

.field public mHotspotPointY:F

.field public mIsActive:Z

.field public mIsPressed:Z

.field public mListener:Landroidx/recyclerview/widget/RecyclerView$ItemBackgroundHolder$1;

.field public mPressDuration:J

.field public mRadius:I

.field public mReleaseDuration:J
...
.method static constructor <clinit>()V
    ...
    const-class v0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->mListener:Landroidx/recyclerview/widget/RecyclerView$ItemBackgroundHolder$1;

    invoke-virtual {p0}, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->init()V
...
.method public constructor <init>([Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->mListener:Landroidx/recyclerview/widget/RecyclerView$ItemBackgroundHolder$1;
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget v1, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->mHotspotPointX:F

    iget v2, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->mHotspotPointY:F

    new-instance v3, Landroid/graphics/Rect;

    invoke-direct {v3}, Landroid/graphics/Rect;-><init>()V

    invoke-virtual {p0, v3}, Landroid/graphics/drawable/LayerDrawable;->getHotspotBounds(Landroid/graphics/Rect;)V
    ...
    iget v4, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->mRadius:I
    ...
    invoke-virtual {p0, v4}, Landroid/graphics/drawable/LayerDrawable;->getHotspotBounds(Landroid/graphics/Rect;)V
...
.method public final getAnimatingTintColor()I
    .locals 2
...
.method public final inflate(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    :try_start_0
    invoke-virtual {p0, v0}, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->updateStateFromTypedArray(Landroid/content/res/TypedArray;)V
    :try_end_0
...
.method public final init()V
    ...
    new-instance v1, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable$$ExternalSyntheticLambda0;

    invoke-direct {v1, p0}, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable$$ExternalSyntheticLambda0;-><init>(Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;)V
...
.method public final onStateChange([I)Z
    ...
    invoke-virtual {p0, v3}, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->startEnterAnimation(F)V
    ...
    invoke-virtual {p0, v0}, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->startEnterAnimation(F)V
    ...
    :cond_8
    iget-boolean v4, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->mIsActive:Z

    if-eqz v4, :cond_c

    if-nez v1, :cond_c

    iget-object v4, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->mAnimator:Landroid/animation/ValueAnimator;
    ...
    :cond_9
    iget-boolean v4, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->mIsPressed:Z

    if-nez v4, :cond_a

    iget-object v3, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->mAnimator:Landroid/animation/ValueAnimator;
    ...
    sget-object v2, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->RELEASE_INTERPOLATOR:Landroid/view/animation/Interpolator;

    invoke-virtual {v0, v2}, Landroid/animation/ValueAnimator;->setInterpolator(Landroid/animation/TimeInterpolator;)V

    iget-object v0, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->mAnimator:Landroid/animation/ValueAnimator;

    iget-wide v2, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->mReleaseDuration:J
    ...
    iget-object v0, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->mListener:Landroidx/recyclerview/widget/RecyclerView$ItemBackgroundHolder$1;

    if-eqz v0, :cond_c

    iget-object v0, v0, Landroidx/recyclerview/widget/RecyclerView$ItemBackgroundHolder$1;->this$1:Landroidx/recyclerview/widget/RecyclerView$ItemBackgroundHolder;

    iget-object v2, v0, Landroidx/recyclerview/widget/RecyclerView$ItemBackgroundHolder;->mActiveBg:Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;

    iget-object v3, v2, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->mListener:Landroidx/recyclerview/widget/RecyclerView$ItemBackgroundHolder$1;

    const/4 v4, 0x0

    if-eqz v3, :cond_b

    iput-object v4, v2, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->mListener:Landroidx/recyclerview/widget/RecyclerView$ItemBackgroundHolder$1;

    :cond_b
    iput-object v4, v0, Landroidx/recyclerview/widget/RecyclerView$ItemBackgroundHolder;->mActiveBg:Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;

    :cond_c
    :goto_4
    iput-boolean v1, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->mIsActive:Z

    iput-boolean v6, p0, Landroidx/appcompat/graphics/drawable/SeslRecoilDrawable;->mIsPressed:Z
...
.method public final startEnterAnimation(F)V
    .locals 4
