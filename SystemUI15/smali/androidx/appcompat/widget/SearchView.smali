...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v1, v8}, Landroidx/appcompat/widget/SearchView$1;-><init>(Landroidx/appcompat/widget/SearchView;)V
    ...
    invoke-direct {v1, v8}, Landroidx/appcompat/widget/SearchView$2;-><init>(Landroidx/appcompat/widget/SearchView;)V

    iput-object v1, v8, Landroidx/appcompat/widget/SearchView;->mReleaseCursorRunnable:Landroidx/appcompat/widget/SearchView$2;
    ...
    invoke-direct {v10, v8}, Landroidx/appcompat/widget/SearchView$5;-><init>(Landroidx/appcompat/widget/SearchView;)V

    new-instance v11, Landroidx/appcompat/widget/SearchView$6;

    invoke-direct {v11, v8}, Landroidx/appcompat/widget/SearchView$6;-><init>(Landroidx/appcompat/widget/SearchView;)V

    new-instance v12, Landroidx/appcompat/widget/SearchView$7;

    invoke-direct {v12, v8}, Landroidx/appcompat/widget/SearchView$7;-><init>(Landroidx/appcompat/widget/SearchView;)V

    new-instance v13, Landroidx/appcompat/widget/SearchView$8;

    invoke-direct {v13, v8}, Landroidx/appcompat/widget/SearchView$8;-><init>(Landroidx/appcompat/widget/SearchView;)V

    new-instance v14, Landroidx/appcompat/widget/SearchView$9;

    invoke-direct {v14, v8}, Landroidx/appcompat/widget/SearchView$9;-><init>(Landroidx/appcompat/widget/SearchView;)V

    new-instance v15, Landroidx/appcompat/widget/SearchView$10;

    invoke-direct {v15, v8}, Landroidx/appcompat/widget/SearchView$10;-><init>(Landroidx/appcompat/widget/SearchView;)V
    ...
    invoke-static {v0, v4, v3, v6, v7}, Landroidx/appcompat/widget/TintTypedArray;->obtainStyledAttributes(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/TintTypedArray;

    move-result-object v5

    iget-object v2, v5, Landroidx/appcompat/widget/TintTypedArray;->mWrapped:Landroid/content/res/TypedArray;
    ...
    iget-object v2, v9, Landroidx/appcompat/widget/TintTypedArray;->mWrapped:Landroid/content/res/TypedArray;
    ...
    invoke-virtual {v1, v2, v8, v7}, Landroid/view/LayoutInflater;->inflate(ILandroid/view/ViewGroup;Z)Landroid/view/View;
    ...
    iput-object v4, v8, Landroidx/appcompat/widget/SearchView;->mSearchButton:Landroid/widget/ImageView;
    ...
    iput-object v5, v8, Landroidx/appcompat/widget/SearchView;->mGoButton:Landroid/widget/ImageView;
    ...
    iput-object v6, v8, Landroidx/appcompat/widget/SearchView;->mCloseButton:Landroid/widget/ImageView;
    ...
    iput-object v7, v8, Landroidx/appcompat/widget/SearchView;->mVoiceButton:Landroid/widget/ImageView;

    const v11, 0x7f0a0a70
    ...
    iput-object v14, v8, Landroidx/appcompat/widget/SearchView;->mCollapsedIcon:Landroid/widget/ImageView;
    ...
    iget-object v3, v9, Landroidx/appcompat/widget/TintTypedArray;->mWrapped:Landroid/content/res/TypedArray;
    ...
    iput-object v2, v8, Landroidx/appcompat/widget/SearchView;->mGVIVoiceIcon:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v6, v2}, Landroid/view/View;->setTooltipText(Ljava/lang/CharSequence;)V

    invoke-virtual {v5}, Landroid/widget/ImageView;->getContentDescription()Ljava/lang/CharSequence;

    move-result-object v2

    invoke-virtual {v5, v2}, Landroid/view/View;->setTooltipText(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v11, v2}, Landroid/view/View;->setTooltipText(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v1, v10}, Landroid/widget/AutoCompleteTextView;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-virtual {v1, v15}, Landroid/widget/AutoCompleteTextView;->addTextChangedListener(Landroid/text/TextWatcher;)V

    invoke-virtual {v1, v12}, Landroid/widget/AutoCompleteTextView;->setOnEditorActionListener(Landroid/widget/TextView$OnEditorActionListener;)V
    ...
    iget-boolean v2, v8, Landroidx/appcompat/widget/SearchView;->mIconifiedByDefault:Z
    ...
    iget-object v0, v8, Landroidx/appcompat/widget/SearchView;->mQueryHint:Ljava/lang/CharSequence;
    ...
    :cond_1
    iget-object v0, v8, Landroidx/appcompat/widget/SearchView;->mDefaultQueryHint:Ljava/lang/CharSequence;
    ...
    invoke-virtual {v0, v10, v2}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v0

    if-eq v0, v2, :cond_3

    iput v0, v8, Landroidx/appcompat/widget/SearchView;->mMaxWidth:I
    ...
    iput-object v0, v8, Landroidx/appcompat/widget/SearchView;->mDefaultQueryHint:Ljava/lang/CharSequence;

    iget-object v10, v9, Landroidx/appcompat/widget/TintTypedArray;->mWrapped:Landroid/content/res/TypedArray;
    ...
    iput-object v10, v8, Landroidx/appcompat/widget/SearchView;->mQueryHint:Ljava/lang/CharSequence;

    iget-object v10, v9, Landroidx/appcompat/widget/TintTypedArray;->mWrapped:Landroid/content/res/TypedArray;

    const/4 v12, 0x6

    invoke-virtual {v10, v12, v2}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v10

    if-eq v10, v2, :cond_4

    invoke-virtual {v1, v10}, Landroid/widget/AutoCompleteTextView;->setImeOptions(I)V
    ...
    invoke-virtual {v1, v10}, Landroid/widget/AutoCompleteTextView;->setInputType(I)V
    ...
    invoke-virtual {v8, v2}, Landroid/view/ViewGroup;->setFocusable(Z)V
    ...
    invoke-static {v10, v14, v13}, Landroid/graphics/Typeface;->create(Landroid/graphics/Typeface;IZ)Landroid/graphics/Typeface;

    move-result-object v10

    invoke-virtual {v1, v10}, Landroid/widget/AutoCompleteTextView;->setTypeface(Landroid/graphics/Typeface;)V
    ...
    :goto_2
    sget-object v13, Landroidx/appcompat/widget/SearchView$SeslSearchViewStyle;->LIGHT_WITH_BACKGROUND:Landroidx/appcompat/widget/SearchView$SeslSearchViewStyle;
    ...
    new-array v14, v13, [Landroidx/appcompat/widget/SearchView$SeslSearchViewStyle;

    sget-object v15, Landroidx/appcompat/widget/SearchView$SeslSearchViewStyle;->LIGHT_WITH_BACKGROUND:Landroidx/appcompat/widget/SearchView$SeslSearchViewStyle;

    const/16 v16, 0x0

    aput-object v15, v14, v16

    sget-object v15, Landroidx/appcompat/widget/SearchView$SeslSearchViewStyle;->LIGHT_WITHOUT_BACKGROUND:Landroidx/appcompat/widget/SearchView$SeslSearchViewStyle;
    ...
    sget-object v13, Landroidx/appcompat/widget/SearchView$SeslSearchViewStyle;->DARK_WITH_BACKGROUND:Landroidx/appcompat/widget/SearchView$SeslSearchViewStyle;

    aput-object v13, v14, v16

    sget-object v13, Landroidx/appcompat/widget/SearchView$SeslSearchViewStyle;->DARK_WITHOUT_BACKGROUND:Landroidx/appcompat/widget/SearchView$SeslSearchViewStyle;
    ...
    invoke-virtual {v10, v2, v1, v4}, Landroidx/appcompat/widget/SearchView$SeslSearchViewStyle;->apply(Landroid/content/res/Resources;Landroidx/appcompat/widget/SearchView$SearchAutoComplete;Ljava/util/List;)V
    ...
    iput-object v2, v8, Landroidx/appcompat/widget/SearchView;->mDropDownAnchor:Landroid/view/View;

    if-eqz v2, :cond_8

    new-instance v4, Landroidx/appcompat/widget/SearchView$4;

    invoke-direct {v4, v8}, Landroidx/appcompat/widget/SearchView$4;-><init>(Landroidx/appcompat/widget/SearchView;)V
    ...
    invoke-virtual {v8, v2}, Landroidx/appcompat/widget/SearchView;->updateViewsVisibility(Z)V

    iget-object v2, v8, Landroidx/appcompat/widget/SearchView;->mQueryHint:Ljava/lang/CharSequence;
    ...
    const-string v9, "hidden_semSetActionModeMenuItemEnabled"

    invoke-static {v1, v9, v6}, Landroidx/reflect/SeslBaseReflector;->getDeclaredMethod(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
