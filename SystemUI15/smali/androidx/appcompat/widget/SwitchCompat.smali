...
.field public final mTrackOffDrawable:Landroid/graphics/drawable/Drawable;

.field public final mTrackOnDrawable:Landroid/graphics/drawable/Drawable;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    :cond_3
    iget-object v1, v15, Landroidx/appcompat/widget/TintTypedArray;->mWrapped:Landroid/content/res/TypedArray;
    ...
    iput-boolean v1, v7, Landroidx/appcompat/widget/SwitchCompat;->mShowText:Z
    ...
    iput v1, v7, Landroidx/appcompat/widget/SwitchCompat;->mThumbTextPadding:I
    ...
    iput v1, v7, Landroidx/appcompat/widget/SwitchCompat;->mSwitchPadding:I
    ...
    iput-boolean v1, v7, Landroidx/appcompat/widget/SwitchCompat;->mSplitTrack:Z

    const/16 v1, 0xa

    invoke-virtual {v15, v1}, Landroidx/appcompat/widget/TintTypedArray;->getColorStateList(I)Landroid/content/res/ColorStateList;
    ...
    iget-boolean v3, v7, Landroidx/appcompat/widget/SwitchCompat;->mHasThumbTintMode:Z

    if-eqz v3, :cond_a

    :cond_6
    iget-object v3, v7, Landroidx/appcompat/widget/SwitchCompat;->mThumbDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iget-boolean v3, v7, Landroidx/appcompat/widget/SwitchCompat;->mHasThumbTint:Z

    if-eqz v3, :cond_8

    iget-object v3, v7, Landroidx/appcompat/widget/SwitchCompat;->mThumbTintList:Landroid/content/res/ColorStateList;
    ...
    iget-object v3, v7, Landroidx/appcompat/widget/SwitchCompat;->mThumbTintMode:Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_d
    iget-object v5, v7, Landroidx/appcompat/widget/SwitchCompat;->mTrackDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v5, v7, Landroidx/appcompat/widget/SwitchCompat;->mTrackTintList:Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v1, v5}, Landroid/graphics/drawable/Drawable;->setTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {v8, v1, v6}, Landroidx/appcompat/widget/TintTypedArray;->obtainStyledAttributes(Landroid/content/Context;I[I)Landroidx/appcompat/widget/TintTypedArray;
    ...
    invoke-virtual {v6, v14, v4}, Landroid/content/res/TypedArray;->getInt(II)I
    ...
    invoke-direct {v0, v2}, Landroidx/appcompat/text/AllCapsTransformationMethod;-><init>(Landroid/content/Context;)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p0, v7}, Landroid/widget/CompoundButton;->playSoundEffect(I)V
