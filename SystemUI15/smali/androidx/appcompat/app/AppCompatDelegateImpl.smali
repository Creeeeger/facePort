...
.method public final applyApplicationSpecificConfig(Z)Z
    ...
    invoke-virtual {v1, v3, v0}, Landroidx/appcompat/app/AppCompatDelegateImpl;->mapNightMode(ILandroid/content/Context;)I
    ...
    invoke-static {v4, v0, v5, v2}, Landroidx/appcompat/app/AppCompatDelegateImpl;->createOverrideAppConfiguration(Landroid/content/Context;ILandroid/content/res/Configuration;Z)Landroid/content/res/Configuration;

    move-result-object v4

    iget-object v0, v1, Landroidx/appcompat/app/AppCompatDelegateImpl;->mContext:Landroid/content/Context;

    iget-boolean v5, v1, Landroidx/appcompat/app/AppCompatDelegateImpl;->mActivityHandlesConfigFlagsChecked:Z
    ...
    iget-object v5, v1, Landroidx/appcompat/app/AppCompatDelegateImpl;->mHost:Ljava/lang/Object;
    ...
    invoke-virtual {v5, v8, v0}, Landroid/content/pm/PackageManager;->getActivityInfo(Landroid/content/ComponentName;I)Landroid/content/pm/ActivityInfo;
    ...
    :cond_3
    :goto_2
    iput-boolean v7, v1, Landroidx/appcompat/app/AppCompatDelegateImpl;->mActivityHandlesConfigFlagsChecked:Z
    ...
    iget-boolean v12, v1, Landroidx/appcompat/app/AppCompatDelegateImpl;->mBaseContextAttached:Z

    invoke-static {v12}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object v18

    iget-boolean v12, v1, Landroidx/appcompat/app/AppCompatDelegateImpl;->mCreated:Z
    ...
    iget-object v6, v1, Landroidx/appcompat/app/AppCompatDelegateImpl;->mHost:Ljava/lang/Object;
    ...
    invoke-virtual {v0, v6, v2}, Landroid/content/res/Resources;->updateConfiguration(Landroid/content/res/Configuration;Landroid/util/DisplayMetrics;)V
    ...
    invoke-virtual {v1, v0}, Landroidx/appcompat/app/AppCompatDelegateImpl;->getAutoTimeNightModeManager(Landroid/content/Context;)Landroidx/appcompat/app/AppCompatDelegateImpl$AutoNightModeManager;
    ...
    iget-object v2, v1, Landroidx/appcompat/app/AppCompatDelegateImpl;->mAutoBatteryNightModeManager:Landroidx/appcompat/app/AppCompatDelegateImpl$AutoBatteryNightModeManager;

    if-nez v2, :cond_13

    new-instance v2, Landroidx/appcompat/app/AppCompatDelegateImpl$AutoBatteryNightModeManager;

    invoke-direct {v2, v1, v0}, Landroidx/appcompat/app/AppCompatDelegateImpl$AutoBatteryNightModeManager;-><init>(Landroidx/appcompat/app/AppCompatDelegateImpl;Landroid/content/Context;)V

    iput-object v2, v1, Landroidx/appcompat/app/AppCompatDelegateImpl;->mAutoBatteryNightModeManager:Landroidx/appcompat/app/AppCompatDelegateImpl$AutoBatteryNightModeManager;

    :cond_13
    iget-object v0, v1, Landroidx/appcompat/app/AppCompatDelegateImpl;->mAutoBatteryNightModeManager:Landroidx/appcompat/app/AppCompatDelegateImpl$AutoBatteryNightModeManager;
...
.method public final attachBaseContext2(Landroid/content/Context;)Landroid/content/Context;
    ...
    invoke-virtual {v2, v1}, Landroidx/appcompat/app/AppLocalesStorageHelper$SerialExecutor;->execute(Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v2, v5}, Landroid/os/LocaleList;->equals(Ljava/lang/Object;)Z
    ...
    iput v2, v3, Landroid/content/res/Configuration;->screenLayout:I
...
.method public final onCreateView(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    check-cast v6, Landroidx/appcompat/app/AppCompatViewInflater;

    iput-object v6, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->mAppCompatViewInflater:Landroidx/appcompat/app/AppCompatViewInflater;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final openPanel(Landroidx/appcompat/app/AppCompatDelegateImpl$PanelFeatureState;Landroid/view/KeyEvent;)V
    ...
    invoke-virtual {v7, v8, v2}, Landroid/content/res/Resources$Theme;->applyStyle(IZ)V
    ...
    invoke-direct {v6, p2, v3}, Landroidx/appcompat/view/ContextThemeWrapper;-><init>(Landroid/content/Context;I)V
...
.method public final setSupportActionBar(Landroidx/appcompat/widget/Toolbar;)V
    ...
    iget-boolean v0, p1, Landroidx/appcompat/widget/Toolbar;->mBackInvokedCallbackEnabled:Z

    const/4 v1, 0x1

    if-eq v0, v1, :cond_3

    iput-boolean v1, p1, Landroidx/appcompat/widget/Toolbar;->mBackInvokedCallbackEnabled:Z
