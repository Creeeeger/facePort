...
.method public constructor <init>(Landroidx/recyclerview/widget/DiffUtil$Callback;Ljava/util/List;[I[IZ)V
    ...
    :goto_1
    iget v2, p2, Landroidx/recyclerview/widget/DiffUtil$Diagonal;->size:I

    if-ge v1, v2, :cond_3

    iget v2, p2, Landroidx/recyclerview/widget/DiffUtil$Diagonal;->x:I

    add-int/2addr v2, v1

    iget v3, p2, Landroidx/recyclerview/widget/DiffUtil$Diagonal;->y:I

    add-int/2addr v3, v1

    invoke-virtual {p5, v2, v3}, Landroidx/recyclerview/widget/DiffUtil$Callback;->areContentsTheSame(II)Z
    ...
    iget-object v5, p0, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->mDiagonals:Ljava/util/List;
    ...
    invoke-virtual {p5, p2, v4}, Landroidx/recyclerview/widget/DiffUtil$Callback;->areItemsTheSame(II)Z

    move-result v6

    if-eqz v6, :cond_7

    invoke-virtual {p5, p2, v4}, Landroidx/recyclerview/widget/DiffUtil$Callback;->areContentsTheSame(II)Z
    ...
    :cond_a
    iget p2, v1, Landroidx/recyclerview/widget/DiffUtil$Diagonal;->size:I
...
.method public final dispatchUpdatesTo(Landroidx/recyclerview/widget/ListUpdateCallback;)V
    ...
    invoke-static {v15, v2, v4}, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->getPostponedUpdate(ZLjava/util/Collection;I)Landroidx/recyclerview/widget/DiffUtil$PostponedUpdate;
    ...
    invoke-static {v15, v2, v9}, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->getPostponedUpdate(ZLjava/util/Collection;I)Landroidx/recyclerview/widget/DiffUtil$PostponedUpdate;
