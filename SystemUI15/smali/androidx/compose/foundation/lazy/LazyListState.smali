...
.field public final prefetchStrategy:Landroidx/compose/foundation/lazy/LazyListPrefetchStrategy;
...
.method public constructor <init>(IILandroidx/compose/foundation/lazy/LazyListPrefetchStrategy;)V
    ...
    iput-object p3, p0, Landroidx/compose/foundation/lazy/LazyListState;->canScrollForward$delegate:Landroidx/compose/runtime/ParcelableSnapshotMutableState;
    ...
    iget-object p3, v1, Landroidx/compose/animation/core/TwoWayConverterImpl;->convertToVector:Lkotlin/jvm/functions/Function1;
...
.method public constructor <init>(IILandroidx/compose/foundation/lazy/LazyListPrefetchStrategy;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    .locals 1
    ...
    new-instance p3, Landroidx/compose/foundation/lazy/DefaultLazyListPrefetchStrategy;

    const/4 p4, 0x2

    invoke-direct {p3, p4}, Landroidx/compose/foundation/lazy/DefaultLazyListPrefetchStrategy;-><init>(I)V
...
.method public final applyMeasureResult$foundation_release(Landroidx/compose/foundation/lazy/LazyListMeasureResult;ZZ)V
    ...
    iget-boolean v2, v0, Landroidx/compose/foundation/lazy/LazyListState;->hasLookaheadPassOccurred:Z

    if-eqz v2, :cond_0

    iput-object v1, v0, Landroidx/compose/foundation/lazy/LazyListState;->postLookaheadLayoutInfo:Landroidx/compose/foundation/lazy/LazyListMeasureResult;
    ...
    iput-boolean v2, v0, Landroidx/compose/foundation/lazy/LazyListState;->hasLookaheadPassOccurred:Z

    :cond_1
    iget-object v3, v1, Landroidx/compose/foundation/lazy/LazyListMeasureResult;->firstVisibleItem:Landroidx/compose/foundation/lazy/LazyListMeasuredItem;

    const/4 v4, 0x0

    if-eqz v3, :cond_2

    iget v5, v3, Landroidx/compose/foundation/lazy/LazyListMeasuredItem;->index:I
    ...
    iget-object v6, v0, Landroidx/compose/foundation/lazy/LazyListState;->canScrollBackward$delegate:Landroidx/compose/runtime/ParcelableSnapshotMutableState;

    invoke-virtual {v6, v5}, Landroidx/compose/runtime/SnapshotMutableStateImpl;->setValue(Ljava/lang/Object;)V

    iget-boolean v5, v1, Landroidx/compose/foundation/lazy/LazyListMeasureResult;->canScrollForward:Z

    invoke-static {v5}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object v5

    iget-object v6, v0, Landroidx/compose/foundation/lazy/LazyListState;->canScrollForward$delegate:Landroidx/compose/runtime/ParcelableSnapshotMutableState;

    invoke-virtual {v6, v5}, Landroidx/compose/runtime/SnapshotMutableStateImpl;->setValue(Ljava/lang/Object;)V

    iget v5, v0, Landroidx/compose/foundation/lazy/LazyListState;->scrollToBeConsumed:F

    iget v6, v1, Landroidx/compose/foundation/lazy/LazyListMeasureResult;->consumedScroll:F

    sub-float/2addr v5, v6

    iput v5, v0, Landroidx/compose/foundation/lazy/LazyListState;->scrollToBeConsumed:F
    ...
    iget-object v9, v0, Landroidx/compose/foundation/lazy/LazyListState;->scrollPosition:Landroidx/compose/foundation/lazy/LazyListScrollPosition;

    if-eqz p3, :cond_6

    iget v2, v1, Landroidx/compose/foundation/lazy/LazyListMeasureResult;->firstVisibleItemScrollOffset:I
    ...
    iget-object v3, v9, Landroidx/compose/foundation/lazy/LazyListScrollPosition;->scrollOffset$delegate:Landroidx/compose/runtime/ParcelableSnapshotMutableIntState;

    invoke-virtual {v3, v2}, Landroidx/compose/runtime/SnapshotMutableIntStateImpl;->setIntValue(I)V
    ...
    iget-object v10, v3, Landroidx/compose/foundation/lazy/LazyListMeasuredItem;->key:Ljava/lang/Object;
    ...
    :goto_3
    iput-object v10, v9, Landroidx/compose/foundation/lazy/LazyListScrollPosition;->lastKnownFirstItemKey:Ljava/lang/Object;

    iget-boolean v10, v9, Landroidx/compose/foundation/lazy/LazyListScrollPosition;->hadFirstNotEmptyLayout:Z

    if-nez v10, :cond_8

    iget v10, v1, Landroidx/compose/foundation/lazy/LazyListMeasureResult;->totalItemsCount:I

    if-lez v10, :cond_a

    :cond_8
    iput-boolean v2, v9, Landroidx/compose/foundation/lazy/LazyListScrollPosition;->hadFirstNotEmptyLayout:Z

    iget v10, v1, Landroidx/compose/foundation/lazy/LazyListMeasureResult;->firstVisibleItemScrollOffset:I
    ...
    iget v4, v3, Landroidx/compose/foundation/lazy/LazyListMeasuredItem;->index:I

    :cond_9
    invoke-virtual {v9, v4, v10}, Landroidx/compose/foundation/lazy/LazyListScrollPosition;->update(II)V

    :cond_a
    iget-boolean v3, v0, Landroidx/compose/foundation/lazy/LazyListState;->prefetchingEnabled:Z

    if-eqz v3, :cond_d

    iget-object v3, v0, Landroidx/compose/foundation/lazy/LazyListState;->prefetchStrategy:Landroidx/compose/foundation/lazy/LazyListPrefetchStrategy;

    check-cast v3, Landroidx/compose/foundation/lazy/DefaultLazyListPrefetchStrategy;

    iget v4, v3, Landroidx/compose/foundation/lazy/DefaultLazyListPrefetchStrategy;->indexToPrefetch:I

    const/4 v6, -0x1

    if-eq v4, v6, :cond_d

    iget-object v4, v1, Landroidx/compose/foundation/lazy/LazyListMeasureResult;->visibleItemsInfo:Ljava/util/List;
    ...
    iget-boolean v4, v3, Landroidx/compose/foundation/lazy/DefaultLazyListPrefetchStrategy;->wasScrollingForward:Z
    ...
    :goto_4
    iget v2, v3, Landroidx/compose/foundation/lazy/DefaultLazyListPrefetchStrategy;->indexToPrefetch:I

    if-eq v2, v4, :cond_d

    iput v6, v3, Landroidx/compose/foundation/lazy/DefaultLazyListPrefetchStrategy;->indexToPrefetch:I

    iget-object v2, v3, Landroidx/compose/foundation/lazy/DefaultLazyListPrefetchStrategy;->currentPrefetchHandle:Landroidx/compose/foundation/lazy/layout/LazyLayoutPrefetchState$PrefetchHandle;
    ...
    :cond_c
    iput-object v5, v3, Landroidx/compose/foundation/lazy/DefaultLazyListPrefetchStrategy;->currentPrefetchHandle:Landroidx/compose/foundation/lazy/layout/LazyLayoutPrefetchState$PrefetchHandle;

    :cond_d
    :goto_5
    if-eqz p2, :cond_11

    sget v2, Landroidx/compose/foundation/lazy/LazyListStateKt;->DeltaThresholdForScrollAnimation:F
    ...
    iget v3, v1, Landroidx/compose/foundation/lazy/LazyListMeasureResult;->scrollBackAmount:F
    ...
    iget-boolean v9, v8, Landroidx/compose/animation/core/AnimationState;->isRunning:Z
    :try_end_0
    ...
    :try_start_1
    invoke-static {v8, v7}, Landroidx/compose/animation/core/AnimationStateKt;->copy$default(Landroidx/compose/animation/core/AnimationState;F)Landroidx/compose/animation/core/AnimationState;

    move-result-object v3

    iput-object v3, v0, Landroidx/compose/foundation/lazy/LazyListState;->_scrollDeltaBetweenPasses:Landroidx/compose/animation/core/AnimationState;

    new-instance v3, Landroidx/compose/foundation/lazy/LazyListState$updateScrollDeltaForPostLookahead$2$1;

    invoke-direct {v3, v0, v5}, Landroidx/compose/foundation/lazy/LazyListState$updateScrollDeltaForPostLookahead$2$1;-><init>(Landroidx/compose/foundation/lazy/LazyListState;Lkotlin/coroutines/Continuation;)V

    invoke-static {v1, v5, v5, v3, v10}, Lkotlinx/coroutines/BuildersKt;->launch$default(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/CoroutineContext;Lkotlinx/coroutines/CoroutineStart;Lkotlin/jvm/functions/Function2;I)Lkotlinx/coroutines/Job;
    ...
    sget-object v12, Landroidx/compose/animation/core/VectorConvertersKt;->FloatToVector:Landroidx/compose/animation/core/TwoWayConverterImpl;
    ...
    new-instance v3, Landroidx/compose/foundation/lazy/LazyListState$updateScrollDeltaForPostLookahead$2$2;

    invoke-direct {v3, v0, v5}, Landroidx/compose/foundation/lazy/LazyListState$updateScrollDeltaForPostLookahead$2$2;-><init>(Landroidx/compose/foundation/lazy/LazyListState;Lkotlin/coroutines/Continuation;)V
    ...
    :goto_7
    invoke-static {v2, v6, v4}, Landroidx/compose/runtime/snapshots/Snapshot$Companion;->restoreNonObservable(Landroidx/compose/runtime/snapshots/Snapshot;Landroidx/compose/runtime/snapshots/Snapshot;Lkotlin/jvm/functions/Function1;)V
    ...
    :cond_12
    invoke-static {v7, v10, v6}, Landroidx/compose/animation/core/ArcMode$$ExternalSyntheticOutline0;->m(Ljava/lang/String;IC)Ljava/lang/String;
