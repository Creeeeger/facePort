...
.method public constructor <init>(Landroid/content/Context;Lkotlin/coroutines/CoroutineContext;)V
    ...
    iput-wide v2, v0, Landroidx/compose/ui/platform/AndroidComposeView;->lastDownPointerPosition:J

    const/4 v2, 0x1

    iput-boolean v2, v0, Landroidx/compose/ui/platform/AndroidComposeView;->superclassInitComplete:Z

    new-instance v3, Landroidx/compose/ui/node/LayoutNodeDrawScope;

    const/4 v4, 0x0

    invoke-direct {v3, v4, v2, v4}, Landroidx/compose/ui/node/LayoutNodeDrawScope;-><init>(Landroidx/compose/ui/graphics/drawscope/CanvasDrawScope;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    iput-object v3, v0, Landroidx/compose/ui/platform/AndroidComposeView;->sharedDrawScope:Landroidx/compose/ui/node/LayoutNodeDrawScope;
    ...
    sget-object v5, Landroidx/compose/runtime/ReferentialEqualityPolicy;->INSTANCE:Landroidx/compose/runtime/ReferentialEqualityPolicy;
    ...
    iput-object v3, v0, Landroidx/compose/ui/platform/AndroidComposeView;->density$delegate:Landroidx/compose/runtime/ParcelableSnapshotMutableState;

    new-instance v6, Landroidx/compose/ui/semantics/EmptySemanticsModifier;

    invoke-direct {v6}, Landroidx/compose/ui/semantics/EmptySemanticsModifier;-><init>()V

    new-instance v7, Landroidx/compose/ui/semantics/EmptySemanticsElement;

    invoke-direct {v7, v6}, Landroidx/compose/ui/semantics/EmptySemanticsElement;-><init>(Landroidx/compose/ui/semantics/EmptySemanticsModifier;)V

    new-instance v15, Landroidx/compose/ui/focus/FocusOwnerImpl;

    new-instance v9, Landroidx/compose/ui/platform/AndroidComposeView$focusOwner$1;

    invoke-direct {v9, v0}, Landroidx/compose/ui/platform/AndroidComposeView$focusOwner$1;-><init>(Ljava/lang/Object;)V

    new-instance v10, Landroidx/compose/ui/platform/AndroidComposeView$focusOwner$2;

    invoke-direct {v10, v0}, Landroidx/compose/ui/platform/AndroidComposeView$focusOwner$2;-><init>(Ljava/lang/Object;)V

    new-instance v11, Landroidx/compose/ui/platform/AndroidComposeView$focusOwner$3;

    invoke-direct {v11, v0}, Landroidx/compose/ui/platform/AndroidComposeView$focusOwner$3;-><init>(Ljava/lang/Object;)V

    new-instance v12, Landroidx/compose/ui/platform/AndroidComposeView$focusOwner$4;

    invoke-direct {v12, v0}, Landroidx/compose/ui/platform/AndroidComposeView$focusOwner$4;-><init>(Ljava/lang/Object;)V

    new-instance v13, Landroidx/compose/ui/platform/AndroidComposeView$focusOwner$5;

    invoke-direct {v13, v0}, Landroidx/compose/ui/platform/AndroidComposeView$focusOwner$5;-><init>(Ljava/lang/Object;)V

    new-instance v14, Landroidx/compose/ui/platform/AndroidComposeView$focusOwner$6;

    invoke-direct {v14, v0}, Landroidx/compose/ui/platform/AndroidComposeView$focusOwner$6;-><init>(Ljava/lang/Object;)V

    move-object v8, v15

    invoke-direct/range {v8 .. v14}, Landroidx/compose/ui/focus/FocusOwnerImpl;-><init>(Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function2;Lkotlin/jvm/functions/Function1;Lkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function0;Lkotlin/jvm/functions/Function0;)V

    iput-object v15, v0, Landroidx/compose/ui/platform/AndroidComposeView;->focusOwner:Landroidx/compose/ui/focus/FocusOwnerImpl;

    new-instance v8, Landroidx/compose/ui/platform/DragAndDropModifierOnDragListener;

    new-instance v9, Landroidx/compose/ui/platform/AndroidComposeView$dragAndDropModifierOnDragListener$1;

    invoke-direct {v9, v0}, Landroidx/compose/ui/platform/AndroidComposeView$dragAndDropModifierOnDragListener$1;-><init>(Ljava/lang/Object;)V

    invoke-direct {v8, v9}, Landroidx/compose/ui/platform/DragAndDropModifierOnDragListener;-><init>(Lkotlin/jvm/functions/Function3;)V

    move-object/from16 v9, p2

    iput-object v9, v0, Landroidx/compose/ui/platform/AndroidComposeView;->coroutineContext:Lkotlin/coroutines/CoroutineContext;

    iput-object v8, v0, Landroidx/compose/ui/platform/AndroidComposeView;->dragAndDropManager:Landroidx/compose/ui/platform/DragAndDropModifierOnDragListener;

    new-instance v9, Landroidx/compose/ui/platform/WindowInfoImpl;

    invoke-direct {v9}, Landroidx/compose/ui/platform/WindowInfoImpl;-><init>()V

    iput-object v9, v0, Landroidx/compose/ui/platform/AndroidComposeView;->_windowInfo:Landroidx/compose/ui/platform/WindowInfoImpl;

    sget-object v9, Landroidx/compose/ui/Modifier;->Companion:Landroidx/compose/ui/Modifier$Companion;

    new-instance v10, Landroidx/compose/ui/platform/AndroidComposeView$keyInputModifier$1;

    invoke-direct {v10, v0}, Landroidx/compose/ui/platform/AndroidComposeView$keyInputModifier$1;-><init>(Landroidx/compose/ui/platform/AndroidComposeView;)V

    invoke-static {v9, v10}, Landroidx/compose/ui/input/key/KeyInputModifierKt;->onKeyEvent(Landroidx/compose/ui/Modifier;Lkotlin/jvm/functions/Function1;)Landroidx/compose/ui/Modifier;

    move-result-object v10

    sget-object v11, Landroidx/compose/ui/platform/AndroidComposeView$rotaryInputModifier$1;->INSTANCE:Landroidx/compose/ui/platform/AndroidComposeView$rotaryInputModifier$1;

    invoke-static {v9, v11}, Landroidx/compose/ui/input/rotary/RotaryInputModifierKt;->onRotaryScrollEvent(Landroidx/compose/ui/Modifier;Lkotlin/jvm/functions/Function1;)Landroidx/compose/ui/Modifier;
    ...
    iput-object v11, v0, Landroidx/compose/ui/platform/AndroidComposeView;->canvasHolder:Landroidx/compose/ui/graphics/CanvasHolder;
    ...
    invoke-direct {v11, v12, v12, v13, v4}, Landroidx/compose/ui/node/LayoutNode;-><init>(ZIILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    invoke-virtual {v11, v3}, Landroidx/compose/ui/node/LayoutNode;->setDensity$1(Landroidx/compose/ui/unit/Density;)V
    ...
    iget-object v7, v15, Landroidx/compose/ui/focus/FocusOwnerImpl;->modifier:Landroidx/compose/ui/Modifier;

    invoke-interface {v3, v7}, Landroidx/compose/ui/Modifier;->then(Landroidx/compose/ui/Modifier;)Landroidx/compose/ui/Modifier;

    move-result-object v3

    iget-object v7, v8, Landroidx/compose/ui/platform/DragAndDropModifierOnDragListener;->modifier:Landroidx/compose/ui/platform/DragAndDropModifierOnDragListener$modifier$1;

    invoke-interface {v3, v7}, Landroidx/compose/ui/Modifier;->then(Landroidx/compose/ui/Modifier;)Landroidx/compose/ui/Modifier;

    move-result-object v3

    invoke-virtual {v11, v3}, Landroidx/compose/ui/node/LayoutNode;->setModifier(Landroidx/compose/ui/Modifier;)V

    iput-object v11, v0, Landroidx/compose/ui/platform/AndroidComposeView;->root:Landroidx/compose/ui/node/LayoutNode;

    new-instance v3, Landroidx/compose/ui/semantics/SemanticsOwner;

    invoke-direct {v3, v11, v6}, Landroidx/compose/ui/semantics/SemanticsOwner;-><init>(Landroidx/compose/ui/node/LayoutNode;Landroidx/compose/ui/semantics/EmptySemanticsModifier;)V

    iput-object v3, v0, Landroidx/compose/ui/platform/AndroidComposeView;->semanticsOwner:Landroidx/compose/ui/semantics/SemanticsOwner;

    new-instance v3, Landroidx/compose/ui/platform/AndroidComposeViewAccessibilityDelegateCompat;

    invoke-direct {v3, v0}, Landroidx/compose/ui/platform/AndroidComposeViewAccessibilityDelegateCompat;-><init>(Landroidx/compose/ui/platform/AndroidComposeView;)V

    iput-object v3, v0, Landroidx/compose/ui/platform/AndroidComposeView;->composeAccessibilityDelegate:Landroidx/compose/ui/platform/AndroidComposeViewAccessibilityDelegateCompat;

    new-instance v6, Landroidx/compose/ui/contentcapture/AndroidContentCaptureManager;

    new-instance v7, Landroidx/compose/ui/platform/AndroidComposeView$contentCaptureManager$1;

    invoke-direct {v7, v0}, Landroidx/compose/ui/platform/AndroidComposeView$contentCaptureManager$1;-><init>(Ljava/lang/Object;)V

    invoke-direct {v6, v0, v7}, Landroidx/compose/ui/contentcapture/AndroidContentCaptureManager;-><init>(Landroidx/compose/ui/platform/AndroidComposeView;Lkotlin/jvm/functions/Function0;)V

    iput-object v6, v0, Landroidx/compose/ui/platform/AndroidComposeView;->contentCaptureManager:Landroidx/compose/ui/contentcapture/AndroidContentCaptureManager;

    new-instance v7, Landroidx/compose/ui/platform/AndroidAccessibilityManager;

    invoke-direct {v7, v1}, Landroidx/compose/ui/platform/AndroidAccessibilityManager;-><init>(Landroid/content/Context;)V

    iput-object v7, v0, Landroidx/compose/ui/platform/AndroidComposeView;->accessibilityManager:Landroidx/compose/ui/platform/AndroidAccessibilityManager;

    new-instance v7, Landroidx/compose/ui/graphics/AndroidGraphicsContext;

    invoke-direct {v7, v0}, Landroidx/compose/ui/graphics/AndroidGraphicsContext;-><init>(Landroid/view/ViewGroup;)V

    iput-object v7, v0, Landroidx/compose/ui/platform/AndroidComposeView;->graphicsContext:Landroidx/compose/ui/graphics/AndroidGraphicsContext;

    new-instance v7, Landroidx/compose/ui/autofill/AutofillTree;

    invoke-direct {v7}, Landroidx/compose/ui/autofill/AutofillTree;-><init>()V

    iput-object v7, v0, Landroidx/compose/ui/platform/AndroidComposeView;->autofillTree:Landroidx/compose/ui/autofill/AutofillTree;

    new-instance v9, Ljava/util/ArrayList;

    invoke-direct {v9}, Ljava/util/ArrayList;-><init>()V

    iput-object v9, v0, Landroidx/compose/ui/platform/AndroidComposeView;->dirtyLayers:Ljava/util/List;

    new-instance v9, Landroidx/compose/ui/input/pointer/MotionEventAdapter;

    invoke-direct {v9}, Landroidx/compose/ui/input/pointer/MotionEventAdapter;-><init>()V

    iput-object v9, v0, Landroidx/compose/ui/platform/AndroidComposeView;->motionEventAdapter:Landroidx/compose/ui/input/pointer/MotionEventAdapter;

    new-instance v9, Landroidx/compose/ui/input/pointer/PointerInputEventProcessor;

    invoke-direct {v9, v11}, Landroidx/compose/ui/input/pointer/PointerInputEventProcessor;-><init>(Landroidx/compose/ui/node/LayoutNode;)V

    iput-object v9, v0, Landroidx/compose/ui/platform/AndroidComposeView;->pointerInputEventProcessor:Landroidx/compose/ui/input/pointer/PointerInputEventProcessor;
    ...
    iput-object v9, v0, Landroidx/compose/ui/platform/AndroidComposeView;->configurationChangeObserver:Lkotlin/jvm/functions/Function1;

    new-instance v9, Landroidx/compose/ui/autofill/AndroidAutofill;

    invoke-direct {v9, v0, v7}, Landroidx/compose/ui/autofill/AndroidAutofill;-><init>(Landroid/view/View;Landroidx/compose/ui/autofill/AutofillTree;)V

    iput-object v9, v0, Landroidx/compose/ui/platform/AndroidComposeView;->_autofill:Landroidx/compose/ui/autofill/AndroidAutofill;

    new-instance v7, Landroidx/compose/ui/autofill/AndroidSemanticAutofill;

    invoke-direct {v7, v0}, Landroidx/compose/ui/autofill/AndroidSemanticAutofill;-><init>(Landroidx/compose/ui/platform/AndroidComposeView;)V

    new-instance v7, Landroidx/compose/ui/platform/AndroidClipboardManager;

    invoke-direct {v7, v1}, Landroidx/compose/ui/platform/AndroidClipboardManager;-><init>(Landroid/content/Context;)V

    iput-object v7, v0, Landroidx/compose/ui/platform/AndroidComposeView;->clipboardManager:Landroidx/compose/ui/platform/AndroidClipboardManager;

    new-instance v7, Landroidx/compose/ui/node/OwnerSnapshotObserver;

    new-instance v9, Landroidx/compose/ui/platform/AndroidComposeView$snapshotObserver$1;

    invoke-direct {v9, v0}, Landroidx/compose/ui/platform/AndroidComposeView$snapshotObserver$1;-><init>(Landroidx/compose/ui/platform/AndroidComposeView;)V

    invoke-direct {v7, v9}, Landroidx/compose/ui/node/OwnerSnapshotObserver;-><init>(Lkotlin/jvm/functions/Function1;)V

    iput-object v7, v0, Landroidx/compose/ui/platform/AndroidComposeView;->snapshotObserver:Landroidx/compose/ui/node/OwnerSnapshotObserver;

    new-instance v7, Landroidx/compose/ui/node/MeasureAndLayoutDelegate;

    invoke-direct {v7, v11}, Landroidx/compose/ui/node/MeasureAndLayoutDelegate;-><init>(Landroidx/compose/ui/node/LayoutNode;)V

    iput-object v7, v0, Landroidx/compose/ui/platform/AndroidComposeView;->measureAndLayoutDelegate:Landroidx/compose/ui/node/MeasureAndLayoutDelegate;
    ...
    invoke-direct {v7, v9}, Landroidx/compose/ui/platform/AndroidViewConfiguration;-><init>(Landroid/view/ViewConfiguration;)V

    iput-object v7, v0, Landroidx/compose/ui/platform/AndroidComposeView;->viewConfiguration:Landroidx/compose/ui/platform/AndroidViewConfiguration;

    const v7, 0x7fffffff

    invoke-static {v7, v7}, Landroidx/compose/ui/unit/IntOffsetKt;->IntOffset(II)J

    move-result-wide v9

    iput-wide v9, v0, Landroidx/compose/ui/platform/AndroidComposeView;->globalPosition:J

    filled-new-array {v12, v12}, [I

    move-result-object v7

    iput-object v7, v0, Landroidx/compose/ui/platform/AndroidComposeView;->tmpPositionArray:[I

    invoke-static {}, Landroidx/compose/ui/graphics/Matrix;->constructor-impl$default()[F

    move-result-object v7

    iput-object v7, v0, Landroidx/compose/ui/platform/AndroidComposeView;->tmpMatrix:[F

    invoke-static {}, Landroidx/compose/ui/graphics/Matrix;->constructor-impl$default()[F

    move-result-object v7

    iput-object v7, v0, Landroidx/compose/ui/platform/AndroidComposeView;->viewToWindowMatrix:[F

    invoke-static {}, Landroidx/compose/ui/graphics/Matrix;->constructor-impl$default()[F

    move-result-object v7

    iput-object v7, v0, Landroidx/compose/ui/platform/AndroidComposeView;->windowToViewMatrix:[F

    const-wide/16 v9, -0x1

    iput-wide v9, v0, Landroidx/compose/ui/platform/AndroidComposeView;->lastMatrixRecalculationAnimationTime:J

    sget-wide v9, Landroidx/compose/ui/geometry/Offset;->Infinite:J

    iput-wide v9, v0, Landroidx/compose/ui/platform/AndroidComposeView;->windowPosition:J

    iput-boolean v2, v0, Landroidx/compose/ui/platform/AndroidComposeView;->isRenderNodeCompatible:Z
    ...
    iput-object v9, v0, Landroidx/compose/ui/platform/AndroidComposeView;->_viewTreeOwners$delegate:Landroidx/compose/runtime/ParcelableSnapshotMutableState;

    new-instance v9, Landroidx/compose/ui/platform/AndroidComposeView$viewTreeOwners$2;

    invoke-direct {v9, v0}, Landroidx/compose/ui/platform/AndroidComposeView$viewTreeOwners$2;-><init>(Landroidx/compose/ui/platform/AndroidComposeView;)V
    ...
    iput-object v9, v0, Landroidx/compose/ui/platform/AndroidComposeView;->viewTreeOwners$delegate:Landroidx/compose/runtime/DerivedSnapshotState;

    new-instance v9, Landroidx/compose/ui/platform/AndroidComposeView$$ExternalSyntheticLambda0;

    invoke-direct {v9, v0}, Landroidx/compose/ui/platform/AndroidComposeView$$ExternalSyntheticLambda0;-><init>(Landroidx/compose/ui/platform/AndroidComposeView;)V

    iput-object v9, v0, Landroidx/compose/ui/platform/AndroidComposeView;->globalLayoutListener:Landroidx/compose/ui/platform/AndroidComposeView$$ExternalSyntheticLambda0;

    new-instance v9, Landroidx/compose/ui/platform/AndroidComposeView$$ExternalSyntheticLambda1;

    invoke-direct {v9, v0}, Landroidx/compose/ui/platform/AndroidComposeView$$ExternalSyntheticLambda1;-><init>(Landroidx/compose/ui/platform/AndroidComposeView;)V

    iput-object v9, v0, Landroidx/compose/ui/platform/AndroidComposeView;->scrollChangedListener:Landroidx/compose/ui/platform/AndroidComposeView$$ExternalSyntheticLambda1;

    new-instance v9, Landroidx/compose/ui/platform/AndroidComposeView$$ExternalSyntheticLambda2;

    invoke-direct {v9, v0}, Landroidx/compose/ui/platform/AndroidComposeView$$ExternalSyntheticLambda2;-><init>(Landroidx/compose/ui/platform/AndroidComposeView;)V

    iput-object v9, v0, Landroidx/compose/ui/platform/AndroidComposeView;->touchModeChangeListener:Landroidx/compose/ui/platform/AndroidComposeView$$ExternalSyntheticLambda2;

    new-instance v9, Landroidx/compose/ui/text/input/TextInputServiceAndroid;

    invoke-direct {v9, v0, v0}, Landroidx/compose/ui/text/input/TextInputServiceAndroid;-><init>(Landroid/view/View;Landroidx/compose/ui/input/pointer/PositionCalculator;)V

    iput-object v9, v0, Landroidx/compose/ui/platform/AndroidComposeView;->legacyTextInputServiceAndroid:Landroidx/compose/ui/text/input/TextInputServiceAndroid;

    new-instance v10, Landroidx/compose/ui/text/input/TextInputService;

    sget-object v13, Landroidx/compose/ui/platform/AndroidComposeView_androidKt;->platformTextInputServiceInterceptor:Lkotlin/jvm/functions/Function1;

    check-cast v13, Landroidx/compose/ui/platform/AndroidComposeView_androidKt$platformTextInputServiceInterceptor$1;

    invoke-virtual {v13}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-direct {v10, v9}, Landroidx/compose/ui/text/input/TextInputService;-><init>(Landroidx/compose/ui/text/input/PlatformTextInputService;)V

    iput-object v10, v0, Landroidx/compose/ui/platform/AndroidComposeView;->textInputService:Landroidx/compose/ui/text/input/TextInputService;

    new-instance v9, Ljava/util/concurrent/atomic/AtomicReference;

    invoke-direct {v9, v4}, Ljava/util/concurrent/atomic/AtomicReference;-><init>(Ljava/lang/Object;)V

    iput-object v9, v0, Landroidx/compose/ui/platform/AndroidComposeView;->textInputSessionMutex:Ljava/util/concurrent/atomic/AtomicReference;

    new-instance v9, Landroidx/compose/ui/platform/DelegatingSoftwareKeyboardController;

    invoke-direct {v9, v10}, Landroidx/compose/ui/platform/DelegatingSoftwareKeyboardController;-><init>(Landroidx/compose/ui/text/input/TextInputService;)V

    iput-object v9, v0, Landroidx/compose/ui/platform/AndroidComposeView;->softwareKeyboardController:Landroidx/compose/ui/platform/DelegatingSoftwareKeyboardController;

    new-instance v9, Landroidx/compose/ui/platform/AndroidFontResourceLoader;

    invoke-direct {v9, v1}, Landroidx/compose/ui/platform/AndroidFontResourceLoader;-><init>(Landroid/content/Context;)V

    iput-object v9, v0, Landroidx/compose/ui/platform/AndroidComposeView;->fontLoader:Landroidx/compose/ui/platform/AndroidFontResourceLoader;
    ...
    invoke-static {v9, v5}, Landroidx/compose/runtime/SnapshotStateKt;->mutableStateOf(Ljava/lang/Object;Landroidx/compose/runtime/SnapshotMutationPolicy;)Landroidx/compose/runtime/ParcelableSnapshotMutableState;

    move-result-object v5

    iput-object v5, v0, Landroidx/compose/ui/platform/AndroidComposeView;->fontFamilyResolver$delegate:Landroidx/compose/runtime/ParcelableSnapshotMutableState;
    ...
    iput v5, v0, Landroidx/compose/ui/platform/AndroidComposeView;->currentFontWeightAdjustment:I
    ...
    :cond_2
    invoke-static {v1, v7}, Landroidx/compose/runtime/SnapshotStateKt;->mutableStateOf(Ljava/lang/Object;Landroidx/compose/runtime/SnapshotMutationPolicy;)Landroidx/compose/runtime/ParcelableSnapshotMutableState;

    move-result-object v1

    iput-object v1, v0, Landroidx/compose/ui/platform/AndroidComposeView;->layoutDirection$delegate:Landroidx/compose/runtime/ParcelableSnapshotMutableState;

    new-instance v1, Landroidx/compose/ui/hapticfeedback/PlatformHapticFeedback;

    invoke-direct {v1, v0}, Landroidx/compose/ui/hapticfeedback/PlatformHapticFeedback;-><init>(Landroid/view/View;)V

    iput-object v1, v0, Landroidx/compose/ui/platform/AndroidComposeView;->hapticFeedBack:Landroidx/compose/ui/hapticfeedback/PlatformHapticFeedback;
    ...
    sget v5, Landroidx/compose/ui/input/InputMode;->Touch:I
    ...
    sget v5, Landroidx/compose/ui/input/InputMode;->Keyboard:I

    :goto_1
    new-instance v7, Landroidx/compose/ui/platform/AndroidComposeView$_inputModeManager$1;

    invoke-direct {v7, v0}, Landroidx/compose/ui/platform/AndroidComposeView$_inputModeManager$1;-><init>(Landroidx/compose/ui/platform/AndroidComposeView;)V

    invoke-direct {v1, v5, v7, v4}, Landroidx/compose/ui/input/InputModeManagerImpl;-><init>(ILkotlin/jvm/functions/Function1;Lkotlin/jvm/internal/DefaultConstructorMarker;)V

    iput-object v1, v0, Landroidx/compose/ui/platform/AndroidComposeView;->_inputModeManager:Landroidx/compose/ui/input/InputModeManagerImpl;

    new-instance v1, Landroidx/compose/ui/modifier/ModifierLocalManager;

    invoke-direct {v1, v0}, Landroidx/compose/ui/modifier/ModifierLocalManager;-><init>(Landroidx/compose/ui/node/Owner;)V

    iput-object v1, v0, Landroidx/compose/ui/platform/AndroidComposeView;->modifierLocalManager:Landroidx/compose/ui/modifier/ModifierLocalManager;

    new-instance v1, Landroidx/compose/ui/platform/AndroidTextToolbar;

    invoke-direct {v1, v0}, Landroidx/compose/ui/platform/AndroidTextToolbar;-><init>(Landroid/view/View;)V

    iput-object v1, v0, Landroidx/compose/ui/platform/AndroidComposeView;->textToolbar:Landroidx/compose/ui/platform/AndroidTextToolbar;

    new-instance v1, Landroidx/compose/ui/platform/WeakCache;

    invoke-direct {v1}, Landroidx/compose/ui/platform/WeakCache;-><init>()V

    iput-object v1, v0, Landroidx/compose/ui/platform/AndroidComposeView;->layerCache:Landroidx/compose/ui/platform/WeakCache;
    ...
    invoke-direct {v1, v4, v12}, Landroidx/compose/runtime/collection/MutableVector;-><init>([Ljava/lang/Object;I)V

    iput-object v1, v0, Landroidx/compose/ui/platform/AndroidComposeView;->endApplyChangesListeners:Landroidx/compose/runtime/collection/MutableVector;

    new-instance v1, Landroidx/compose/ui/platform/AndroidComposeView$resendMotionEventRunnable$1;

    invoke-direct {v1, v0}, Landroidx/compose/ui/platform/AndroidComposeView$resendMotionEventRunnable$1;-><init>(Landroidx/compose/ui/platform/AndroidComposeView;)V

    iput-object v1, v0, Landroidx/compose/ui/platform/AndroidComposeView;->resendMotionEventRunnable:Landroidx/compose/ui/platform/AndroidComposeView$resendMotionEventRunnable$1;

    new-instance v1, Landroidx/compose/ui/platform/AndroidComposeView$$ExternalSyntheticLambda3;

    const/4 v4, 0x0

    invoke-direct {v1, v0, v4}, Landroidx/compose/ui/platform/AndroidComposeView$$ExternalSyntheticLambda3;-><init>(Ljava/lang/Object;I)V

    iput-object v1, v0, Landroidx/compose/ui/platform/AndroidComposeView;->sendHoverExitEvent:Landroidx/compose/ui/platform/AndroidComposeView$$ExternalSyntheticLambda3;

    new-instance v1, Landroidx/compose/ui/platform/AndroidComposeView$resendMotionEventOnLayout$1;

    invoke-direct {v1, v0}, Landroidx/compose/ui/platform/AndroidComposeView$resendMotionEventOnLayout$1;-><init>(Landroidx/compose/ui/platform/AndroidComposeView;)V

    iput-object v1, v0, Landroidx/compose/ui/platform/AndroidComposeView;->resendMotionEventOnLayout:Lkotlin/jvm/functions/Function0;
    ...
    iput-object v1, v0, Landroidx/compose/ui/platform/AndroidComposeView;->matrixToWindow:Landroidx/compose/ui/platform/CalculateMatrixToWindowApi29;

    invoke-virtual {v0, v6}, Landroid/view/ViewGroup;->addOnAttachStateChangeListener(Landroid/view/View$OnAttachStateChangeListener;)V

    invoke-virtual {v0, v12}, Landroid/view/ViewGroup;->setWillNotDraw(Z)V
    ...
    invoke-virtual {v0, v12}, Landroid/view/View;->setDefaultFocusHighlightEnabled(Z)V
    ...
    invoke-virtual {v0, v8}, Landroid/view/ViewGroup;->setOnDragListener(Landroid/view/View$OnDragListener;)V

    invoke-virtual {v11, v0}, Landroidx/compose/ui/node/LayoutNode;->attach$ui_release(Landroidx/compose/ui/node/Owner;)V

    sget-object v1, Landroidx/compose/ui/platform/AndroidComposeViewForceDarkModeQ;->INSTANCE:Landroidx/compose/ui/platform/AndroidComposeViewForceDarkModeQ;

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-virtual {v0, v12}, Landroid/view/View;->setForceDarkAllowed(Z)V
    ...
    iput-object v1, v0, Landroidx/compose/ui/platform/AndroidComposeView;->scrollCapture:Landroidx/compose/ui/scrollcapture/ScrollCapture;

    new-instance v1, Landroidx/compose/ui/platform/AndroidComposeView$pointerIconService$1;

    invoke-direct {v1, v0}, Landroidx/compose/ui/platform/AndroidComposeView$pointerIconService$1;-><init>(Landroidx/compose/ui/platform/AndroidComposeView;)V

    iput-object v1, v0, Landroidx/compose/ui/platform/AndroidComposeView;->pointerIconService:Landroidx/compose/ui/platform/AndroidComposeView$pointerIconService$1;
...
.method public static convertMeasureSpec-I7RO_PI(I)J
    ...
    sget p0, Lkotlin/ULong;->$r8$clinit:I
...
.method public final autofill(Landroid/util/SparseArray;)V
    ...
    iget-object v4, v4, Landroidx/compose/ui/autofill/AutofillTree;->children:Ljava/util/Map;
    ...
    iget-object v2, v2, Landroidx/compose/ui/autofill/AutofillNode;->onFill:Lkotlin/jvm/functions/Function1;
...
.method public final canScrollHorizontally(I)Z
    ...
    invoke-virtual {v0, v2, v3, p1, v1}, Landroidx/compose/ui/platform/AndroidComposeViewAccessibilityDelegateCompat;->canScroll-0AR0LA0$ui_release(JIZ)Z
...
.method public final dispatchDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v4, p0, Landroidx/compose/ui/platform/AndroidComposeView;->root:Landroidx/compose/ui/node/LayoutNode;
...
.method public final dispatchHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    sget-object v16, Landroidx/compose/ui/node/NodeCoordinator;->Companion:Landroidx/compose/ui/node/NodeCoordinator$Companion;
    ...
    sget-object v4, Landroidx/compose/ui/node/NodeCoordinator;->Companion:Landroidx/compose/ui/node/NodeCoordinator$Companion;
...
.method public final dispatchKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    invoke-static {v1}, Landroidx/compose/ui/input/pointer/PointerKeyboardModifiers;->box-impl(I)Landroidx/compose/ui/input/pointer/PointerKeyboardModifiers;
...
.method public final onAttachedToWindow()V
    ...
    sget v1, Landroidx/compose/ui/input/InputMode;->Touch:I
    ...
    sget v1, Landroidx/compose/ui/input/InputMode;->Keyboard:I

    :goto_0
    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v1}, Landroidx/compose/ui/input/InputMode;->box-impl(I)Landroidx/compose/ui/input/InputMode;
...
.method public final onCreateInputConnection(Landroid/view/inputmethod/EditorInfo;)Landroid/view/inputmethod/InputConnection;
    ...
    sget v4, Landroidx/compose/ui/text/input/ImeAction;->Default:I

    invoke-static {v3, v4}, Landroidx/compose/ui/text/input/ImeAction;->equals-impl0(II)Z

    move-result v5

    iget-boolean v6, v1, Landroidx/compose/ui/text/input/ImeOptions;->singleLine:Z
    ...
    :cond_4
    sget v5, Landroidx/compose/ui/text/input/ImeAction;->Go:I

    invoke-static {v3, v5}, Landroidx/compose/ui/text/input/ImeAction;->equals-impl0(II)Z
    ...
    :cond_5
    sget v5, Landroidx/compose/ui/text/input/ImeAction;->Next:I
    ...
    :cond_6
    sget v5, Landroidx/compose/ui/text/input/ImeAction;->Previous:I
    ...
    :cond_7
    sget v5, Landroidx/compose/ui/text/input/ImeAction;->Search:I
    ...
    :cond_8
    sget v5, Landroidx/compose/ui/text/input/ImeAction;->Send:I
    ...
    :cond_9
    sget v5, Landroidx/compose/ui/text/input/ImeAction;->Done:I
    ...
    iget-object v3, v1, Landroidx/compose/ui/text/input/ImeOptions;->platformImeOptions:Landroidx/compose/ui/text/input/PlatformImeOptions;
    ...
    sget v3, Landroidx/compose/ui/text/input/KeyboardType;->Text:I

    iget v5, v1, Landroidx/compose/ui/text/input/ImeOptions;->keyboardType:I

    invoke-static {v5, v3}, Landroidx/compose/ui/text/input/KeyboardType;->equals-impl0(II)Z
    ...
    :cond_b
    sget v3, Landroidx/compose/ui/text/input/KeyboardType;->Ascii:I
    ...
    :cond_c
    sget v3, Landroidx/compose/ui/text/input/KeyboardType;->Number:I
    ...
    :cond_d
    sget v3, Landroidx/compose/ui/text/input/KeyboardType;->Phone:I
    ...
    :cond_e
    sget v3, Landroidx/compose/ui/text/input/KeyboardType;->Uri:I
    ...
    :cond_f
    sget v3, Landroidx/compose/ui/text/input/KeyboardType;->Email:I
    ...
    :cond_12
    sget v3, Landroidx/compose/ui/text/input/KeyboardType;->Decimal:I
    ...
    invoke-virtual {p1, v0, v10}, Landroid/view/inputmethod/EditorInfo;->setInitialSurroundingSubText(Ljava/lang/CharSequence;I)V
    ...
    invoke-virtual {v1, v3}, Landroidx/compose/ui/text/input/NullableInputConnectionWrapperApi24;->closeDelegate(Landroid/view/inputmethod/InputConnection;)V
    ...
    invoke-direct {v2, p1, v1}, Landroidx/compose/ui/text/input/NullableInputConnectionWrapperApi34;-><init>(Landroid/view/inputmethod/InputConnection;Lkotlin/jvm/functions/Function0;)V
...
.method public final onCreateVirtualViewTranslationRequests([J[ILjava/util/function/Consumer;)V
    ...
    sget-object p2, Landroidx/compose/ui/contentcapture/AndroidContentCaptureManager$ViewTranslationHelperMethods;->INSTANCE:Landroidx/compose/ui/contentcapture/AndroidContentCaptureManager$ViewTranslationHelperMethods;
    ...
    invoke-static {v1, v3, v4, v5}, Landroidx/compose/ui/util/ListUtilsKt;->fastJoinToString$default(Ljava/util/List;Ljava/lang/CharSequence;Lkotlin/jvm/functions/Function1;I)Ljava/lang/String;
    ...
    invoke-static {v1}, Landroid/view/translation/TranslationRequestValue;->forText(Ljava/lang/CharSequence;)Landroid/view/translation/TranslationRequestValue;

    move-result-object v1

    invoke-virtual {v2, v3, v1}, Landroid/view/translation/ViewTranslationRequest$Builder;->setValue(Ljava/lang/String;Landroid/view/translation/TranslationRequestValue;)Landroid/view/translation/ViewTranslationRequest$Builder;
...
.method public final onProvideAutofillVirtualStructure(Landroid/view/ViewStructure;I)V
    ...
    iget-object v1, v0, Landroidx/compose/ui/autofill/AutofillTree;->children:Ljava/util/Map;
    ...
    iget-object v0, v0, Landroidx/compose/ui/autofill/AutofillTree;->children:Ljava/util/Map;
    ...
    invoke-virtual {v4, v3, v2}, Landroid/view/ViewStructure;->setAutofillId(Landroid/view/autofill/AutofillId;I)V

    iget-object v3, p0, Landroidx/compose/ui/autofill/AndroidAutofill;->view:Landroid/view/View;
    ...
    invoke-virtual {v4, v2, v3, v5, v5}, Landroid/view/ViewStructure;->setId(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget v2, Landroidx/compose/ui/autofill/ContentDataType;->Text:I

    invoke-virtual {v4, v2}, Landroid/view/ViewStructure;->setAutofillType(I)V

    iget-object v2, v1, Landroidx/compose/ui/autofill/AutofillNode;->autofillTypes:Ljava/util/List;
    ...
    check-cast v8, Landroidx/compose/ui/autofill/AutofillType;

    sget-object v9, Landroidx/compose/ui/autofill/AndroidAutofillType_androidKt;->androidAutofillTypes:Ljava/util/HashMap;
    ...
    invoke-virtual {v4, v2}, Landroid/view/ViewStructure;->setAutofillHints([Ljava/lang/String;)V

    iget-object v1, v1, Landroidx/compose/ui/autofill/AutofillNode;->boundingBox:Landroidx/compose/ui/geometry/Rect;

    if-nez v1, :cond_2

    const-string v1, "Autofill Warning"

    const-string v2, "Bounding box not set.\n                        Did you call perform autofillTree before the component was positioned? "
...
.method public final onRequestMeasure(Landroidx/compose/ui/node/LayoutNode;ZZZ)V
    ...
    sget-object v2, Landroidx/compose/ui/node/MeasureAndLayoutDelegate$WhenMappings;->$EnumSwitchMapping$0:[I
...
.method public final onRequestRelayout(Landroidx/compose/ui/node/LayoutNode;ZZ)V
    ...
    iget-object v7, p1, Landroidx/compose/ui/node/LayoutNode;->layoutDelegate:Landroidx/compose/ui/node/LayoutNodeLayoutDelegate;

    iget-object v7, v7, Landroidx/compose/ui/node/LayoutNodeLayoutDelegate;->layoutState:Landroidx/compose/ui/node/LayoutNode$LayoutState;

    sget-object v8, Landroidx/compose/ui/node/MeasureAndLayoutDelegate$WhenMappings;->$EnumSwitchMapping$0:[I
    ...
    :cond_3
    iput-boolean v6, v1, Landroidx/compose/ui/node/LayoutNodeLayoutDelegate;->lookaheadLayoutPending:Z

    iput-boolean v6, v1, Landroidx/compose/ui/node/LayoutNodeLayoutDelegate;->lookaheadLayoutPendingForAlignment:Z

    iput-boolean v6, v1, Landroidx/compose/ui/node/LayoutNodeLayoutDelegate;->layoutPending:Z

    iput-boolean v6, v1, Landroidx/compose/ui/node/LayoutNodeLayoutDelegate;->layoutPendingForAlignment:Z
    ...
    :cond_6
    invoke-virtual {v2, p1, v6}, Landroidx/compose/ui/node/DepthSortedSetsForDifferentPasses;->add(Landroidx/compose/ui/node/LayoutNode;Z)V
    ...
    invoke-virtual {p3, p1, v5}, Landroidx/compose/ui/node/DepthSortedSetsForDifferentPasses;->add(Landroidx/compose/ui/node/LayoutNode;Z)V
...
.method public final requestFocus(ILandroid/graphics/Rect;)Z
    ...
    sget p1, Landroidx/compose/ui/focus/FocusDirection;->Enter:I
...
.method public final sendMotionEvent-8iAsVTc(Landroid/view/MotionEvent;)I
    ...
    invoke-static {v2}, Landroidx/compose/ui/input/pointer/PointerKeyboardModifiers;->box-impl(I)Landroidx/compose/ui/input/pointer/PointerKeyboardModifiers;
...
.method public final textInputSession(Lkotlin/jvm/functions/Function2;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/intrinsics/CoroutineSingletons;
    .locals 4
