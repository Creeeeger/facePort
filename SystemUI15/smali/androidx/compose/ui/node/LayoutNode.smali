...
.method public static requestRemeasure$ui_release$default(Landroidx/compose/ui/node/LayoutNode;ZI)V
    ...
    :goto_1
    iget-boolean v4, p0, Landroidx/compose/ui/node/LayoutNode;->ignoreRemeasureRequests:Z

    if-nez v4, :cond_8

    iget-boolean v4, p0, Landroidx/compose/ui/node/LayoutNode;->isVirtual:Z
    ...
    :cond_3
    sget-object v5, Landroidx/compose/ui/node/Owner;->Companion:Landroidx/compose/ui/node/Owner$Companion;

    check-cast v4, Landroidx/compose/ui/platform/AndroidComposeView;

    invoke-virtual {v4, p0, v3, p1, v2}, Landroidx/compose/ui/platform/AndroidComposeView;->onRequestMeasure(Landroidx/compose/ui/node/LayoutNode;ZZZ)V
    ...
    :goto_2
    iget-object v2, p2, Landroidx/compose/ui/node/LayoutNode;->intrinsicsUsageByParent:Landroidx/compose/ui/node/LayoutNode$UsageByParent;
...
.method public final applyModifier(Landroidx/compose/ui/Modifier;)V
    ...
    iget-object v2, v7, Landroidx/compose/ui/node/NodeChain;->head:Landroidx/compose/ui/Modifier$Node;

    sget-object v8, Landroidx/compose/ui/node/NodeChainKt;->SentinelHead:Landroidx/compose/ui/node/NodeChainKt$SentinelHead$1;

    const/4 v9, 0x0

    if-eq v2, v8, :cond_21

    iput-object v8, v2, Landroidx/compose/ui/Modifier$Node;->parent:Landroidx/compose/ui/Modifier$Node;

    iput-object v2, v8, Landroidx/compose/ui/Modifier$Node;->child:Landroidx/compose/ui/Modifier$Node;

    iget-object v10, v7, Landroidx/compose/ui/node/NodeChain;->current:Landroidx/compose/runtime/collection/MutableVector;
    ...
    :goto_0
    iget-object v4, v7, Landroidx/compose/ui/node/NodeChain;->buffer:Landroidx/compose/runtime/collection/MutableVector;
    ...
    iget v4, v11, Landroidx/compose/runtime/collection/MutableVector;->size:I
    ...
    iget v4, v6, Landroidx/compose/runtime/collection/MutableVector;->size:I
    ...
    iget-object v12, v4, Landroidx/compose/ui/CombinedModifier;->inner:Landroidx/compose/ui/Modifier;
    ...
    invoke-direct {v1, v11}, Landroidx/compose/ui/node/NodeChainKt$fillVector$1;-><init>(Landroidx/compose/runtime/collection/MutableVector;)V
    ...
    :cond_6
    iget v1, v11, Landroidx/compose/runtime/collection/MutableVector;->size:I

    iget-object v13, v7, Landroidx/compose/ui/node/NodeChain;->tail:Landroidx/compose/ui/node/TailModifierNode;

    const-string v4, "expected prior modifier list to be non-empty"

    iget-object v6, v7, Landroidx/compose/ui/node/NodeChain;->layoutNode:Landroidx/compose/ui/node/LayoutNode;

    if-ne v1, v3, :cond_11

    iget-object v1, v8, Landroidx/compose/ui/Modifier$Node;->child:Landroidx/compose/ui/Modifier$Node;
    ...
    iget-object v15, v11, Landroidx/compose/runtime/collection/MutableVector;->content:[Ljava/lang/Object;
    ...
    :cond_7
    invoke-static {v14, v15}, Landroidx/compose/ui/Actual_jvmKt;->areObjectsOfSameType(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    :cond_9
    invoke-static {v14, v15, v1}, Landroidx/compose/ui/node/NodeChain;->updateNode(Landroidx/compose/ui/Modifier$Element;Landroidx/compose/ui/Modifier$Element;Landroidx/compose/ui/Modifier$Node;)V
    ...
    :cond_c
    invoke-static {v4}, Landroidx/compose/ui/internal/InlineClassHelperKt;->throwIllegalStateExceptionForNullCheck(Ljava/lang/String;)V
    ...
    iget-object v1, v6, Landroidx/compose/ui/node/LayoutNode;->pendingModifier:Landroidx/compose/ui/Modifier;
    ...
    :cond_11
    iget-object v2, v6, Landroidx/compose/ui/node/LayoutNode;->pendingModifier:Landroidx/compose/ui/Modifier;
    ...
    :goto_8
    iget v3, v11, Landroidx/compose/runtime/collection/MutableVector;->size:I

    if-ge v1, v3, :cond_12

    iget-object v3, v11, Landroidx/compose/runtime/collection/MutableVector;->content:[Ljava/lang/Object;
    ...
    :cond_12
    iget-object v1, v13, Landroidx/compose/ui/Modifier$Node;->parent:Landroidx/compose/ui/Modifier$Node;
    ...
    :goto_b
    iget-object v2, v7, Landroidx/compose/ui/node/NodeChain;->innerCoordinator:Landroidx/compose/ui/node/InnerNodeCoordinator;

    iput-object v1, v2, Landroidx/compose/ui/node/NodeCoordinator;->wrappedBy:Landroidx/compose/ui/node/NodeCoordinator;

    iput-object v2, v7, Landroidx/compose/ui/node/NodeChain;->outerCoordinator:Landroidx/compose/ui/node/NodeCoordinator;
    ...
    invoke-direct {v10, v1, v2}, Landroidx/compose/runtime/collection/MutableVector;-><init>([Ljava/lang/Object;I)V
    ...
    :goto_d
    iput-object v11, v7, Landroidx/compose/ui/node/NodeChain;->current:Landroidx/compose/runtime/collection/MutableVector;
    ...
    :goto_e
    iput-object v10, v7, Landroidx/compose/ui/node/NodeChain;->buffer:Landroidx/compose/runtime/collection/MutableVector;
    ...
    :goto_f
    iput-object v9, v13, Landroidx/compose/ui/Modifier$Node;->parent:Landroidx/compose/ui/Modifier$Node;

    iput-object v9, v1, Landroidx/compose/ui/Modifier$Node;->child:Landroidx/compose/ui/Modifier$Node;

    const/4 v3, -0x1

    iput v3, v1, Landroidx/compose/ui/Modifier$Node;->aggregateChildKindSet:I

    iput-object v9, v1, Landroidx/compose/ui/Modifier$Node;->coordinator:Landroidx/compose/ui/node/NodeCoordinator;

    if-eq v13, v1, :cond_1f

    iput-object v13, v7, Landroidx/compose/ui/node/NodeChain;->head:Landroidx/compose/ui/Modifier$Node;
    ...
    invoke-virtual {v7, v1}, Landroidx/compose/ui/node/NodeChain;->has-H91voCI$ui_release(I)Z
...
.method public final hitTest-M_7yMNQ$ui_release(JLandroidx/compose/ui/node/HitTestResult;ZZ)V
    ...
    sget-object v1, Landroidx/compose/ui/node/NodeCoordinator;->Companion:Landroidx/compose/ui/node/NodeCoordinator$Companion;
...
.method public final onLayoutComplete()V
    ...
    :cond_1
    :goto_0
    sget-object v5, Landroidx/compose/ui/node/NodeCoordinator;->Companion:Landroidx/compose/ui/node/NodeCoordinator$Companion;
