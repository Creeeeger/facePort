...
.method public static configurePaint-2qPWKa0$default(Landroidx/compose/ui/graphics/drawscope/CanvasDrawScope;JLandroidx/compose/ui/graphics/drawscope/DrawStyle;FLandroidx/compose/ui/graphics/ColorFilter;I)Landroidx/compose/ui/graphics/AndroidPaint;
    ...
    :cond_4
    invoke-virtual {p0}, Landroidx/compose/ui/graphics/AndroidPaint;->getFilterQuality-f-v9h1I()I
    ...
    invoke-virtual {p0, v0}, Landroidx/compose/ui/graphics/AndroidPaint;->setFilterQuality-vDHp3xo(I)V
...
.method public final configurePaint-swdJneE(Landroidx/compose/ui/graphics/Brush;Landroidx/compose/ui/graphics/drawscope/DrawStyle;FLandroidx/compose/ui/graphics/ColorFilter;II)Landroidx/compose/ui/graphics/AndroidPaint;
    ...
    :cond_5
    invoke-virtual {p2}, Landroidx/compose/ui/graphics/AndroidPaint;->getFilterQuality-f-v9h1I()I
...
.method public final drawLine-1RTmtNc(Landroidx/compose/ui/graphics/Brush;JJFILandroidx/compose/ui/graphics/PathEffect;FLandroidx/compose/ui/graphics/ColorFilter;I)V
    ...
    iget-object v8, v7, Landroidx/compose/ui/graphics/drawscope/CanvasDrawScope;->drawParams:Landroidx/compose/ui/graphics/drawscope/CanvasDrawScope$DrawParams;
    ...
    invoke-virtual {p1, v4, v11, v12, v10}, Landroidx/compose/ui/graphics/Brush;->applyTo-Pq9zytI(FJLandroidx/compose/ui/graphics/AndroidPaint;)V

    goto :goto_0

    :cond_0
    iget-object v0, v10, Landroidx/compose/ui/graphics/AndroidPaint;->internalPaint:Landroid/graphics/Paint;
    ...
    :cond_1
    invoke-virtual {v10, v4}, Landroidx/compose/ui/graphics/AndroidPaint;->setAlpha(F)V

    :goto_0
    iget-object v0, v10, Landroidx/compose/ui/graphics/AndroidPaint;->internalColorFilter:Landroidx/compose/ui/graphics/ColorFilter;
    ...
    invoke-virtual {v10, v5}, Landroidx/compose/ui/graphics/AndroidPaint;->setColorFilter(Landroidx/compose/ui/graphics/ColorFilter;)V

    :cond_2
    iget v0, v10, Landroidx/compose/ui/graphics/AndroidPaint;->_blendMode:I
    ...
    invoke-virtual {v10, v6}, Landroidx/compose/ui/graphics/AndroidPaint;->setBlendMode-s9anfk8(I)V
    ...
    :cond_4
    invoke-virtual {v10, v1}, Landroidx/compose/ui/graphics/AndroidPaint;->setStrokeWidth(F)V
    ...
    :goto_2
    invoke-virtual {v10}, Landroidx/compose/ui/graphics/AndroidPaint;->getStrokeCap-KaPHkGw()I
    ...
    invoke-virtual {v10, v2}, Landroidx/compose/ui/graphics/AndroidPaint;->setStrokeCap-BeK7IIE(I)V

    :cond_6
    invoke-virtual {v10}, Landroidx/compose/ui/graphics/AndroidPaint;->getStrokeJoin-LxFBmk8()I
    ...
    invoke-virtual {v10, v1}, Landroidx/compose/ui/graphics/AndroidPaint;->setStrokeJoin-Ww9F2mQ(I)V

    :cond_7
    iget-object v0, v10, Landroidx/compose/ui/graphics/AndroidPaint;->pathEffect:Landroidx/compose/ui/graphics/PathEffect;
    ...
    invoke-virtual {v10, v3}, Landroidx/compose/ui/graphics/AndroidPaint;->setPathEffect(Landroidx/compose/ui/graphics/PathEffect;)V

    :cond_8
    invoke-virtual {v10}, Landroidx/compose/ui/graphics/AndroidPaint;->getFilterQuality-f-v9h1I()I
    ...
    invoke-virtual {v10, v9}, Landroidx/compose/ui/graphics/AndroidPaint;->setFilterQuality-vDHp3xo(I)V
...
.method public final drawLine-NGM6Ib0(JJJFILandroidx/compose/ui/graphics/PathEffect;FLandroidx/compose/ui/graphics/ColorFilter;I)V
    ...
    invoke-static {v8, p1, p2}, Landroidx/compose/ui/graphics/Color;->copy-wmQWz5c$default(FJ)J

    move-result-wide v8

    :goto_0
    iget-object v10, v5, Landroidx/compose/ui/graphics/AndroidPaint;->internalPaint:Landroid/graphics/Paint;
    ...
    invoke-virtual {v5, v8, v9}, Landroidx/compose/ui/graphics/AndroidPaint;->setColor-8_81llA(J)V

    :cond_1
    iget-object v8, v5, Landroidx/compose/ui/graphics/AndroidPaint;->internalShader:Landroid/graphics/Shader;

    if-eqz v8, :cond_2

    const/4 v8, 0x0

    invoke-virtual {v5, v8}, Landroidx/compose/ui/graphics/AndroidPaint;->setShader(Landroid/graphics/Shader;)V

    :cond_2
    iget-object v8, v5, Landroidx/compose/ui/graphics/AndroidPaint;->internalColorFilter:Landroidx/compose/ui/graphics/ColorFilter;
    ...
    invoke-virtual {v5, v3}, Landroidx/compose/ui/graphics/AndroidPaint;->setColorFilter(Landroidx/compose/ui/graphics/ColorFilter;)V

    :cond_3
    iget v3, v5, Landroidx/compose/ui/graphics/AndroidPaint;->_blendMode:I
    ...
    invoke-virtual {v5, v4}, Landroidx/compose/ui/graphics/AndroidPaint;->setBlendMode-s9anfk8(I)V

    :cond_4
    iget-object v3, v5, Landroidx/compose/ui/graphics/AndroidPaint;->internalPaint:Landroid/graphics/Paint;
    ...
    :cond_5
    invoke-virtual {v5, v0}, Landroidx/compose/ui/graphics/AndroidPaint;->setStrokeWidth(F)V

    :goto_1
    iget-object v0, v5, Landroidx/compose/ui/graphics/AndroidPaint;->internalPaint:Landroid/graphics/Paint;
    ...
    :goto_2
    invoke-virtual {v5}, Landroidx/compose/ui/graphics/AndroidPaint;->getStrokeCap-KaPHkGw()I
    ...
    invoke-virtual {v5, v1}, Landroidx/compose/ui/graphics/AndroidPaint;->setStrokeCap-BeK7IIE(I)V

    :cond_7
    invoke-virtual {v5}, Landroidx/compose/ui/graphics/AndroidPaint;->getStrokeJoin-LxFBmk8()I
    ...
    invoke-virtual {v5, v1}, Landroidx/compose/ui/graphics/AndroidPaint;->setStrokeJoin-Ww9F2mQ(I)V

    :cond_8
    iget-object v0, v5, Landroidx/compose/ui/graphics/AndroidPaint;->pathEffect:Landroidx/compose/ui/graphics/PathEffect;
    ...
    invoke-virtual {v5, v2}, Landroidx/compose/ui/graphics/AndroidPaint;->setPathEffect(Landroidx/compose/ui/graphics/PathEffect;)V

    :cond_9
    invoke-virtual {v5}, Landroidx/compose/ui/graphics/AndroidPaint;->getFilterQuality-f-v9h1I()I
    ...
    invoke-virtual {v5, v7}, Landroidx/compose/ui/graphics/AndroidPaint;->setFilterQuality-vDHp3xo(I)V
...
.method public final selectPaint(Landroidx/compose/ui/graphics/drawscope/DrawStyle;)Landroidx/compose/ui/graphics/AndroidPaint;
    ...
    :cond_1
    invoke-virtual {p0, v1}, Landroidx/compose/ui/graphics/AndroidPaint;->setStrokeWidth(F)V

    :goto_0
    invoke-virtual {p0}, Landroidx/compose/ui/graphics/AndroidPaint;->getStrokeCap-KaPHkGw()I
    ...
    invoke-virtual {p0, v1}, Landroidx/compose/ui/graphics/AndroidPaint;->setStrokeCap-BeK7IIE(I)V
    ...
    :goto_1
    invoke-virtual {p0}, Landroidx/compose/ui/graphics/AndroidPaint;->getStrokeJoin-LxFBmk8()I
    ...
    invoke-virtual {p0, v1}, Landroidx/compose/ui/graphics/AndroidPaint;->setStrokeJoin-Ww9F2mQ(I)V
