...
.method public constructor <init>(Landroid/content/Context;Ljava/util/concurrent/Executor;Lcom/android/systemui/util/settings/SecureSettings;Lcom/android/systemui/util/DeviceConfigProxy;Lcom/android/systemui/settings/UserTracker;)V
    ...
    invoke-direct {p1, p0, p3}, Lcom/android/systemui/qrcodescanner/controller/QRCodeScannerController$$ExternalSyntheticLambda0;-><init>(Ljava/lang/Object;I)V
...
.method public final registerQRCodePreferenceObserver()V
    ...
    invoke-direct {v2, p0, v4}, Lcom/android/systemui/qrcodescanner/controller/QRCodeScannerController$$ExternalSyntheticLambda0;-><init>(Ljava/lang/Object;I)V
    ...
    const-string v1, "lock_screen_show_qr_code_scanner"
    ...
    invoke-interface {v2, v1}, Lcom/android/systemui/util/settings/SettingsProxy;->getUriFor(Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-interface {v2, v1, v3, p0, v0}, Lcom/android/systemui/util/settings/UserSettingsProxy;->registerContentObserverForUserSync(Landroid/net/Uri;ZLandroid/database/ContentObserver;I)V
...
.method public final varargs registerQRCodeScannerChangeObservers([I)V
    ...
    invoke-static {v2, v3, v4}, Lcom/android/keyguard/ClockEventController$zenModeCallback$1$$ExternalSyntheticOutline0;->m(ILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v3, p0, v4}, Lcom/android/systemui/qrcodescanner/controller/QRCodeScannerController$$ExternalSyntheticLambda0;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-virtual {v4, v5, v3, v2}, Lcom/android/systemui/util/DeviceConfigProxy;->addOnPropertiesChangedListener(Ljava/lang/String;Ljava/util/concurrent/Executor;Landroid/provider/DeviceConfig$OnPropertiesChangedListener;)V
...
.method public final varargs unregisterQRCodeScannerChangeObservers([I)V
    ...
    invoke-static {v3, v4, v5}, Lcom/android/keyguard/ClockEventController$zenModeCallback$1$$ExternalSyntheticOutline0;->m(ILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v6, v7, v4, v5}, Lcom/android/systemui/util/settings/UserSettingsProxy;->putStringForUser(Ljava/lang/String;Ljava/lang/String;I)Z
    ...
    invoke-virtual {v5, v3}, Lcom/android/systemui/util/DeviceConfigProxy;->removeOnPropertiesChangedListener(Landroid/provider/DeviceConfig$OnPropertiesChangedListener;)V
...
.method public final updateQRCodeScannerPreferenceDetails(Z)V
    ...
    invoke-interface {p1, v1, v2, v3}, Lcom/android/systemui/util/settings/UserSettingsProxy;->putStringForUser(Ljava/lang/String;Ljava/lang/String;I)Z
