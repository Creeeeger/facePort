.class final Lcom/android/systemui/media/mediaoutput/icons/device/KimchiRefrigeratorKt$KimchiRefrigerator$2;
...
# static fields
.field public static final INSTANCE:Lcom/android/systemui/media/mediaoutput/icons/device/KimchiRefrigeratorKt$KimchiRefrigerator$2;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/android/systemui/media/mediaoutput/icons/device/KimchiRefrigeratorKt$KimchiRefrigerator$2;

    invoke-direct {v0}, Lcom/android/systemui/media/mediaoutput/icons/device/KimchiRefrigeratorKt$KimchiRefrigerator$2;-><init>()V

    sput-object v0, Lcom/android/systemui/media/mediaoutput/icons/device/KimchiRefrigeratorKt$KimchiRefrigerator$2;->INSTANCE:Lcom/android/systemui/media/mediaoutput/icons/device/KimchiRefrigeratorKt$KimchiRefrigerator$2;
...
.method public final invoke()Ljava/lang/Object;
    ...
    const-string v1, "KimchiRefrigerator"
    ...
    const v1, 0x41bdd2f2    # 23.728f

    const v2, 0x40bdf3b6    # 5.936f

    invoke-virtual {v0, v1, v2}, Landroidx/compose/ui/graphics/vector/PathBuilder;->moveTo(FF)V

    const v10, 0x41cb4396    # 25.408f

    const v11, 0x40f3b646    # 7.616f

    const v6, 0x41c53b64    # 24.654f

    const v7, 0x40bdf3b6    # 5.936f

    const v8, 0x41cb4396    # 25.408f
    ...
    const v5, 0x41cb4396    # 25.408f

    const v12, 0x40f3b646    # 7.616f

    invoke-virtual {v0, v5, v12}, Landroidx/compose/ui/graphics/vector/PathBuilder;->lineTo(FF)V

    const v13, 0x41e3126f    # 28.384f

    invoke-virtual {v0, v5, v13}, Landroidx/compose/ui/graphics/vector/PathBuilder;->lineTo(FF)V

    const v10, 0x41bdd2f2    # 23.728f

    const v11, 0x41f08312    # 30.064f

    const v6, 0x41cb4396    # 25.408f

    const v7, 0x41ea7cee    # 29.311f

    const v8, 0x41c53b64    # 24.654f

    const v9, 0x41f08312    # 30.064f

    move-object v5, v0

    invoke-virtual/range {v5 .. v11}, Landroidx/compose/ui/graphics/vector/PathBuilder;->curveTo(FFFFFF)V

    const v5, 0x41f08312    # 30.064f

    invoke-virtual {v0, v1, v5}, Landroidx/compose/ui/graphics/vector/PathBuilder;->lineTo(FF)V

    const v14, 0x41445a1d    # 12.272f

    invoke-virtual {v0, v14, v5}, Landroidx/compose/ui/graphics/vector/PathBuilder;->lineTo(FF)V

    const v10, 0x412978d5    # 10.592f

    const v11, 0x41e3126f    # 28.384f

    const v6, 0x41358937    # 11.346f

    const v7, 0x41f08312    # 30.064f

    const v8, 0x412978d5    # 10.592f

    const v9, 0x41ea7cee    # 29.311f

    move-object v5, v0

    invoke-virtual/range {v5 .. v11}, Landroidx/compose/ui/graphics/vector/PathBuilder;->curveTo(FFFFFF)V

    const v5, 0x412978d5    # 10.592f

    invoke-virtual {v0, v5, v13}, Landroidx/compose/ui/graphics/vector/PathBuilder;->lineTo(FF)V

    invoke-virtual {v0, v5, v12}, Landroidx/compose/ui/graphics/vector/PathBuilder;->lineTo(FF)V

    const v10, 0x41445a1d    # 12.272f

    const v11, 0x40bdf3b6    # 5.936f

    const v6, 0x412978d5    # 10.592f

    const v7, 0x40d6147b    # 6.69f

    const v8, 0x41358937    # 11.346f

    const v9, 0x40bdf3b6    # 5.936f

    move-object v5, v0

    invoke-virtual/range {v5 .. v11}, Landroidx/compose/ui/graphics/vector/PathBuilder;->curveTo(FFFFFF)V

    const v5, 0x41bdced9    # 23.726f

    const v6, 0x41c58d50    # 24.694f
    ...
    invoke-static {v0, v5, v13, v5, v6}, Landroidx/compose/material/icons/filled/CloseKt$$ExternalSyntheticOutline0;->m(Landroidx/compose/ui/graphics/vector/PathBuilder;FFFF)V

    const v2, 0x41bdd0e5    # 23.727f

    const v6, 0x419a9fbe    # 19.328f

    invoke-virtual {v0, v2, v6}, Landroidx/compose/ui/graphics/vector/PathBuilder;->moveTo(FF)V

    invoke-virtual {v0, v14, v6}, Landroidx/compose/ui/graphics/vector/PathBuilder;->lineTo(FF)V

    const v7, 0x41b81aa0    # 23.013f

    invoke-virtual {v0, v14, v7}, Landroidx/compose/ui/graphics/vector/PathBuilder;->lineTo(FF)V

    invoke-static {v0, v5, v7, v2, v6}, Landroidx/compose/material/icons/filled/CloseKt$$ExternalSyntheticOutline0;->m(Landroidx/compose/ui/graphics/vector/PathBuilder;FFFF)V
    ...
    const v5, 0x418d3127    # 17.649f

    invoke-virtual {v0, v14, v5}, Landroidx/compose/ui/graphics/vector/PathBuilder;->lineTo(FF)V

    invoke-static {v0, v2, v5, v1, v12}, Landroidx/compose/material/icons/filled/CloseKt$$ExternalSyntheticOutline0;->m(Landroidx/compose/ui/graphics/vector/PathBuilder;FFFF)V

    const v1, 0x41765326    # 15.3953f

    const v2, 0x411a92a3    # 9.6608f

    invoke-virtual {v0, v1, v2}, Landroidx/compose/ui/graphics/vector/PathBuilder;->moveTo(FF)V

    const v5, 0x416244d0    # 14.1418f
