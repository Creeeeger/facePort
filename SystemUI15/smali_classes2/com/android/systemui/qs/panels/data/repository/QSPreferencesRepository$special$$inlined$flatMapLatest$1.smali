...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget v4, Lcom/android/systemui/qs/panels/data/repository/QSPreferencesRepository;->$r8$clinit:I

    iget-object v3, v3, Lcom/android/systemui/qs/panels/data/repository/QSPreferencesRepository;->userFileManager:Lcom/android/systemui/settings/UserFileManager;

    check-cast v3, Lcom/android/systemui/settings/UserFileManagerImpl;

    const-string v4, "quick_settings_prefs"

    invoke-virtual {v3, v1, v4}, Lcom/android/systemui/settings/UserFileManagerImpl;->getSharedPreferences$1(ILjava/lang/String;)Landroid/content/SharedPreferences;

    move-result-object v1

    sget-object v3, Lcom/android/systemui/util/kotlin/SharedPreferencesExt;->INSTANCE:Lcom/android/systemui/util/kotlin/SharedPreferencesExt;

    invoke-virtual {v3, v1}, Lcom/android/systemui/util/kotlin/SharedPreferencesExt;->observe(Landroid/content/SharedPreferences;)Lkotlinx/coroutines/flow/Flow;
    ...
    invoke-direct {v4, v5}, Lcom/android/systemui/util/kotlin/FlowKt$emitOnStart$1;-><init>(Lkotlin/coroutines/Continuation;)V
    ...
    new-instance v3, Lcom/android/systemui/qs/panels/data/repository/QSPreferencesRepository$showLabels$lambda$1$$inlined$map$1;

    invoke-direct {v3, v5, v1}, Lcom/android/systemui/qs/panels/data/repository/QSPreferencesRepository$showLabels$lambda$1$$inlined$map$1;-><init>(Lkotlinx/coroutines/flow/Flow;Landroid/content/SharedPreferences;)V
