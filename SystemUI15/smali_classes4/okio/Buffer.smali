...
.method public final indexOf(BJJ)J
    ...
    invoke-static {v0, p0, p1, v1}, Landroidx/compose/runtime/snapshots/SnapshotStateObserver$$ExternalSyntheticOutline0;->m(Ljava/lang/String;JLjava/lang/String;)Ljava/lang/StringBuilder;
...
.method public final rangeEquals(Lokio/ByteString;)Z
    .locals 6
    ...
    invoke-virtual {p1, v2}, Lokio/ByteString;->internalGet$external__okio__android_common__okio_lib(I)B
...
.method public final readLongLe()J
    ...
    iget-object v14, v1, Lokio/Segment;->data:[B
...
.method public final write([B)Lokio/BufferedSink;
    ...
    invoke-virtual {p0, p1, v1, v0}, Lokio/Buffer;->write([BII)V
...
.method public final write(Lokio/Buffer;J)V
    ...
    invoke-static {v7, v6, v4, v5}, Lkotlin/collections/ArraysKt___ArraysJvmKt;->copyInto$default([B[BII)V
...
.method public final write(Lokio/ByteString;)V
    ...
    invoke-virtual {p1, v0, p0}, Lokio/ByteString;->write$external__okio__android_common__okio_lib(ILokio/Buffer;)V
...
.method public final writeDecimalLong(J)V
    ...
    invoke-virtual {p0, v3, p1, p2}, Lokio/Buffer;->writeUtf8(IILjava/lang/String;)V
...
.method public final writeUtf8(IILjava/lang/String;)V
    ...
    invoke-static {p2, p0, p1, p3}, Landroidx/compose/foundation/text/HeightInLinesModifierKt$$ExternalSyntheticOutline0;->m(IILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public final writeUtf8(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1, v0, p1}, Lokio/Buffer;->writeUtf8(IILjava/lang/String;)V
...
.method public final writeUtf8CodePoint(I)V
    ...
    invoke-virtual {v0, v3}, Lokio/Buffer;->writableSegment$external__okio__android_common__okio_lib(I)Lokio/Segment;
    ...
    sget v9, Lokio/-SegmentedByteString;->DEFAULT__ByteString_size:I

    if-eqz v1, :cond_6

    sget-object v9, Lokio/internal/-ByteString;->HEX_DIGIT_CHARS:[C

    shr-int/lit8 v10, v1, 0x1c
    ...
    invoke-static {v2, v5, v5}, Lkotlin/collections/AbstractList$Companion;->checkBoundsIndexes$kotlin_stdlib(III)V

    new-instance v1, Ljava/lang/String;

    sub-int/2addr v5, v2

    invoke-direct {v1, v9, v2, v5}, Ljava/lang/String;-><init>([CII)V
