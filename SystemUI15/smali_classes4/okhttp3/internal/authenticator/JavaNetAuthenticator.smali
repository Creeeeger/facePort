...
.method public synthetic constructor <init>(Lokhttp3/Dns;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    sget-object p1, Lokhttp3/Dns;->SYSTEM:Lokhttp3/Dns$Companion$DnsSystem;
...
.method public static connectToInetAddress(Ljava/net/Proxy;Lokhttp3/HttpUrl;Lokhttp3/Dns;)Ljava/net/InetAddress;
    .locals 2
    ...
    :cond_2
    iget-object p0, p1, Lokhttp3/HttpUrl;->host:Ljava/lang/String;

    check-cast p2, Lokhttp3/Dns$Companion$DnsSystem;
    ...
    invoke-virtual {p2, p1}, Ljava/net/UnknownHostException;->initCause(Ljava/lang/Throwable;)Ljava/lang/Throwable;
...
.method public final authenticate(Lokhttp3/Route;Lokhttp3/Response;)Lokhttp3/Request;
    ...
    iget-object v4, v2, Lokhttp3/Response;->headers:Lokhttp3/Headers;
    ...
    invoke-virtual {v0, v11}, Lokio/Buffer;->writeUtf8(Ljava/lang/String;)V

    :try_start_0
    invoke-static {v0, v8}, Lokhttp3/internal/http/HttpHeaders;->readChallengeHeader(Lokio/Buffer;Ljava/util/List;)V
    :try_end_0
    ...
    invoke-static {v0, v12, v11}, Lokhttp3/internal/platform/Platform;->log(Ljava/lang/String;ILjava/lang/Throwable;)V
    ...
    iget-object v7, v6, Lokhttp3/Challenge;->scheme:Ljava/lang/String;
    ...
    iget-object v7, v1, Lokhttp3/Route;->address:Lokhttp3/Address;
    ...
    iget-object v8, v7, Lokhttp3/internal/authenticator/JavaNetAuthenticator;->defaultDns:Lokhttp3/Dns;
    ...
    invoke-static {v2, v5, v8}, Lokhttp3/internal/authenticator/JavaNetAuthenticator;->connectToInetAddress(Ljava/net/Proxy;Lokhttp3/HttpUrl;Lokhttp3/Dns;)Ljava/net/InetAddress;
    ...
    iget-object v8, v6, Lokhttp3/Challenge;->authParams:Ljava/util/Map;
    ...
    iget-object v8, v6, Lokhttp3/Challenge;->scheme:Ljava/lang/String;
    ...
    :cond_a
    iget-object v10, v5, Lokhttp3/HttpUrl;->host:Ljava/lang/String;

    invoke-static {v2, v5, v8}, Lokhttp3/internal/authenticator/JavaNetAuthenticator;->connectToInetAddress(Ljava/net/Proxy;Lokhttp3/HttpUrl;Lokhttp3/Dns;)Ljava/net/InetAddress;

    move-result-object v11

    iget v12, v5, Lokhttp3/HttpUrl;->port:I
    ...
    iget-object v15, v6, Lokhttp3/Challenge;->scheme:Ljava/lang/String;

    :try_start_2
    new-instance v9, Ljava/net/URL;

    iget-object v8, v5, Lokhttp3/HttpUrl;->url:Ljava/lang/String;
    ...
    iget-object v2, v6, Lokhttp3/Challenge;->authParams:Ljava/util/Map;
    ...
    :goto_b
    sget v5, Lokhttp3/Credentials;->$r8$clinit:I
    ...
    invoke-direct {v2, v4}, Lokhttp3/Request$Builder;-><init>(Lokhttp3/Request;)V

    iget-object v3, v2, Lokhttp3/Request$Builder;->headers:Lokhttp3/Headers$Builder;

    invoke-virtual {v3, v0, v1}, Lokhttp3/Headers$Builder;->set(Ljava/lang/String;Ljava/lang/String;)V
