...
.method constructor greylist-max-o <init>(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;[Ljava/lang/Object;Landroid/os/CancellationSignal;)V
    ...
    invoke-virtual {v5, v6, v7, p4, v4}, Landroid/database/sqlite/SQLiteSession;->prepare(Ljava/lang/String;ILandroid/os/CancellationSignal;Landroid/database/sqlite/SQLiteStatementInfo;)V
    ...
    :cond_1
    iget-boolean v5, v4, Landroid/database/sqlite/SQLiteStatementInfo;->readOnly:Z
    ...
    iget-object v5, v4, Landroid/database/sqlite/SQLiteStatementInfo;->columnNames:[Ljava/lang/String;

    iput-object v5, p0, Landroid/database/sqlite/SQLiteProgram;->mColumnNames:[Ljava/lang/String;

    iget v5, v4, Landroid/database/sqlite/SQLiteStatementInfo;->numParameters:I
