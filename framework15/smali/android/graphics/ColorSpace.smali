...
.method static constructor blacklist <clinit>()V
    ...
    invoke-direct/range {v14 .. v24}, Landroid/graphics/ColorSpace$Rgb$TransferParameters;-><init>(DDDDD)V

    sput-object v2, Landroid/graphics/ColorSpace;->SMPTE_170M_TRANSFER_PARAMETERS:Landroid/graphics/ColorSpace$Rgb$TransferParameters;

    new-instance v2, Landroid/graphics/ColorSpace$Rgb$TransferParameters;

    const-wide v36, -0x401a1076f23e9022L    # -0.685490157
    ...
    const-wide v30, 0x40165e05183e19b4L    # 5.591816309728916

    const-wide v32, 0x3fd23803fd659be6L    # 0.28466892

    const-wide v34, 0x3fe1eac9e840f18dL    # 0.55991073

    move-object/from16 v25, v2

    invoke-direct/range {v25 .. v39}, Landroid/graphics/ColorSpace$Rgb$TransferParameters;-><init>(DDDDDDD)V

    sput-object v2, Landroid/graphics/ColorSpace;->BT2020_HLG_TRANSFER_PARAMETERS:Landroid/graphics/ColorSpace$Rgb$TransferParameters;

    new-instance v2, Landroid/graphics/ColorSpace$Rgb$TransferParameters;

    const-wide v14, 0x40191c0d56e7162bL    # 6.277394636015326

    const-wide/high16 v16, -0x4000000000000000L    # -2.0

    const-wide v4, -0x40071dce7cd03537L    # -1.555223

    const-wide v6, 0x3ffdc46b69db65edL    # 1.860454

    const-wide v8, 0x3f89f9b5860989b1L    # 0.012683313515655966

    const-wide v10, 0x4032da0000000000L    # 18.8515625

    const-wide v12, -0x3fcd500000000000L    # -18.6875

    move-object v3, v2

    invoke-direct/range {v3 .. v17}, Landroid/graphics/ColorSpace$Rgb$TransferParameters;-><init>(DDDDDDD)V

    sput-object v2, Landroid/graphics/ColorSpace;->BT2020_PQ_TRANSFER_PARAMETERS:Landroid/graphics/ColorSpace$Rgb$TransferParameters;
    ...
    invoke-direct/range {v4 .. v11}, Landroid/graphics/ColorSpace$Rgb;-><init>(Ljava/lang/String;[F[F[FLandroid/graphics/ColorSpace$Rgb$TransferParameters;ILandroid/graphics/ColorSpace$Rgb-IA;)V
    ...
    invoke-direct/range {v4 .. v13}, Landroid/graphics/ColorSpace$Rgb;-><init>(Ljava/lang/String;[F[FDFFILandroid/graphics/ColorSpace$Rgb-IA;)V
    ...
    invoke-direct/range {v4 .. v15}, Landroid/graphics/ColorSpace$Rgb;-><init>(Ljava/lang/String;[F[F[FLjava/util/function/DoubleUnaryOperator;Ljava/util/function/DoubleUnaryOperator;FFLandroid/graphics/ColorSpace$Rgb$TransferParameters;ILandroid/graphics/ColorSpace$Rgb-IA;)V
    ...
    sget-object v5, Landroid/graphics/ColorSpace;->SRGB_PRIMARIES:[F
    ...
    const-string/jumbo v4, "scRGB IEC 61966-2-2:2003"
    ...
    invoke-direct/range {v3 .. v12}, Landroid/graphics/ColorSpace$Rgb;-><init>(Ljava/lang/String;[F[FDFFILandroid/graphics/ColorSpace$Rgb-IA;)V
    ...
    invoke-direct/range {v3 .. v10}, Landroid/graphics/ColorSpace$Rgb;-><init>(Ljava/lang/String;[F[F[FLandroid/graphics/ColorSpace$Rgb$TransferParameters;ILandroid/graphics/ColorSpace$Rgb-IA;)V
    ...
    sget-object v5, Landroid/graphics/ColorSpace;->BT2020_PRIMARIES:[F

    sget-object v6, Landroid/graphics/ColorSpace;->ILLUMINANT_D65:[F

    new-instance v8, Landroid/graphics/ColorSpace$Rgb$TransferParameters;

    const-wide v25, 0x3fb4d9e83e425aeeL    # 0.08145

    const-wide v27, 0x4001c71c71c71c72L    # 2.2222222222222223

    const-wide v19, 0x3fed1c03d1b450c3L    # 0.9096697898662786

    const-wide v21, 0x3fb71fe1725d79e9L    # 0.09033021013372146

    const-wide v23, 0x3fcc71c71c71c71cL    # 0.2222222222222222

    move-object/from16 v18, v8

    invoke-direct/range {v18 .. v28}, Landroid/graphics/ColorSpace$Rgb$TransferParameters;-><init>(DDDDD)V
    ...
    sget-object v4, Landroid/graphics/ColorSpace;->DCI_P3_PRIMARIES:[F
    ...
    sget-object v4, Landroid/graphics/ColorSpace;->NTSC_1953_PRIMARIES:[F

    sget-object v5, Landroid/graphics/ColorSpace;->ILLUMINANT_C:[F

    sget-object v7, Landroid/graphics/ColorSpace;->SMPTE_170M_TRANSFER_PARAMETERS:Landroid/graphics/ColorSpace$Rgb$TransferParameters;
    ...
    invoke-direct/range {v2 .. v11}, Landroid/graphics/ColorSpace$Rgb;-><init>(Ljava/lang/String;[F[FDFFILandroid/graphics/ColorSpace$Rgb-IA;)V
    ...
    sget-object v5, Landroid/graphics/ColorSpace;->ILLUMINANT_D60:[F
    ...
    invoke-direct/range {v6 .. v17}, Landroid/graphics/ColorSpace$Rgb;-><init>(Ljava/lang/String;[F[F[FLjava/util/function/DoubleUnaryOperator;Ljava/util/function/DoubleUnaryOperator;FFLandroid/graphics/ColorSpace$Rgb$TransferParameters;ILandroid/graphics/ColorSpace$Rgb-IA;)V
    ...
    invoke-direct {v2, v4, v3, v5}, Landroid/graphics/ColorSpace$OkLab;-><init>(Ljava/lang/String;ILandroid/graphics/ColorSpace$OkLab-IA;)V
