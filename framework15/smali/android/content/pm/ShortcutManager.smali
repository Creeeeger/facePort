...
.method public whitelist requestPinShortcut(Landroid/content/pm/ShortcutInfo;Landroid/content/IntentSender;)Z
    ...
    iget-object v0, v1, Landroid/content/pm/ShortcutManager;->mContext:Landroid/content/Context;
    ...
    iget-object v2, v1, Landroid/content/pm/ShortcutManager;->mService:Landroid/content/pm/IShortcutService;

    iget-object v3, v1, Landroid/content/pm/ShortcutManager;->mContext:Landroid/content/Context;

    invoke-virtual {v3}, Landroid/content/Context;->getPackageName()Ljava/lang/String;

    move-result-object v3

    invoke-virtual/range {p0 .. p0}, Landroid/content/pm/ShortcutManager;->injectMyUserId()I
    ...
    invoke-interface/range {v2 .. v8}, Landroid/content/pm/IShortcutService;->requestPinShortcutAsDisplay(Ljava/lang/String;Landroid/content/pm/ShortcutInfo;Landroid/content/IntentSender;IILcom/android/internal/infra/AndroidFuture;)V

    goto :goto_1

    :cond_1
    iget-object v9, v1, Landroid/content/pm/ShortcutManager;->mService:Landroid/content/pm/IShortcutService;

    iget-object v2, v1, Landroid/content/pm/ShortcutManager;->mContext:Landroid/content/Context;
    ...
    invoke-interface/range {v9 .. v15}, Landroid/content/pm/IShortcutService;->requestPinShortcutAsDisplay(Ljava/lang/String;Landroid/content/pm/ShortcutInfo;Landroid/content/IntentSender;IILcom/android/internal/infra/AndroidFuture;)V
    ...
    invoke-interface/range {v2 .. v7}, Landroid/content/pm/IShortcutService;->requestPinShortcut(Ljava/lang/String;Landroid/content/pm/ShortcutInfo;Landroid/content/IntentSender;ILcom/android/internal/infra/AndroidFuture;)V

    :goto_2
    invoke-static {v8}, Landroid/content/pm/ShortcutManager;->getFutureOrThrow(Lcom/android/internal/infra/AndroidFuture;)Ljava/lang/Object;
