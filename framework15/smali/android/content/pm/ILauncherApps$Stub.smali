...
.field static final blacklist TRANSACTION_cacheShortcuts:I = 0x21

.field static final blacklist TRANSACTION_changePackageIcon:I = 0x2a

.field static final blacklist TRANSACTION_getActivityLaunchIntent:I = 0x7

.field static final blacklist TRANSACTION_getActivityOverrides:I = 0x24

.field static final blacklist TRANSACTION_getAllSessions:I = 0x1e
...
.field static final greylist-max-o TRANSACTION_getShortcutConfigActivities:I = 0x1a

.field static final greylist-max-o TRANSACTION_getShortcutConfigActivityIntent:I = 0x1b

.field static final greylist-max-o TRANSACTION_getShortcutIconFd:I = 0x17

.field static final greylist-max-o TRANSACTION_getShortcutIconResId:I = 0x16

.field static final blacklist TRANSACTION_getShortcutIconUri:I = 0x23

.field static final blacklist TRANSACTION_getShortcutIntent:I = 0x1c

.field static final greylist-max-o TRANSACTION_getShortcuts:I = 0x12

.field static final blacklist TRANSACTION_getShortcutsAsync:I = 0x13

.field static final greylist-max-o TRANSACTION_getSuspendedPackageLauncherExtras:I = 0xe

.field static final blacklist TRANSACTION_getUserProfiles:I = 0x28

.field static final greylist-max-o TRANSACTION_hasShortcutHostPermission:I = 0x18
...
.field static final greylist-max-o TRANSACTION_pinShortcuts:I = 0x14

.field static final blacklist TRANSACTION_registerDumpCallback:I = 0x25

.field static final blacklist TRANSACTION_registerPackageInstallerCallback:I = 0x1d

.field static final blacklist TRANSACTION_registerShortcutChangeCallback:I = 0x1f
...
.field static final blacklist TRANSACTION_saveViewCaptureData:I = 0x29

.field static final blacklist TRANSACTION_setArchiveCompatibilityOptions:I = 0x27

.field static final blacklist TRANSACTION_shouldHideFromSuggestions:I = 0x19
...
.field static final greylist-max-o TRANSACTION_startShortcut:I = 0x15

.field static final blacklist TRANSACTION_unRegisterDumpCallback:I = 0x26

.field static final blacklist TRANSACTION_uncacheShortcuts:I = 0x22

.field static final blacklist TRANSACTION_unregisterShortcutChangeCallback:I = 0x20
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :pswitch_1
    invoke-virtual/range {p0 .. p0}, Landroid/content/pm/ILauncherApps$Stub;->saveViewCaptureData()V
    ...
    :pswitch_2
    invoke-virtual/range {p0 .. p0}, Landroid/content/pm/ILauncherApps$Stub;->getUserProfiles()Ljava/util/List;
    ...
    invoke-virtual {v8, v0, v1}, Landroid/content/pm/ILauncherApps$Stub;->setArchiveCompatibilityOptions(ZZ)V
    ...
    :pswitch_1f
    invoke-virtual/range {p0 .. p0}, Landroid/content/pm/ILauncherApps$Stub;->getPrivateSpaceSettingsIntent()Landroid/content/IntentSender;
    ...
    invoke-virtual {v8, v0, v1, v2}, Landroid/content/pm/ILauncherApps$Stub;->getAppMarketActivityIntent(Ljava/lang/String;Ljava/lang/String;Landroid/os/UserHandle;)Landroid/content/IntentSender;
    ...
    invoke-virtual {v8, v0}, Landroid/content/pm/ILauncherApps$Stub;->getPreInstalledSystemPackages(Landroid/os/UserHandle;)Ljava/util/List;
    ...
    invoke-virtual {v8, v0}, Landroid/content/pm/ILauncherApps$Stub;->getLauncherUserInfo(Landroid/os/UserHandle;)Landroid/content/pm/LauncherUserInfo;
