...
.method constructor greylist-max-o <init>(Landroid/os/Parcel;)V
    ...
    iput v2, v0, Landroid/content/ClipData;->mCallingUserId:I

    new-instance v2, Landroid/content/ClipDescription;

    invoke-direct {v2, v1}, Landroid/content/ClipDescription;-><init>(Landroid/os/Parcel;)V

    iput-object v2, v0, Landroid/content/ClipData;->mClipDescription:Landroid/content/ClipDescription;
    ...
    iput-object v2, v0, Landroid/content/ClipData;->mIcon:Landroid/graphics/Bitmap;
    ...
    iput-object v2, v0, Landroid/content/ClipData;->mItems:Ljava/util/ArrayList;
    ...
    sget-object v5, Landroid/view/textclassifier/TextLinks;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    invoke-direct/range {v5 .. v11}, Landroid/content/ClipData$Item;-><init>(Ljava/lang/CharSequence;Ljava/lang/String;Landroid/content/Intent;Landroid/content/IntentSender;Landroid/net/Uri;Landroid/content/ClipData$Item-IA;)V

    invoke-virtual {v5, v2}, Landroid/content/ClipData$Item;->setActivityInfo(Landroid/content/pm/ActivityInfo;)V

    invoke-virtual {v5, v1}, Landroid/content/ClipData$Item;->setTextLinks(Landroid/view/textclassifier/TextLinks;)V

    iget-object v6, v0, Landroid/content/ClipData;->mItems:Ljava/util/ArrayList;
    ...
    iput v1, v0, Landroid/content/ClipData;->mCallingUserId:I

    invoke-virtual/range {p1 .. p1}, Landroid/os/Parcel;->readString()Ljava/lang/String;

    move-result-object v1

    iput-object v1, v0, Landroid/content/ClipData;->mCallingPackageName:Ljava/lang/String;
