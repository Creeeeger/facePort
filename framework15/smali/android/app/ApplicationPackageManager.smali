...
.method private blacklist findGetLiveIconMethod(Ljava/lang/Class;)Ljava/lang/reflect/Method;
    ...
    const-string v4, "!@call method fail getLiveIcon"
...
.method private blacklist getLiveIcon(Landroid/content/pm/PackageItemInfo;IZ)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v1, v5}, Landroid/app/ApplicationPackageManager;->getPackagePath(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v8, ".LiveIconLoader"
    ...
    sget-object v9, Landroid/app/ApplicationPackageManager;->sLiveIconPackageMatchers:Landroid/util/ArrayMap;

    monitor-enter v9

    :try_start_0
    sget-object v10, Landroid/app/ApplicationPackageManager;->sLiveIconLoaders:Landroid/util/ArrayMap;
    ...
    const-string v13, " class. reuse it "
    ...
    const-string/jumbo v13, "we don\'t have "
    ...
    const-string v13, " package path. load it"
    ...
    invoke-direct {v0, v6, v12}, Ldalvik/system/PathClassLoader;-><init>(Ljava/lang/String;Ljava/lang/ClassLoader;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    :try_start_2
    invoke-static {v8, v11, v12}, Ljava/lang/Class;->forName(Ljava/lang/String;ZLjava/lang/ClassLoader;)Ljava/lang/Class;
    ...
    :try_start_3
    invoke-direct {v1, v0}, Landroid/app/ApplicationPackageManager;->findGetLiveIconMethod(Ljava/lang/Class;)Ljava/lang/reflect/Method;

    move-result-object v13

    move-object v7, v13

    sget-object v13, Landroid/app/ApplicationPackageManager;->sLiveIconPackageMatchers:Landroid/util/ArrayMap;

    invoke-virtual {v13, v5}, Landroid/util/ArrayMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v13, Landroid/app/ApplicationPackageManager;->sLiveIconLoaders:Landroid/util/ArrayMap;

    invoke-virtual {v13, v5}, Landroid/util/ArrayMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v13, Landroid/app/ApplicationPackageManager;->sLiveIconPackageMatchers:Landroid/util/ArrayMap;

    invoke-virtual {v13, v5, v6}, Landroid/util/ArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v13, Landroid/app/ApplicationPackageManager;->sLiveIconLoaders:Landroid/util/ArrayMap;

    invoke-virtual {v13, v5, v7}, Landroid/util/ArrayMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string v13, "\' package name. load it"
    ...
    invoke-direct {v0}, Landroid/app/ApplicationPackageManager$LiveIconObject;-><init>()V
    ...
    const-string v14, ", useAppIconResources : "
    ...
    iget-object v10, v1, Landroid/app/ApplicationPackageManager;->mAppIconSolution:Landroid/app/SemAppIconSolution;

    iget-object v12, v1, Landroid/app/ApplicationPackageManager;->mContext:Landroid/app/ContextImpl;

    invoke-virtual {v10, v12}, Landroid/app/SemAppIconSolution;->getAppIconPackageResources(Landroid/content/Context;)Landroid/content/res/Resources;
    ...
    invoke-virtual {v0, v11}, Landroid/app/ApplicationPackageManager$LiveIconObject;->setLiveIcon(Ljava/lang/Object;)V
    ...
    filled-new-array {v12, v11, v10}, [Ljava/lang/Object;
    ...
    invoke-direct {v14, v5, v12}, Landroid/content/ComponentName;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    filled-new-array {v15, v11, v10, v14}, [Ljava/lang/Object;
    ...
    filled-new-array {v11, v15, v10, v14}, [Ljava/lang/Object;
    ...
    check-cast v11, Landroid/app/ApplicationPackageManager$LiveIconObject;

    invoke-virtual {v11}, Landroid/app/ApplicationPackageManager$LiveIconObject;->getLiveIcon()Ljava/lang/Object;

    move-result-object v12

    instance-of v14, v12, Landroid/graphics/drawable/Drawable;
    ...
    const-string v4, "Abnormal object has returned for liveicon : "
    ...
    const-string v10, "FAILED to getLiveIcon"
...
.method private blacklist getPackagePath(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v2, "get application info error in getLiveIcon : "
...
.method private blacklist supportLiveIconByPackage(Landroid/content/pm/PackageItemInfo;)Ljava/lang/Boolean;
    ...
    invoke-virtual {p0, v3, v4}, Landroid/app/ApplicationPackageManager;->getActivityInfo(Landroid/content/ComponentName;I)Landroid/content/pm/ActivityInfo;
    ...
    invoke-virtual {p0, v3, v4}, Landroid/app/ApplicationPackageManager;->getApplicationInfo(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    ...
    const-string v3, "LiveIconSupport"
    ...
    const-string v5, "App doesn\'t support live icon : ["
    ...
    const-string v5, "]. just show default Icon."
    ...
    const-string v5, "get application info error in getLiveIcon : "
...
.method public blacklist clearAppCategoryHintDeveloper(Ljava/lang/String;)V
    ...
    invoke-interface {v0, p1}, Landroid/content/pm/IPackageManager;->clearAppCategoryHintDeveloper(Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public blacklist clearAppCategoryHintUser(Ljava/lang/String;)V
    ...
    invoke-interface {v0, p1}, Landroid/content/pm/IPackageManager;->clearAppCategoryHintUser(Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public blacklist getAppCategoryHintUserMap()Ljava/util/Map;
    ...
    invoke-interface {v0}, Landroid/content/pm/IPackageManager;->getAppCategoryHintUserMap()Ljava/util/Map;
...
.method public blacklist getAppCategoryInfos(Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-interface {v0, p1}, Landroid/content/pm/IPackageManager;->getAppCategoryInfos(Ljava/lang/String;)Ljava/util/Map;
...
.method public greylist-max-o getUserBadgeForDensity(Landroid/os/UserHandle;I)Landroid/graphics/drawable/Drawable;
    ...
    new-instance v4, Landroid/app/ApplicationPackageManager$$ExternalSyntheticLambda0;

    invoke-direct {v4, p0, p1, p2}, Landroid/app/ApplicationPackageManager$$ExternalSyntheticLambda0;-><init>(Landroid/app/ApplicationPackageManager;Landroid/os/UserHandle;I)V
...
.method public whitelist getUserBadgedIcon(Landroid/graphics/drawable/Drawable;Landroid/os/UserHandle;)Landroid/graphics/drawable/Drawable;
    ...
    new-instance v5, Landroid/app/ApplicationPackageManager$$ExternalSyntheticLambda2;

    invoke-direct {v5, p0, p2}, Landroid/app/ApplicationPackageManager$$ExternalSyntheticLambda2;-><init>(Landroid/app/ApplicationPackageManager;Landroid/os/UserHandle;)V
...
.method public blacklist loadUnbadgedItemIcon(Landroid/content/pm/PackageItemInfo;Landroid/content/pm/ApplicationInfo;ZI)Landroid/graphics/drawable/Drawable;
    ...
    :goto_3
    iget-boolean v2, v8, Landroid/content/pm/PackageItemInfo;->isArchived:Z
    ...
    iget-boolean v4, v8, Landroid/content/pm/PackageItemInfo;->isArchived:Z
    ...
    invoke-direct {v0, v4, v12}, Landroid/app/ApplicationPackageManager;->replacedIconFromAppPolicy(Ljava/lang/String;I)Z
    ...
    invoke-virtual {v4, v5, v8}, Landroid/app/SemAppIconSolution;->needToGetLiveIcon(Landroid/content/Context;Landroid/content/pm/PackageItemInfo;)Z
    ...
    invoke-virtual {v4, v5, v8, v1, v11}, Landroid/app/SemAppIconSolution;->getAppIconFromTheme(Landroid/content/Context;Landroid/content/pm/PackageItemInfo;Landroid/graphics/drawable/Drawable;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v0, v2}, Landroid/app/ApplicationPackageManager;->getArchivedAppIcon(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v8, v9, v2}, Lcom/samsung/android/core/pm/PmUtils;->supportLiveIcon(Landroid/content/pm/PackageItemInfo;Landroid/content/pm/ApplicationInfo;Landroid/content/Context;)Z

    move-result v2

    if-eqz v2, :cond_15

    invoke-direct {v0, v8, v11, v7}, Landroid/app/ApplicationPackageManager;->getLiveIcon(Landroid/content/pm/PackageItemInfo;IZ)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v1, v2, v4, v3, v5}, Landroid/app/SemAppIconSolution;->getColorThemeIcon(Landroid/content/Context;Landroid/graphics/drawable/Drawable;Ljava/lang/String;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v1, v2, v14, v11}, Landroid/app/SemAppIconSolution;->wrapIconShadowAndNight(Landroid/content/Context;Landroid/graphics/drawable/Drawable;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v1, v6}, Landroid/app/SemAppIconSolution;->applyAppIconColorFilter(Landroid/graphics/drawable/Drawable;)V
...
.method public blacklist semGetDrawableForIconTray(Landroid/graphics/drawable/Drawable;ILjava/lang/String;I)Landroid/graphics/drawable/Drawable;
    ...
    instance-of v6, v10, Landroid/app/SemAppIconSolution$ShadowDrawable;
    ...
    const-string/jumbo v7, "shadow is already applied, pkg = "
    ...
    invoke-virtual {v1, v4}, Landroid/app/SemAppIconSolution;->checkAppIconThemePackage(Landroid/content/Context;)I
    ...
    const-string v2, "Just return a stored icon at ArchiveState, pkg = "
    ...
    invoke-virtual {v3, v4, v10, v12, v1}, Landroid/app/SemAppIconSolution;->getColorThemeIcon(Landroid/content/Context;Landroid/graphics/drawable/Drawable;Ljava/lang/String;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v2, v3}, Landroid/app/SemAppIconSolution;->wrapIconShadow(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v1, v2, v10, v11}, Landroid/app/SemAppIconSolution;->wrapIconShadowAndNight(Landroid/content/Context;Landroid/graphics/drawable/Drawable;I)Landroid/graphics/drawable/Drawable;
...
.method public whitelist setAppCategoryHintDeveloper(Ljava/lang/String;I)V
    .locals 2

    :try_start_0
    iget-object v0, p0, Landroid/app/ApplicationPackageManager;->mPM:Landroid/content/pm/IPackageManager;

    invoke-interface {v0, p1, p2}, Landroid/content/pm/IPackageManager;->setAppCategoryHintDeveloper(Ljava/lang/String;I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public blacklist setAppCategoryHintUser(Ljava/lang/String;I)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/content/pm/IPackageManager;->setAppCategoryHintUser(Ljava/lang/String;I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
