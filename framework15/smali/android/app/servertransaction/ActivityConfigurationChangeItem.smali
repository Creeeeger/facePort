...
.method public static blacklist obtain(Landroid/os/IBinder;Landroid/content/res/Configuration;Landroid/window/ActivityWindowInfo;)Landroid/app/servertransaction/ActivityConfigurationChangeItem;
    .locals 2
    ...
    :cond_0
    invoke-virtual {v0, p0}, Landroid/app/servertransaction/ActivityConfigurationChangeItem;->setActivityToken(Landroid/os/IBinder;)V

    new-instance v1, Landroid/content/res/Configuration;

    invoke-direct {v1, p1}, Landroid/content/res/Configuration;-><init>(Landroid/content/res/Configuration;)V

    iput-object v1, v0, Landroid/app/servertransaction/ActivityConfigurationChangeItem;->mConfiguration:Landroid/content/res/Configuration;

    new-instance v1, Landroid/window/ActivityWindowInfo;

    invoke-direct {v1, p2}, Landroid/window/ActivityWindowInfo;-><init>(Landroid/window/ActivityWindowInfo;)V

    iput-object v1, v0, Landroid/app/servertransaction/ActivityConfigurationChangeItem;->mActivityWindowInfo:Landroid/window/ActivityWindowInfo;
