...
# direct methods
.method public static synthetic blacklist $r8$lambda$4KcKOAMR-1CdXfbliW5ZV-l4y-g(Landroid/window/TaskOrganizer$1;IZ)V
    .locals 0

    invoke-direct {p0, p1, p2}, Landroid/window/TaskOrganizer$1;->lambda$onImmersiveModeChanged$10(IZ)V

    return-void
.end method

.method public static synthetic blacklist $r8$lambda$8pYE2mE6gMoeDMIID9aBjyuOxYY(Landroid/window/TaskOrganizer$1;IZ)V
    .locals 0

    invoke-direct {p0, p1, p2}, Landroid/window/TaskOrganizer$1;->lambda$onNewDexImmersiveModeChanged$11(IZ)V
...
.method public static synthetic blacklist $r8$lambda$dxu9QsDD70MqumlDfC2-Qzlc8Ss(Landroid/window/TaskOrganizer$1;Landroid/app/ActivityManager$RunningTaskInfo;I)V
    .locals 0

    invoke-direct {p0, p1, p2}, Landroid/window/TaskOrganizer$1;->lambda$requestAffordanceAnim$13(Landroid/app/ActivityManager$RunningTaskInfo;I)V
...
.method public static synthetic blacklist $r8$lambda$rDXp5ZhjhJzRN8AvxpdgUpbi4i4(Landroid/window/TaskOrganizer$1;IZ)V
    .locals 0

    invoke-direct {p0, p1, p2}, Landroid/window/TaskOrganizer$1;->lambda$resetStashedFreeform$12(IZ)V

    return-void
.end method

.method public static synthetic blacklist $r8$lambda$uhrvnZTYX2xTIjidTjGQ_3TDCAc(Landroid/window/TaskOrganizer$1;Landroid/content/pm/ActivityInfo;ILandroid/content/res/Configuration;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Landroid/window/TaskOrganizer$1;->lambda$preloadSplashScreenAppIcon$14(Landroid/content/pm/ActivityInfo;ILandroid/content/res/Configuration;)V
...
.method private synthetic blacklist lambda$onImmersiveModeChanged$10(IZ)V
    .locals 1
...
.method private synthetic blacklist lambda$onNewDexImmersiveModeChanged$11(IZ)V
    .locals 1

    iget-object v0, p0, Landroid/window/TaskOrganizer$1;->this$0:Landroid/window/TaskOrganizer;

    invoke-virtual {v0, p1, p2}, Landroid/window/TaskOrganizer;->onNewDexImmersiveModeChanged(IZ)V
...
.method private synthetic blacklist lambda$preloadSplashScreenAppIcon$14(Landroid/content/pm/ActivityInfo;ILandroid/content/res/Configuration;)V
    .locals 1
...
.method private synthetic blacklist lambda$requestAffordanceAnim$13(Landroid/app/ActivityManager$RunningTaskInfo;I)V
    .locals 1

    iget-object v0, p0, Landroid/window/TaskOrganizer$1;->this$0:Landroid/window/TaskOrganizer;

    invoke-virtual {v0, p1, p2}, Landroid/window/TaskOrganizer;->requestAffordanceAnim(Landroid/app/ActivityManager$RunningTaskInfo;I)V

    return-void
.end method

.method private synthetic blacklist lambda$resetStashedFreeform$12(IZ)V
    .locals 1
...
.method public blacklist copySplashScreenView(I)V
    ...
    invoke-direct {v1, p0, p1}, Landroid/window/TaskOrganizer$1$$ExternalSyntheticLambda11;-><init>(Landroid/window/TaskOrganizer$1;I)V
...
.method public blacklist onAppSplashScreenViewRemoved(I)V
    ...
    invoke-direct {v1, p0, p1}, Landroid/window/TaskOrganizer$1$$ExternalSyntheticLambda9;-><init>(Landroid/window/TaskOrganizer$1;I)V
...
.method public blacklist onImeDrawnOnTask(I)V
    ...
    invoke-direct {v1, p0, p1}, Landroid/window/TaskOrganizer$1$$ExternalSyntheticLambda13;-><init>(Landroid/window/TaskOrganizer$1;I)V
...
.method public blacklist onImmersiveModeChanged(IZ)V
    ...
    new-instance v1, Landroid/window/TaskOrganizer$1$$ExternalSyntheticLambda14;

    invoke-direct {v1, p0, p1, p2}, Landroid/window/TaskOrganizer$1$$ExternalSyntheticLambda14;-><init>(Landroid/window/TaskOrganizer$1;IZ)V
...
.method public blacklist onTaskAppeared(Landroid/app/ActivityManager$RunningTaskInfo;Landroid/view/SurfaceControl;)V
    ...
    invoke-direct {v1, p0, p1, p2}, Landroid/window/TaskOrganizer$1$$ExternalSyntheticLambda12;-><init>(Landroid/window/TaskOrganizer$1;Landroid/app/ActivityManager$RunningTaskInfo;Landroid/view/SurfaceControl;)V
...
.method public blacklist requestAffordanceAnim(Landroid/app/ActivityManager$RunningTaskInfo;I)V
    ...
    invoke-direct {v1, p0, p1, p2}, Landroid/window/TaskOrganizer$1$$ExternalSyntheticLambda8;-><init>(Landroid/window/TaskOrganizer$1;Landroid/app/ActivityManager$RunningTaskInfo;I)V
...
.method public blacklist resetStashedFreeform(IZ)V
    ...
    invoke-direct {v1, p0, p1, p2}, Landroid/window/TaskOrganizer$1$$ExternalSyntheticLambda10;-><init>(Landroid/window/TaskOrganizer$1;IZ)V
