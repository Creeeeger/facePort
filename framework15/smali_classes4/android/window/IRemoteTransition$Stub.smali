...
.method public static blacklist getDefaultTransactionName(I)Ljava/lang/String;
    ...
    :pswitch_0
    const-string/jumbo v0, "onTransitionConsumed"
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    const-string v9, "android.window.IRemoteTransition"
    ...
    invoke-virtual {v6, v0, v1}, Landroid/window/IRemoteTransition$Stub;->onTransitionConsumed(Landroid/os/IBinder;Z)V
    ...
    check-cast v13, Landroid/window/TransitionInfo;
    ...
    sget-object v0, Landroid/window/WindowAnimationState;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    check-cast v16, [Landroid/window/WindowAnimationState;
    ...
    sget-object v1, Landroid/window/TransitionInfo;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    invoke-static {v3}, Landroid/window/IRemoteTransitionFinishedCallback$Stub;->asInterface(Landroid/os/IBinder;)Landroid/window/IRemoteTransitionFinishedCallback;

    move-result-object v3

    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->enforceNoDataAvail()V

    invoke-virtual {v6, v0, v1, v2, v3}, Landroid/window/IRemoteTransition$Stub;->startAnimation(Landroid/os/IBinder;Landroid/window/TransitionInfo;Landroid/view/SurfaceControl$Transaction;Landroid/window/IRemoteTransitionFinishedCallback;)V
