...
.method public blacklist findDefaultModeByRefreshRate(F)Landroid/view/Display$Mode;
    ...
    invoke-virtual {p0, p1, v0}, Landroid/view/DisplayInfo;->findDefaultModeByRefreshRate(F[Landroid/view/Display$Mode;)Landroid/view/Display$Mode;
...
.method public blacklist findDefaultModeByRefreshRate(F[Landroid/view/Display$Mode;)Landroid/view/Display$Mode;
    .locals 6
...
.method public greylist-max-o getDefaultRefreshRates()[F
    ...
    invoke-virtual {p0, v0}, Landroid/view/DisplayInfo;->getDefaultRefreshRates([Landroid/view/Display$Mode;)[F
...
.method public blacklist getDefaultRefreshRates([Landroid/view/Display$Mode;)[F
    .locals 9
...
.method public greylist-max-o readFromParcel(Landroid/os/Parcel;)V
    ...
    iput-object v4, p0, Landroid/view/DisplayInfo;->supportedColorModes:[I
    ...
    iget-object v5, p0, Landroid/view/DisplayInfo;->supportedColorModes:[I
    ...
    :cond_3
    const-class v4, Landroid/view/Display$HdrCapabilities;

    invoke-virtual {p1, v1, v4}, Landroid/os/Parcel;->readParcelable(Ljava/lang/ClassLoader;Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v4

    check-cast v4, Landroid/view/Display$HdrCapabilities;

    iput-object v4, p0, Landroid/view/DisplayInfo;->hdrCapabilities:Landroid/view/Display$HdrCapabilities;

    invoke-virtual {p1}, Landroid/os/Parcel;->readBoolean()Z

    move-result v4

    iput-boolean v4, p0, Landroid/view/DisplayInfo;->minimalPostProcessingSupported:Z

    invoke-virtual {p1}, Landroid/os/Parcel;->readInt()I

    move-result v4

    iput v4, p0, Landroid/view/DisplayInfo;->logicalDensityDpi:I

    invoke-virtual {p1}, Landroid/os/Parcel;->readFloat()F

    move-result v4

    iput v4, p0, Landroid/view/DisplayInfo;->physicalXDpi:F

    invoke-virtual {p1}, Landroid/os/Parcel;->readFloat()F

    move-result v4

    iput v4, p0, Landroid/view/DisplayInfo;->physicalYDpi:F
    ...
    iput v4, p0, Landroid/view/DisplayInfo;->state:I

    invoke-virtual {p1}, Landroid/os/Parcel;->readInt()I

    move-result v4

    iput v4, p0, Landroid/view/DisplayInfo;->committedState:I

    invoke-virtual {p1}, Landroid/os/Parcel;->readInt()I

    move-result v4

    iput v4, p0, Landroid/view/DisplayInfo;->ownerUid:I

    invoke-virtual {p1}, Landroid/os/Parcel;->readString8()Ljava/lang/String;

    move-result-object v4

    iput-object v4, p0, Landroid/view/DisplayInfo;->ownerPackageName:Ljava/lang/String;

    invoke-virtual {p1}, Landroid/os/Parcel;->readString8()Ljava/lang/String;

    move-result-object v4

    iput-object v4, p0, Landroid/view/DisplayInfo;->uniqueId:Ljava/lang/String;

    invoke-virtual {p1}, Landroid/os/Parcel;->readInt()I

    move-result v4

    iput v4, p0, Landroid/view/DisplayInfo;->removeMode:I
    ...
    iput v4, p0, Landroid/view/DisplayInfo;->brightnessMinimum:F

    invoke-virtual {p1}, Landroid/os/Parcel;->readFloat()F

    move-result v4

    iput v4, p0, Landroid/view/DisplayInfo;->brightnessMaximum:F

    invoke-virtual {p1}, Landroid/os/Parcel;->readFloat()F

    move-result v4

    iput v4, p0, Landroid/view/DisplayInfo;->brightnessDefault:F

    sget-object v4, Landroid/view/RoundedCorners;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {p1, v4}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object v4

    check-cast v4, Landroid/view/RoundedCorners;

    iput-object v4, p0, Landroid/view/DisplayInfo;->roundedCorners:Landroid/view/RoundedCorners;
    ...
    iput-object v5, p0, Landroid/view/DisplayInfo;->userDisabledHdrTypes:[I
    ...
    iget-object v6, p0, Landroid/view/DisplayInfo;->userDisabledHdrTypes:[I
    ...
    iput v5, p0, Landroid/view/DisplayInfo;->installOrientation:I

    sget-object v5, Landroid/view/DisplayShape;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {p1, v5}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Landroid/view/DisplayShape;

    iput-object v5, p0, Landroid/view/DisplayInfo;->displayShape:Landroid/view/DisplayShape;

    sget-object v5, Landroid/view/SurfaceControl$RefreshRateRange;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {p1, v5}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Landroid/view/SurfaceControl$RefreshRateRange;

    iput-object v5, p0, Landroid/view/DisplayInfo;->layoutLimitedRefreshRate:Landroid/view/SurfaceControl$RefreshRateRange;

    invoke-virtual {p1}, Landroid/os/Parcel;->readFloat()F

    move-result v5

    iput v5, p0, Landroid/view/DisplayInfo;->hdrSdrRatio:F

    const-class v5, Landroid/view/SurfaceControl$RefreshRateRange;

    invoke-virtual {p1, v1, v5}, Landroid/os/Parcel;->readSparseArray(Ljava/lang/ClassLoader;Ljava/lang/Class;)Landroid/util/SparseArray;
