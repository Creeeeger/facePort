...
# direct methods
.method public static synthetic blacklist $r8$lambda$3Mwitn0b3Eai0mZgcSB4iAskCWg(Landroid/view/contentcapture/MainContentCaptureSession;Landroid/view/contentcapture/ContentCaptureEvent;)V
    .locals 0

    invoke-direct {p0, p1}, Landroid/view/contentcapture/MainContentCaptureSession;->lambda$internalNotifyChildSessionFinished$11(Landroid/view/contentcapture/ContentCaptureEvent;)V

    return-void
.end method

.method public static synthetic blacklist $r8$lambda$6yU0bjt7FGD_ijdUXOLoD_6XcQk(Landroid/view/contentcapture/MainContentCaptureSession;)V
    .locals 0
...
.method public static synthetic blacklist $r8$lambda$7OebYwWX5j5WPxUlUG9rK845zMk(Landroid/view/contentcapture/MainContentCaptureSession;Landroid/view/contentcapture/ContentCaptureEvent;)V
    .locals 0

    invoke-direct {p0, p1}, Landroid/view/contentcapture/MainContentCaptureSession;->lambda$internalNotifyContextUpdated$12(Landroid/view/contentcapture/ContentCaptureEvent;)V

    return-void
.end method

.method public static synthetic blacklist $r8$lambda$ANHzLTVmYvWSDf8_f5fW6Ur9WAE(Landroid/view/contentcapture/MainContentCaptureSession;Landroid/view/contentcapture/ContentCaptureEvent;)V
    .locals 0

    invoke-direct {p0, p1}, Landroid/view/contentcapture/MainContentCaptureSession;->lambda$internalNotifySessionResumed$8(Landroid/view/contentcapture/ContentCaptureEvent;)V

    return-void
.end method

.method public static synthetic blacklist $r8$lambda$Aq1w-ovi3DXHcMEOi9Zw8oNrbq0(Landroid/view/contentcapture/MainContentCaptureSession;Landroid/view/contentcapture/ContentCaptureEvent;)V
    .locals 0

    invoke-direct {p0, p1}, Landroid/view/contentcapture/MainContentCaptureSession;->lambda$internalNotifyViewTextChanged$5(Landroid/view/contentcapture/ContentCaptureEvent;)V

    return-void
.end method

.method public static synthetic blacklist $r8$lambda$HzLSaa3-yN-H1Vfe6SGvPAZhkRk(Landroid/view/contentcapture/MainContentCaptureSession;Landroid/view/contentcapture/ContentCaptureEvent;)V
    .locals 0

    invoke-direct {p0, p1}, Landroid/view/contentcapture/MainContentCaptureSession;->lambda$notifyWindowBoundsChanged$13(Landroid/view/contentcapture/ContentCaptureEvent;)V

    return-void
.end method

.method public static synthetic blacklist $r8$lambda$KAoalQj0uS2XX2HjqAbf6zl3wPk(Landroid/view/contentcapture/MainContentCaptureSession;Landroid/view/contentcapture/ContentCaptureEvent;)V
    .locals 0

    invoke-direct {p0, p1}, Landroid/view/contentcapture/MainContentCaptureSession;->lambda$internalNotifyViewDisappeared$4(Landroid/view/contentcapture/ContentCaptureEvent;)V

    return-void
.end method

.method public static synthetic blacklist $r8$lambda$L9N4XMhmE62mgrQ07gVqb_wN5gA(Landroid/view/contentcapture/MainContentCaptureSession;Landroid/view/contentcapture/ContentCaptureEvent;)V
    .locals 0

    invoke-direct {p0, p1}, Landroid/view/contentcapture/MainContentCaptureSession;->lambda$internalNotifySessionPaused$9(Landroid/view/contentcapture/ContentCaptureEvent;)V

    return-void
.end method

.method public static synthetic blacklist $r8$lambda$aU7vd1kRZcuZ452Yada12Yh3aP8(Landroid/view/contentcapture/MainContentCaptureSession;Landroid/view/contentcapture/ContentCaptureEvent;)V
    .locals 0

    invoke-direct {p0, p1}, Landroid/view/contentcapture/MainContentCaptureSession;->lambda$internalNotifyViewInsetsChanged$6(Landroid/view/contentcapture/ContentCaptureEvent;)V

    return-void
.end method

.method public static synthetic blacklist $r8$lambda$fTIUYF_Q43OJJDu9P6C6iJJBMcM(Landroid/view/contentcapture/MainContentCaptureSession;Landroid/view/contentcapture/ContentCaptureEvent;)V
    .locals 0

    invoke-direct {p0, p1}, Landroid/view/contentcapture/MainContentCaptureSession;->lambda$internalNotifyViewAppeared$3(Landroid/view/contentcapture/ContentCaptureEvent;)V

    return-void
.end method

.method public static synthetic blacklist $r8$lambda$mXQkg9aCAzf4tmwBlyTDxcQu_lY(Landroid/view/contentcapture/MainContentCaptureSession;Landroid/view/contentcapture/ContentCaptureEvent;)V
    .locals 0

    invoke-direct {p0, p1}, Landroid/view/contentcapture/MainContentCaptureSession;->lambda$internalNotifyChildSessionStarted$10(Landroid/view/contentcapture/ContentCaptureEvent;)V

    return-void
.end method

.method public static synthetic blacklist $r8$lambda$oepl0cugTcZmYzN42emv3jpTEGk(Landroid/view/contentcapture/MainContentCaptureSession;Landroid/view/contentcapture/ContentCaptureEvent;)V
    .locals 0

    invoke-direct {p0, p1}, Landroid/view/contentcapture/MainContentCaptureSession;->lambda$internalNotifyViewTreeEvent$7(Landroid/view/contentcapture/ContentCaptureEvent;)V

    return-void
.end method

.method public static synthetic blacklist $r8$lambda$pwgTQSjbdJk8OlCjjTLJQ5bb-Vg(Landroid/view/contentcapture/MainContentCaptureSession;I)V
    .locals 0
...
.method public static synthetic blacklist $r8$lambda$qpT3iQUN4y5LuGt7D5Zn03iy2rc(Landroid/view/contentcapture/MainContentCaptureSession;)V
    .locals 0
...
.method public constructor blacklist <init>(Landroid/view/contentcapture/ContentCaptureManager$StrippedContext;Landroid/view/contentcapture/ContentCaptureManager;Landroid/os/Handler;Landroid/view/contentcapture/IContentCaptureManager;)V
    .locals 2
...
.method private blacklist checkOnUiThread()V
    .locals 4
...
.method private blacklist clearEvents()Landroid/content/pm/ParceledListSlice;
    ...
    invoke-direct {p0}, Landroid/view/contentcapture/MainContentCaptureSession;->checkOnUiThread()V
...
.method private synthetic blacklist lambda$internalNotifyChildSessionFinished$11(Landroid/view/contentcapture/ContentCaptureEvent;)V
    .locals 1
...
.method private synthetic blacklist lambda$internalNotifyChildSessionStarted$10(Landroid/view/contentcapture/ContentCaptureEvent;)V
    .locals 1
...
.method private synthetic blacklist lambda$internalNotifyContextUpdated$12(Landroid/view/contentcapture/ContentCaptureEvent;)V
    .locals 1
...
.method private synthetic blacklist lambda$internalNotifySessionPaused$9(Landroid/view/contentcapture/ContentCaptureEvent;)V
    .locals 1
...
.method private synthetic blacklist lambda$internalNotifySessionResumed$8(Landroid/view/contentcapture/ContentCaptureEvent;)V
    .locals 1
...
.method private synthetic blacklist lambda$internalNotifyViewAppeared$3(Landroid/view/contentcapture/ContentCaptureEvent;)V
    .locals 0

    invoke-virtual {p0, p1}, Landroid/view/contentcapture/MainContentCaptureSession;->sendEvent(Landroid/view/contentcapture/ContentCaptureEvent;)V

    return-void
.end method

.method private synthetic blacklist lambda$internalNotifyViewDisappeared$4(Landroid/view/contentcapture/ContentCaptureEvent;)V
    .locals 0
...
.method private synthetic blacklist lambda$internalNotifyViewInsetsChanged$6(Landroid/view/contentcapture/ContentCaptureEvent;)V
    .locals 0
...
.method private synthetic blacklist lambda$internalNotifyViewTextChanged$5(Landroid/view/contentcapture/ContentCaptureEvent;)V
    .locals 0
...
.method private synthetic blacklist lambda$internalNotifyViewTreeEvent$7(Landroid/view/contentcapture/ContentCaptureEvent;)V
    .locals 1
...
.method private synthetic blacklist lambda$notifyWindowBoundsChanged$13(Landroid/view/contentcapture/ContentCaptureEvent;)V
    .locals 0
...
.method private blacklist notifyContentCaptureEventsImpl(Landroid/util/SparseArray;)V
    ...
    instance-of v8, v6, Landroid/view/autofill/AutofillId;
    ...
    const-string/jumbo v11, "no content capture session on view: "
    ...
    invoke-virtual {v8, v11, v7}, Landroid/view/View;->onProvideContentCaptureStructure(Landroid/view/ViewStructure;I)V

    invoke-virtual {v9, v11}, Landroid/view/contentcapture/ContentCaptureSession;->notifyViewAppeared(Landroid/view/ViewStructure;)V
    ...
    :cond_6
    invoke-virtual {p0, v3, v7}, Landroid/view/contentcapture/MainContentCaptureSession;->internalNotifyViewTreeEvent(IZ)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private blacklist sendContentCaptureEvent(Landroid/view/contentcapture/ContentCaptureEvent;Z)V
    ...
    invoke-direct/range {p0 .. p0}, Landroid/view/contentcapture/MainContentCaptureSession;->checkOnUiThread()V
...
.method blacklist internalNotifyChildSessionFinished(II)V
    ...
    new-instance v2, Landroid/view/contentcapture/MainContentCaptureSession$$ExternalSyntheticLambda9;

    invoke-direct {v2, p0, v0}, Landroid/view/contentcapture/MainContentCaptureSession$$ExternalSyntheticLambda9;-><init>(Landroid/view/contentcapture/MainContentCaptureSession;Landroid/view/contentcapture/ContentCaptureEvent;)V
...
.method blacklist internalNotifyChildSessionStarted(IILandroid/view/contentcapture/ContentCaptureContext;)V
    ...
    new-instance v2, Landroid/view/contentcapture/MainContentCaptureSession$$ExternalSyntheticLambda1;

    invoke-direct {v2, p0, v0}, Landroid/view/contentcapture/MainContentCaptureSession$$ExternalSyntheticLambda1;-><init>(Landroid/view/contentcapture/MainContentCaptureSession;Landroid/view/contentcapture/ContentCaptureEvent;)V
...
.method blacklist internalNotifyContextUpdated(ILandroid/view/contentcapture/ContentCaptureContext;)V
    ...
    new-instance v2, Landroid/view/contentcapture/MainContentCaptureSession$$ExternalSyntheticLambda2;

    invoke-direct {v2, p0, v0}, Landroid/view/contentcapture/MainContentCaptureSession$$ExternalSyntheticLambda2;-><init>(Landroid/view/contentcapture/MainContentCaptureSession;Landroid/view/contentcapture/ContentCaptureEvent;)V
...
.method public blacklist internalNotifySessionPaused()V
    ...
    new-instance v2, Landroid/view/contentcapture/MainContentCaptureSession$$ExternalSyntheticLambda4;

    invoke-direct {v2, p0, v0}, Landroid/view/contentcapture/MainContentCaptureSession$$ExternalSyntheticLambda4;-><init>(Landroid/view/contentcapture/MainContentCaptureSession;Landroid/view/contentcapture/ContentCaptureEvent;)V
...
.method public blacklist internalNotifySessionResumed()V
    ...
    new-instance v2, Landroid/view/contentcapture/MainContentCaptureSession$$ExternalSyntheticLambda7;

    invoke-direct {v2, p0, v0}, Landroid/view/contentcapture/MainContentCaptureSession$$ExternalSyntheticLambda7;-><init>(Landroid/view/contentcapture/MainContentCaptureSession;Landroid/view/contentcapture/ContentCaptureEvent;)V
...
.method blacklist internalNotifyViewAppeared(ILandroid/view/contentcapture/ViewNode$ViewStructureImpl;)V
    ...
    new-instance v2, Landroid/view/contentcapture/MainContentCaptureSession$$ExternalSyntheticLambda6;

    invoke-direct {v2, p0, v0}, Landroid/view/contentcapture/MainContentCaptureSession$$ExternalSyntheticLambda6;-><init>(Landroid/view/contentcapture/MainContentCaptureSession;Landroid/view/contentcapture/ContentCaptureEvent;)V
...
.method blacklist internalNotifyViewDisappeared(ILandroid/view/autofill/AutofillId;)V
    ...
    invoke-direct {v2, p0, v0}, Landroid/view/contentcapture/MainContentCaptureSession$$ExternalSyntheticLambda12;-><init>(Landroid/view/contentcapture/MainContentCaptureSession;Landroid/view/contentcapture/ContentCaptureEvent;)V
...
.method blacklist internalNotifyViewInsetsChanged(ILandroid/graphics/Insets;)V
    ...
    new-instance v2, Landroid/view/contentcapture/MainContentCaptureSession$$ExternalSyntheticLambda11;

    invoke-direct {v2, p0, v0}, Landroid/view/contentcapture/MainContentCaptureSession$$ExternalSyntheticLambda11;-><init>(Landroid/view/contentcapture/MainContentCaptureSession;Landroid/view/contentcapture/ContentCaptureEvent;)V
...
.method blacklist internalNotifyViewTextChanged(ILandroid/view/autofill/AutofillId;Ljava/lang/CharSequence;)V
    ...
    new-instance v8, Landroid/view/contentcapture/MainContentCaptureSession$$ExternalSyntheticLambda8;

    invoke-direct {v8, p0, v6}, Landroid/view/contentcapture/MainContentCaptureSession$$ExternalSyntheticLambda8;-><init>(Landroid/view/contentcapture/MainContentCaptureSession;Landroid/view/contentcapture/ContentCaptureEvent;)V
...
.method public blacklist internalNotifyViewTreeEvent(IZ)V
    ...
    new-instance v5, Landroid/view/contentcapture/MainContentCaptureSession$$ExternalSyntheticLambda10;

    invoke-direct {v5, p0, v3}, Landroid/view/contentcapture/MainContentCaptureSession$$ExternalSyntheticLambda10;-><init>(Landroid/view/contentcapture/MainContentCaptureSession;Landroid/view/contentcapture/ContentCaptureEvent;)V
...
.method public blacklist notifyWindowBoundsChanged(ILandroid/graphics/Rect;)V
    ...
    new-instance v2, Landroid/view/contentcapture/MainContentCaptureSession$$ExternalSyntheticLambda3;

    invoke-direct {v2, p0, v0}, Landroid/view/contentcapture/MainContentCaptureSession$$ExternalSyntheticLambda3;-><init>(Landroid/view/contentcapture/MainContentCaptureSession;Landroid/view/contentcapture/ContentCaptureEvent;)V
...
.method blacklist onDestroy()V
    ...
    invoke-direct {v1, p0}, Landroid/view/contentcapture/MainContentCaptureSession$$ExternalSyntheticLambda5;-><init>(Landroid/view/contentcapture/MainContentCaptureSession;)V
...
.method public blacklist onSessionStarted(ILandroid/os/IBinder;)V
    ...
    invoke-direct {v1, p0}, Landroid/view/contentcapture/MainContentCaptureSession$$ExternalSyntheticLambda13;-><init>(Landroid/view/contentcapture/MainContentCaptureSession;)V
    ...
    iget-object v2, p0, Landroid/view/contentcapture/MainContentCaptureSession;->mComponentName:Landroid/content/ComponentName;
    ...
    iput-object v1, p0, Landroid/view/contentcapture/MainContentCaptureSession;->mContentProtectionEventProcessor:Landroid/view/contentprotection/ContentProtectionEventProcessor;
