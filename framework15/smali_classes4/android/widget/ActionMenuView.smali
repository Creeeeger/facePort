...
.method private greylist-max-o onMeasureExactFormat(II)V
    ...
    :cond_1
    instance-of v8, v7, Lcom/android/internal/view/menu/ActionMenuItemView;
    ...
    iput-boolean v2, v3, Landroid/widget/ActionMenuView$LayoutParams;->expanded:Z

    iput v2, v3, Landroid/widget/ActionMenuView$LayoutParams;->extraPixels:I

    iput v2, v3, Landroid/widget/ActionMenuView$LayoutParams;->cellsUsed:I

    iput-boolean v2, v3, Landroid/widget/ActionMenuView$LayoutParams;->expandable:Z

    iput v2, v3, Landroid/widget/ActionMenuView$LayoutParams;->leftMargin:I

    iput v2, v3, Landroid/widget/ActionMenuView$LayoutParams;->rightMargin:I

    if-eqz v8, :cond_3

    move-object v2, v7

    check-cast v2, Lcom/android/internal/view/menu/ActionMenuItemView;

    invoke-virtual {v2}, Lcom/android/internal/view/menu/ActionMenuItemView;->hasText()Z
    ...
    :goto_2
    iput-boolean v2, v3, Landroid/widget/ActionMenuView$LayoutParams;->preventEdgeOffset:Z

    iget-boolean v2, v0, Landroid/widget/ActionMenuView;->mIsThemeDeviceDefaultFamily:Z

    if-eqz v2, :cond_4

    iput-boolean v8, v3, Landroid/widget/ActionMenuView$LayoutParams;->preventEdgeOffset:Z

    :cond_4
    iget-boolean v2, v3, Landroid/widget/ActionMenuView$LayoutParams;->isOverflowButton:Z
    ...
    :goto_3
    invoke-static {v7, v11, v2, v6, v5}, Landroid/widget/ActionMenuView;->measureChildForCells(Landroid/view/View;IIII)I
    ...
    iget-boolean v2, v3, Landroid/widget/ActionMenuView$LayoutParams;->expandable:Z
    ...
    iget-boolean v7, v5, Landroid/widget/ActionMenuView$LayoutParams;->expandable:Z
    ...
    iget v2, v5, Landroid/widget/ActionMenuView$LayoutParams;->cellsUsed:I
    ...
    iget v8, v9, Landroid/widget/ActionMenuView$LayoutParams;->cellsUsed:I
    ...
    iget-boolean v8, v9, Landroid/widget/ActionMenuView$LayoutParams;->preventEdgeOffset:Z
    ...
    iget-boolean v8, v0, Landroid/widget/ActionMenuView;->mIsThemeDeviceDefaultFamily:Z
    ...
    invoke-virtual {v7, v8, v14, v13, v14}, Landroid/view/View;->setPadding(IIII)V
    ...
    iput v8, v9, Landroid/widget/ActionMenuView$LayoutParams;->cellsUsed:I

    iput-boolean v13, v9, Landroid/widget/ActionMenuView$LayoutParams;->expanded:Z
    ...
    iget-boolean v13, v9, Landroid/widget/ActionMenuView$LayoutParams;->preventEdgeOffset:Z
    ...
    instance-of v13, v2, Lcom/android/internal/view/menu/ActionMenuItemView;

    if-eqz v13, :cond_1e

    iput v7, v3, Landroid/widget/ActionMenuView$LayoutParams;->extraPixels:I

    const/4 v13, 0x1

    iput-boolean v13, v3, Landroid/widget/ActionMenuView$LayoutParams;->expanded:Z

    if-nez v8, :cond_1d

    iget-boolean v13, v3, Landroid/widget/ActionMenuView$LayoutParams;->preventEdgeOffset:Z
    ...
    iput v13, v3, Landroid/widget/ActionMenuView$LayoutParams;->leftMargin:I
    ...
    :cond_1e
    iget-boolean v13, v3, Landroid/widget/ActionMenuView$LayoutParams;->isOverflowButton:Z
    ...
    iput v13, v3, Landroid/widget/ActionMenuView$LayoutParams;->rightMargin:I
    ...
    iget-boolean v13, v8, Landroid/widget/ActionMenuView$LayoutParams;->expanded:Z
    ...
    :cond_24
    iget v13, v8, Landroid/widget/ActionMenuView$LayoutParams;->cellsUsed:I

    mul-int/2addr v13, v11

    iget v2, v8, Landroid/widget/ActionMenuView$LayoutParams;->extraPixels:I
