...
.method private static blacklist getDefaults()Landroid/os/PersistableBundle;
    ...
    const-string v1, "imsvoice.carrier_volte_roaming_available_bool"

    const/4 v2, 0x1

    invoke-virtual {v0, v1, v2}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    const-string v1, "imsvoice.include_caller_id_service_codes_in_sip_invite_bool"

    const/4 v3, 0x0

    invoke-virtual {v0, v1, v3}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    const-string v1, "imsvoice.multiendpoint_supported_bool"

    invoke-virtual {v0, v1, v3}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    const-string v1, "imsvoice.session_timer_supported_bool"

    invoke-virtual {v0, v1, v2}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    const-string v1, "imsvoice.oip_source_from_header_bool"

    invoke-virtual {v0, v1, v3}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    const-string v1, "imsvoice.prack_supported_for_18x_bool"

    invoke-virtual {v0, v1, v3}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    const-string v1, "imsvoice.voice_qos_precondition_supported_bool"

    invoke-virtual {v0, v1, v2}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    const-string v1, "imsvoice.voice_on_default_bearer_supported_bool"

    invoke-virtual {v0, v1, v3}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V

    const-string v1, "imsvoice.session_refresher_type_int"

    invoke-virtual {v0, v1, v2}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "imsvoice.session_privacy_type_int"

    invoke-virtual {v0, v1, v3}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "imsvoice.session_refresh_method_int"

    invoke-virtual {v0, v1, v2}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "imsvoice.conference_subscribe_type_int"

    invoke-virtual {v0, v1, v2}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "imsvoice.audio_rtp_inactivity_timer_millis_int"

    const/16 v4, 0x4e20

    invoke-virtual {v0, v1, v4}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "imsvoice.audio_rtcp_inactivity_timer_millis_int"

    invoke-virtual {v0, v1, v4}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "imsvoice.dedicated_bearer_wait_timer_millis_int"

    const/16 v4, 0x1f40

    invoke-virtual {v0, v1, v4}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "imsvoice.ringing_timer_millis_int"

    const v4, 0x15f90

    invoke-virtual {v0, v1, v4}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "imsvoice.ringback_timer_millis_int"

    invoke-virtual {v0, v1, v4}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "imsvoice.mo_call_request_timeout_millis_int"

    const/16 v4, 0x1388

    invoke-virtual {v0, v1, v4}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "imsvoice.session_expires_timer_sec_int"

    const/16 v4, 0x708

    invoke-virtual {v0, v1, v4}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "imsvoice.minimum_session_expires_timer_sec_int"

    const/16 v4, 0x5a

    invoke-virtual {v0, v1, v4}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "imsvoice.audio_as_bandwidth_kbps_int"

    const/16 v4, 0x29

    invoke-virtual {v0, v1, v4}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "imsvoice.audio_rs_bandwidth_bps_int"

    const/16 v4, 0x258

    invoke-virtual {v0, v1, v4}, Landroid/os/PersistableBundle;->putInt(Ljava/lang/String;I)V

    const-string v1, "imsvoice.audio_rr_bandwidth_bps_int"
    ...
    const-string v6, "imsvoice.audio_inactivity_call_end_reasons_int_array"

    invoke-virtual {v0, v6, v5}, Landroid/os/PersistableBundle;->putIntArray(Ljava/lang/String;[I)V

    const-string v5, "imsvoice.srvcc_type_int_array"
    ...
    const-string v1, "imsvoice.conference_factory_uri_string"
    ...
    const-string v4, "imsvoice.amrwb_payload_type_int_array"
    ...
    const-string v4, "imsvoice.amrnb_payload_type_int_array"
    ...
    const-string v4, "imsvoice.dtmfwb_payload_type_int_array"
    ...
    const-string v4, "imsvoice.dtmfnb_payload_type_int_array"

    invoke-virtual {v1, v4, v3}, Landroid/os/PersistableBundle;->putIntArray(Ljava/lang/String;[I)V

    const-string v3, "imsvoice.audio_codec_capability_payload_types_bundle"
    ...
    const-string v6, "imsvoice.amr_codec_attribute_payload_format_int"
    ...
    const-string v7, "imsvoice.amrwb_payload_description_bundle"
    ...
    const-string v2, "imsvoice.amrnb_payload_description_bundle"
