...
.method constructor blacklist <init>(Landroid/telephony/satellite/SatelliteManager;Landroid/os/Handler;Ljava/util/concurrent/Executor;Landroid/os/OutcomeReceiver;)V
    ...
    iput-object p1, p0, Landroid/telephony/satellite/SatelliteManager$29;->this$0:Landroid/telephony/satellite/SatelliteManager;

    iput-object p3, p0, Landroid/telephony/satellite/SatelliteManager$29;->val$executor:Ljava/util/concurrent/Executor;

    iput-object p4, p0, Landroid/telephony/satellite/SatelliteManager$29;->val$callback:Landroid/os/OutcomeReceiver;
...
.method static synthetic blacklist lambda$onReceiveResult$1(Landroid/os/OutcomeReceiver;Landroid/telephony/satellite/SatelliteSessionStats;)V
    ...
    invoke-direct {v0, p0, p1}, Landroid/telephony/satellite/SatelliteManager$29$$ExternalSyntheticLambda0;-><init>(Landroid/os/OutcomeReceiver;Landroid/telephony/satellite/SatelliteSessionStats;)V
...
.method static synthetic blacklist lambda$onReceiveResult$3(Landroid/os/OutcomeReceiver;)V
    ...
    new-instance v0, Landroid/telephony/satellite/SatelliteManager$29$$ExternalSyntheticLambda5;

    invoke-direct {v0, p0}, Landroid/telephony/satellite/SatelliteManager$29$$ExternalSyntheticLambda5;-><init>(Landroid/os/OutcomeReceiver;)V
...
.method static synthetic blacklist lambda$onReceiveResult$5(Landroid/os/OutcomeReceiver;I)V
    ...
    new-instance v0, Landroid/telephony/satellite/SatelliteManager$29$$ExternalSyntheticLambda4;

    invoke-direct {v0, p0, p1}, Landroid/telephony/satellite/SatelliteManager$29$$ExternalSyntheticLambda4;-><init>(Landroid/os/OutcomeReceiver;I)V
...
.method protected whitelist onReceiveResult(ILandroid/os/Bundle;)V
    ...
    iget-object v1, p0, Landroid/telephony/satellite/SatelliteManager$29;->val$executor:Ljava/util/concurrent/Executor;

    iget-object v2, p0, Landroid/telephony/satellite/SatelliteManager$29;->val$callback:Landroid/os/OutcomeReceiver;

    new-instance v3, Landroid/telephony/satellite/SatelliteManager$29$$ExternalSyntheticLambda1;

    invoke-direct {v3, v2, v0}, Landroid/telephony/satellite/SatelliteManager$29$$ExternalSyntheticLambda1;-><init>(Landroid/os/OutcomeReceiver;Landroid/telephony/satellite/SatelliteSessionStats;)V
    ...
    iget-object v1, p0, Landroid/telephony/satellite/SatelliteManager$29;->val$callback:Landroid/os/OutcomeReceiver;

    new-instance v2, Landroid/telephony/satellite/SatelliteManager$29$$ExternalSyntheticLambda2;

    invoke-direct {v2, v1}, Landroid/telephony/satellite/SatelliteManager$29$$ExternalSyntheticLambda2;-><init>(Landroid/os/OutcomeReceiver;)V
    ...
    new-instance v2, Landroid/telephony/satellite/SatelliteManager$29$$ExternalSyntheticLambda3;

    invoke-direct {v2, v1, p1}, Landroid/telephony/satellite/SatelliteManager$29$$ExternalSyntheticLambda3;-><init>(Landroid/os/OutcomeReceiver;I)V
