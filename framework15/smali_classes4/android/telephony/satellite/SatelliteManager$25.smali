...
.method constructor blacklist <init>(Landroid/telephony/satellite/SatelliteManager;Ljava/util/concurrent/Executor;Landroid/telephony/satellite/NtnSignalStrengthCallback;)V
    ...
    iput-object p1, p0, Landroid/telephony/satellite/SatelliteManager$25;->this$0:Landroid/telephony/satellite/SatelliteManager;

    iput-object p2, p0, Landroid/telephony/satellite/SatelliteManager$25;->val$executor:Ljava/util/concurrent/Executor;

    iput-object p3, p0, Landroid/telephony/satellite/SatelliteManager$25;->val$callback:Landroid/telephony/satellite/NtnSignalStrengthCallback;
...
.method static synthetic blacklist lambda$onNtnSignalStrengthChanged$1(Landroid/telephony/satellite/NtnSignalStrengthCallback;Landroid/telephony/satellite/NtnSignalStrength;)V
    ...
    new-instance v0, Landroid/telephony/satellite/SatelliteManager$25$$ExternalSyntheticLambda1;

    invoke-direct {v0, p0, p1}, Landroid/telephony/satellite/SatelliteManager$25$$ExternalSyntheticLambda1;-><init>(Landroid/telephony/satellite/NtnSignalStrengthCallback;Landroid/telephony/satellite/NtnSignalStrength;)V
...
.method public blacklist onNtnSignalStrengthChanged(Landroid/telephony/satellite/NtnSignalStrength;)V
    ...
    iget-object v1, p0, Landroid/telephony/satellite/SatelliteManager$25;->val$callback:Landroid/telephony/satellite/NtnSignalStrengthCallback;

    new-instance v2, Landroid/telephony/satellite/SatelliteManager$25$$ExternalSyntheticLambda0;

    invoke-direct {v2, v1, p1}, Landroid/telephony/satellite/SatelliteManager$25$$ExternalSyntheticLambda0;-><init>(Landroid/telephony/satellite/NtnSignalStrengthCallback;Landroid/telephony/satellite/NtnSignalStrength;)V
