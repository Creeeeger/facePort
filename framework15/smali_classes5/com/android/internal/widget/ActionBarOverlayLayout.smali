...
.method private blacklist applyInsets(Landroid/view/View;Landroid/graphics/Rect;ZZZZZ)Z
    ...
    invoke-direct/range {v1 .. v7}, Lcom/android/internal/widget/ActionBarOverlayLayout;->setPadding(Landroid/view/View;Landroid/graphics/Rect;ZZZZ)Z
    ...
    :cond_0
    sget-object v3, Lcom/android/internal/widget/ActionBarOverlayLayout;->EMPTY_RECT:Landroid/graphics/Rect;
    ...
    invoke-direct/range {v1 .. v7}, Lcom/android/internal/widget/ActionBarOverlayLayout;->setMargin(Landroid/view/View;Landroid/graphics/Rect;ZZZZ)Z
...
.method public whitelist onApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    iput-boolean v0, v8, Lcom/android/internal/widget/ActionBarOverlayLayout;->mDecorFitsSystemWindows:Z

    iget-boolean v0, v8, Lcom/android/internal/widget/ActionBarOverlayLayout;->mDecorFitsSystemWindows:Z
    ...
    :goto_3
    iput-boolean v0, v8, Lcom/android/internal/widget/ActionBarOverlayLayout;->mActionBarExtendsIntoSystemInsets:Z

    iget-object v0, v8, Lcom/android/internal/widget/ActionBarOverlayLayout;->mActionBarVisibilityCallback:Lcom/android/internal/widget/ActionBarOverlayLayout$ActionBarVisibilityCallback;
    ...
    iget-boolean v3, v8, Lcom/android/internal/widget/ActionBarOverlayLayout;->mActionBarExtendsIntoSystemInsets:Z
    ...
    :goto_4
    invoke-interface {v0, v1}, Lcom/android/internal/widget/ActionBarOverlayLayout$ActionBarVisibilityCallback;->enableContentAnimations(Z)V

    :cond_5
    invoke-virtual/range {p1 .. p1}, Landroid/view/WindowInsets;->getSystemWindowInsets()Landroid/graphics/Insets;

    move-result-object v13

    iget-object v0, v8, Lcom/android/internal/widget/ActionBarOverlayLayout;->mSystemInsets:Landroid/graphics/Rect;

    iget v1, v13, Landroid/graphics/Insets;->left:I

    iget v2, v13, Landroid/graphics/Insets;->top:I
    ...
    iget-object v1, v8, Lcom/android/internal/widget/ActionBarOverlayLayout;->mActionBarTop:Lcom/android/internal/widget/ActionBarContainer;

    iget-object v2, v8, Lcom/android/internal/widget/ActionBarOverlayLayout;->mSystemInsets:Landroid/graphics/Rect;
    ...
    iget-object v0, v8, Lcom/android/internal/widget/ActionBarOverlayLayout;->mActionBarBottom:Lcom/android/internal/widget/ActionBarContainer;

    if-eqz v0, :cond_6

    iget-object v1, v8, Lcom/android/internal/widget/ActionBarOverlayLayout;->mActionBarBottom:Lcom/android/internal/widget/ActionBarContainer;
    ...
    :cond_6
    iget-object v0, v8, Lcom/android/internal/widget/ActionBarOverlayLayout;->mBaseContentInsets:Landroid/graphics/Rect;

    invoke-virtual {p0, v9, v0}, Lcom/android/internal/widget/ActionBarOverlayLayout;->computeSystemWindowInsets(Landroid/view/WindowInsets;Landroid/graphics/Rect;)Landroid/view/WindowInsets;

    iget-object v0, v8, Lcom/android/internal/widget/ActionBarOverlayLayout;->mBaseContentInsets:Landroid/graphics/Rect;

    invoke-virtual {v9, v0}, Landroid/view/WindowInsets;->inset(Landroid/graphics/Rect;)Landroid/view/WindowInsets;

    move-result-object v0

    iput-object v0, v8, Lcom/android/internal/widget/ActionBarOverlayLayout;->mBaseInnerInsets:Landroid/view/WindowInsets;

    iget-object v0, v8, Lcom/android/internal/widget/ActionBarOverlayLayout;->mLastBaseInnerInsets:Landroid/view/WindowInsets;

    iget-object v1, v8, Lcom/android/internal/widget/ActionBarOverlayLayout;->mBaseInnerInsets:Landroid/view/WindowInsets;
    ...
    iget-object v0, v8, Lcom/android/internal/widget/ActionBarOverlayLayout;->mBaseInnerInsets:Landroid/view/WindowInsets;

    iput-object v0, v8, Lcom/android/internal/widget/ActionBarOverlayLayout;->mLastBaseInnerInsets:Landroid/view/WindowInsets;

    :cond_7
    iget-object v0, v8, Lcom/android/internal/widget/ActionBarOverlayLayout;->mLastBaseContentInsets:Landroid/graphics/Rect;

    iget-object v1, v8, Lcom/android/internal/widget/ActionBarOverlayLayout;->mBaseContentInsets:Landroid/graphics/Rect;
...
.method protected whitelist onMeasure(II)V
    ...
    iget v0, v7, Lcom/android/internal/widget/ActionBarOverlayLayout;->mActionBarHeight:I

    iget-boolean v2, v7, Lcom/android/internal/widget/ActionBarOverlayLayout;->mActionBarExtendsIntoSystemInsets:Z

    if-eqz v2, :cond_2

    iget-object v2, v7, Lcom/android/internal/widget/ActionBarOverlayLayout;->mSystemInsets:Landroid/graphics/Rect;
    ...
    iget-boolean v0, v7, Lcom/android/internal/widget/ActionBarOverlayLayout;->mActionBarExtendsIntoSystemInsets:Z

    if-eqz v0, :cond_7

    iget-object v0, v7, Lcom/android/internal/widget/ActionBarOverlayLayout;->mSystemInsets:Landroid/graphics/Rect;
    ...
    iget-boolean v0, v7, Lcom/android/internal/widget/ActionBarOverlayLayout;->mDecorFitsSystemWindows:Z
