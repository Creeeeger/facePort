...
.method public blacklist getSatelliteImei(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
...
.method public blacklist semGetSatelliteState(I)Landroid/telephony/satellite/SemSatelliteState;
    ...
    sget-object v3, Landroid/telephony/satellite/SemSatelliteState;->CREATOR:Landroid/os/Parcelable$Creator;

    invoke-virtual {v1, v3}, Landroid/os/Parcel;->readTypedObject(Landroid/os/Parcelable$Creator;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Landroid/telephony/satellite/SemSatelliteState;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
