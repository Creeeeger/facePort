...
.method private greylist-max-o initializeFromParcelLocked(Landroid/os/Parcel;ZZ)V
    ...
    invoke-static/range {p1 .. p1}, Landroid/os/BaseBundle;->isEmptyParcel(Landroid/os/Parcel;)Z
    ...
    iget-object v0, v1, Landroid/os/BaseBundle;->mMap:Landroid/util/ArrayMap;
    ...
    iput-object v0, v1, Landroid/os/BaseBundle;->mMap:Landroid/util/ArrayMap;
    ...
    :goto_0
    iput-boolean v11, v1, Landroid/os/BaseBundle;->mParcelledByNative:Z

    iput-object v10, v1, Landroid/os/BaseBundle;->mParcelledData:Landroid/os/Parcel;
    ...
    invoke-direct {v3, v12}, Landroid/util/ArrayMap;-><init>(I)V
    ...
    invoke-virtual {v0, v12}, Landroid/util/ArrayMap;->ensureCapacity(I)V
    ...
    :goto_2
    :try_start_0
    iget-object v7, v1, Landroid/os/BaseBundle;->mClassLoader:Ljava/lang/ClassLoader;
    ...
    invoke-virtual/range {v2 .. v8}, Landroid/os/Parcel;->readArrayMap(Landroid/util/ArrayMap;IZZLjava/lang/ClassLoader;[I)V
    :try_end_0
    .catch Landroid/os/BadParcelableException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iput-object v10, v1, Landroid/os/BaseBundle;->mWeakParcelledData:Ljava/lang/ref/WeakReference;
    ...
    invoke-static/range {p1 .. p1}, Landroid/os/BaseBundle;->recycleParcel(Landroid/os/Parcel;)V
    ...
    iput-object v0, v1, Landroid/os/BaseBundle;->mWeakParcelledData:Ljava/lang/ref/WeakReference;
    ...
    :goto_4
    iput v0, v1, Landroid/os/BaseBundle;->mLazyValues:I

    iput-boolean v11, v1, Landroid/os/BaseBundle;->mParcelledByNative:Z

    iput-object v13, v1, Landroid/os/BaseBundle;->mMap:Landroid/util/ArrayMap;
    ...
    const-string v3, "Failed to parse Bundle, but defusing quietly"

    invoke-static {v2, v3, v0}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I

    invoke-virtual {v13}, Landroid/util/ArrayMap;->erase()V
    :try_end_1
    ...
    iput-object v2, v1, Landroid/os/BaseBundle;->mWeakParcelledData:Ljava/lang/ref/WeakReference;

    :cond_b
    :goto_8
    aget v2, v14, v11

    iput v2, v1, Landroid/os/BaseBundle;->mLazyValues:I
