...
.method public whitelist pauseRecording(Landroid/os/Bundle;)V
    ...
    const-string/jumbo v2, "pauseRecording failed - recording already paused"
    ...
    const-string/jumbo v2, "pauseRecording failed - operation not supported"
    ...
    const-string/jumbo v1, "pauseRecording failed - recording not yet started or stopping"
...
.method public whitelist resumeRecording(Landroid/os/Bundle;)V
    ...
    const-string/jumbo v1, "resumeRecording failed - recording not yet started or stopping or not yet tuned"
...
.method public whitelist setTvInteractiveAppView(Landroid/media/tv/interactive/TvInteractiveAppView;Ljava/lang/String;)V
    ...
    const-string/jumbo v1, "null recordingId is not allowed only when the view is not null"
    ...
    const-string/jumbo v1, "recordingId should be null when the view is null"
