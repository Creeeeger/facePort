...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    const-string v12, "android.permission.IPermissionManager"
    ...
    invoke-virtual {v8, v0, v1, v2}, Landroid/permission/IPermissionManager$Stub;->getAllPermissionStates(Ljava/lang/String;Ljava/lang/String;I)Ljava/util/Map;
    ...
    new-instance v4, Landroid/permission/IPermissionManager$Stub$$ExternalSyntheticLambda0;

    invoke-direct {v4, v11}, Landroid/permission/IPermissionManager$Stub$$ExternalSyntheticLambda0;-><init>(Landroid/os/Parcel;)V
    ...
    invoke-virtual {v8, v0, v1, v2}, Landroid/permission/IPermissionManager$Stub;->checkUidPermission(ILjava/lang/String;I)I
    ...
    invoke-virtual {v8, v0, v1, v2, v3}, Landroid/permission/IPermissionManager$Stub;->checkPermission(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)I
    ...
    invoke-virtual {v8, v0}, Landroid/permission/IPermissionManager$Stub;->isRegisteredAttributionSource(Landroid/content/AttributionSourceState;)Z
    ...
    invoke-virtual {v8, v0}, Landroid/permission/IPermissionManager$Stub;->getRegisteredAttributionSourceCount(I)I
    ...
    invoke-virtual {v8, v0}, Landroid/permission/IPermissionManager$Stub;->registerAttributionSource(Landroid/content/AttributionSourceState;)Landroid/os/IBinder;
    ...
    invoke-virtual {v8, v0, v1}, Landroid/permission/IPermissionManager$Stub;->isAutoRevokeExempted(Ljava/lang/String;I)Z
    ...
    invoke-virtual {v8, v0, v1, v2}, Landroid/permission/IPermissionManager$Stub;->setAutoRevokeExempted(Ljava/lang/String;ZI)Z
    ...
    invoke-virtual {v8, v0}, Landroid/permission/IPermissionManager$Stub;->getAutoRevokeExemptionGrantedPackages(I)Ljava/util/List;
    ...
    invoke-virtual {v8, v0}, Landroid/permission/IPermissionManager$Stub;->getAutoRevokeExemptionRequestedPackages(I)Ljava/util/List;
    ...
    invoke-virtual {v8, v0, v1}, Landroid/permission/IPermissionManager$Stub;->stopOneTimePermissionSession(Ljava/lang/String;I)V
    ...
    invoke-virtual {v8, v0, v1, v2, v3}, Landroid/permission/IPermissionManager$Stub;->isPermissionRevokedByPolicy(Ljava/lang/String;Ljava/lang/String;II)Z
    ...
    invoke-virtual {v8, v0, v1, v2, v3}, Landroid/permission/IPermissionManager$Stub;->shouldShowRequestPermissionRationale(Ljava/lang/String;Ljava/lang/String;II)Z
    ...
    invoke-virtual {v8, v0, v1}, Landroid/permission/IPermissionManager$Stub;->revokePostNotificationPermissionWithoutKillForTest(Ljava/lang/String;I)V
    ...
    invoke-virtual {v8, v0, v1, v2, v3}, Landroid/permission/IPermissionManager$Stub;->grantRuntimePermission(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V
    ...
    invoke-virtual {v8, v0, v1, v2, v3}, Landroid/permission/IPermissionManager$Stub;->removeAllowlistedRestrictedPermission(Ljava/lang/String;Ljava/lang/String;II)Z
    ...
    invoke-virtual {v8, v0, v1, v2, v3}, Landroid/permission/IPermissionManager$Stub;->addAllowlistedRestrictedPermission(Ljava/lang/String;Ljava/lang/String;II)Z
    ...
    invoke-virtual {v8, v0, v1, v2}, Landroid/permission/IPermissionManager$Stub;->getAllowlistedRestrictedPermissions(Ljava/lang/String;II)Ljava/util/List;
    ...
    invoke-virtual {v8, v0}, Landroid/permission/IPermissionManager$Stub;->removeOnPermissionsChangeListener(Landroid/permission/IOnPermissionsChangeListener;)V
    ...
    invoke-virtual {v8, v0}, Landroid/permission/IPermissionManager$Stub;->addOnPermissionsChangeListener(Landroid/permission/IOnPermissionsChangeListener;)V
    ...
    invoke-virtual {v8, v0, v1, v2}, Landroid/permission/IPermissionManager$Stub;->updatePermissionFlagsForAllApps(III)V
    ...
    invoke-virtual {v8, v0, v1, v2, v3}, Landroid/permission/IPermissionManager$Stub;->getPermissionFlags(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)I
    ...
    invoke-virtual {v8, v0}, Landroid/permission/IPermissionManager$Stub;->removePermission(Ljava/lang/String;)V
    ...
    invoke-virtual {v8, v0, v1}, Landroid/permission/IPermissionManager$Stub;->addPermission(Landroid/content/pm/PermissionInfo;Z)Z
    ...
    invoke-virtual {v8, v0, v1}, Landroid/permission/IPermissionManager$Stub;->queryPermissionsByGroup(Ljava/lang/String;I)Landroid/content/pm/ParceledListSlice;
    ...
    invoke-virtual {v8, v0, v1, v2}, Landroid/permission/IPermissionManager$Stub;->getPermissionInfo(Ljava/lang/String;Ljava/lang/String;I)Landroid/content/pm/PermissionInfo;
    ...
    invoke-virtual {v8, v0, v1}, Landroid/permission/IPermissionManager$Stub;->getPermissionGroupInfo(Ljava/lang/String;I)Landroid/content/pm/PermissionGroupInfo;
    ...
    invoke-virtual {v8, v0}, Landroid/permission/IPermissionManager$Stub;->getAllPermissionGroups(I)Landroid/content/pm/ParceledListSlice;
