...
.field public static final blacklist SEM_AUTO_WIFI_ABTEST_PARAM:Ljava/lang/String; = "sem_auto_wifi_abtest_param"
    .annotation runtime Landroid/provider/Settings$Readable;
    .end annotation
.end field

.field public static final blacklist SEM_AUTO_WIFI_ABTEST_REPORT:Ljava/lang/String; = "sem_auto_wifi_abtest_report"
    .annotation runtime Landroid/provider/Settings$Readable;
    .end annotation
.end field
...
.field public static final blacklist SHOW_PLAYBACK_CONTROLS_BELOW_VIDEOS:Ljava/lang/String; = "show_playback_controls_below_videos"
    .annotation runtime Landroid/provider/Settings$Readable;
    .end annotation
.end field
...
.method static constructor blacklist <clinit>()V
    ...
    invoke-direct {v1, v2}, Landroid/provider/Settings$ContentProviderHolder;-><init>(Landroid/net/Uri;)V
    ...
    sget-object v8, Landroid/provider/Settings$Global;->sProviderHolder:Landroid/provider/Settings$ContentProviderHolder;

    const-class v9, Landroid/provider/Settings$Global;

    const-string v5, "GET_global"

    const-string v6, "PUT_global"

    const-string v7, "DELETE_global"

    move-object v3, v1

    invoke-direct/range {v3 .. v9}, Landroid/provider/Settings$NameValueCache;-><init>(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/provider/Settings$ContentProviderHolder;Ljava/lang/Class;)V
    ...
    sget-object v1, Landroid/provider/Settings$Global;->MOVED_TO_SECURE:Ljava/util/HashSet;
    ...
    const-string/jumbo v2, "show_zen_settings_suggestion"
    ...
    sget-object v1, Landroid/provider/Settings$Global;->MOVED_TO_SYSTEM:Ljava/util/HashSet;
    ...
    sget-object v1, Landroid/provider/Settings$Global;->INSTANT_APP_SETTINGS:Ljava/util/Set;
