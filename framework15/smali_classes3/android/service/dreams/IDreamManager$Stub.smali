...
.field static final blacklist TRANSACTION_semStartDozing:I = 0x14
...
.method public whitelist onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-virtual/range {v0 .. v6}, Landroid/service/dreams/IDreamManager$Stub;->semStartDozing(Landroid/os/IBinder;IIIIZ)V
    ...
    invoke-virtual {v7, v0}, Landroid/service/dreams/IDreamManager$Stub;->setDreamIsObscured(Z)V
    ...
    invoke-virtual {v7, v0}, Landroid/service/dreams/IDreamManager$Stub;->startDreamActivity(Landroid/content/Intent;)V
    ...
    invoke-virtual {v7, v0}, Landroid/service/dreams/IDreamManager$Stub;->registerDreamOverlayService(Landroid/content/ComponentName;)V
    ...
    invoke-virtual {v7, v0}, Landroid/service/dreams/IDreamManager$Stub;->setSystemDreamComponent(Landroid/content/ComponentName;)V
    ...
    invoke-virtual {v7, v0, v1}, Landroid/service/dreams/IDreamManager$Stub;->setDreamComponentsForUser(I[Landroid/content/ComponentName;)V
    ...
    invoke-virtual {v7, v0}, Landroid/service/dreams/IDreamManager$Stub;->getDreamComponentsForUser(I)[Landroid/content/ComponentName;
    ...
    invoke-virtual {v7, v0}, Landroid/service/dreams/IDreamManager$Stub;->forceAmbientDisplayEnabled(Z)V
    ...
    invoke-virtual {v7, v0}, Landroid/service/dreams/IDreamManager$Stub;->stopDozing(Landroid/os/IBinder;)V
    ...
    invoke-virtual {v7, v0, v1, v2, v3}, Landroid/service/dreams/IDreamManager$Stub;->startDozing(Landroid/os/IBinder;III)V
    ...
    invoke-virtual {v7, v0, v1}, Landroid/service/dreams/IDreamManager$Stub;->finishSelf(Landroid/os/IBinder;Z)V
    ...
    invoke-virtual {v7, v0}, Landroid/service/dreams/IDreamManager$Stub;->canStartDreaming(Z)Z
    ...
    invoke-virtual {v7, v0, v1}, Landroid/service/dreams/IDreamManager$Stub;->testDream(ILandroid/content/ComponentName;)V
    ...
    invoke-virtual {v7, v0}, Landroid/service/dreams/IDreamManager$Stub;->getDefaultDreamComponentForUser(I)Landroid/content/ComponentName;
    ...
    invoke-virtual {v7, v0}, Landroid/service/dreams/IDreamManager$Stub;->setDreamComponents([Landroid/content/ComponentName;)V
