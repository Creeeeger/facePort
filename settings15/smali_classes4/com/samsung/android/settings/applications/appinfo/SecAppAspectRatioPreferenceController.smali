.class public Lcom/samsung/android/settings/applications/appinfo/SecAppAspectRatioPreferenceController;
.super Lcom/android/settings/applications/appinfo/AppInfoPreferenceControllerBase;
.source "qb/98004394 196cb3c588f4bce8f34d9a4b22ef87dca56ab51c1d488078a331bdfa0f5f580b"


# static fields
.field static final TAG:Ljava/lang/String; = "SecAppAspectRatioPreferenceController"


# instance fields
.field private mAtm:Landroid/app/IActivityTaskManager;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/samsung/android/settings/applications/appinfo/SecAppAspectRatioPreferenceController;->mAtm:Landroid/app/IActivityTaskManager;

    return-void
.end method

.method private getAspectRatioCategory(I)I
    .locals 0
...
.method public getAvailabilityStatus()I
    ...
    iget-object v2, p0, Lcom/android/settings/applications/appinfo/AppInfoPreferenceControllerBase;->mAppEntry:Lcom/android/settingslib/applications/ApplicationsState$AppEntry;
    ...
    invoke-virtual {v0, v3, v2}, Landroid/content/pm/LauncherApps;->getActivityList(Ljava/lang/String;Landroid/os/UserHandle;)Ljava/util/List;
    ...
    invoke-direct {v0, v2, v3}, Lcom/samsung/android/core/CompatChangeableApps;-><init>(IZ)V

    iget-object v2, p0, Lcom/samsung/android/settings/applications/appinfo/SecAppAspectRatioPreferenceController;->mPackageName:Ljava/lang/String;

    invoke-virtual {v0, v2}, Lcom/samsung/android/core/CompatChangeableApps;->isMinAspectRatioOverrideDisallowed(Ljava/lang/String;)Z
    ...
    iget-object v1, p0, Lcom/android/settings/applications/appinfo/AppInfoPreferenceControllerBase;->mAppEntry:Lcom/android/settingslib/applications/ApplicationsState$AppEntry;
...
.method public getDetailFragmentClass()Ljava/lang/Class;
    ...
    const-class p0, Lcom/samsung/android/settings/applications/appinfo/SecAppAspectRatioDetails;
...
.method public getSummary()Ljava/lang/CharSequence;
    ...
    :try_start_0
    iget-object v0, p0, Lcom/samsung/android/settings/applications/appinfo/SecAppAspectRatioPreferenceController;->mAtm:Landroid/app/IActivityTaskManager;
    ...
    invoke-interface {v0, v2, v1}, Landroid/app/IActivityTaskManager;->getUserOrSystemMinAspectRatioOverrideCode(Ljava/lang/String;I)I
    ...
    :catch_0
    const-string v0, "SecAppAspectRatioPreferenceController"

    const-string v1, "Failed to get user or system min aspect ratio"
    ...
    invoke-direct {p0, v0}, Lcom/samsung/android/settings/applications/appinfo/SecAppAspectRatioPreferenceController;->getAspectRatioCategory(I)I
...
.method public refreshUi()V
    ...
    invoke-virtual {p0}, Lcom/samsung/android/settings/applications/appinfo/SecAppAspectRatioPreferenceController;->getAvailabilityStatus()I
...
.method public setPackageName(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/samsung/android/settings/applications/appinfo/SecAppAspectRatioPreferenceController;->mPackageName:Ljava/lang/String;
