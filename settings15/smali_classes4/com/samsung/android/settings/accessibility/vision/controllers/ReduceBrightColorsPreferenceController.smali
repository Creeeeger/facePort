.class public Lcom/samsung/android/settings/accessibility/vision/controllers/ReduceBrightColorsPreferenceController;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/samsung/android/settings/accessibility/vision/controllers/ReduceBrightColorsPreferenceController;->mContext:Landroid/content/Context;
    ...
    iput-object p1, p0, Lcom/samsung/android/settings/accessibility/vision/controllers/ReduceBrightColorsPreferenceController;->mColorDisplayManager:Landroid/hardware/display/ColorDisplayManager;

    return-void
.end method

.method private getExtraDimStatusMap(Landroid/content/Context;Z)Ljava/util/Map;
    .locals 1
    ...
    invoke-static {v0, p1, p2, p0}, Ljava/util/Map;->of(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/util/Map;
...
.method public getAvailabilityStatus()I
    ...
    iget-object v0, p0, Lcom/samsung/android/settings/accessibility/vision/controllers/ReduceBrightColorsPreferenceController;->mContext:Landroid/content/Context;
    ...
    invoke-static {v0}, Lcom/samsung/android/settings/accessibility/SecAccessibilityUtils;->isSupportReduceBrightness(Landroid/content/Context;)Z

    move-result v0

    if-eqz v0, :cond_1

    iget-object p0, p0, Lcom/samsung/android/settings/accessibility/vision/controllers/ReduceBrightColorsPreferenceController;->mContext:Landroid/content/Context;
...
.method public getStatusLoggingData(Landroid/content/Context;)Ljava/util/Map;
    ...
    invoke-virtual {p0}, Lcom/samsung/android/settings/accessibility/vision/controllers/ReduceBrightColorsPreferenceController;->isChecked()Z

    move-result v1

    invoke-direct {p0, p1, v1}, Lcom/samsung/android/settings/accessibility/vision/controllers/ReduceBrightColorsPreferenceController;->getExtraDimStatusMap(Landroid/content/Context;Z)Ljava/util/Map;

    move-result-object p0

    const-string p1, "A11YSE3171"

    invoke-virtual {v0, v4, p1, p0}, Lcom/android/settingslib/core/instrumentation/MetricsFeatureProvider;->actionBackground(ILjava/lang/String;Ljava/util/Map;)V
...
.method public getUriList()Ljava/util/List;
    ...
    const-string/jumbo p0, "reduce_bright_colors_activated"
