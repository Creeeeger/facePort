.class public final Lcom/samsung/android/settings/accessibility/bixby/action/hearing/LiveTranscribeAction;
...
.method public final doGetSupportFeature(Landroid/content/Context;Lcom/samsung/android/settings/accessibility/bixby/data/ParsedBundle;)Landroid/os/Bundle;
    ...
    iget-object v1, p0, Lcom/samsung/android/settings/accessibility/bixby/action/hearing/LiveTranscribeAction;->connectionPreference:Lcom/android/settingslib/RestrictedPreference;

    if-nez v1, :cond_0

    invoke-virtual {p0, p1}, Lcom/samsung/android/settings/accessibility/bixby/action/hearing/LiveTranscribeAction;->init(Landroid/content/Context;)V

    :cond_0
    iget-object p0, p0, Lcom/samsung/android/settings/accessibility/bixby/action/hearing/LiveTranscribeAction;->connectionPreference:Lcom/android/settingslib/RestrictedPreference;
...
.method public final getControllerName(Landroid/content/Context;)Ljava/lang/String;
    ...
    const-string p0, "com.samsung.android.settings.accessibility.hearing.controllers.LiveTranscribePreferenceController"
...
.method public final getPunchoutIntent(Landroid/content/Context;)Landroid/content/Intent;
    ...
    iget-object v0, p0, Lcom/samsung/android/settings/accessibility/bixby/action/hearing/LiveTranscribeAction;->connectionPreference:Lcom/android/settingslib/RestrictedPreference;
...
.method public final init(Landroid/content/Context;)V
    ...
    sget-object v1, Lcom/samsung/android/settings/accessibility/AccessibilityConstant;->COMPONENT_NAME_LIVE_TRANSCRIBE:Landroid/content/ComponentName;
    ...
    invoke-virtual {v0, p1}, Lcom/android/settings/accessibility/RestrictedPreferenceHelper;->createAccessibilityServicePreferenceList(Ljava/util/List;)Ljava/util/List;
    ...
    :cond_0
    sget-object v1, Lcom/samsung/android/settings/accessibility/AccessibilityConstant;->COMPONENT_NAME_GOOGLE_LIVE_TRANSCRIBE_SHORTCUT:Landroid/content/ComponentName;
    ...
    :goto_0
    iput-object p1, p0, Lcom/samsung/android/settings/accessibility/bixby/action/hearing/LiveTranscribeAction;->connectionPreference:Lcom/android/settingslib/RestrictedPreference;
