.class public Lcom/samsung/android/settings/accessibility/advanced/controller/SecAccessibilityTimeoutPreferenceController;
.super Lcom/android/settings/accessibility/AccessibilityTimeoutPreferenceController;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/settings/accessibility/AccessibilityTimeoutPreferenceController;-><init>(Landroid/content/Context;Ljava/lang/String;)V
...
.method public bridge synthetic getBackupKeys()Ljava/util/List;
    ...
    invoke-super {p0}, Lcom/android/settings/accessibility/AccessibilityTimeoutPreferenceController;->getBackupKeys()Ljava/util/List;
...
.method public bridge synthetic getLaunchIntent()Landroid/content/Intent;
    ...
    invoke-super {p0}, Lcom/android/settings/accessibility/AccessibilityTimeoutPreferenceController;->getLaunchIntent()Landroid/content/Intent;
...
.method public getStatusLoggingData(Landroid/content/Context;)Ljava/util/Map;
    ...
    invoke-static {p0, p1}, Lcom/samsung/android/settings/accessibility/advanced/controller/SecAccessibilityTimeoutUtil;->getTimeoutTitle(Landroid/content/Context;I)Ljava/lang/CharSequence;
...
.method public bridge synthetic getStatusText()Ljava/lang/String;
    ...
    invoke-super {p0}, Lcom/android/settings/accessibility/AccessibilityTimeoutPreferenceController;->getStatusText()Ljava/lang/String;
...
.method public getSummary()Ljava/lang/CharSequence;
    ...
    invoke-static {v0}, Lcom/android/settings/accessibility/AccessibilityTimeoutUtils;->getSecureAccessibilityTimeoutValue(Landroid/content/ContentResolver;)I

    move-result v0

    invoke-static {p0, v0}, Lcom/samsung/android/settings/accessibility/advanced/controller/SecAccessibilityTimeoutUtil;->getTimeoutTitle(Landroid/content/Context;I)Ljava/lang/CharSequence;
...
.method public getUriList()Ljava/util/List;
    ...
    const-string p0, "accessibility_interactive_ui_timeout_ms"
...
.method public getValue()Lcom/samsung/android/settings/cube/ControlValue;
    ...
    invoke-static {v1}, Lcom/android/settings/accessibility/AccessibilityTimeoutUtils;->getSecureAccessibilityTimeoutValue(Landroid/content/ContentResolver;)I
...
.method public bridge synthetic ignoreUserInteraction()V
    ...
    invoke-super {p0}, Lcom/android/settings/accessibility/AccessibilityTimeoutPreferenceController;->ignoreUserInteraction()V
...
.method public bridge synthetic needUserInteraction(Ljava/lang/Object;)Lcom/samsung/android/settings/cube/Controllable$ControllableType;
    ...
    invoke-super {p0, p1}, Lcom/android/settings/accessibility/AccessibilityTimeoutPreferenceController;->needUserInteraction(Ljava/lang/Object;)Lcom/samsung/android/settings/cube/Controllable$ControllableType;
...
.method public bridge synthetic runDefaultAction()Z
    ...
    invoke-super {p0}, Lcom/android/settings/accessibility/AccessibilityTimeoutPreferenceController;->runDefaultAction()Z
...
.method public setValue(Lcom/samsung/android/settings/cube/ControlValue;)Lcom/samsung/android/settings/cube/ControlResult;
    ...
    const-string/jumbo v2, "setValue - value is not number type. value : "
    ...
    const-string v2, "SecAccessibilityTimeoutPreferenceController"

    invoke-static {v2, v1, v0}, Landroid/util/Log;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I

    :cond_0
    invoke-super {p0, p1}, Lcom/android/settings/accessibility/AccessibilityTimeoutPreferenceController;->setValue(Lcom/samsung/android/settings/cube/ControlValue;)Lcom/samsung/android/settings/cube/ControlResult;
