.class public Lcom/samsung/android/settings/accessibility/dexterity/controllers/VoiceAccessPreferenceController;
.super Lcom/samsung/android/settings/accessibility/base/controller/AccessibilityServicePreferenceController;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/samsung/android/settings/accessibility/base/controller/AccessibilityServicePreferenceController;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    return-void
.end method

.method private isVoiceAccessEnabled()Z
    .locals 1
    ...
    sget-object v0, Lcom/samsung/android/settings/accessibility/AccessibilityConstant;->COMPONENT_NAME_VOICE_ACCESS:Landroid/content/ComponentName;
...
.method public displayPreference(Landroidx/preference/PreferenceScreen;)V
    ...
    invoke-super {p0, p1}, Lcom/samsung/android/settings/accessibility/base/controller/AccessibilityRestrictedPreferenceController;->displayPreference(Landroidx/preference/PreferenceScreen;)V
...
.method public getAvailabilityStatus()I
    ...
    invoke-static {v0}, Lcom/samsung/android/settings/accessibility/SecAccessibilityUtils;->isDesktopDualModeMonitorDisplay(Landroid/content/Context;)Z
    ...
    invoke-virtual {p0}, Lcom/samsung/android/settings/accessibility/dexterity/controllers/VoiceAccessPreferenceController;->getComponentName()Landroid/content/ComponentName;
...
.method public bridge synthetic getBackupKeys()Ljava/util/List;
    ...
    invoke-super {p0}, Lcom/samsung/android/settings/accessibility/base/controller/AccessibilityServicePreferenceController;->getBackupKeys()Ljava/util/List;
...
.method public getComponentName()Landroid/content/ComponentName;
    ...
    sget-object p0, Lcom/samsung/android/settings/accessibility/AccessibilityConstant;->COMPONENT_NAME_VOICE_ACCESS:Landroid/content/ComponentName;
...
.method public getIcon(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p1, p0}, Lcom/samsung/android/settings/accessibility/SecAccessibilityUtils;->getAccessibilityServiceInfo(Landroid/content/Context;Landroid/content/ComponentName;)Landroid/accessibilityservice/AccessibilityServiceInfo;
...
.method public bridge synthetic getLaunchIntent()Landroid/content/Intent;
    ...
    invoke-super {p0}, Lcom/samsung/android/settings/accessibility/base/controller/AccessibilityServicePreferenceController;->getLaunchIntent()Landroid/content/Intent;
...
.method public getStatusLoggingData(Landroid/content/Context;)Ljava/util/Map;
    ...
    invoke-direct {p0}, Lcom/samsung/android/settings/accessibility/dexterity/controllers/VoiceAccessPreferenceController;->isVoiceAccessEnabled()Z
...
.method public bridge synthetic getStatusText()Ljava/lang/String;
    ...
    invoke-super {p0}, Lcom/samsung/android/settings/accessibility/base/controller/AccessibilityServicePreferenceController;->getStatusText()Ljava/lang/String;
...
.method public bridge synthetic ignoreUserInteraction()V
    ...
    invoke-super {p0}, Lcom/samsung/android/settings/accessibility/base/controller/AccessibilityServicePreferenceController;->ignoreUserInteraction()V
...
.method public bridge synthetic needUserInteraction(Ljava/lang/Object;)Lcom/samsung/android/settings/cube/Controllable$ControllableType;
    ...
    invoke-super {p0, p1}, Lcom/samsung/android/settings/accessibility/base/controller/AccessibilityServicePreferenceController;->needUserInteraction(Ljava/lang/Object;)Lcom/samsung/android/settings/cube/Controllable$ControllableType;
...
.method public bridge synthetic runDefaultAction()Z
    ...
    invoke-super {p0}, Lcom/samsung/android/settings/accessibility/base/controller/AccessibilityServicePreferenceController;->runDefaultAction()Z
...
.method public setValue(Lcom/samsung/android/settings/cube/ControlValue;)Lcom/samsung/android/settings/cube/ControlResult;
    ...
    :cond_0
    invoke-super {p0, p1}, Lcom/samsung/android/settings/accessibility/base/controller/AccessibilityServicePreferenceController;->setValue(Lcom/samsung/android/settings/cube/ControlValue;)Lcom/samsung/android/settings/cube/ControlResult;
...
.method public updateDynamicRawDataToIndex(Ljava/util/List;)V
    ...
    invoke-static {v0, v1}, Lcom/samsung/android/settings/accessibility/SecAccessibilityUtils;->getAccessibilityServiceInfo(Landroid/content/Context;Landroid/content/ComponentName;)Landroid/accessibilityservice/AccessibilityServiceInfo;
