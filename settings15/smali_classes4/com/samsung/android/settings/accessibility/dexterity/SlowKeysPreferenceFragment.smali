.class public Lcom/samsung/android/settings/accessibility/dexterity/SlowKeysPreferenceFragment;
...
.field public final mSlowKeysObserver:Lcom/samsung/android/settings/accessibility/dexterity/SlowKeysPreferenceFragment$1;

.field public mSlowKeysOnKeyListener:Lcom/samsung/android/settings/accessibility/dexterity/SlowKeysPreferenceFragment$SlowKeyOnKeyListener;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/samsung/android/settings/accessibility/dexterity/SlowKeysPreferenceFragment;->mKeyEventFinished:Z

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lcom/samsung/android/settings/accessibility/dexterity/SlowKeysPreferenceFragment;->mCurrentTime:J

    new-instance v0, Lcom/samsung/android/settings/accessibility/dexterity/SlowKeysPreferenceFragment$1;

    new-instance v1, Landroid/os/Handler;

    invoke-direct {v1}, Landroid/os/Handler;-><init>()V

    invoke-direct {v0, p0, v1}, Lcom/samsung/android/settings/accessibility/dexterity/SlowKeysPreferenceFragment$1;-><init>(Lcom/samsung/android/settings/accessibility/dexterity/SlowKeysPreferenceFragment;Landroid/os/Handler;)V

    iput-object v0, p0, Lcom/samsung/android/settings/accessibility/dexterity/SlowKeysPreferenceFragment;->mSlowKeysObserver:Lcom/samsung/android/settings/accessibility/dexterity/SlowKeysPreferenceFragment$1;
...
.method public final onCheckedChanged(Landroid/widget/CompoundButton;Z)V
    ...
    invoke-static {p1, p2}, Lcom/samsung/android/settings/accessibility/dexterity/SlowKeysUtils;->setSlowKeysEnable(Landroid/content/Context;Z)V
    ...
    :cond_0
    iget-object p1, p0, Lcom/samsung/android/settings/accessibility/dexterity/SlowKeysPreferenceFragment;->mSlowKeysOnKeyListener:Lcom/samsung/android/settings/accessibility/dexterity/SlowKeysPreferenceFragment$SlowKeyOnKeyListener;
...
.method public final onPause()V
    ...
    iget-object p0, p0, Lcom/samsung/android/settings/accessibility/dexterity/SlowKeysPreferenceFragment;->mSlowKeysObserver:Lcom/samsung/android/settings/accessibility/dexterity/SlowKeysPreferenceFragment$1;
...
.method public final onResume()V
    ...
    iget-object v2, p0, Lcom/samsung/android/settings/accessibility/dexterity/SlowKeysPreferenceFragment;->mSlowKeysObserver:Lcom/samsung/android/settings/accessibility/dexterity/SlowKeysPreferenceFragment$1;

    const/4 v3, 0x1

    invoke-virtual {v0, v1, v3, v2}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;)V

    iget-object v0, p0, Lcom/samsung/android/settings/accessibility/dexterity/SlowKeysPreferenceFragment;->mContext:Landroid/content/Context;

    invoke-static {v0}, Landroid/hardware/input/InputSettings;->isAccessibilitySlowKeysEnabled(Landroid/content/Context;)Z

    move-result v0

    iget-object v1, p0, Lcom/samsung/android/settings/accessibility/dexterity/SlowKeysPreferenceFragment;->switchBar:Lcom/android/settings/widget/SettingsMainSwitchBar;
...
.method public final onValueChange(Ljava/lang/String;)V
    ...
    const-string/jumbo v1, "slow_keys_period"
    ...
    iget-object p0, p0, Lcom/samsung/android/settings/accessibility/dexterity/SlowKeysPreferenceFragment;->mContext:Landroid/content/Context;

    const/4 p1, 0x1

    invoke-static {p0, p1}, Lcom/samsung/android/settings/accessibility/dexterity/SlowKeysUtils;->setSlowKeysEnable(Landroid/content/Context;Z)V
...
.method public final onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    iput-object p1, p0, Lcom/samsung/android/settings/accessibility/dexterity/SlowKeysPreferenceFragment;->mContext:Landroid/content/Context;
    ...
    iput-object p1, p0, Lcom/samsung/android/settings/accessibility/dexterity/SlowKeysPreferenceFragment;->switchBar:Lcom/android/settings/widget/SettingsMainSwitchBar;

    :cond_0
    iget-object p1, p0, Lcom/samsung/android/settings/accessibility/dexterity/SlowKeysPreferenceFragment;->switchBar:Lcom/android/settings/widget/SettingsMainSwitchBar;
    ...
    iget-object p2, p0, Lcom/samsung/android/settings/accessibility/dexterity/SlowKeysPreferenceFragment;->mContext:Landroid/content/Context;

    invoke-static {p2}, Landroid/hardware/input/InputSettings;->isAccessibilitySlowKeysEnabled(Landroid/content/Context;)Z
    ...
    new-instance p2, Lcom/samsung/android/settings/accessibility/dexterity/SlowKeysPreferenceFragment$$ExternalSyntheticLambda0;

    invoke-direct {p2, p0}, Lcom/samsung/android/settings/accessibility/dexterity/SlowKeysPreferenceFragment$$ExternalSyntheticLambda0;-><init>(Lcom/samsung/android/settings/accessibility/dexterity/SlowKeysPreferenceFragment;)V
    ...
    new-instance p1, Lcom/samsung/android/settings/accessibility/dexterity/SlowKeysPreferenceFragment$SlowKeyOnKeyListener;

    invoke-direct {p1, p0}, Lcom/samsung/android/settings/accessibility/dexterity/SlowKeysPreferenceFragment$SlowKeyOnKeyListener;-><init>(Lcom/samsung/android/settings/accessibility/dexterity/SlowKeysPreferenceFragment;)V

    iput-object p1, p0, Lcom/samsung/android/settings/accessibility/dexterity/SlowKeysPreferenceFragment;->mSlowKeysOnKeyListener:Lcom/samsung/android/settings/accessibility/dexterity/SlowKeysPreferenceFragment$SlowKeyOnKeyListener;
