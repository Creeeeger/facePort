.class public Lcom/samsung/android/settings/accessibility/hearing/controllers/SecLiveCaptionPreferenceController;
.super Lcom/android/settings/accessibility/LiveCaptionPreferenceController;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/android/settings/accessibility/LiveCaptionPreferenceController;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    return-void
.end method

.method private isEnabledStatus(Landroid/content/Context;)Z
    .locals 1
...
.method public getAvailabilityStatus()I
    ...
    :cond_0
    invoke-super {p0}, Lcom/android/settings/accessibility/LiveCaptionPreferenceController;->getAvailabilityStatus()I
...
.method public bridge synthetic getBackupKeys()Ljava/util/List;
    ...
    invoke-super {p0}, Lcom/android/settings/accessibility/LiveCaptionPreferenceController;->getBackupKeys()Ljava/util/List;
...
.method public bridge synthetic getLaunchIntent()Landroid/content/Intent;
    ...
    invoke-super {p0}, Lcom/android/settings/accessibility/LiveCaptionPreferenceController;->getLaunchIntent()Landroid/content/Intent;
...
.method public getStatusLoggingData(Landroid/content/Context;)Ljava/util/Map;
    ...
    invoke-virtual {p0}, Lcom/samsung/android/settings/accessibility/hearing/controllers/SecLiveCaptionPreferenceController;->getAvailabilityStatus()I
    ...
    :cond_0
    invoke-direct {p0, p1}, Lcom/samsung/android/settings/accessibility/hearing/controllers/SecLiveCaptionPreferenceController;->isEnabledStatus(Landroid/content/Context;)Z
...
.method public bridge synthetic getStatusText()Ljava/lang/String;
    ...
    invoke-super {p0}, Lcom/android/settings/accessibility/LiveCaptionPreferenceController;->getStatusText()Ljava/lang/String;
...
.method public getSummary()Ljava/lang/CharSequence;
    ...
    invoke-direct {p0, v0}, Lcom/samsung/android/settings/accessibility/hearing/controllers/SecLiveCaptionPreferenceController;->isEnabledStatus(Landroid/content/Context;)Z
...
.method public getUriList()Ljava/util/List;
    ...
    const-string/jumbo p0, "odi_captions_enabled"
...
.method public bridge synthetic ignoreUserInteraction()V
    ...
    invoke-super {p0}, Lcom/android/settings/accessibility/LiveCaptionPreferenceController;->ignoreUserInteraction()V
...
.method public bridge synthetic needUserInteraction(Ljava/lang/Object;)Lcom/samsung/android/settings/cube/Controllable$ControllableType;
    ...
    invoke-super {p0, p1}, Lcom/android/settings/accessibility/LiveCaptionPreferenceController;->needUserInteraction(Ljava/lang/Object;)Lcom/samsung/android/settings/cube/Controllable$ControllableType;
...
.method public bridge synthetic runDefaultAction()Z
    ...
    invoke-super {p0}, Lcom/android/settings/accessibility/LiveCaptionPreferenceController;->runDefaultAction()Z
...
.method public setValue(Lcom/samsung/android/settings/cube/ControlValue;)Lcom/samsung/android/settings/cube/ControlResult;
    ...
    :cond_1
    invoke-super {p0, p1}, Lcom/android/settings/accessibility/LiveCaptionPreferenceController;->setValue(Lcom/samsung/android/settings/cube/ControlValue;)Lcom/samsung/android/settings/cube/ControlResult;
