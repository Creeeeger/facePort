.class public final Lcom/samsung/android/settings/connection/GigaMultiPath$8;
...
# direct methods
.method public synthetic constructor <init>(Lcom/samsung/android/settings/connection/GigaMultiPath;Landroid/os/Handler;I)V
    .locals 0

    iput p3, p0, Lcom/samsung/android/settings/connection/GigaMultiPath$8;->$r8$classId:I
...
.method public final onChange(Z)V
    ...
    iget p1, p0, Lcom/samsung/android/settings/connection/GigaMultiPath$8;->$r8$classId:I
    ...
    iget-boolean p1, p0, Lcom/samsung/android/settings/connection/GigaMultiPath;->mIsNetworkEnabling:Z

    const/4 v0, 0x0

    if-eqz p1, :cond_0

    iget-boolean p1, p0, Lcom/samsung/android/settings/connection/GigaMultiPath;->mIsMobileDataEnabling:Z

    if-eqz p1, :cond_0

    iput-boolean v0, p0, Lcom/samsung/android/settings/connection/GigaMultiPath;->mIsMobileDataEnabling:Z

    iget-boolean p1, p0, Lcom/samsung/android/settings/connection/GigaMultiPath;->mIsWiFiEnabling:Z

    if-nez p1, :cond_1

    iput-boolean v0, p0, Lcom/samsung/android/settings/connection/GigaMultiPath;->mIsNetworkEnabling:Z
    ...
    invoke-virtual {p0, p1}, Lcom/samsung/android/settings/connection/GigaMultiPath;->sendMptcpStartBroadCast$1(Z)V
    ...
    invoke-virtual {p1}, Lcom/samsung/android/settings/connection/GigaMultiPath;->isSimValid$1()Z
