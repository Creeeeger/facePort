...
.method public constructor <init>()V
    ...
    const-string/jumbo v0, "screenshots_and_screen_recorder"

    const-string v1, "/Settings/Advanced/SmartCapture"

    invoke-virtual {p0, v0, v1}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string/jumbo v0, "smart_stay"
    ...
    const-string v1, "/Settings/Advanced/DoubleTapToSleep"

    invoke-virtual {p0, v0, v1}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string/jumbo v0, "onehand_operation_settings"
    ...
    const-string/jumbo v0, "xcover_top_short_press_key"

    const-string v1, "/Settings/Advanced/XcoverTopKeyShortPress"

    invoke-virtual {p0, v0, v1}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string/jumbo v0, "xcover_top_long_press_key"

    const-string v1, "/Settings/Advanced/XcoverTopKeyLongPress"

    invoke-virtual {p0, v0, v1}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string/jumbo v0, "xcover_top_key_on_lockscreen_key"
    ...
    const-string v1, "/Settings/Advanced/SideKeyDoublePress"

    invoke-virtual {p0, v0, v1}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v0, "function_key_long_press"

    const-string v1, "/Settings/Advanced/SideKeyLongPress"

    invoke-virtual {p0, v0, v1}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string/jumbo v0, "smart_popup_view"

    const-string v1, "/Settings/Advanced/SmartPopupView"

    invoke-virtual {p0, v0, v1}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string/jumbo v0, "top_level_location"
    ...
    const-string/jumbo v0, "wifi_switch_for_individual_apps"
    ...
    const-string/jumbo v0, "wifi_offload"

    const-string v1, "/Settings/Connections/WiFi/Advanced/WifiOffload"

    invoke-virtual {p0, v0, v1}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string/jumbo v0, "notify_open_networks"

    const-string v1, "/Settings/Connections/WiFi/Advanced/WifiNotifications"

    invoke-virtual {p0, v0, v1}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string/jumbo v0, "switch_to_better_wifi"
    ...
    const-string v1, "/Settings/Connections/PrivateDnsMode"

    invoke-virtual {p0, v0, v1}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string/jumbo v0, "private_dns_settings_specifier"

    const-string v1, "/Settings/Connections/PrivateDnsSpecifier"
    ...
    const-string/jumbo v0, "screen_off_pocket"
    ...
    const-string/jumbo v0, "sec_font_size"
    ...
    const-string/jumbo v0, "sec_screen_size"
    ...
    const-string/jumbo v0, "show_battery_percent"
    ...
    const-string/jumbo v0, "night_theme"
    ...
    const-string v1, "/Settings/Display/RefreshRate"

    invoke-virtual {p0, v0, v1}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string/jumbo v0, "task_bar"

    const-string v1, "/Settings/Display/TaskBar"
    ...
    const-string/jumbo v0, "show_virtual_keyboard_switch"
    ...
    const-string v1, "/Settings/General/LocationTimeZoneDetection"
    ...
    const-string/jumbo v0, "where_to_show"
    ...
    const-string/jumbo v0, "noti_view_style"
    ...
    const-string/jumbo v0, "notification_2"

    const-string v1, "/Settings/Sound/NotificationSoundSim2"

    invoke-virtual {p0, v0, v1}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string/jumbo v0, "screen_locking_sounds"

    const-string v1, "/Settings/Sound/ScreenLockSound"

    invoke-virtual {p0, v0, v1}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string/jumbo v0, "touch_sounds"
    ...
    const-string/jumbo v0, "vibrate_on_touch"

    const-string v1, "/Settings/Sound/VibrationFeedback"

    invoke-virtual {p0, v0, v1}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string/jumbo v0, "phone_vibration_pattern"

    const-string v1, "/Settings/Sound/VibrationPattern"

    invoke-virtual {p0, v0, v1}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string/jumbo v0, "notification_vibration_pattern"
    ...
    const-string/jumbo v0, "spen_detachment_sound"
    ...
    const-string v1, "/HBD/Toolbar/UseToolbar"

    invoke-virtual {p0, v0, v1}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v0, "SETTINGS_PHYSICAL_KEYBOARD_TOOLBAR"

    const-string v1, "/HBD/PhysicalKeyboardToolbar"
