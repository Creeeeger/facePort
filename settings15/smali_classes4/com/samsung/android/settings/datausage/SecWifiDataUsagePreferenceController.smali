.class public Lcom/samsung/android/settings/datausage/SecWifiDataUsagePreferenceController;
.super Lcom/android/settings/core/BasePreferenceController;
.source "qb/98004394 196cb3c588f4bce8f34d9a4b22ef87dca56ab51c1d488078a331bdfa0f5f580b"


# static fields
.field private static TAG:Ljava/lang/String; = "SecWifiDataUsagePreferenceController"
...
# direct methods
.method public static bridge synthetic -$$Nest$fgetmDataUsageInfo(Lcom/samsung/android/settings/datausage/SecWifiDataUsagePreferenceController;)Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;
    .locals 0

    iget-object p0, p0, Lcom/samsung/android/settings/datausage/SecWifiDataUsagePreferenceController;->mDataUsageInfo:Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;
...
.method public static bridge synthetic -$$Nest$sfgetsSecureFolderTotalBytes()J
    ...
    sget-wide v0, Lcom/samsung/android/settings/datausage/SecWifiDataUsagePreferenceController;->sSecureFolderTotalBytes:J
...
.method public static bridge synthetic -$$Nest$sfputsSecureFolderTotalBytes(J)V
    ...
    sput-wide p0, Lcom/samsung/android/settings/datausage/SecWifiDataUsagePreferenceController;->sSecureFolderTotalBytes:J
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/samsung/android/settings/datausage/SecWifiDataUsagePreferenceController;->mNetworkTemplate:Landroid/net/NetworkTemplate;
    ...
    iput-object p1, p0, Lcom/samsung/android/settings/datausage/SecWifiDataUsagePreferenceController;->mDataUsageController:Lcom/android/settingslib/net/DataUsageController;

    iget-object p2, p0, Lcom/samsung/android/settings/datausage/SecWifiDataUsagePreferenceController;->mNetworkTemplate:Landroid/net/NetworkTemplate;
    ...
    iput-object p1, p0, Lcom/samsung/android/settings/datausage/SecWifiDataUsagePreferenceController;->mDataUsageInfo:Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;

    return-void
.end method

.method public static synthetic access$000(Lcom/samsung/android/settings/datausage/SecWifiDataUsagePreferenceController;)Landroid/content/Context;
    .locals 0
...
.method public static synthetic access$100(Lcom/samsung/android/settings/datausage/SecWifiDataUsagePreferenceController;Landroidx/preference/Preference;)V
    .locals 0
...
.method private refreshDataUsageInfo()V
    ...
    iget-object v0, p0, Lcom/samsung/android/settings/datausage/SecWifiDataUsagePreferenceController;->mDataUsageController:Lcom/android/settingslib/net/DataUsageController;

    if-eqz v0, :cond_0

    iget-object v1, p0, Lcom/samsung/android/settings/datausage/SecWifiDataUsagePreferenceController;->mNetworkTemplate:Landroid/net/NetworkTemplate;
    ...
    iput-object v0, p0, Lcom/samsung/android/settings/datausage/SecWifiDataUsagePreferenceController;->mDataUsageInfo:Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;
...
.method public getLaunchIntent()Landroid/content/Intent;
    ...
    iget-object v2, p0, Lcom/samsung/android/settings/datausage/SecWifiDataUsagePreferenceController;->mNetworkTemplate:Landroid/net/NetworkTemplate;
...
.method public getSummary()Ljava/lang/CharSequence;
    ...
    sget-object v2, Lcom/samsung/android/settings/datausage/SecWifiDataUsagePreferenceController;->TAG:Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, p0, Lcom/samsung/android/settings/datausage/SecWifiDataUsagePreferenceController;->mDataUsageInfo:Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;
...
.method public handlePreferenceTreeClick(Landroidx/preference/Preference;)Z
    ...
    invoke-virtual {p0}, Lcom/samsung/android/settings/datausage/SecWifiDataUsagePreferenceController;->getLaunchIntent()Landroid/content/Intent;
...
.method public updateState(Landroidx/preference/Preference;)V
    ...
    invoke-direct {p0}, Lcom/samsung/android/settings/datausage/SecWifiDataUsagePreferenceController;->refreshDataUsageInfo()V
    ...
    iget-object v3, p0, Lcom/samsung/android/settings/datausage/SecWifiDataUsagePreferenceController;->mDataUsageInfo:Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;
    ...
    iget-object v3, p0, Lcom/samsung/android/settings/datausage/SecWifiDataUsagePreferenceController;->mNetworkTemplate:Landroid/net/NetworkTemplate;
    ...
    new-instance v4, Lcom/samsung/android/settings/datausage/SecWifiDataUsagePreferenceController$1;

    invoke-direct {v4, p0, p1}, Lcom/samsung/android/settings/datausage/SecWifiDataUsagePreferenceController$1;-><init>(Lcom/samsung/android/settings/datausage/SecWifiDataUsagePreferenceController;Landroidx/preference/Preference;)V
    ...
    :cond_0
    iget-object v2, p0, Lcom/samsung/android/settings/datausage/SecWifiDataUsagePreferenceController;->mDataUsageInfo:Lcom/android/settingslib/net/DataUsageController$DataUsageInfo;
    ...
    sget-wide v2, Lcom/samsung/android/settings/datausage/SecWifiDataUsagePreferenceController;->sSecureFolderTotalBytes:J
    ...
    :cond_3
    sget-object v0, Lcom/samsung/android/settings/datausage/SecWifiDataUsagePreferenceController;->TAG:Ljava/lang/String;
