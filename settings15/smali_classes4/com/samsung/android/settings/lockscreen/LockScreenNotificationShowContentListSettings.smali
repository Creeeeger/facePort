...
.field public mAllSwitchPreference:Lcom/samsung/android/settings/lockscreen/ShowContentListItemPreference;
...
.field public final mAppNameComparator:Lcom/samsung/android/settings/lockscreen/LockScreenNotificationShowContentListSettings$1;
...
.field public final mPreferenceChange:Lcom/samsung/android/settings/lockscreen/LockScreenNotificationShowContentListSettings$2;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/samsung/android/settings/lockscreen/LockScreenNotificationShowContentListSettings$4;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/samsung/android/settings/lockscreen/LockScreenNotificationShowContentListSettings;->STATUS_LOGGING_PROVIDER:Lcom/samsung/android/settings/logging/status/StatusLogger$StatusLoggingProvider;
...
.method public constructor <init>()V
    ...
    invoke-direct {v0}, Lcom/samsung/android/settings/lockscreen/LockScreenNotificationShowContentListSettings$1;-><init>()V

    iput-object v0, p0, Lcom/samsung/android/settings/lockscreen/LockScreenNotificationShowContentListSettings;->mAppNameComparator:Lcom/samsung/android/settings/lockscreen/LockScreenNotificationShowContentListSettings$1;
    ...
    iput-object v0, p0, Lcom/samsung/android/settings/lockscreen/LockScreenNotificationShowContentListSettings;->mPreferenceChange:Lcom/samsung/android/settings/lockscreen/LockScreenNotificationShowContentListSettings$2;
...
.method public final fillInAppList(Ljava/util/ArrayList;)V
    ...
    iget-object v0, p0, Lcom/samsung/android/settings/lockscreen/LockScreenNotificationShowContentListSettings;->mAppNameComparator:Lcom/samsung/android/settings/lockscreen/LockScreenNotificationShowContentListSettings$1;
    ...
    iget-boolean v6, p0, Lcom/samsung/android/settings/lockscreen/LockScreenNotificationShowContentListSettings;->mAllAppsEnabled:Z

    iget v7, p0, Lcom/samsung/android/settings/lockscreen/LockScreenNotificationShowContentListSettings;->mInstalledAppCountInWhiteList:I
    ...
    iget-boolean v0, p0, Lcom/samsung/android/settings/lockscreen/LockScreenNotificationShowContentListSettings;->isSearch:Z
    ...
    new-instance v11, Lcom/samsung/android/settings/lockscreen/ShowContentListItemPreference;

    invoke-direct {v11, v8, v9}, Lcom/samsung/android/settings/lockscreen/ShowContentListItemPreference;-><init>(Landroid/content/Context;I)V

    iput-object v11, p0, Lcom/samsung/android/settings/lockscreen/LockScreenNotificationShowContentListSettings;->mAllSwitchPreference:Lcom/samsung/android/settings/lockscreen/ShowContentListItemPreference;

    new-instance v12, Lcom/samsung/android/settings/lockscreen/ShowContentAppInfo;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/samsung/android/settings/lockscreen/ShowContentAppInfo;-><init>(Ljava/lang/String;Ljava/lang/String;Landroid/graphics/drawable/Drawable;IZ)V

    iput-object v12, v11, Lcom/samsung/android/settings/lockscreen/ShowContentListItemPreference;->mShowContentAppInfo:Lcom/samsung/android/settings/lockscreen/ShowContentAppInfo;

    iget-object v0, p0, Lcom/samsung/android/settings/lockscreen/LockScreenNotificationShowContentListSettings;->mAllSwitchPreference:Lcom/samsung/android/settings/lockscreen/ShowContentListItemPreference;

    iput-boolean v10, v0, Lcom/samsung/android/settings/lockscreen/ShowContentListItemPreference;->mAllowDrawerDivider:Z

    iput-boolean v9, v0, Lcom/samsung/android/settings/lockscreen/ShowContentListItemPreference;->mAllowLineDivider:Z

    iget-object v1, p0, Lcom/samsung/android/settings/lockscreen/LockScreenNotificationShowContentListSettings;->mAppAppsPreferenceTitle:Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/samsung/android/settings/lockscreen/LockScreenNotificationShowContentListSettings;->mPreferenceChange:Lcom/samsung/android/settings/lockscreen/LockScreenNotificationShowContentListSettings$2;
    ...
    check-cast v1, Lcom/samsung/android/settings/lockscreen/ShowContentAppInfo;
    ...
    :cond_4
    new-instance v2, Lcom/samsung/android/settings/lockscreen/ShowContentListItemPreference;

    invoke-direct {v2, v8}, Lcom/samsung/android/settings/lockscreen/ShowContentListItemPreference;-><init>(Landroid/content/Context;)V

    add-int/lit8 v3, v7, -0x1

    if-ne v0, v3, :cond_5

    iput-boolean v10, v2, Lcom/samsung/android/settings/lockscreen/ShowContentListItemPreference;->mAllowDrawerDivider:Z

    iput-boolean v9, v2, Lcom/samsung/android/settings/lockscreen/ShowContentListItemPreference;->mAllowLineDivider:Z
    ...
    :cond_6
    :goto_1
    iget-object v3, v1, Lcom/samsung/android/settings/lockscreen/ShowContentAppInfo;->appName:Ljava/lang/String;

    invoke-virtual {v2, v3}, Landroidx/preference/Preference;->setTitle(Ljava/lang/CharSequence;)V

    iput-object v1, v2, Lcom/samsung/android/settings/lockscreen/ShowContentListItemPreference;->mShowContentAppInfo:Lcom/samsung/android/settings/lockscreen/ShowContentAppInfo;

    iget-boolean v1, v1, Lcom/samsung/android/settings/lockscreen/ShowContentAppInfo;->isSelected:Z
    ...
    iget-object v1, p0, Lcom/samsung/android/settings/lockscreen/LockScreenNotificationShowContentListSettings;->mAppListPref:Landroidx/preference/PreferenceCategory;

    invoke-virtual {v1, v2}, Landroidx/preference/PreferenceGroup;->addPreference(Landroidx/preference/Preference;)V

    iget-object v1, p0, Lcom/samsung/android/settings/lockscreen/LockScreenNotificationShowContentListSettings;->mItemPrefList:Ljava/util/ArrayList;
...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    invoke-direct {v0, p0}, Lcom/samsung/android/settings/lockscreen/LockScreenNotificationShowContentListSettings$GetAppListAsyncTask;-><init>(Lcom/samsung/android/settings/lockscreen/LockScreenNotificationShowContentListSettings;)V
...
.method public final onMenuItemActionExpand(Landroid/view/MenuItem;)Z
    ...
    iput-boolean v1, p0, Lcom/samsung/android/settings/lockscreen/LockScreenNotificationShowContentListSettings;->isSearch:Z
...
.method public final onQueryTextChange(Ljava/lang/String;)Z
    ...
    iget-object v5, v2, Lcom/samsung/android/settings/lockscreen/ShowContentAppInfo;->appName:Ljava/lang/String;
...
.method public final declared-synchronized updateLockScreenNotificationVisibility()V
    .locals 8
    ...
    iget-object v5, v4, Lcom/samsung/android/settings/lockscreen/ShowContentListItemPreference;->mShowContentAppInfo:Lcom/samsung/android/settings/lockscreen/ShowContentAppInfo;

    iget-boolean v6, v5, Lcom/samsung/android/settings/lockscreen/ShowContentAppInfo;->isSelected:Z

    if-eqz v6, :cond_0

    iget-object v5, v5, Lcom/samsung/android/settings/lockscreen/ShowContentAppInfo;->packageName:Ljava/lang/String;
    ...
    iget-object v7, v4, Lcom/samsung/android/settings/lockscreen/ShowContentListItemPreference;->mShowContentAppInfo:Lcom/samsung/android/settings/lockscreen/ShowContentAppInfo;

    iget-object v7, v7, Lcom/samsung/android/settings/lockscreen/ShowContentAppInfo;->packageName:Ljava/lang/String;
    ...
    iget-object v6, v4, Lcom/samsung/android/settings/lockscreen/ShowContentListItemPreference;->mShowContentAppInfo:Lcom/samsung/android/settings/lockscreen/ShowContentAppInfo;

    iget-object v6, v6, Lcom/samsung/android/settings/lockscreen/ShowContentAppInfo;->packageName:Ljava/lang/String;

    invoke-virtual {v1, v6, v2}, Landroid/content/pm/PackageManager;->getPackageUid(Ljava/lang/String;I)I

    move-result v7

    iget-object v4, v4, Lcom/samsung/android/settings/lockscreen/ShowContentListItemPreference;->mShowContentAppInfo:Lcom/samsung/android/settings/lockscreen/ShowContentAppInfo;

    iget-boolean v4, v4, Lcom/samsung/android/settings/lockscreen/ShowContentAppInfo;->isSelected:Z

    invoke-virtual {v5}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v7, v4, v6}, Lcom/android/settings/notification/NotificationBackend;->setLockScreenNotificationVisibilityForPackage(IILjava/lang/String;)V
    :try_end_1
