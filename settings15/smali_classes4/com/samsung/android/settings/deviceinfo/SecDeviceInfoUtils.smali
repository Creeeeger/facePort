.class public abstract Lcom/samsung/android/settings/deviceinfo/SecDeviceInfoUtils;
...
.method public static checkRootingCondition()Z
    ...
    :cond_0
    const-string v13, "/system/usr/we-need-root/su-backup"

    const-string v14, "/system/xbin/mu"
    ...
    const-string/jumbo v2, "rooting:su located at : "
...
.method public static getImei(Landroid/content/Context;IZ)Ljava/lang/String;
    .locals 7
    ...
    :cond_0
    const-string p2, "getImei() - call getDeviceId"
    ...
    :cond_6
    invoke-static {p1}, Lcom/samsung/android/settings/deviceinfo/SecDeviceInfoUtils;->addWhitespaceEvery4digits(Ljava/lang/String;)Ljava/lang/String;
...
.method public static getImeiTitleSuffix(Landroid/content/Context;)Ljava/lang/String;
    .locals 2
...
.method public static getImeiTitleSuffix(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-static {p0, p1}, Lcom/samsung/android/settings/deviceinfo/SecDeviceInfoUtils;->isActiveSimPresent(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1}, Lcom/samsung/android/settings/deviceinfo/SecDeviceInfoUtils;->isOpportunisticSim(Landroid/content/Context;I)Z
    ...
    const-string p1, "isEsim: TelephonyManager is null"
...
.method public static getPreferenceToSpecificActivityTitleInfo(Landroid/content/Context;Landroid/content/Intent;)Ljava/lang/String;
    .locals 4
...
.method public static getPrintableImei(Ljava/lang/String;)Ljava/lang/String;
    .locals 3
...
.method public static isActiveSimPresent(Landroid/content/Context;I)Z
    .locals 2
    ...
    const-string p1, " isActiveSimPresent = "
...
.method public static isOpportunisticSim(Landroid/content/Context;I)Z
    .locals 4
    ...
    invoke-static {p1, v2, v3}, Landroidx/appcompat/widget/ListPopupWindow$$ExternalSyntheticOutline0;->m(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public static isPhoneStatusUnlocked()Z
    .locals 3
