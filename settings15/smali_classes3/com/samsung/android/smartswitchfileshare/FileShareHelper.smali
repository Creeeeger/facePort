.class public final Lcom/samsung/android/smartswitchfileshare/FileShareHelper;
...
.field public final fileUtil:Lcom/samsung/android/smartswitchfileshare/FileUtil;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    :cond_0
    const-string v0, "WifiSmartSwitchBackupRestore[SmartSwitchFileShare]"
    ...
    invoke-direct {v1, p1}, Lcom/samsung/android/smartswitchfileshare/FileUtil;-><init>(Landroid/content/ContentResolver;)V
...
# virtual methods
.method public final copy(Landroid/content/Intent;Ljava/io/File;)I
    .locals 18

    move-object/from16 v1, p0

    invoke-virtual/range {p0 .. p1}, Lcom/samsung/android/smartswitchfileshare/FileShareHelper;->getPathUris(Landroid/content/Intent;)Ljava/util/List;
    ...
    iget-object v7, v1, Lcom/samsung/android/smartswitchfileshare/FileShareHelper;->context:Landroid/content/Context;
    ...
    const-string v10, "], needDelSrc[false]"

    invoke-static {v0, v7, v9, v3, v10}, Landroidx/constraintlayout/motion/widget/MotionLayout$$ExternalSyntheticOutline0;->m(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    iget-object v9, v1, Lcom/samsung/android/smartswitchfileshare/FileShareHelper;->TAG:Ljava/lang/String;
    ...
    iget-object v0, v1, Lcom/samsung/android/smartswitchfileshare/FileShareHelper;->context:Landroid/content/Context;

    invoke-static {v0, v11}, Landroid/provider/DocumentsContract;->isDocumentUri(Landroid/content/Context;Landroid/net/Uri;)Z
    ...
    invoke-virtual {v0, v7, v3}, Ljava/lang/String;->replaceFirst(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_5
    const-string v15, "cpUriToFile seems not a files srcUri[%s]"

    iget-object v0, v1, Lcom/samsung/android/smartswitchfileshare/FileShareHelper;->fileUtil:Lcom/samsung/android/smartswitchfileshare/FileUtil;

    iget-object v6, v0, Lcom/samsung/android/smartswitchfileshare/FileUtil;->TAG:Ljava/lang/String;
    ...
    iget-object v1, v0, Lcom/samsung/android/smartswitchfileshare/FileUtil;->contentResolver:Landroid/content/ContentResolver;
    ...
    :try_start_3
    invoke-virtual {v0, v8, v1}, Lcom/samsung/android/smartswitchfileshare/FileUtil;->cpStream(Ljava/io/InputStream;Ljava/io/OutputStream;)Z
    :try_end_3
    ...
    filled-new-array {v1, v11, v12, v8}, [Ljava/lang/Object;
    ...
    filled-new-array {v11, v12, v1, v6, v8}, [Ljava/lang/Object;

    move-result-object v1

    const-string v6, "copyUriToFile file srcUri[%s] > dstFile[%s], copyRes[%b], delRes[%b], time[%d]"
    ...
    const-string v1, "copyUriToFile srcUri is not a DocumentUri : "
    ...
    const-string v3, "], deleted[0], time["
    ...
    invoke-static {v2, v0, v9}, Lcom/android/settings/Utils$$ExternalSyntheticOutline0;->m(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)V
...
.method public final copyFileToDirUri(Ljava/io/File;Landroid/net/Uri;)I
    .locals 7
    ...
    invoke-virtual {p0, p2, v0, v2}, Lcom/samsung/android/smartswitchfileshare/FileShareHelper;->createFile(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-virtual {p0, v3, p2}, Lcom/samsung/android/smartswitchfileshare/FileShareHelper;->copyFileToDirUri(Ljava/io/File;Landroid/net/Uri;)I
    ...
    iget-object v3, p0, Lcom/samsung/android/smartswitchfileshare/FileShareHelper;->contentResolver:Landroid/content/ContentResolver;
    ...
    :try_start_1
    iget-object p0, p0, Lcom/samsung/android/smartswitchfileshare/FileShareHelper;->fileUtil:Lcom/samsung/android/smartswitchfileshare/FileUtil;

    invoke-virtual {p0, p1, v2}, Lcom/samsung/android/smartswitchfileshare/FileUtil;->copyFileToStream(Ljava/io/File;Ljava/io/OutputStream;)Z
    ...
    const-string v5, "copyFileToFileUri delete SecurityException [%s]"
    ...
    const-string p1, "copyFileToFileUri invalid dstFileUri : "
    ...
    const-string p1, "copy invalid dstDirUri : "
...
.method public final createFile(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
    .locals 2

    iget-object v0, p0, Lcom/samsung/android/smartswitchfileshare/FileShareHelper;->TAG:Ljava/lang/String;

    :try_start_0
    iget-object p0, p0, Lcom/samsung/android/smartswitchfileshare/FileShareHelper;->contentResolver:Landroid/content/ContentResolver;
...
.method public final getPathUris(Landroid/content/Intent;)Ljava/util/List;
    .locals 5
    ...
    iget-object v2, p0, Lcom/samsung/android/smartswitchfileshare/FileShareHelper;->TAG:Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Lcom/samsung/android/smartswitchfileshare/FileUtil;->getDataFromUri(Landroid/net/Uri;)Ljava/lang/String;
...
.method public final move(Landroid/content/Intent;Ljava/io/File;)I
    .locals 1
    ...
    invoke-virtual {p0, p2, p1}, Lcom/samsung/android/smartswitchfileshare/FileShareHelper;->copyFileToDirUri(Ljava/io/File;Landroid/net/Uri;)I
