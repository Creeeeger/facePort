.class public final Lcom/samsung/android/settings/wifi/develop/weeklyreport/WeeklyXAxisRenderer;
...
.method public final drawLabels(Landroid/graphics/Canvas;FLcom/github/mikephil/charting/utils/MPPointF;)V
    ...
    iput-object v1, p0, Lcom/samsung/android/settings/wifi/develop/weeklyreport/WeeklyXAxisRenderer;->mPositions:[F
    ...
    :goto_0
    iget-object v3, p0, Lcom/samsung/android/settings/wifi/develop/weeklyreport/WeeklyXAxisRenderer;->mPositions:[F
    ...
    iget v2, p0, Lcom/samsung/android/settings/wifi/develop/weeklyreport/WeeklyXAxisRenderer;->mLabelMargin:F

    add-float/2addr p2, v2

    iget-object v2, p0, Lcom/samsung/android/settings/wifi/develop/weeklyreport/WeeklyXAxisRenderer;->mPositions:[F
    ...
    iget-boolean v3, p0, Lcom/samsung/android/settings/wifi/develop/weeklyreport/WeeklyXAxisRenderer;->mSelectedInfoLoaded:Z

    if-eqz v3, :cond_1

    iget v3, p0, Lcom/samsung/android/settings/wifi/develop/weeklyreport/WeeklyXAxisRenderer;->mSelectedLabel:I
    ...
    iget v4, p0, Lcom/samsung/android/settings/wifi/develop/weeklyreport/WeeklyXAxisRenderer;->mLabelBgYOffset:I

    add-int/2addr v3, v4

    int-to-float v3, v3

    iget-object v4, p0, Lcom/samsung/android/settings/wifi/develop/weeklyreport/WeeklyXAxisRenderer;->mSelectedLabelBgPaint:Landroid/graphics/Paint;

    iget v7, p0, Lcom/samsung/android/settings/wifi/develop/weeklyreport/WeeklyXAxisRenderer;->mLabelBgRadius:F
    ...
    iget-object v4, p0, Lcom/samsung/android/settings/wifi/develop/weeklyreport/WeeklyXAxisRenderer;->mSelectedLabelPaint:Landroid/graphics/Paint;
    ...
    iget-object v4, p0, Lcom/samsung/android/settings/wifi/develop/weeklyreport/WeeklyXAxisRenderer;->mLabelPaint:Landroid/graphics/Paint;
