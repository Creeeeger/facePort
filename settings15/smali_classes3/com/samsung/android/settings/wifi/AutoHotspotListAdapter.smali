.class public final Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter;
...
.method static constructor <clinit>()V
    ...
    sput-object v2, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter;->STATE_WIFI6_SECURED:[I

    filled-new-array {v1}, [I

    move-result-object v1

    sput-object v1, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter;->STATE_WIFI6_NONE:[I
    ...
    sput-object v0, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter;->STATE_WIFI6E_SECURED:[I
...
.method public final onBindViewHolder(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;I)V
    ...
    iget-object v0, p0, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter;->mSemWifiManager:Lcom/samsung/android/wifi/SemWifiManager;

    iget-object v2, p2, Lcom/samsung/android/wifi/SemWifiApBleScanResult;->mWifiMac:Ljava/lang/String;

    invoke-virtual {v0, v2}, Lcom/samsung/android/wifi/SemWifiManager;->getSmartApConnectedStatusFromScanResult(Ljava/lang/String;)I
    ...
    iget-object v2, p1, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter$AutoHotspotApViewHolder;->mIcon:Landroid/widget/ImageView;

    iget-object v3, p1, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter$AutoHotspotApViewHolder;->mFrictionSld:Landroid/graphics/drawable/StateListDrawable;
    ...
    sget-object v5, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter;->STATE_WIFI6_NONE:[I

    sget-object v10, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter;->STATE_WIFI6_SECURED:[I
    ...
    sget-object v2, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter;->STATE_WIFI6E_SECURED:[I
    ...
    :cond_9
    sget-object v2, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter;->STATE_WIFI6E_NONE:[I
    ...
    sget-object v2, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter;->STATE_SECURED:[I
    ...
    :cond_d
    sget-object v2, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter;->STATE_NONE:[I

    invoke-virtual {v3, v2}, Landroid/graphics/drawable/StateListDrawable;->setState([I)Z

    :cond_e
    :goto_2
    sget v2, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter$AutoHotspotApViewHolder;->$r8$clinit:I

    iget-object v2, p1, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter$AutoHotspotApViewHolder;->mTitle:Landroid/widget/TextView;

    iget-object v3, p2, Lcom/samsung/android/wifi/SemWifiApBleScanResult;->mSSID:Ljava/lang/String;

    invoke-virtual {v2, v3}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget-object v2, p1, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter$AutoHotspotApViewHolder;->mView:Landroid/view/View;
    ...
    iget-object v3, p0, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter;->mContext:Landroid/content/Context;
    ...
    iget-object v3, p1, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter$AutoHotspotApViewHolder;->mView:Landroid/view/View;
    ...
    :cond_10
    iget-boolean v3, p2, Lcom/samsung/android/wifi/SemWifiApBleScanResult;->isDataSaverEnabled:Z

    if-eqz v3, :cond_11

    const-string v3, "onBindViewHolder() - Selected  BleAp  DataSaver enabled: "
    ...
    :cond_13
    iget-boolean v3, p2, Lcom/samsung/android/wifi/SemWifiApBleScanResult;->isMobileDataLimitReached:Z

    if-eqz v3, :cond_14

    const-string v3, "onBindViewHolder() - Selected  BleAp  isMobileDataLimitReached : "
    ...
    :cond_14
    iget-boolean v3, p2, Lcom/samsung/android/wifi/SemWifiApBleScanResult;->isNotValidNetwork:Z

    if-eqz v3, :cond_15

    const-string v3, "onBindViewHolder() - Selected  BleAp  isNotValidNetwork : "
    ...
    :goto_4
    iget-object v3, p0, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter;->mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    iput-object v3, p0, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter;->mWifiManager:Landroid/net/wifi/WifiManager;
    ...
    :cond_18
    iget-object v3, p1, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter$AutoHotspotApViewHolder;->mSummary:Landroid/widget/TextView;
    ...
    iget-object v1, p1, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter$AutoHotspotApViewHolder;->mView:Landroid/view/View;

    invoke-virtual {v1, v9}, Landroid/view/View;->setClickable(Z)V

    iget-object v1, p1, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter$AutoHotspotApViewHolder;->mTitle:Landroid/widget/TextView;

    const v2, 0x3ecccccd    # 0.4f

    invoke-virtual {v1, v2}, Landroid/widget/TextView;->setAlpha(F)V

    iget-object v1, p1, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter$AutoHotspotApViewHolder;->mSummary:Landroid/widget/TextView;

    invoke-virtual {v1, v2}, Landroid/widget/TextView;->setAlpha(F)V

    iget-object v1, p1, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter$AutoHotspotApViewHolder;->mIcon:Landroid/widget/ImageView;
    ...
    :goto_5
    iget-object p1, p1, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter$AutoHotspotApViewHolder;->mView:Landroid/view/View;

    new-instance v1, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter$1;

    invoke-direct {v1, p0, p2, v0}, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter$1;-><init>(Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter;Lcom/samsung/android/wifi/SemWifiApBleScanResult;I)V
...
.method public final onCreateViewHolder(Landroid/view/ViewGroup;I)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    ...
    iget-object p2, p0, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter;->mContext:Landroid/content/Context;
    ...
    iget-object v2, p0, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter;->mParentView:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {p2, v1, v2, v0}, Landroid/view/LayoutInflater;->inflate(ILandroid/view/ViewGroup;Z)Landroid/view/View;

    move-result-object p2

    new-instance v0, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter$AutoHotspotApViewHolder;
    ...
    iput-object p1, v0, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter$AutoHotspotApViewHolder;->mIcon:Landroid/widget/ImageView;
    ...
    iput-object p1, v0, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter$AutoHotspotApViewHolder;->mTitle:Landroid/widget/TextView;
    ...
    iput-object p1, v0, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter$AutoHotspotApViewHolder;->mSummary:Landroid/widget/TextView;

    iput-object p2, v0, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter$AutoHotspotApViewHolder;->mView:Landroid/view/View;
    ...
    iput-object p0, v0, Lcom/samsung/android/settings/wifi/AutoHotspotListAdapter$AutoHotspotApViewHolder;->mFrictionSld:Landroid/graphics/drawable/StateListDrawable;
