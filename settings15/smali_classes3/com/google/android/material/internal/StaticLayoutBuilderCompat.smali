...
.method public final build()Landroid/text/StaticLayout;
    ...
    invoke-static {v2, v0, v3, v5, v1}, Landroid/text/StaticLayout$Builder;->obtain(Ljava/lang/CharSequence;IILandroid/text/TextPaint;I)Landroid/text/StaticLayout$Builder;
    ...
    :cond_7
    iget-object p0, p0, Lcom/google/android/material/internal/StaticLayoutBuilderCompat;->staticLayoutBuilderConfigurer:Lcom/google/android/material/appbar/CollapsingToolbarLayout$StaticLayoutBuilderConfigurer;

    if-eqz p0, :cond_8

    invoke-interface {p0, v0}, Lcom/google/android/material/appbar/CollapsingToolbarLayout$StaticLayoutBuilderConfigurer;->configure(Landroid/text/StaticLayout$Builder;)V
