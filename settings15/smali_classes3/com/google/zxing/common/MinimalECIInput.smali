...
.method public constructor <init>(Ljava/lang/String;Ljava/nio/charset/Charset;I)V
    ...
    invoke-static {v1, v7, v2}, Landroidx/compose/runtime/ComposerKt$$ExternalSyntheticOutline0;->m(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static addEdges(Ljava/lang/String;Lcom/google/zxing/common/ECIEncoderSet;[[Lcom/google/zxing/common/MinimalECIInput$InputEdge;ILcom/google/zxing/common/MinimalECIInput$InputEdge;I)V
    ...
    iget-object v0, p1, Lcom/google/zxing/common/ECIEncoderSet;->encoders:[Ljava/nio/charset/CharsetEncoder;

    array-length v0, v0

    iget v1, p1, Lcom/google/zxing/common/ECIEncoderSet;->priorityEncoderIndex:I

    if-ltz v1, :cond_1

    if-eq p0, p5, :cond_0

    invoke-virtual {p1, p0, v1}, Lcom/google/zxing/common/ECIEncoderSet;->canEncode(CI)Z
    ...
    invoke-virtual {p1, p0, v7}, Lcom/google/zxing/common/ECIEncoderSet;->canEncode(CI)Z
    ...
    new-instance v9, Lcom/google/zxing/common/MinimalECIInput$InputEdge;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/google/zxing/common/MinimalECIInput$InputEdge;-><init>(CLcom/google/zxing/common/ECIEncoderSet;ILcom/google/zxing/common/MinimalECIInput$InputEdge;I)V
    ...
    iget v2, v9, Lcom/google/zxing/common/MinimalECIInput$InputEdge;->cachedTotalSize:I

    iget v1, v1, Lcom/google/zxing/common/MinimalECIInput$InputEdge;->cachedTotalSize:I
