...
.method public final onAttach(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/android/settings/wifi/ConfigureWifiEntryFragment;->mWorkerThread:Landroid/os/HandlerThread;

    invoke-virtual {p1}, Landroid/os/HandlerThread;->start()V

    new-instance v4, Lcom/android/settings/wifi/ConfigureWifiEntryFragment$1;

    sget-object p1, Ljava/time/ZoneOffset;->UTC:Ljava/time/ZoneOffset;

    invoke-direct {v4, p1}, Landroid/os/SimpleClock;-><init>(Ljava/time/ZoneId;)V
    ...
    iget-object v3, p0, Lcom/android/settings/wifi/ConfigureWifiEntryFragment;->mWorkerThread:Landroid/os/HandlerThread;
    ...
    invoke-static/range {v0 .. v5}, Lcom/android/settings/wifi/WifiTrackerLibProviderImpl;->createNetworkDetailsTracker(Landroidx/lifecycle/Lifecycle;Landroid/content/Context;Landroid/os/Handler;Landroid/os/Handler;Ljava/time/Clock;Ljava/lang/String;)Lcom/android/wifitrackerlib/NetworkDetailsTracker;

    move-result-object p1

    iput-object p1, p0, Lcom/android/settings/wifi/ConfigureWifiEntryFragment;->mNetworkDetailsTracker:Lcom/android/wifitrackerlib/NetworkDetailsTracker;
...
.method public final onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-direct {p3, p0, v1}, Lcom/android/settings/wifi/ConfigureWifiEntryFragment$$ExternalSyntheticLambda0;-><init>(Lcom/android/settings/wifi/ConfigureWifiEntryFragment;I)V
    ...
    iget-object v4, p0, Lcom/android/settings/wifi/ConfigureWifiEntryFragment;->mWifiEntry:Lcom/android/wifitrackerlib/WifiEntry;
