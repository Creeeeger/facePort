...
# static fields
.field public static final EMPTY_SUB_ID_LIST:[I


# instance fields
.field public mConstructionSubId:I

.field public mSil:Ljava/util/List;

.field public mSubscriptionChangeListener:Lcom/android/settings/network/ActiveSubscriptionsListener;

.field public mTabLayout:Lcom/android/settings/widget/SlidingTabLayout;

.field public mViewPager:Lcom/android/settings/widget/RtlCompatibleViewPager;
...
.method public getSelectableSubscriptions(Landroid/content/Context;)Ljava/util/List;
    .locals 0
...
.method public getSubscriptionChangeListener(Landroid/content/Context;)Lcom/android/settings/network/ActiveSubscriptionsListener;
    .locals 2
...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    invoke-static {p1, v0, v2}, Landroidx/preference/Preference$$ExternalSyntheticOutline0;->m(Ljava/lang/StringBuilder;ILjava/lang/String;)V
...
.method public final onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-direct {p3, p0}, Lcom/android/settings/wifi/calling/WifiCallingSettings$InternalViewPagerListener;-><init>(Lcom/android/settings/wifi/calling/WifiCallingSettings;)V
    ...
    :cond_1
    iget p2, p0, Lcom/android/settings/wifi/calling/WifiCallingSettings;->mConstructionSubId:I
...
.method public final onStart()V
    ...
    invoke-virtual {v0, v2}, Lcom/android/settings/widget/SlidingTabLayout;->setViewPager(Lcom/android/settings/widget/RtlCompatibleViewPager;)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/settings/network/ActiveSubscriptionsListener;->monitorSubscriptionsChange(Z)V
...
.method public final updateSubList()Ljava/util/List;
    .locals 7
    ...
    sget-object v6, Lcom/android/settings/network/telephony/MobileNetworkUtils;->EMPTY_DRAWABLE:Landroid/graphics/drawable/Drawable;

    if-nez v5, :cond_2

    new-instance v5, Lcom/android/settings/network/ims/WifiCallingQueryImsState;

    invoke-direct {v5, v4, v3}, Lcom/android/settings/network/ims/WifiCallingQueryImsState;-><init>(Landroid/content/Context;I)V

    :cond_2
    invoke-virtual {v5}, Lcom/android/settings/network/ims/WifiCallingQueryImsState;->isReadyToWifiCalling()Z
...
.method public final updateTitleForCurrentSub()V
    .locals 2
