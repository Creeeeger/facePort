...
# direct methods
.method public constructor <init>(Lcom/android/settings/spa/app/appcompat/UserAspectRatioAppPresenter;Lkotlin/coroutines/Continuation;)V
    .locals 0
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v3, v1, Lcom/android/settings/spa/app/appcompat/UserAspectRatioAppPresenter;->manager:Lcom/android/settings/applications/appcompat/UserAspectRatioManager;

    iget-object v4, v1, Lcom/android/settings/spa/app/appcompat/UserAspectRatioAppPresenter;->app:Landroid/content/pm/ApplicationInfo;

    iget-object v4, v4, Landroid/content/pm/ApplicationInfo;->packageName:Ljava/lang/String;

    iget-object v1, v1, Lcom/android/settings/spa/app/appcompat/UserAspectRatioAppPresenter;->context:Landroid/content/Context;

    invoke-virtual {v1}, Landroid/content/Context;->getUserId()I

    move-result v1

    iget-object v5, v3, Lcom/android/settings/applications/appcompat/UserAspectRatioManager;->mIPm:Landroid/content/pm/IPackageManager;

    invoke-interface {v5, v4, v1}, Landroid/content/pm/IPackageManager;->getUserMinAspectRatio(Ljava/lang/String;I)I

    move-result v5

    invoke-virtual {v3, v5, v4}, Lcom/android/settings/applications/appcompat/UserAspectRatioManager;->hasAspectRatioOption(ILjava/lang/String;)Z
    ...
    :goto_0
    invoke-virtual {v3, v5, v1, v4}, Lcom/android/settings/applications/appcompat/UserAspectRatioManager;->getUserMinAspectRatioEntry(IILjava/lang/String;)Ljava/lang/String;
