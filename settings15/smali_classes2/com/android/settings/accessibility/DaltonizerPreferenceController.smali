...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/android/settings/accessibility/DaltonizerPreferenceController;->mAccessibilityDaltonizerKeyToValueMap:Ljava/util/Map;
...
.method private getEnabledSummaryFromArray()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0}, Lcom/android/settings/accessibility/DaltonizerPreferenceController;->getDaltonizerindexToKeyMap()Ljava/util/Map;

    iget-object p0, p0, Lcom/android/settings/accessibility/DaltonizerPreferenceController;->mAccessibilityDaltonizerKeyToValueMap:Ljava/util/Map;
...
.method public getDaltonizerindexToKeyMap()Ljava/util/Map;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v0, p0, Lcom/android/settings/accessibility/DaltonizerPreferenceController;->mAccessibilityDaltonizerKeyToValueMap:Ljava/util/Map;
    ...
    iget-object v3, p0, Lcom/android/settings/accessibility/DaltonizerPreferenceController;->mAccessibilityDaltonizerKeyToValueMap:Ljava/util/Map;
...
.method public getStatusLoggingData(Landroid/content/Context;)Ljava/util/Map;
    ...
    const-string p0, "Tritan"

    goto :goto_0

    :cond_3
    const-string p0, "Deutan"
    ...
    const-string v8, "No feature factory configured"
    ...
    invoke-static {v1}, Lcom/samsung/android/settings/accessibility/base/logging/A11yStatusLoggingUtil;->getSwitchStatus(Z)Ljava/lang/String;
    ...
    const-string v1, "A11YSE3070"

    const/16 v2, 0xbfe

    invoke-virtual {p0, v2, v1, v0}, Lcom/android/settingslib/core/instrumentation/MetricsFeatureProvider;->actionBackground(ILjava/lang/String;Ljava/util/Map;)V
    ...
    const-string v0, "A11YSE3073"

    invoke-virtual {p0, v2, v0, p1}, Lcom/android/settingslib/core/instrumentation/MetricsFeatureProvider;->actionBackground(ILjava/lang/String;Ljava/util/Map;)V
...
.method public getSummary()Ljava/lang/CharSequence;
    ...
    invoke-direct {p0}, Lcom/android/settings/accessibility/DaltonizerPreferenceController;->getEnabledSummaryFromArray()Ljava/lang/CharSequence;
...
.method public getUriList()Ljava/util/List;
    ...
    const-string p0, "accessibility_display_daltonizer_enabled"
...
.method public getValue()Lcom/samsung/android/settings/cube/ControlValue;
    ...
    invoke-virtual {p0}, Lcom/android/settings/accessibility/DaltonizerPreferenceController;->getControlType()I
