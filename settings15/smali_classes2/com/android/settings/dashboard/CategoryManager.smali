.class public final Lcom/android/settings/dashboard/CategoryManager;
.super Ljava/lang/Object;
.source "qb/98004394 196cb3c588f4bce8f34d9a4b22ef87dca56ab51c1d488078a331bdfa0f5f580b"


# static fields
.field public static sInstance:Lcom/android/settings/dashboard/CategoryManager;


# instance fields
.field public mCategories:Ljava/util/List;

.field public final mCategoryByKeyMap:Ljava/util/Map;

.field public final mInterestingConfigChanges:Lcom/android/settingslib/applications/InterestingConfigChanges;

.field public final mTileByComponentCache:Ljava/util/Map;
...
# virtual methods
.method public declared-synchronized backwardCompatCleanupForCategory(Ljava/util/Map;Ljava/util/Map;)V
    .locals 6
    ...
    iget-object v4, v4, Lcom/android/settingslib/drawer/Tile;->mCategory:Ljava/lang/String;
    ...
    iget-object v3, v1, Lcom/android/settingslib/drawer/Tile;->mCategory:Ljava/lang/String;
    ...
    iput-object v2, v1, Lcom/android/settingslib/drawer/Tile;->mCategory:Ljava/lang/String;
...
.method public declared-synchronized filterDuplicateTiles(Ljava/util/Map;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v1, v0, Lcom/android/settingslib/drawer/DashboardCategory;->mTiles:Ljava/util/List;
    ...
    iget-object v4, v0, Lcom/android/settingslib/drawer/DashboardCategory;->mTiles:Ljava/util/List;
    ...
    :cond_2
    iget-object v4, v4, Lcom/android/settingslib/drawer/Tile;->mIntent:Landroid/content/Intent;
...
.method public final declared-synchronized getTileByComponentMap()Ljava/util/Map;
    .locals 3
...
.method public final declared-synchronized getTilesByCategory(Landroid/content/Context;Ljava/lang/String;)Lcom/android/settingslib/drawer/DashboardCategory;
    .locals 1
    ...
    :try_start_1
    invoke-virtual {p0, p1, v0}, Lcom/android/settings/dashboard/CategoryManager;->tryInitCategories(Landroid/content/Context;Z)V
    :try_end_1
...
.method public declared-synchronized mergeSecurityPrivacyKeys(Landroid/content/Context;Ljava/util/Map;Ljava/util/Map;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v0, p2, Lcom/android/settingslib/drawer/Tile;->mCategory:Ljava/lang/String;
    ...
    iput-object v0, p2, Lcom/android/settingslib/drawer/Tile;->mCategory:Ljava/lang/String;
...
.method public declared-synchronized sortCategories(Landroid/content/Context;Ljava/util/Map;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_1
    iget-object v2, v0, Lcom/android/settingslib/drawer/DashboardCategory;->mTiles:Ljava/util/List;

    new-instance v3, Lcom/android/settingslib/drawer/DashboardCategory$$ExternalSyntheticLambda0;

    invoke-direct {v3, v1}, Lcom/android/settingslib/drawer/DashboardCategory$$ExternalSyntheticLambda0;-><init>(Ljava/lang/String;)V
...
.method public final declared-synchronized tryInitCategories(Landroid/content/Context;Z)V
    .locals 4
