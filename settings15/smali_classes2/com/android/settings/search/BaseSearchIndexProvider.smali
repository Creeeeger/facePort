...
.method public getDynamicRawDataToIndex(Landroid/content/Context;)Ljava/util/List;
    .locals 2
    ...
    invoke-virtual {p0}, Lcom/android/settings/search/BaseSearchIndexProvider;->supportDynamicRawIndexingWithController()Z
    ...
    invoke-interface {p1, v0}, Lcom/android/settings/core/PreferenceControllerMixin;->updateDynamicRawDataToIndex(Ljava/util/List;)V
    ...
    invoke-virtual {p1, v0}, Lcom/android/settings/core/BasePreferenceController;->updateDynamicRawDataToIndex(Ljava/util/List;)V
...
.method public getNonIndexableKeys(Landroid/content/Context;)Ljava/util/List;
    ...
    invoke-virtual {p0, p1, v1}, Lcom/android/settings/search/BaseSearchIndexProvider;->getNonIndexableKeysFromXml(Landroid/content/Context;Z)Ljava/util/List;

    move-result-object v1

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    invoke-virtual {p0, p1}, Lcom/android/settings/search/BaseSearchIndexProvider;->getRawDataToIndex(Landroid/content/Context;)Ljava/util/List;
...
.method public getNonIndexableKeysFromXml(Landroid/content/Context;IZ)Ljava/util/List;
    ...
    invoke-static {p2, p1, p3}, Landroidx/compose/foundation/text/input/internal/RecordingInputConnection$$ExternalSyntheticOutline0;->m(ILjava/lang/String;Ljava/lang/String;)V

    :cond_2
    return-object p0
.end method

.method public final getNonIndexableKeysFromXml(Landroid/content/Context;Z)Ljava/util/List;
    .locals 3

    invoke-virtual {p0, p1}, Lcom/android/settings/search/BaseSearchIndexProvider;->getXmlResourcesToIndex(Landroid/content/Context;)Ljava/util/List;
...
.method public getRawDataToIndex(Landroid/content/Context;)Ljava/util/List;
    ...
    invoke-interface {p1, v0}, Lcom/android/settings/core/PreferenceControllerMixin;->updateRawDataToIndex(Ljava/util/List;)V
...
.method public getXmlResourcesToIndex(Landroid/content/Context;)Ljava/util/List;
    .locals 1
...
.method public supportDynamicRawIndexingWithController()Z
    .locals 0

    instance-of p0, p0, Lcom/android/settings/notification/modes/ZenModesListFragment$1;
