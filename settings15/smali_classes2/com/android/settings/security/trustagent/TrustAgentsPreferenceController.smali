...
# static fields
.field private static final GMS_TRUST_AGENT_CLASSNAME:Ljava/lang/String; = "com.google.android.gms.auth.trustagent.GoogleTrustAgent"
...
.method private findAvailableTrustAgents()V
    ...
    invoke-static {v3, v1}, Lcom/android/settings/security/trustagent/TrustAgentManager;->shouldProvideTrust(Landroid/content/pm/PackageManager;Landroid/content/pm/ResolveInfo;)Z
    ...
    invoke-static {v1}, Lcom/android/settings/security/trustagent/TrustAgentManager;->getComponentName(Landroid/content/pm/ResolveInfo;)Landroid/content/ComponentName;
...
.method private removeUselessExistingPreferences()V
    ...
    instance-of v3, v2, Lcom/android/settingslib/RestrictedSwitchPreference;
...
.method private updateAgents()V
    ...
    iget-object v3, v2, Lcom/android/settings/security/trustagent/TrustAgentInfo;->mComponentName:Landroid/content/ComponentName;
    ...
    iget-object v5, v4, Lcom/android/settingslib/RestrictedSwitchPreference;->mHelper:Lcom/android/settingslib/RestrictedPreferenceHelper;

    const/4 v6, 0x1

    iput-boolean v6, v5, Lcom/android/settingslib/RestrictedPreferenceHelper;->mDisabledSummary:Z

    iget-object v5, v2, Lcom/android/settings/security/trustagent/TrustAgentInfo;->mLabel:Ljava/lang/CharSequence;

    invoke-virtual {v4, v5}, Landroidx/preference/Preference;->setTitle(Ljava/lang/CharSequence;)V

    iget-object v5, v2, Lcom/android/settings/security/trustagent/TrustAgentInfo;->mComponentName:Landroid/content/ComponentName;

    invoke-virtual {v5}, Landroid/content/ComponentName;->getClassName()Ljava/lang/String;

    move-result-object v5

    const-string v6, "com.google.android.gms.auth.trustagent.GoogleTrustAgent"
    ...
    :cond_1
    iget-object v2, v2, Lcom/android/settings/security/trustagent/TrustAgentInfo;->mIcon:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v5, v2, v3}, Landroid/app/admin/DevicePolicyManager;->getTrustAgentConfiguration(Landroid/content/ComponentName;Landroid/content/ComponentName;)Ljava/util/List;
    ...
    :cond_2
    invoke-virtual {v4, v2}, Lcom/android/settingslib/RestrictedSwitchPreference;->setDisabledByAdmin(Lcom/android/settingslib/RestrictedLockUtils$EnforcedAdmin;)V
...
.method public onPreferenceChange(Landroidx/preference/Preference;Ljava/lang/Object;)Z
    ...
    iget-object v2, v2, Lcom/android/settings/security/trustagent/TrustAgentInfo;->mComponentName:Landroid/content/ComponentName;
