...
# instance fields
.field public mAvailableRecognizerInfos:Ljava/util/ArrayList;

.field public final mContext:Landroid/content/Context;

.field public mCurrentRecognizer:Landroid/content/ComponentName;
...
.method public static validRecognitionServices(Landroid/content/Context;)Ljava/util/ArrayList;
    .locals 9
    ...
    const-string v3, "No android.speech meta-data for "
    ...
    const-string v5, "android.speech"

    invoke-virtual {v2, v4, v5}, Landroid/content/pm/ServiceInfo;->loadXmlMetaData(Landroid/content/pm/PackageManager;Ljava/lang/String;)Landroid/content/res/XmlResourceParser;
    ...
    sget-object v6, Lcom/android/internal/R$styleable;->RecognitionService:[I
    ...
    const-string v5, " package meta-data does not start with a `recognition-service` tag"
    ...
    invoke-direct {v5, v3}, Lorg/xmlpull/v1/XmlPullParserException;-><init>(Ljava/lang/String;)V
    ...
    const-string v4, " package recognition service meta-data"
    ...
    const-string v5, "VoiceInputHelper"
...
.method public final buildUi()V
    ...
    iget-object v3, v1, Lcom/android/settings/language/VoiceInputHelper$RecognizerInfo;->mService:Landroid/content/pm/ServiceInfo;
