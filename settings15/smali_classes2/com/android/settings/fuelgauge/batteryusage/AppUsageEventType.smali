...
# static fields
.field public static final synthetic $VALUES:[Lcom/android/settings/fuelgauge/batteryusage/AppUsageEventType;
...
.method static constructor <clinit>()V
    ...
    new-instance v1, Lcom/android/settings/fuelgauge/batteryusage/AppUsageEventType;

    const-string v2, "ACTIVITY_RESUMED"

    const/4 v3, 0x1

    invoke-direct {v1, v2, v3, v3}, Lcom/android/settings/fuelgauge/batteryusage/AppUsageEventType;-><init>(Ljava/lang/String;II)V

    sput-object v1, Lcom/android/settings/fuelgauge/batteryusage/AppUsageEventType;->ACTIVITY_RESUMED:Lcom/android/settings/fuelgauge/batteryusage/AppUsageEventType;

    new-instance v2, Lcom/android/settings/fuelgauge/batteryusage/AppUsageEventType;

    const-string v3, "ACTIVITY_STOPPED"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4, v4}, Lcom/android/settings/fuelgauge/batteryusage/AppUsageEventType;-><init>(Ljava/lang/String;II)V

    sput-object v2, Lcom/android/settings/fuelgauge/batteryusage/AppUsageEventType;->ACTIVITY_STOPPED:Lcom/android/settings/fuelgauge/batteryusage/AppUsageEventType;

    new-instance v3, Lcom/android/settings/fuelgauge/batteryusage/AppUsageEventType;

    const-string v4, "DEVICE_SHUTDOWN"

    const/4 v5, 0x3

    invoke-direct {v3, v4, v5, v5}, Lcom/android/settings/fuelgauge/batteryusage/AppUsageEventType;-><init>(Ljava/lang/String;II)V

    sput-object v3, Lcom/android/settings/fuelgauge/batteryusage/AppUsageEventType;->DEVICE_SHUTDOWN:Lcom/android/settings/fuelgauge/batteryusage/AppUsageEventType;
