.class public final Lcom/android/settings/development/AppPicker$AppListAdapter;
...
.field public final mPackageInfoList:Ljava/util/List;

.field public final synthetic this$0:Lcom/android/settings/development/AppPicker;
...
.method public constructor <init>(Lcom/android/settings/development/AppPicker;Landroid/content/Context;)V
    ...
    :cond_0
    iget-boolean v4, p1, Lcom/android/settings/development/AppPicker;->mDebuggableOnly:Z
    ...
    :cond_1
    iget-boolean v4, p1, Lcom/android/settings/development/AppPicker;->mNonSystemOnly:Z
    ...
    :cond_2
    iget-object v4, p1, Lcom/android/settings/development/AppPicker;->mPermissionName:Ljava/lang/String;
    ...
    iget-object v8, p1, Lcom/android/settings/development/AppPicker;->mPermissionName:Ljava/lang/String;
    ...
    sget-object v2, Lcom/android/settings/development/AppPicker;->sDisplayNameComparator:Lcom/android/settings/development/AppPicker$1;

    invoke-static {v1, v2}, Ljava/util/Collections;->sort(Ljava/util/List;Ljava/util/Comparator;)V

    iget-boolean p1, p1, Lcom/android/settings/development/AppPicker;->mIncludeNothing:Z

    if-eqz p1, :cond_8

    new-instance p1, Lcom/android/settings/development/AppPicker$MyApplicationInfo;
    ...
    iput-object p2, p1, Lcom/android/settings/development/AppPicker$MyApplicationInfo;->label:Ljava/lang/CharSequence;

    iget-object p2, p0, Lcom/android/settings/development/AppPicker$AppListAdapter;->mPackageInfoList:Ljava/util/List;
