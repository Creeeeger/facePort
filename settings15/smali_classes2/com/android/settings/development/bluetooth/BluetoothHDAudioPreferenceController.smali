.class public final Lcom/android/settings/development/bluetooth/BluetoothHDAudioPreferenceController;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lcom/android/settingslib/core/lifecycle/Lifecycle;Lcom/android/settings/development/bluetooth/AbstractBluetoothPreferenceController$Callback;)V
    .locals 0
    ...
    iput-object p3, p0, Lcom/android/settings/development/bluetooth/BluetoothHDAudioPreferenceController;->mCallback:Lcom/android/settings/development/bluetooth/AbstractBluetoothPreferenceController$Callback;
...
.method public final onPreferenceChange(Landroidx/preference/Preference;Ljava/lang/Object;)Z
    ...
    invoke-virtual {v0}, Lcom/android/settings/development/bluetooth/AbstractBluetoothDialogPreferenceController;->onHDAudioEnabled()V

    :cond_4
    instance-of v0, p1, Lcom/android/settings/development/bluetooth/AbstractBluetoothListPreferenceController;

    if-eqz v0, :cond_3

    check-cast p1, Lcom/android/settings/development/bluetooth/AbstractBluetoothListPreferenceController;

    check-cast p1, Lcom/android/settings/development/bluetooth/BluetoothCodecListPreferenceController;

    sget-boolean v0, Lcom/android/settings/development/bluetooth/BluetoothCodecListPreferenceController;->DEBUG:Z
    ...
    const-string v3, "onHDAudioEnabled: enabled="
    ...
    :cond_5
    iget-object p1, p1, Lcom/android/settings/development/bluetooth/AbstractBluetoothListPreferenceController;->mListPreference:Landroidx/preference/ListPreference;

    if-nez p1, :cond_6

    const-string p1, "onHDAudioEnabled: List preference is null"
