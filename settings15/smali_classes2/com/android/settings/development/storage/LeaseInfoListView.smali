...
# instance fields
.field public mAdapter:Lcom/android/settings/development/storage/LeaseInfoListView$LeaseListAdapter;

.field public mBlobInfo:Landroid/app/blob/BlobInfo;

.field public mBlobStoreManager:Landroid/app/blob/BlobStoreManager;

.field public mContext:Lcom/android/settings/development/storage/LeaseInfoListView;
...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    iput-object p0, p0, Lcom/android/settings/development/storage/LeaseInfoListView;->mContext:Lcom/android/settings/development/storage/LeaseInfoListView;
    ...
    iget-object v2, p0, Lcom/android/settings/development/storage/LeaseInfoListView;->mBlobInfo:Landroid/app/blob/BlobInfo;

    invoke-virtual {v2}, Landroid/app/blob/BlobInfo;->getId()J
    ...
    invoke-virtual {p0, v6, v2}, Landroid/app/ListActivity;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {v2}, Landroid/app/blob/BlobInfo;->getSizeBytes()J

    move-result-wide v2

    sget-object v4, Lcom/android/settings/development/storage/SharedDataUtils;->FORMATTER:Landroid/icu/text/SimpleDateFormat;
    ...
    new-instance v2, Lcom/android/settings/development/storage/LeaseInfoListView$$ExternalSyntheticLambda0;

    invoke-direct {v2, p0}, Lcom/android/settings/development/storage/LeaseInfoListView$$ExternalSyntheticLambda0;-><init>(Lcom/android/settings/development/storage/LeaseInfoListView;)V
