...
.field public static final REGEX_DISPLAY_NAME_SUFFIX_PATTERN:Ljava/util/regex/Pattern;

.field static final SUB_ID:Ljava/lang/String; = "sub_id"

.field public static sActiveResultsForTesting:Ljava/util/List;

.field public static sAvailableResultsForTesting:Ljava/util/List;

.field public static sEnableRacDialogForTesting:Ljava/lang/Boolean;
...
.method public static getActiveSubscriptions(Landroid/telephony/SubscriptionManager;)Ljava/util/List;
    ...
    invoke-direct {v0, v1}, Lcom/android/settings/network/SubscriptionUtil$$ExternalSyntheticLambda2;-><init>(I)V
...
.method public static getDefaultSubscriptionSelection(Ljava/util/List;)Lcom/android/settings/network/helper/SubscriptionAnnotation;
    .locals 3
...
.method public static getSubById(Landroid/telephony/SubscriptionManager;I)Landroid/telephony/SubscriptionInfo;
    ...
    invoke-direct {v0, p1, v2}, Lcom/android/settings/network/SubscriptionUtil$$ExternalSyntheticLambda4;-><init>(II)V
...
.method public static getSubscriptionOrDefault(Landroid/content/Context;I)Landroid/telephony/SubscriptionInfo;
    ...
    invoke-direct {v0, v2}, Lcom/android/settings/network/SubscriptionUtil$$ExternalSyntheticLambda1;-><init>(I)V

    :goto_0
    new-instance v2, Lcom/android/settings/network/helper/SelectableSubscriptions;

    invoke-direct {v2, p0}, Lcom/android/settings/network/helper/SelectableSubscriptions;-><init>(Landroid/content/Context;)V

    invoke-virtual {v2}, Lcom/android/settings/network/helper/SelectableSubscriptions;->call()Ljava/util/List;

    move-result-object p0

    new-instance v2, Ljava/lang/StringBuilder;

    const-string v3, "get subId="
    ...
    invoke-direct {v3, v4}, Lcom/android/settings/network/SubscriptionUtil$$ExternalSyntheticLambda2;-><init>(I)V
    ...
    invoke-direct {v3, p1, v4}, Lcom/android/settings/network/SubscriptionUtil$$ExternalSyntheticLambda4;-><init>(II)V
...
.method public static getUniqueSubscriptionDisplayName(Landroid/content/Context;Landroid/telephony/SubscriptionInfo;)Ljava/lang/CharSequence;
    .locals 1
...
.method public static getUniqueSubscriptionDisplayNames(Landroid/content/Context;)Ljava/util/Map;
    ...
    invoke-virtual {v0}, Lcom/android/settings/network/SubscriptionUtil$$ExternalSyntheticLambda5;->get()Ljava/lang/Object;
    ...
    invoke-direct {v3, v4, v1}, Lcom/android/settings/network/SubscriptionUtil$$ExternalSyntheticLambda6;-><init>(ILjava/lang/Object;)V

    invoke-interface {v2, v3}, Ljava/util/stream/Stream;->filter(Ljava/util/function/Predicate;)Ljava/util/stream/Stream;

    move-result-object v2

    new-instance v3, Lcom/android/settings/network/SubscriptionUtil$$ExternalSyntheticLambda1;

    const/4 v4, 0x3

    invoke-direct {v3, v4}, Lcom/android/settings/network/SubscriptionUtil$$ExternalSyntheticLambda1;-><init>(I)V
    ...
    new-instance v4, Lcom/android/settings/network/SubscriptionUtil$$ExternalSyntheticLambda19;

    invoke-direct {v4, p0, v2}, Lcom/android/settings/network/SubscriptionUtil$$ExternalSyntheticLambda19;-><init>(Landroid/content/Context;Ljava/util/Set;)V

    invoke-interface {v3, v4}, Ljava/util/stream/Stream;->map(Ljava/util/function/Function;)Ljava/util/stream/Stream;

    move-result-object v3

    new-instance v4, Lcom/android/settings/network/SubscriptionUtil$$ExternalSyntheticLambda6;

    const/4 v5, 0x1

    invoke-direct {v4, v5, v1}, Lcom/android/settings/network/SubscriptionUtil$$ExternalSyntheticLambda6;-><init>(ILjava/lang/Object;)V
    ...
    new-instance v3, Lcom/android/settings/network/SubscriptionUtil$$ExternalSyntheticLambda19;

    invoke-direct {v3, p0, v2}, Lcom/android/settings/network/SubscriptionUtil$$ExternalSyntheticLambda19;-><init>(Landroid/content/Context;Ljava/util/Set;)V
    ...
    invoke-direct {v0, v2, v1}, Lcom/android/settings/network/SubscriptionUtil$$ExternalSyntheticLambda10;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v0, v1}, Lcom/android/settings/network/SubscriptionUtil$$ExternalSyntheticLambda1;-><init>(I)V

    new-instance v1, Lcom/android/settings/network/SubscriptionUtil$$ExternalSyntheticLambda1;

    const/4 v2, 0x2

    invoke-direct {v1, v2}, Lcom/android/settings/network/SubscriptionUtil$$ExternalSyntheticLambda1;-><init>(I)V
...
.method public static isCarrierRac(Landroid/content/Context;I)Z
    .locals 1
...
.method public static isConnectedToMobileDataWithDifferentSubId(Landroid/content/Context;I)Z
    .locals 1
...
.method public static isConvertedPsimSubscription(Landroid/content/Context;I)Z
    .locals 2
...
.method public static isEmbeddedSubscriptionVisible(Landroid/telephony/SubscriptionInfo;)Z
    .locals 2
...
.method public static isInactiveInsertedPSim(Landroid/telephony/UiccSlotInfo;)Z
    .locals 2
...
.method public static isValidCachedDisplayName(Ljava/lang/String;Ljava/lang/String;)Z
    .locals 1
...
.method public static shouldShowRacDialogWhenErasingAllEsims(Landroid/content/Context;)Z
    ...
    new-instance v2, Lcom/android/settings/network/SubscriptionUtil$$ExternalSyntheticLambda3;

    invoke-direct {v2, v0}, Lcom/android/settings/network/SubscriptionUtil$$ExternalSyntheticLambda3;-><init>(Ljava/util/List;)V
...
.method public static shouldShowRacDialogWhenErasingEsim(Landroid/content/Context;II)Z
    .locals 1
