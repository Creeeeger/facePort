...
# direct methods
.method public static final getSelectableSubscriptionInfoList(Landroid/content/Context;)Ljava/util/List;
    .locals 7
    ...
    invoke-static {p0}, Lcom/android/settings/network/telephony/SubscriptionRepositoryKt;->requireSubscriptionManager(Landroid/content/Context;)Landroid/telephony/SubscriptionManager;
    ...
    new-instance v2, Lcom/android/settings/network/telephony/SubscriptionRepositoryKt$getSelectableSubscriptionInfoList$lambda$7$lambda$6$$inlined$sortedBy$1;
    ...
    invoke-static {v2, v1}, Lkotlin/collections/CollectionsKt___CollectionsKt;->take(Ljava/lang/Iterable;I)Ljava/util/List;
    ...
    :cond_9
    sget-object p0, Lcom/android/settings/network/telephony/SubscriptionRepositoryKt$getSelectableSubscriptionInfoList$3;->INSTANCE:Lcom/android/settings/network/telephony/SubscriptionRepositoryKt$getSelectableSubscriptionInfoList$3;

    sget-object v1, Lcom/android/settings/network/telephony/SubscriptionRepositoryKt$getSelectableSubscriptionInfoList$4;->INSTANCE:Lcom/android/settings/network/telephony/SubscriptionRepositoryKt$getSelectableSubscriptionInfoList$4;
...
.method public static final subscriptionsChangedFlow(Landroid/content/Context;)Lkotlinx/coroutines/flow/Flow;
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/settings/network/telephony/SubscriptionRepositoryKt$subscriptionsChangedFlow$1;-><init>(Landroid/content/Context;Lkotlin/coroutines/Continuation;)V
    ...
    new-instance v0, Lcom/android/settings/network/telephony/SubscriptionRepositoryKt$subscriptionsChangedFlow$2;
