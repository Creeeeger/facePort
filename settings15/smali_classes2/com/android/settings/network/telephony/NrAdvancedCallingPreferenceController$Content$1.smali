...
# direct methods
.method public constructor <init>(Landroidx/compose/runtime/Composer;Ljava/lang/String;Landroidx/compose/runtime/MutableState;Landroidx/compose/runtime/MutableState;Lkotlinx/coroutines/internal/ContextScope;Lcom/android/settings/network/telephony/NrAdvancedCallingPreferenceController;)V
    .locals 1
    ...
    new-instance p1, Lcom/android/settings/network/telephony/NrAdvancedCallingPreferenceController$Content$1$summary$1;

    invoke-direct {p1, p2}, Lcom/android/settings/network/telephony/NrAdvancedCallingPreferenceController$Content$1$summary$1;-><init>(Ljava/lang/String;)V
    ...
    new-instance p1, Lcom/android/settings/network/telephony/NrAdvancedCallingPreferenceController$Content$1$changeable$1;

    invoke-direct {p1, p3}, Lcom/android/settings/network/telephony/NrAdvancedCallingPreferenceController$Content$1$changeable$1;-><init>(Landroidx/compose/runtime/MutableState;)V
    ...
    new-instance p1, Lcom/android/settings/network/telephony/NrAdvancedCallingPreferenceController$Content$1$checked$1;

    invoke-direct {p1, p4}, Lcom/android/settings/network/telephony/NrAdvancedCallingPreferenceController$Content$1$checked$1;-><init>(Landroidx/compose/runtime/MutableState;)V
    ...
    new-instance p1, Lcom/android/settings/network/telephony/NrAdvancedCallingPreferenceController$Content$1$onCheckedChange$1;

    invoke-direct {p1, p5, p6}, Lcom/android/settings/network/telephony/NrAdvancedCallingPreferenceController$Content$1$onCheckedChange$1;-><init>(Lkotlinx/coroutines/internal/ContextScope;Lcom/android/settings/network/telephony/NrAdvancedCallingPreferenceController;)V
