...
.field public final mBroadcastReceiver:Lcom/android/settingslib/bluetooth/BluetoothEventManager$1;
...
.field public final mPackageBroadcastReceiver:Lcom/android/settingslib/bluetooth/BluetoothEventManager$1;

.field public final mProfileBroadcastReceiver:Lcom/android/settingslib/bluetooth/BluetoothEventManager$1;
...
.method public constructor <init>(Lcom/android/settingslib/bluetooth/LocalBluetoothAdapter;Lcom/android/settingslib/bluetooth/LocalBluetoothManager;Lcom/android/settingslib/bluetooth/CachedBluetoothDeviceManager;Landroid/content/Context;)V
    .locals 9

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    new-instance p2, Lcom/android/settingslib/bluetooth/BluetoothEventManager$1;

    const/4 v0, 0x1

    invoke-direct {p2, p0, v0}, Lcom/android/settingslib/bluetooth/BluetoothEventManager$1;-><init>(Lcom/android/settingslib/bluetooth/BluetoothEventManager;I)V

    iput-object p2, p0, Lcom/android/settingslib/bluetooth/BluetoothEventManager;->mBroadcastReceiver:Lcom/android/settingslib/bluetooth/BluetoothEventManager$1;

    new-instance p2, Lcom/android/settingslib/bluetooth/BluetoothEventManager$1;

    invoke-direct {p2, p0, v0}, Lcom/android/settingslib/bluetooth/BluetoothEventManager$1;-><init>(Lcom/android/settingslib/bluetooth/BluetoothEventManager;I)V

    iput-object p2, p0, Lcom/android/settingslib/bluetooth/BluetoothEventManager;->mProfileBroadcastReceiver:Lcom/android/settingslib/bluetooth/BluetoothEventManager$1;
    ...
    new-instance v2, Lcom/android/settingslib/bluetooth/BluetoothEventManager$1;

    invoke-direct {v2, p0, v0}, Lcom/android/settingslib/bluetooth/BluetoothEventManager$1;-><init>(Lcom/android/settingslib/bluetooth/BluetoothEventManager;I)V

    new-instance v3, Lcom/android/settingslib/bluetooth/BluetoothEventManager$1;

    const/4 v4, 0x0

    invoke-direct {v3, p0, v4}, Lcom/android/settingslib/bluetooth/BluetoothEventManager$1;-><init>(Lcom/android/settingslib/bluetooth/BluetoothEventManager;I)V

    const-string v5, "BluetoothEventManager"

    const-string v6, "BluetoothEventManager Constructor :: "
    ...
    iput-object p3, p0, Lcom/android/settingslib/bluetooth/BluetoothEventManager;->mUserHandle:Landroid/os/UserHandle;

    iput-object p3, p0, Lcom/android/settingslib/bluetooth/BluetoothEventManager;->mReceiverHandler:Landroid/os/Handler;

    invoke-virtual {v1}, Ljava/util/ArrayList;->clear()V

    const-string p3, "android.bluetooth.adapter.action.STATE_CHANGED"

    new-instance v7, Lcom/android/settingslib/bluetooth/BluetoothEventManager$DeviceSyncHandler;

    invoke-direct {v7, p0, v0}, Lcom/android/settingslib/bluetooth/BluetoothEventManager$DeviceSyncHandler;-><init>(Lcom/android/settingslib/bluetooth/BluetoothEventManager;I)V

    invoke-virtual {p0, p3, v7}, Lcom/android/settingslib/bluetooth/BluetoothEventManager;->addHandler(Ljava/lang/String;Lcom/android/settingslib/bluetooth/BluetoothEventManager$Handler;)V
    ...
    invoke-direct {v7, p0, v8}, Lcom/android/settingslib/bluetooth/BluetoothEventManager$DeviceSyncHandler;-><init>(Lcom/android/settingslib/bluetooth/BluetoothEventManager;I)V

    invoke-virtual {p0, p3, v7}, Lcom/android/settingslib/bluetooth/BluetoothEventManager;->addHandler(Ljava/lang/String;Lcom/android/settingslib/bluetooth/BluetoothEventManager$Handler;)V

    const-string p3, "android.bluetooth.adapter.action.DISCOVERY_STARTED"

    new-instance v7, Lcom/android/settingslib/bluetooth/BluetoothEventManager$ScanningStateChangedHandler;

    invoke-direct {v7, p0, v0}, Lcom/android/settingslib/bluetooth/BluetoothEventManager$ScanningStateChangedHandler;-><init>(Lcom/android/settingslib/bluetooth/BluetoothEventManager;Z)V
    ...
    invoke-direct {v0, p0, v4}, Lcom/android/settingslib/bluetooth/BluetoothEventManager$ScanningStateChangedHandler;-><init>(Lcom/android/settingslib/bluetooth/BluetoothEventManager;Z)V

    invoke-virtual {p0, p3, v0}, Lcom/android/settingslib/bluetooth/BluetoothEventManager;->addHandler(Ljava/lang/String;Lcom/android/settingslib/bluetooth/BluetoothEventManager$Handler;)V

    const-string p3, "android.bluetooth.device.action.FOUND"

    new-instance v0, Lcom/android/settingslib/bluetooth/BluetoothEventManager$DeviceSyncHandler;

    const/16 v7, 0xd

    invoke-direct {v0, p0, v7}, Lcom/android/settingslib/bluetooth/BluetoothEventManager$DeviceSyncHandler;-><init>(Lcom/android/settingslib/bluetooth/BluetoothEventManager;I)V
    ...
    new-instance v0, Lcom/android/settingslib/bluetooth/BluetoothEventManager$DeviceNameChangedHandler;
    ...
    invoke-direct {v0, p0, v4}, Lcom/android/settingslib/bluetooth/BluetoothEventManager$DeviceSyncHandler;-><init>(Lcom/android/settingslib/bluetooth/BluetoothEventManager;I)V
    ...
    invoke-direct {p3, p0, v0}, Lcom/android/settingslib/bluetooth/BluetoothEventManager$DelayedSyncHandler;-><init>(Lcom/android/settingslib/bluetooth/BluetoothEventManager;Landroid/os/Looper;)V
    ...
    :cond_0
    :goto_0
    invoke-virtual {p0, v2, v5}, Lcom/android/settingslib/bluetooth/BluetoothEventManager;->registerIntentReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)V
    ...
    :cond_1
    :goto_1
    invoke-virtual {p0, v3, v6}, Lcom/android/settingslib/bluetooth/BluetoothEventManager;->registerIntentReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)V
    ...
    new-instance v0, Lcom/samsung/android/settingslib/bluetooth/scsp/ScspUtils$$ExternalSyntheticLambda0;

    invoke-direct {v0, p4, p2, p3}, Lcom/samsung/android/settingslib/bluetooth/scsp/ScspUtils$$ExternalSyntheticLambda0;-><init>(Landroid/content/Context;Ljava/util/Collection;Landroid/os/Handler;)V
...
.method public final readRestoredDevices()V
    ...
    iput-object v5, v3, Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;->mErrorMsg:Ljava/lang/String;

    iget v5, v4, Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;->mBondState:I

    iput v5, v3, Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;->mBondState:I

    iget-boolean v4, v4, Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;->mIsBondingByCached:Z

    iput-boolean v4, v3, Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;->mIsBondingByCached:Z
    ...
    :goto_4
    iget-object v5, v3, Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;->mBondingDetector:Lcom/samsung/android/settingslib/bluetooth/detector/BluetoothRetryDetector;

    if-eqz v5, :cond_5

    iput v4, v5, Lcom/samsung/android/settingslib/bluetooth/detector/BluetoothRetryDetector;->mCount:I
    ...
    iput v4, v3, Lcom/android/settingslib/bluetooth/CachedBluetoothDevice;->mSequence:I
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_1
...
.method public registerAdapterIntentReceiver()V
    ...
    iget-object v2, p0, Lcom/android/settingslib/bluetooth/BluetoothEventManager;->mBroadcastReceiver:Lcom/android/settingslib/bluetooth/BluetoothEventManager$1;
    ...
    :cond_0
    :goto_0
    iget-object v1, p0, Lcom/android/settingslib/bluetooth/BluetoothEventManager;->mBroadcastReceiver:Lcom/android/settingslib/bluetooth/BluetoothEventManager$1;
    ...
    invoke-virtual {p0, v1, v2}, Lcom/android/settingslib/bluetooth/BluetoothEventManager;->registerIntentReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)V

    iget-object v1, p0, Lcom/android/settingslib/bluetooth/BluetoothEventManager;->mReceivers:Ljava/util/ArrayList;

    iget-object p0, p0, Lcom/android/settingslib/bluetooth/BluetoothEventManager;->mBroadcastReceiver:Lcom/android/settingslib/bluetooth/BluetoothEventManager$1;
...
.method public registerProfileIntentReceiver()V
    ...
    iget-object v2, p0, Lcom/android/settingslib/bluetooth/BluetoothEventManager;->mProfileBroadcastReceiver:Lcom/android/settingslib/bluetooth/BluetoothEventManager$1;
    ...
    :cond_0
    :goto_0
    iget-object v1, p0, Lcom/android/settingslib/bluetooth/BluetoothEventManager;->mProfileBroadcastReceiver:Lcom/android/settingslib/bluetooth/BluetoothEventManager$1;
    ...
    iget-object p0, p0, Lcom/android/settingslib/bluetooth/BluetoothEventManager;->mProfileBroadcastReceiver:Lcom/android/settingslib/bluetooth/BluetoothEventManager$1;
...
.method public final registerSemCallback(Lcom/samsung/android/settingslib/bluetooth/SemBluetoothCallback;)V
    .locals 1
...
.method public final unregisterSemCallback(Lcom/samsung/android/settingslib/bluetooth/SemBluetoothCallback;)V
    .locals 1
