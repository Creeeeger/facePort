.class public final Lcom/android/settingslib/applications/ApplicationsState$Session;
...
# instance fields
.field public final mCallbacks:Lcom/android/settingslib/applications/ApplicationsState$Callbacks;
...
# virtual methods
.method public final getAllApps()Ljava/util/ArrayList;
    .locals 2
...
.method public final handleRebuildList()V
    ...
    iget-object v9, p0, Lcom/android/settingslib/applications/ApplicationsState$Session;->this$0:Lcom/android/settingslib/applications/ApplicationsState;

    iget-object v9, v9, Lcom/android/settingslib/applications/ApplicationsState;->mUm:Landroid/os/UserManager;

    invoke-virtual {v9, v8}, Landroid/os/UserManager;->isQuietModeEnabled(Landroid/os/UserHandle;)Z

    move-result v10

    if-eqz v10, :cond_5

    invoke-virtual {v9, v8}, Landroid/os/UserManager;->getUserProperties(Landroid/os/UserHandle;)Landroid/content/pm/UserProperties;

    move-result-object v9

    invoke-virtual {v9}, Landroid/content/pm/UserProperties;->getShowInQuietMode()I
    ...
    invoke-interface {v1, v6, v7}, Lcom/android/settingslib/applications/ApplicationsState$AppFilter;->refreshAppEntryOnRebuild(Lcom/android/settingslib/applications/ApplicationsState$AppEntry;Z)V
...
.method public final rebuild(Lcom/android/settingslib/applications/ApplicationsState$AppFilter;Ljava/util/Comparator;Z)V
    .locals 3
