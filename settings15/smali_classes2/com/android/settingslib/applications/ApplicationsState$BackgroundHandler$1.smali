...
.method public final onGetStatsCompleted(Landroid/content/pm/PackageStats;Z)V
    ...
    iget-wide v0, v3, Lcom/android/settingslib/applications/ApplicationsState$AppEntry;->cacheSize:J

    cmp-long v0, v0, v4

    if-nez v0, :cond_3

    iget-wide v0, v3, Lcom/android/settingslib/applications/ApplicationsState$AppEntry;->codeSize:J

    cmp-long v0, v0, v11

    if-nez v0, :cond_3

    iget-wide v0, v3, Lcom/android/settingslib/applications/ApplicationsState$AppEntry;->dataSize:J

    cmp-long v0, v0, v13

    if-nez v0, :cond_3

    iget-wide v0, v3, Lcom/android/settingslib/applications/ApplicationsState$AppEntry;->externalCodeSize:J

    cmp-long v0, v0, v17

    if-nez v0, :cond_3

    iget-wide v0, v3, Lcom/android/settingslib/applications/ApplicationsState$AppEntry;->externalDataSize:J

    cmp-long v0, v0, v7

    if-nez v0, :cond_3

    iget-wide v0, v3, Lcom/android/settingslib/applications/ApplicationsState$AppEntry;->externalCacheSize:J
    ...
    iput-wide v4, v3, Lcom/android/settingslib/applications/ApplicationsState$AppEntry;->cacheSize:J

    iput-wide v11, v3, Lcom/android/settingslib/applications/ApplicationsState$AppEntry;->codeSize:J

    iput-wide v13, v3, Lcom/android/settingslib/applications/ApplicationsState$AppEntry;->dataSize:J

    move-wide/from16 v0, v17

    iput-wide v0, v3, Lcom/android/settingslib/applications/ApplicationsState$AppEntry;->externalCodeSize:J

    move-wide v7, v15

    iput-wide v7, v3, Lcom/android/settingslib/applications/ApplicationsState$AppEntry;->externalDataSize:J

    iget-wide v0, v6, Landroid/content/pm/PackageStats;->externalCacheSize:J

    iput-wide v0, v3, Lcom/android/settingslib/applications/ApplicationsState$AppEntry;->externalCacheSize:J
    ...
    invoke-static {v1, v9, v10}, Lcom/android/settingslib/applications/ApplicationsState;->-$$Nest$mgetSizeStr(Lcom/android/settingslib/applications/ApplicationsState;J)Ljava/lang/String;

    move-result-object v1

    iput-object v1, v3, Lcom/android/settingslib/applications/ApplicationsState$AppEntry;->sizeStr:Ljava/lang/String;
    ...
    invoke-static {v1, v4, v5}, Lcom/android/settingslib/applications/ApplicationsState;->-$$Nest$mgetSizeStr(Lcom/android/settingslib/applications/ApplicationsState;J)Ljava/lang/String;

    move-result-object v1

    iput-object v1, v3, Lcom/android/settingslib/applications/ApplicationsState$AppEntry;->internalSizeStr:Ljava/lang/String;
    ...
    iput-object v1, v3, Lcom/android/settingslib/applications/ApplicationsState$AppEntry;->externalSizeStr:Ljava/lang/String;
