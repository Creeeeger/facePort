...
.field public mListener:Lcom/samsung/android/settings/wifi/WifiSettingsListController$1;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-boolean v3, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mScale:Z
    ...
    new-instance v4, Landroidx/swiperefreshlayout/widget/CircleImageView;
    ...
    sget-object v8, Landroidx/swiperefreshlayout/R$styleable;->SwipeRefreshLayout:[I
    ...
    invoke-virtual {v5, v10, v9, v3}, Landroid/content/res/Resources$Theme;->resolveAttribute(ILandroid/util/TypedValue;Z)Z
    ...
    iput v5, v4, Landroidx/swiperefreshlayout/widget/CircleImageView;->mBackgroundColor:I
    ...
    invoke-static {v4, v6}, Landroidx/core/view/ViewCompat$Api21Impl;->setElevation(Landroid/view/View;F)V

    invoke-virtual {v5}, Landroid/graphics/drawable/ShapeDrawable;->getPaint()Landroid/graphics/Paint;

    move-result-object v6

    iget v7, v4, Landroidx/swiperefreshlayout/widget/CircleImageView;->mBackgroundColor:I

    invoke-virtual {v6, v7}, Landroid/graphics/Paint;->setColor(I)V

    invoke-virtual {v4, v5}, Landroid/view/View;->setBackground(Landroid/graphics/drawable/Drawable;)V

    iput-object v4, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mCircleView:Landroidx/swiperefreshlayout/widget/CircleImageView;

    new-instance v4, Landroidx/swiperefreshlayout/widget/CircularProgressDrawable;

    invoke-virtual {p0}, Landroid/view/ViewGroup;->getContext()Landroid/content/Context;

    move-result-object v5

    invoke-direct {v4, v5}, Landroidx/swiperefreshlayout/widget/CircularProgressDrawable;-><init>(Landroid/content/Context;)V

    iput-object v4, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mProgress:Landroidx/swiperefreshlayout/widget/CircularProgressDrawable;

    iget-object v5, v4, Landroidx/swiperefreshlayout/widget/CircularProgressDrawable;->mFourDot:Landroidx/swiperefreshlayout/widget/CircularProgressDrawable$FourDot;

    iget v6, v4, Landroidx/swiperefreshlayout/widget/CircularProgressDrawable;->mScreenDensity:F

    const/high16 v7, 0x40100000    # 2.25f

    mul-float/2addr v7, v6

    iput v7, v5, Landroidx/swiperefreshlayout/widget/CircularProgressDrawable$FourDot;->mDotRadius:F

    const/high16 v7, 0x41600000    # 14.0f

    mul-float/2addr v7, v6

    iput v7, v5, Landroidx/swiperefreshlayout/widget/CircularProgressDrawable$FourDot;->mCenterRadius:F
    ...
    iput v4, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mSpinnerOffsetEnd:I
...
.method public final moveSpinner(F)V
    ...
    iget-object v1, v1, Landroidx/swiperefreshlayout/widget/CircularProgressDrawable;->mFourDot:Landroidx/swiperefreshlayout/widget/CircularProgressDrawable$FourDot;

    iget v1, v1, Landroidx/swiperefreshlayout/widget/CircularProgressDrawable$FourDot;->mAlpha:I

    const/16 v4, 0xff

    if-ge v1, v4, :cond_6

    iget-object v1, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mAlphaMaxAnimation:Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout$4;
    ...
    new-instance v4, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout$4;

    invoke-direct {v4, p0, v1}, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout$4;-><init>(Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;I)V
    ...
    iput-object v5, v1, Landroidx/swiperefreshlayout/widget/CircleImageView;->mListener:Landroid/view/animation/Animation$AnimationListener;
    ...
    iput-object v4, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mAlphaMaxAnimation:Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout$4;
...
.method public final onNestedScroll(Landroid/view/View;IIIII[I)V
    ...
    iget-boolean v3, v0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mActionDown:Z
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p0, v3}, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->startScaleDownAnimation(Landroid/view/animation/Animation$AnimationListener;)V
    ...
    invoke-virtual {p0, v1, v1}, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->setRefreshing(ZZ)V
...
.method public final setRefreshing(ZZ)V
    ...
    iget-object p1, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mListener:Lcom/samsung/android/settings/wifi/WifiSettingsListController$1;

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Lcom/samsung/android/settings/wifi/WifiSettingsListController$1;->onRefresh()V
...
.method public final startScaleDownAnimation(Landroid/view/animation/Animation$AnimationListener;)V
    ...
    iput-object v0, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mScaleDownAnimation:Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout$2;

    const-wide/16 v1, 0x12c

    invoke-virtual {v0, v1, v2}, Landroid/view/animation/Animation;->setDuration(J)V

    iget-object v0, p0, Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout;->mScaleDownAnimation:Landroidx/swiperefreshlayout/widget/SwipeRefreshLayout$2;
