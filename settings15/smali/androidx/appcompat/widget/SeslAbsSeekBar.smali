...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-virtual {v3, v0, p4}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I
...
.method public static access$000(Landroidx/appcompat/widget/SeslSeekBar;I)V
    .locals 0
...
.method public final drawableStateChanged()V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/SeslAbsSeekBar;->updateDualColorMode()V
...
.method public final getHoverPopupType()I
    ...
    const-string/jumbo v2, "semGetHoverPopupType"
...
.method public final initMuteAnimation()V
    ...
    invoke-direct {v6, p0, v7}, Landroidx/appcompat/widget/SeslAbsSeekBar$1;-><init>(Landroidx/appcompat/widget/SeslAbsSeekBar;I)V
...
.method public final initializeExpandMode()V
    ...
    invoke-direct {v2, v7, v3, v5}, Landroid/graphics/drawable/ClipDrawable;-><init>(Landroid/graphics/drawable/Drawable;II)V

    aput-object v2, v1, v5

    new-instance v2, Landroid/graphics/drawable/ClipDrawable;

    invoke-direct {v2, v8, v3, v5}, Landroid/graphics/drawable/ClipDrawable;-><init>(Landroid/graphics/drawable/Drawable;II)V
    ...
    invoke-virtual {v2, v5}, Landroid/graphics/drawable/LayerDrawable;->setPaddingMode(I)V
    ...
    invoke-virtual {v2, v5, v1}, Landroid/graphics/drawable/LayerDrawable;->setId(II)V
...
.method public final onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    const-string/jumbo v6, "setHoveringPoint"
...
.method public onStopTrackingTouch()V
    ...
    invoke-direct {v1, p0, v2}, Landroidx/appcompat/widget/SeslAbsSeekBar$1;-><init>(Landroidx/appcompat/widget/SeslAbsSeekBar;I)V
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iput-boolean v2, v0, Landroidx/appcompat/widget/SeslAbsSeekBar;->mIsDragging:Z

    iget-object v1, v0, Landroidx/appcompat/widget/SeslAbsSeekBar;->mValueAnimator:Landroid/animation/ValueAnimator;
    ...
    :cond_b
    iget-object v1, v0, Landroidx/appcompat/widget/SeslSeekBar;->mOnSeekBarChangeListener:Landroidx/appcompat/widget/SeslSeekBar$OnSeekBarChangeListener;

    if-eqz v1, :cond_c

    invoke-interface {v1, v0}, Landroidx/appcompat/widget/SeslSeekBar$OnSeekBarChangeListener;->onStartTrackingTouch(Landroidx/appcompat/widget/SeslSeekBar;)V
    ...
    sget-object v3, Landroidx/reflect/view/SeslViewReflector;->mClass:Ljava/lang/Class;
    ...
    :catch_0
    const-string v3, "Reflector did not find method = "
    ...
    invoke-static {v3, v6, v7, v0, v4}, Landroidx/appcompat/app/AlertDialog$$ExternalSyntheticOutline0;->m(Ljava/lang/reflect/Method;Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/reflect/InvocationTargetException;)V
    ...
    invoke-static {v3, v6, v7, v0, v4}, Landroidx/appcompat/app/AlertDialog$$ExternalSyntheticOutline0;->m(Ljava/lang/reflect/Method;Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/IllegalArgumentException;)V
    ...
    invoke-static {v3, v6, v7, v0, v4}, Landroidx/appcompat/app/AlertDialog$$ExternalSyntheticOutline0;->m(Ljava/lang/reflect/Method;Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/IllegalAccessException;)V
...
.method public final setDualModeOverlapColor(II)V
    .locals 1

    invoke-static {p1}, Landroidx/appcompat/widget/SeslAbsSeekBar;->colorToColorStateList(I)Landroid/content/res/ColorStateList;
...
.method public setMode(I)V
    ...
    iput v1, v6, Landroidx/appcompat/widget/SeslAbsSeekBar;->mLevelDrawPadding:F
    ...
    invoke-virtual {v6, v0}, Landroidx/appcompat/widget/SeslAbsSeekBar;->setProgressDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-direct {v1, v6, v2, v3, v7}, Landroidx/appcompat/widget/SeslAbsSeekBar$ThumbDrawable;-><init>(Landroidx/appcompat/widget/SeslAbsSeekBar;ILandroid/content/res/ColorStateList;Z)V
    ...
    invoke-direct {v2, v9, v3, v13}, Landroid/graphics/drawable/ClipDrawable;-><init>(Landroid/graphics/drawable/Drawable;II)V

    aput-object v2, v1, v7

    new-instance v2, Landroid/graphics/drawable/ClipDrawable;

    invoke-direct {v2, v10, v3, v13}, Landroid/graphics/drawable/ClipDrawable;-><init>(Landroid/graphics/drawable/Drawable;II)V
    ...
    invoke-virtual {v2, v14, v12}, Landroid/graphics/drawable/LayerDrawable;->setId(II)V

    invoke-virtual {v2, v7, v11}, Landroid/graphics/drawable/LayerDrawable;->setId(II)V

    const v1, 0x102000d

    invoke-virtual {v2, v13, v1}, Landroid/graphics/drawable/LayerDrawable;->setId(II)V

    invoke-virtual {v6, v2}, Landroidx/appcompat/widget/SeslAbsSeekBar;->setProgressDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    :cond_3
    new-instance v9, Landroidx/appcompat/widget/SeslAbsSeekBar$SliderDrawable;

    iget v0, v6, Landroidx/appcompat/widget/SeslAbsSeekBar;->mModeExpandTrackMinWidth:I

    int-to-float v2, v0

    iget v0, v6, Landroidx/appcompat/widget/SeslAbsSeekBar;->mModeExpandTrackMaxWidth:I
    ...
    new-instance v10, Landroidx/appcompat/widget/SeslAbsSeekBar$SliderDrawable;
    ...
    iget v2, v6, Landroidx/appcompat/widget/SeslAbsSeekBar;->mModeExpandThumbRadius:I

    iget-object v3, v6, Landroidx/appcompat/widget/SeslAbsSeekBar;->mDefaultActivatedThumbColor:Landroid/content/res/ColorStateList;

    invoke-direct {v1, v6, v2, v3, v14}, Landroidx/appcompat/widget/SeslAbsSeekBar$ThumbDrawable;-><init>(Landroidx/appcompat/widget/SeslAbsSeekBar;ILandroid/content/res/ColorStateList;Z)V
    ...
    invoke-direct {v2, v10, v3, v7}, Landroid/graphics/drawable/ClipDrawable;-><init>(Landroid/graphics/drawable/Drawable;II)V

    aput-object v2, v1, v7

    new-instance v2, Landroid/graphics/drawable/ClipDrawable;

    invoke-direct {v2, v15, v3, v7}, Landroid/graphics/drawable/ClipDrawable;-><init>(Landroid/graphics/drawable/Drawable;II)V
    ...
    iget-boolean v2, v6, Landroidx/appcompat/widget/SeslAbsSeekBar;->mIsLightTheme:Z
    ...
    iput-boolean v7, v6, Landroidx/appcompat/widget/SeslAbsSeekBar;->mIsSetModeCalled:Z
...
.method public setOverlapPointForDualColor(I)V
    ...
    new-instance p1, Landroidx/appcompat/widget/SeslAbsSeekBar$SliderDrawable;

    iget v0, p0, Landroidx/appcompat/widget/SeslAbsSeekBar;->mModeExpandTrackMinWidth:I

    int-to-float v3, v0

    iget v0, p0, Landroidx/appcompat/widget/SeslAbsSeekBar;->mModeExpandTrackMaxWidth:I

    int-to-float v4, v0

    iget-object v5, p0, Landroidx/appcompat/widget/SeslAbsSeekBar;->mOverlapNormalProgressColor:Landroid/content/res/ColorStateList;
    ...
    invoke-direct/range {v1 .. v6}, Landroidx/appcompat/widget/SeslAbsSeekBar$SliderDrawable;-><init>(Landroidx/appcompat/widget/SeslAbsSeekBar;FFLandroid/content/res/ColorStateList;Z)V

    iput-object p1, p0, Landroidx/appcompat/widget/SeslAbsSeekBar;->mOverlapBackground:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v11, p0, Landroidx/appcompat/widget/SeslAbsSeekBar;->mOverlapNormalProgressColor:Landroid/content/res/ColorStateList;
    ...
    invoke-direct/range {v7 .. v12}, Landroidx/appcompat/widget/SeslAbsSeekBar$SliderDrawable;-><init>(Landroidx/appcompat/widget/SeslAbsSeekBar;FFLandroid/content/res/ColorStateList;Z)V
...
.method public final startDrag(Landroid/view/MotionEvent;)V
    ...
    iput-boolean v0, v1, Landroidx/appcompat/widget/SeslAbsSeekBar;->mIsDragging:Z

    iget-object v2, v1, Landroidx/appcompat/widget/SeslAbsSeekBar;->mValueAnimator:Landroid/animation/ValueAnimator;
    ...
    :cond_1
    iget-object v2, v1, Landroidx/appcompat/widget/SeslSeekBar;->mOnSeekBarChangeListener:Landroidx/appcompat/widget/SeslSeekBar$OnSeekBarChangeListener;

    if-eqz v2, :cond_2

    invoke-interface {v2, v1}, Landroidx/appcompat/widget/SeslSeekBar$OnSeekBarChangeListener;->onStartTrackingTouch(Landroidx/appcompat/widget/SeslSeekBar;)V
...
.method public final updateDrawableBounds(II)V
    ...
    iget p1, p0, Landroidx/appcompat/widget/SeslAbsSeekBar;->mOverlapPoint:I
...
.method public final updateDualColorMode()V
    ...
    :cond_0
    iget-object v2, p0, Landroidx/appcompat/widget/SeslAbsSeekBar;->mOverlapNormalProgressColor:Landroid/content/res/ColorStateList;
    ...
    iget v2, p0, Landroidx/appcompat/widget/SeslAbsSeekBar;->mOverlapPoint:I
    ...
    invoke-super {p0, v0}, Landroidx/appcompat/widget/SeslProgressBar;->setProgressTintList(Landroid/content/res/ColorStateList;)V
