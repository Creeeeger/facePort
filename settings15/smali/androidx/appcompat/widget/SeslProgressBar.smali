...
.field public mAccessibilityEventSender:Landroidx/appcompat/widget/SeslProgressBar$RefreshProgressRunnable;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iget-object p2, p0, Landroidx/appcompat/widget/SeslProgressBar;->mProgressDrawable:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/SeslProgressBar;->applySecondaryProgressTint()V
...
.method public final onDetachedFromWindow()V
    ...
    :cond_1
    iget-object v0, p0, Landroidx/appcompat/widget/SeslProgressBar;->mAccessibilityEventSender:Landroidx/appcompat/widget/SeslProgressBar$RefreshProgressRunnable;
...
.method public onProgressRefresh(FZI)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/SeslProgressBar;->mAccessibilityEventSender:Landroidx/appcompat/widget/SeslProgressBar$RefreshProgressRunnable;

    if-nez p1, :cond_0

    new-instance p1, Landroidx/appcompat/widget/SeslProgressBar$RefreshProgressRunnable;

    const/4 p3, 0x1

    invoke-direct {p1, p3, p0}, Landroidx/appcompat/widget/SeslProgressBar$RefreshProgressRunnable;-><init>(ILjava/lang/Object;)V

    iput-object p1, p0, Landroidx/appcompat/widget/SeslProgressBar;->mAccessibilityEventSender:Landroidx/appcompat/widget/SeslProgressBar$RefreshProgressRunnable;
...
.method public final declared-synchronized refreshProgress(IIZZ)V
    ...
    :cond_2
    iput p1, v0, Landroidx/appcompat/widget/SeslProgressBar$RefreshData;->id:I

    iput p2, v0, Landroidx/appcompat/widget/SeslProgressBar$RefreshData;->progress:I

    iput-boolean p3, v0, Landroidx/appcompat/widget/SeslProgressBar$RefreshData;->fromUser:Z

    iput-boolean p4, v0, Landroidx/appcompat/widget/SeslProgressBar$RefreshData;->animate:Z

    iget-object p1, p0, Landroidx/appcompat/widget/SeslProgressBar;->mRefreshData:Ljava/util/ArrayList;
...
.method public setIndeterminateDrawableTiled(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, v4, v5}, Landroidx/appcompat/widget/SeslProgressBar;->tileify(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
...
.method public setMode(I)V
    ...
    iput-boolean p1, p0, Landroidx/appcompat/widget/SeslProgressBar;->mOnlyIndeterminate:Z

    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/SeslProgressBar;->setIndeterminate(Z)V

    new-instance v0, Landroidx/appcompat/widget/SeslProgressBar$CirCleProgressDrawable;
    ...
    invoke-direct {v0, p0, p1, v3}, Landroidx/appcompat/widget/SeslProgressBar$CirCleProgressDrawable;-><init>(Landroidx/appcompat/widget/SeslProgressBar;ZLandroid/content/res/ColorStateList;)V
    ...
    invoke-direct {v1, p0, v2, v4}, Landroidx/appcompat/widget/SeslProgressBar$CirCleProgressDrawable;-><init>(Landroidx/appcompat/widget/SeslProgressBar;ZLandroid/content/res/ColorStateList;)V
...
.method public setProgressDrawableTiled(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, p1, v0}, Landroidx/appcompat/widget/SeslProgressBar;->tileify(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
