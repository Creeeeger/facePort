...
.method public final performFiltering(Ljava/lang/CharSequence;)Landroid/widget/Filter$FilterResults;
    ...
    invoke-static {v9, v8, v0}, Landroidx/picker/model/AppInfo$Companion;->obtain(ILjava/lang/String;Ljava/lang/String;)Landroidx/picker/model/AppInfo;
    ...
    const-string v8, "Fail to get application query result: "
    ...
    :cond_8
    :goto_8
    const-class v0, Landroidx/picker/model/viewdata/CategoryViewData;

    invoke-static {v4, v0}, Lkotlin/collections/CollectionsKt___CollectionsKt;->filterIsInstance(Ljava/lang/Iterable;Ljava/lang/Class;)Ljava/util/List;

    move-result-object v0

    const-class v5, Landroidx/picker/model/viewdata/AppInfoViewData;

    invoke-static {v4, v5}, Lkotlin/collections/CollectionsKt___CollectionsKt;->filterIsInstance(Ljava/lang/Iterable;Ljava/lang/Class;)Ljava/util/List;

    move-result-object v4

    iget-object v5, v1, Landroidx/picker/adapter/AbsAdapter$1;->this$0:Landroidx/picker/adapter/AbsAdapter;

    invoke-virtual {v5, v0, v7}, Landroidx/picker/adapter/AbsAdapter;->getAppInfoFilterResult(Ljava/util/List;Ljava/util/List;)Ljava/util/List;

    move-result-object v5

    iget-object v6, v1, Landroidx/picker/adapter/AbsAdapter$1;->this$0:Landroidx/picker/adapter/AbsAdapter;

    invoke-virtual {v6, v4, v7}, Landroidx/picker/adapter/AbsAdapter;->getAppInfoFilterResult(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {v7, v5}, Landroidx/picker/adapter/AbsAdapter;->generateFilterHeader(Ljava/lang/String;Ljava/util/List;)Landroidx/picker/model/viewdata/GroupTitleViewData;
    ...
    iget-object v9, v7, Landroidx/picker/model/viewdata/CategoryViewData;->appData:Landroidx/picker/model/appdata/CategoryAppData;

    iget-object v9, v9, Landroidx/picker/model/appdata/CategoryAppData;->appInfo:Landroidx/picker/model/AppInfo;

    invoke-direct {v8, v9}, Landroidx/picker/model/AppData$ListCheckBoxAppDataBuilder;-><init>(Landroidx/picker/model/AppInfo;)V

    iget-object v9, v7, Landroidx/picker/model/viewdata/CategoryViewData;->appData:Landroidx/picker/model/appdata/CategoryAppData;

    iget-object v10, v9, Landroidx/picker/model/appdata/CategoryAppData;->label:Ljava/lang/String;

    invoke-virtual {v8, v10}, Landroidx/picker/model/AppData$ListCheckBoxAppDataBuilder;->setLabel(Ljava/lang/String;)Landroidx/picker/model/AppData$ListCheckBoxAppDataBuilder;

    move-result-object v8

    iget-object v9, v9, Landroidx/picker/model/appdata/CategoryAppData;->icon:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v8, v9}, Landroidx/picker/model/AppData$ListCheckBoxAppDataBuilder;->setIcon(Landroid/graphics/drawable/Drawable;)Landroidx/picker/model/AppData$ListCheckBoxAppDataBuilder;

    move-result-object v8

    iget-object v9, v7, Landroidx/picker/model/viewdata/CategoryViewData;->selectableItem:Landroidx/picker/loader/select/SelectableItem;

    invoke-virtual {v9}, Landroidx/picker/loader/select/SelectableItem;->isSelected()Z
    ...
    invoke-virtual {v8}, Landroidx/picker/model/AppData$ListCheckBoxAppDataBuilder;->build()Landroidx/picker/model/AppInfoData;

    move-result-object v8

    move-object v10, v8

    check-cast v10, Landroidx/picker/model/AppInfoDataImpl;

    new-instance v8, Landroidx/picker/model/viewdata/AppInfoViewData;

    new-instance v11, Landroidx/picker/loader/AppIconFlow;

    new-instance v9, Landroidx/picker/adapter/AbsAdapter$2;

    invoke-direct {v9, v10, v10}, Landroidx/picker/adapter/AbsAdapter$2;-><init>(Landroidx/picker/model/AppInfoDataImpl;Landroidx/picker/model/AppInfoDataImpl;)V

    new-instance v12, Landroidx/picker/adapter/AbsAdapter$$ExternalSyntheticLambda1;

    invoke-direct {v12, v7}, Landroidx/picker/adapter/AbsAdapter$$ExternalSyntheticLambda1;-><init>(Landroidx/picker/model/viewdata/CategoryViewData;)V

    invoke-direct {v11, v9, v12}, Landroidx/picker/loader/AppIconFlow;-><init>(Landroidx/picker/features/observable/UpdateMutableState;Lkotlinx/coroutines/flow/Flow;)V

    const/4 v13, -0x1

    const/4 v14, 0x0

    iget-object v12, v7, Landroidx/picker/model/viewdata/CategoryViewData;->selectableItem:Landroidx/picker/loader/select/SelectableItem;

    move-object v9, v8

    invoke-direct/range {v9 .. v14}, Landroidx/picker/model/viewdata/AppInfoViewData;-><init>(Landroidx/picker/model/AppInfoData;Landroidx/picker/loader/AppIconFlow;Landroidx/picker/loader/select/SelectableItem;ILkotlin/jvm/functions/Function1;)V
    ...
    invoke-static {v0, v4}, Landroidx/picker/adapter/AbsAdapter;->generateFilterHeader(Ljava/lang/String;Ljava/util/List;)Landroidx/picker/model/viewdata/GroupTitleViewData;
