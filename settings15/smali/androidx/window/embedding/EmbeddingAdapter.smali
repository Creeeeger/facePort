...
.method static constructor <clinit>()V
    ...
    const-class v1, Landroidx/window/embedding/EmbeddingAdapter;
...
.method private final translate(Landroidx/window/extensions/embedding/SplitInfo;)Landroidx/window/embedding/SplitInfo;
    ...
    const-string/jumbo v2, "splitInfo.primaryActivityStack"
    ...
    const-string/jumbo v3, "splitInfo.secondaryActivityStack"
    ...
    const-string/jumbo v3, "splitInfo.splitInfoToken"
...
.method private final translateActivityRule(Landroidx/window/embedding/ActivityRule;Ljava/lang/Class;)Landroidx/window/extensions/embedding/ActivityRule;
    ...
    invoke-direct {p0, p1, p2}, Landroidx/window/embedding/EmbeddingAdapter$$ExternalSyntheticLambda8;-><init>(Landroidx/window/embedding/ActivityRule;I)V

    new-instance p2, Landroidx/window/embedding/EmbeddingAdapter$$ExternalSyntheticLambda8;

    const/4 v0, 0x1

    invoke-direct {p2, p1, v0}, Landroidx/window/embedding/EmbeddingAdapter$$ExternalSyntheticLambda8;-><init>(Landroidx/window/embedding/ActivityRule;I)V
...
.method private final translateSplitPairRule(Landroid/content/Context;Landroidx/window/embedding/SplitPairRule;Ljava/lang/Class;)Landroidx/window/extensions/embedding/SplitPairRule;
    ...
    invoke-direct {p3, p2, v0}, Landroidx/window/embedding/EmbeddingAdapter$$ExternalSyntheticLambda5;-><init>(Landroidx/window/embedding/SplitPairRule;I)V

    new-instance v0, Landroidx/window/embedding/EmbeddingAdapter$$ExternalSyntheticLambda5;

    const/4 v1, 0x1

    invoke-direct {v0, p2, v1}, Landroidx/window/embedding/EmbeddingAdapter$$ExternalSyntheticLambda5;-><init>(Landroidx/window/embedding/SplitPairRule;I)V

    new-instance v1, Landroidx/window/embedding/EmbeddingAdapter$$ExternalSyntheticLambda0;

    const/4 v2, 0x2

    invoke-direct {v1, p2, p1, v2}, Landroidx/window/embedding/EmbeddingAdapter$$ExternalSyntheticLambda0;-><init>(Landroidx/window/embedding/SplitRule;Landroid/content/Context;I)V
...
.method private final translateSplitPlaceholderRule(Landroid/content/Context;Landroidx/window/embedding/SplitPlaceholderRule;Ljava/lang/Class;)Landroidx/window/extensions/embedding/SplitPlaceholderRule;
    ...
    invoke-direct {p3, p2, v0}, Landroidx/window/embedding/EmbeddingAdapter$$ExternalSyntheticLambda1;-><init>(Landroidx/window/embedding/SplitPlaceholderRule;I)V

    new-instance v0, Landroidx/window/embedding/EmbeddingAdapter$$ExternalSyntheticLambda1;

    const/4 v1, 0x1

    invoke-direct {v0, p2, v1}, Landroidx/window/embedding/EmbeddingAdapter$$ExternalSyntheticLambda1;-><init>(Landroidx/window/embedding/SplitPlaceholderRule;I)V
    ...
    const-string p2, "SplitPlaceholderRuleBuil\u2026er)\n                    )"
...
.method public final translate$window_release(Landroidx/window/extensions/embedding/SplitAttributes;)Landroidx/window/embedding/SplitAttributes;
    ...
    const-string/jumbo v2, "splitAttributes.animationBackground"
    ...
    invoke-virtual {v2, v1}, Landroidx/window/embedding/EmbeddingAnimationBackground$Companion;->createColorBackground(I)Landroidx/window/embedding/EmbeddingAnimationBackground$ColorBackground;
    ...
    :cond_7
    sget-object v1, Landroidx/window/embedding/EmbeddingAnimationBackground;->DEFAULT:Landroidx/window/embedding/EmbeddingAnimationBackground;

    :goto_2
    invoke-virtual {v0, v1}, Landroidx/window/embedding/SplitAttributes$Builder;->setAnimationBackground(Landroidx/window/embedding/EmbeddingAnimationBackground;)Landroidx/window/embedding/SplitAttributes$Builder;
...
.method public final translateDividerAttributes(Landroidx/window/extensions/embedding/DividerAttributes;)Landroidx/window/embedding/DividerAttributes;
    ...
    invoke-virtual {p0, v0}, Landroidx/window/embedding/DividerAttributes$DraggableDividerAttributes$Builder;->setWidthDp(I)Landroidx/window/embedding/DividerAttributes$DraggableDividerAttributes$Builder;
    ...
    invoke-virtual {p0, v0}, Landroidx/window/embedding/DividerAttributes$DraggableDividerAttributes$Builder;->setColor(I)Landroidx/window/embedding/DividerAttributes$DraggableDividerAttributes$Builder;
    ...
    :cond_2
    new-instance v0, Landroidx/window/embedding/DividerAttributes$DragRange$SplitRatioDragRange;
    ...
    invoke-direct {v0, v1, p1}, Landroidx/window/embedding/DividerAttributes$DragRange$SplitRatioDragRange;-><init>(FF)V
...
.method public final translateDividerAttributes(Landroidx/window/embedding/DividerAttributes;)Landroidx/window/extensions/embedding/DividerAttributes;
    ...
    const-string p0, "dividerAttributes"
    ...
    :cond_0
    new-instance p0, Landroidx/window/extensions/embedding/DividerAttributes$Builder;

    instance-of v0, p1, Landroidx/window/embedding/DividerAttributes$FixedDividerAttributes;
    ...
    :cond_1
    instance-of v0, p1, Landroidx/window/embedding/DividerAttributes$DraggableDividerAttributes;
    ...
    :goto_0
    invoke-direct {p0, v0}, Landroidx/window/extensions/embedding/DividerAttributes$Builder;-><init>(I)V

    invoke-virtual {p1}, Landroidx/window/embedding/DividerAttributes;->getColor()I

    move-result v0

    invoke-virtual {p0, v0}, Landroidx/window/extensions/embedding/DividerAttributes$Builder;->setDividerColor(I)Landroidx/window/extensions/embedding/DividerAttributes$Builder;
    ...
    invoke-virtual {p0, v0}, Landroidx/window/extensions/embedding/DividerAttributes$Builder;->setWidthDp(I)Landroidx/window/extensions/embedding/DividerAttributes$Builder;
    ...
    instance-of v0, v0, Landroidx/window/embedding/DividerAttributes$DragRange$SplitRatioDragRange;
    ...
    check-cast v0, Landroidx/window/embedding/DividerAttributes$DragRange$SplitRatioDragRange;

    invoke-virtual {v0}, Landroidx/window/embedding/DividerAttributes$DragRange$SplitRatioDragRange;->getMinRatio()F

    move-result v0

    invoke-virtual {p0, v0}, Landroidx/window/extensions/embedding/DividerAttributes$Builder;->setPrimaryMinRatio(F)Landroidx/window/extensions/embedding/DividerAttributes$Builder;
    ...
    invoke-virtual {p1}, Landroidx/window/embedding/DividerAttributes$DragRange$SplitRatioDragRange;->getMaxRatio()F

    move-result p1

    invoke-virtual {v0, p1}, Landroidx/window/extensions/embedding/DividerAttributes$Builder;->setPrimaryMaxRatio(F)Landroidx/window/extensions/embedding/DividerAttributes$Builder;
...
.method public final translateSplitPinRule(Landroid/content/Context;Landroidx/window/embedding/SplitPinRule;)Landroidx/window/extensions/embedding/SplitPinRule;
    ...
    invoke-direct {v0, p2, p1, v1}, Landroidx/window/embedding/EmbeddingAdapter$$ExternalSyntheticLambda0;-><init>(Landroidx/window/embedding/SplitRule;Landroid/content/Context;I)V
