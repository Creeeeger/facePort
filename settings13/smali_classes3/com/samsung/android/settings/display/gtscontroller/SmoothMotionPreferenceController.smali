...
.source "SmoothMotionPreferenceController.java"
...
.method public getEntries()Ljava/util/ArrayList;
    ...
    sget v2, Lcom/android/settings/R$string;->sec_high_refresh_rate_standard_title:I
    ...
    sget v1, Lcom/android/settings/R$string;->sec_high_refresh_rate_dynamic_title:I
...
.method public getSelectedValue()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/samsung/android/settings/display/gtscontroller/SmoothMotionPreferenceController;->getAvailabilityStatus()I
...
.method public getSummary()Ljava/lang/CharSequence;
    ...
    invoke-static {v0, v2}, Lcom/samsung/android/settings/display/SecDisplayUtils;->getIntRefreshRate(Landroid/content/Context;I)I
...
.method public getValue()Lcom/samsung/android/settings/cube/ControlValue;
    ...
    invoke-virtual {p0}, Lcom/samsung/android/settings/cube/ControlValue;->getKey()Ljava/lang/String;
    ...
    .line 95
    invoke-virtual {p0}, Lcom/samsung/android/settings/cube/ControlValue;->getAvailabilityStatus()I
    ...
    .line 97
    invoke-virtual {p0}, Lcom/samsung/android/settings/cube/ControlValue;->getBundle()Landroid/os/Bundle;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/samsung/android/settings/cube/ControlValue$Builder;->setBundle(Landroid/os/Bundle;)Lcom/samsung/android/settings/cube/ControlValue$Builder;

    move-result-object v0

    .line 98
    invoke-virtual {p0}, Lcom/samsung/android/settings/cube/ControlValue;->getControlId()Ljava/lang/String;
    ...
    .line 99
    invoke-virtual {p0}, Lcom/samsung/android/settings/cube/ControlValue;->isDefault()Z
    ...
    .line 100
    invoke-virtual {p0}, Lcom/samsung/android/settings/cube/ControlValue;->getStatusCode()Ljava/lang/String;
