.class public Lcom/samsung/android/settings/widget/SecRestrictedSwitchPreference;
...
# direct methods
.method public static synthetic $r8$lambda$AHVxzxfYZfglwx2TybQyT64A8bw(Landroid/content/Context;I)Ljava/lang/String;
    .locals 0

    invoke-static {p0, p1}, Lcom/samsung/android/settings/widget/SecRestrictedSwitchPreference;->lambda$getUpdatableEnterpriseString$0(Landroid/content/Context;I)Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lcom/samsung/android/settings/widget/SecRestrictedSwitchPreference;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 100
    invoke-direct {p0, p1, p2, p3, v0}, Lcom/samsung/android/settings/widget/SecRestrictedSwitchPreference;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    .line 57
    iput-boolean p3, p0, Lcom/samsung/android/settings/widget/SecRestrictedSwitchPreference;->mUseAdditionalSummary:Z
    ...
    iput-object p4, p0, Lcom/samsung/android/settings/widget/SecRestrictedSwitchPreference;->mHelper:Lcom/android/settingslib/RestrictedPreferenceHelper;
    ...
    :goto_0
    iput-boolean p4, p0, Lcom/samsung/android/settings/widget/SecRestrictedSwitchPreference;->mUseAdditionalSummary:Z
    ...
    iput-object p2, p0, Lcom/samsung/android/settings/widget/SecRestrictedSwitchPreference;->mRestrictedSwitchSummary:Ljava/lang/CharSequence;
    ...
    :cond_3
    :goto_1
    iget-boolean p2, p0, Lcom/samsung/android/settings/widget/SecRestrictedSwitchPreference;->mUseAdditionalSummary:Z
    ...
    .line 91
    sget p1, Lcom/android/settings/R$layout;->sec_restricted_switch_preference_large:I
    ...
    .line 93
    :cond_4
    sget p1, Lcom/android/settings/R$layout;->sec_restricted_switch_preference:I

    invoke-virtual {p0, p1}, Landroidx/preference/Preference;->setLayoutResource(I)V

    .line 95
    :goto_2
    invoke-virtual {p0, p3}, Lcom/samsung/android/settings/widget/SecRestrictedSwitchPreference;->useAdminDisabledSummary(Z)V
...
.method private static getUpdatableEnterpriseString(Landroid/content/Context;Ljava/lang/String;I)Ljava/lang/String;
    ...
    new-instance v1, Lcom/samsung/android/settings/widget/SecRestrictedSwitchPreference$$ExternalSyntheticLambda0;

    invoke-direct {v1, p0, p2}, Lcom/samsung/android/settings/widget/SecRestrictedSwitchPreference$$ExternalSyntheticLambda0;-><init>(Landroid/content/Context;I)V
...
.method public isDisabledByAdmin()Z
    ...
    .line 243
    iget-object p0, p0, Lcom/samsung/android/settings/widget/SecRestrictedSwitchPreference;->mHelper:Lcom/android/settingslib/RestrictedPreferenceHelper;
...
.method public onBindViewHolder(Landroidx/preference/PreferenceViewHolder;)V
    ...
    .line 133
    iget-object v0, p0, Lcom/samsung/android/settings/widget/SecRestrictedSwitchPreference;->mRestrictedSwitchSummary:Ljava/lang/CharSequence;
    ...
    .line 135
    invoke-static {v0, v2, v1}, Lcom/samsung/android/settings/widget/SecRestrictedSwitchPreference;->getUpdatableEnterpriseString(Landroid/content/Context;Ljava/lang/String;I)Ljava/lang/String;
    ...
    .line 151
    iget v3, p0, Lcom/samsung/android/settings/widget/SecRestrictedSwitchPreference;->mIconSize:I
    ...
    iget v4, p0, Lcom/samsung/android/settings/widget/SecRestrictedSwitchPreference;->mIconSize:I
    ...
    .line 155
    :cond_3
    iget-boolean v2, p0, Lcom/samsung/android/settings/widget/SecRestrictedSwitchPreference;->mUseAdditionalSummary:Z
...
.method public setAppOps(Landroid/app/AppOpsManager;)V
    ...
    .line 114
    iput-object p1, p0, Lcom/samsung/android/settings/widget/SecRestrictedSwitchPreference;->mAppOpsManager:Landroid/app/AppOpsManager;
...
.method public setEnabled(Z)V
    ...
    .line 224
    iget-object v2, p0, Lcom/samsung/android/settings/widget/SecRestrictedSwitchPreference;->mHelper:Lcom/android/settingslib/RestrictedPreferenceHelper;
    ...
    .line 227
    invoke-virtual {p0}, Lcom/samsung/android/settings/widget/SecRestrictedSwitchPreference;->isDisabledByAppOps()Z
