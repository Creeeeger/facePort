...
.method static bridge synthetic -$$Nest$fgetmRestrictedIcon(Lcom/android/settings/widget/SwitchBar;)Landroid/widget/ImageView;
    .locals 0
...
.method static bridge synthetic -$$Nest$fgetmSwitch(Lcom/android/settings/widget/SwitchBar;)Lcom/android/settings/widget/ToggleSwitch;
    .locals 0
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    .line 111
    iput-object p3, p0, Lcom/android/settings/widget/SwitchBar;->mSessionDesc:Ljava/lang/String;
    ...
    sget v3, Lcom/android/settings/R$color;->sec_widget_switchbar_background_color:I
    ...
    sget v3, Lcom/android/settings/R$color;->sec_widget_switchbar_checked_background_color:I
    ...
    :goto_0
    iput-boolean p3, p0, Lcom/android/settings/widget/SwitchBar;->mIsLightTheme:Z
    ...
    .line 175
    sget p2, Lcom/android/settings/R$id;->switch_background:I
    ...
    iput-object p2, p0, Lcom/android/settings/widget/SwitchBar;->mBackground:Landroid/widget/LinearLayout;

    .line 176
    sget p4, Lcom/android/settings/R$drawable;->sec_switchbar_background:I

    invoke-virtual {p2, p4}, Landroid/widget/LinearLayout;->setBackgroundResource(I)V

    .line 177
    iget-object p2, p0, Lcom/android/settings/widget/SwitchBar;->mBackground:Landroid/widget/LinearLayout;

    new-instance p4, Lcom/android/settings/widget/SwitchBar$1;

    invoke-direct {p4, p0}, Lcom/android/settings/widget/SwitchBar$1;-><init>(Lcom/android/settings/widget/SwitchBar;)V
    ...
    sget p4, Lcom/android/settings/R$string;->switch_off_text:I

    invoke-virtual {p0, p2, p4}, Lcom/android/settings/widget/SwitchBar;->setSwitchBarText(II)V
    ...
    new-instance p3, Lcom/android/settings/widget/SwitchBar$2;

    invoke-direct {p3, p0, p1}, Lcom/android/settings/widget/SwitchBar$2;-><init>(Lcom/android/settings/widget/SwitchBar;Landroid/content/Context;)V

    invoke-virtual {p2, p3}, Landroid/widget/ImageView;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 220
    sget p2, Lcom/android/settings/R$id;->scanning_progress:I

    invoke-virtual {p0, p2}, Landroid/widget/LinearLayout;->findViewById(I)Landroid/view/View;

    move-result-object p2

    iput-object p2, p0, Lcom/android/settings/widget/SwitchBar;->mProgressBar:Landroid/view/View;

    .line 221
    sget p2, Lcom/android/settings/R$id;->sub_app_bar_divider:I

    invoke-virtual {p0, p2}, Landroid/widget/LinearLayout;->findViewById(I)Landroid/view/View;

    move-result-object p2

    iput-object p2, p0, Lcom/android/settings/widget/SwitchBar;->mDivider:Landroid/view/View;
    ...
    invoke-direct {p1, p0}, Lcom/android/settings/widget/SwitchBar$SwitchBarDelegate;-><init>(Landroid/view/View;)V
...
.method public removeOnSwitchChangeListener(Lcom/android/settings/widget/SwitchBar$OnSwitchChangeListener;)V
    ...
    const-string v0, "listener already removed or it isn\'t contained : "
...
.method public setSessionDescription(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/settings/widget/SwitchBar$SwitchBarDelegate;->setSessionName(Ljava/lang/String;)V
...
.method public show()V
    ...
    invoke-virtual {v0, p0}, Lcom/android/settings/widget/SwitchBar$SwitchBarDelegate;->setSessionName(Ljava/lang/String;)V
    ...
    iget-object p0, p0, Lcom/android/settings/widget/SwitchBar;->mSessionDesc:Ljava/lang/String;
