...
.method private getDynamicSearchIndexableRawData(Landroid/content/Context;Lcom/android/settingslib/search/SearchIndexableData;)Ljava/util/List;
    ...
    const-string v0, "Exception - getDynamicSearchIndexableRawData() class : "
    ...
    const-string p1, "SettingsSearchProvider"
    ...
    .line 504
    iget-object v1, v0, Landroid/provider/SearchIndexableData;->className:Ljava/lang/String;
...
.method private getNonIndexableKeysFromProvider(Landroid/content/Context;)Ljava/util/List;
    ...
    check-cast v3, Lcom/android/settingslib/search/SearchIndexableData;
    ...
    .line 329
    invoke-virtual {v3}, Lcom/android/settingslib/search/SearchIndexableData;->getSearchIndexProvider()Lcom/android/settingslib/search/Indexable$SearchIndexProvider;

    move-result-object v7

    .line 332
    :try_start_0
    invoke-interface {v7, p1}, Lcom/android/settingslib/search/Indexable$SearchIndexProvider;->getNonIndexableKeys(Landroid/content/Context;)Ljava/util/List;
    ...
    .line 359
    :cond_1
    sget-object v12, Lcom/android/settings/search/SettingsSearchIndexablesProvider;->INVALID_KEYS:Ljava/util/Collection;
    ...
    const-string v7, " tried to add an empty non-indexable key"
    ...
    .line 365
    sget-boolean v5, Lcom/android/settings/search/SettingsSearchIndexablesProvider;->DEBUG:Z
    ...
    const-string v6, "Non-indexables "
    ...
    .line 368
    invoke-virtual {v3}, Lcom/android/settingslib/search/SearchIndexableData;->getTargetClass()Ljava/lang/Class;
    ...
    const-string v6, "No indexable, total time "
    ...
    const-string v6, "debug.com.android.settings.search.crash_on_error"
    ...
    const-string v7, "Error trying to get non-indexable keys from: "
    ...
    invoke-direct {p0, v5}, Ljava/lang/RuntimeException;-><init>(Ljava/lang/Throwable;)V
    ...
    const-string p1, "Non-indexables, total time : "
...
.method private getNonIndexableKeysFromProvider(Landroid/content/Context;Landroid/os/Bundle;)Ljava/util/List;
    ...
    invoke-interface {p2}, Lcom/android/settings/search/SearchFeatureProvider;->getSearchIndexableResources()Lcom/android/settingslib/search/SearchIndexableResources;

    move-result-object p2

    invoke-interface {p2}, Lcom/android/settingslib/search/SearchIndexableResources;->getProviderValues()Ljava/util/Collection;
    ...
    :cond_1
    :try_start_0
    invoke-interface {v4, p1}, Lcom/android/settingslib/search/Indexable$SearchIndexProvider;->getNonIndexableKeys(Landroid/content/Context;)Ljava/util/List;
    ...
    .line 657
    :cond_2
    sget-object v9, Lcom/android/settings/search/SettingsSearchIndexablesProvider;->INVALID_KEYS:Ljava/util/Collection;
    ...
    .line 662
    sget-boolean v2, Lcom/android/settings/search/SettingsSearchIndexablesProvider;->DEBUG:Z
    ...
    const-string v1, ", Non-indexables: "
    ...
    const-string v1, ", No indexable, total time (ms): "
    ...
    const-string v4, "Error trying to get non-indexable keys from: "
...
.method private getSearchIndexableRawFromProvider(Landroid/content/Context;)Ljava/util/List;
    ...
    .line 452
    iget-object v5, v4, Landroid/provider/SearchIndexableData;->className:Ljava/lang/String;
    ...
    const-string v4, "Exception - getSearchIndexableRawFromProvider() class : "
...
.method private getSearchIndexableResourcesFromProvider(Landroid/content/Context;)Ljava/util/List;
    ...
    const-string v4, "Exception - getSearchIndexableResourcesFromProvider() class : "
...
.method public secQueryNonIndexableKeys([Ljava/lang/String;Landroid/os/Bundle;)Landroid/database/Cursor;
    ...
    invoke-direct {p0, v0, p2}, Lcom/android/settings/search/SettingsSearchIndexablesProvider;->getNonIndexableKeysFromProvider(Landroid/content/Context;Landroid/os/Bundle;)Ljava/util/List;
