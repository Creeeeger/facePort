...
# direct methods
.method public static addWhiteBorder(Landroid/content/Context;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    .locals 3
...
.method public static getSecScannerIntent(Z)Landroid/content/Intent;
    .locals 1

    const/4 v0, 0x0

    .line 284
    invoke-static {p0, v0}, Lcom/android/settings/wifi/WifiUtils;->getSecScannerIntent(ZZ)Landroid/content/Intent;
...
.method public static getSecScannerIntent(ZZ)Landroid/content/Intent;
    .locals 3
    ...
    const-string/jumbo v1, "request_qr_scan_type"
    ...
    const-string/jumbo p0, "request_result"
    ...
    .line 295
    invoke-static {}, Lcom/android/settings/wifi/WifiUtils;->isJdmModel()Z

    move-result p0

    if-eqz p0, :cond_1

    const-string/jumbo p0, "request_from_setupwizard"
...
.method public static isBlockedByEnterprise(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    .line 268
    invoke-static {p1}, Lcom/samsung/wifitrackerlib/SemWifiUtils;->addQuotationIfNeeded(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 269
    invoke-static {p0, v1}, Lcom/samsung/android/settings/wifi/WifiDevicePolicyManager;->isEnterpriseKnoxSsid(Landroid/content/Context;[Ljava/lang/String;)Z
    ...
    .line 270
    invoke-static {p0}, Lcom/samsung/android/settings/wifi/WifiDevicePolicyManager;->isAllowedToChangeUserPolicy(Landroid/content/Context;)Z
...
.method public static isCameraSupportQrScan(Landroid/content/Context;)Z
    .locals 2
    ...
    .line 327
    invoke-static {p0, v0}, Lcom/android/settings/wifi/WifiUtils;->isPackageAvailable(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static isNetworkLockedDown(Landroid/content/Context;Landroid/net/wifi/WifiConfiguration;)Z
    ...
    invoke-static {v3, v6}, Lcom/android/settings/Utils;->getManagedProfileId(Landroid/os/UserManager;I)I
    ...
    const-string p0, "config is not eligible for lockdown"
...
.method public static isSecurityTypeSupportQrCode(Landroid/content/Context;Lcom/android/wifitrackerlib/WifiEntry;)Z
    ...
    :cond_0
    const-string/jumbo p1, "wifi_qrcode"
