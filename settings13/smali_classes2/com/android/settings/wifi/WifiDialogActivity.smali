...
.method protected hasPermissionForResult()Z
    ...
    const-string/jumbo v0, "no calling package"
...
.method public onForget(Lcom/android/settings/wifi/WifiDialog;)V
    ...
    invoke-virtual {v1, v2}, Lcom/samsung/wifitrackerlib/WifiIssueDetectorUtil;->reportForgetNetwork(I)V
...
.method public onSubmit(Lcom/android/settings/wifi/WifiDialog;)V
    ...
    .line 295
    new-instance v4, Lcom/samsung/wifitrackerlib/WifiIssueDetectorUtil;

    invoke-virtual {p0}, Landroid/app/Activity;->getApplicationContext()Landroid/content/Context;

    move-result-object v5

    invoke-direct {v4, v5}, Lcom/samsung/wifitrackerlib/WifiIssueDetectorUtil;-><init>(Landroid/content/Context;)V

    invoke-virtual {v4, v1}, Lcom/samsung/wifitrackerlib/WifiIssueDetectorUtil;->reportConnectNetwork(Landroid/net/wifi/WifiConfiguration;)V

    .line 296
    iget-object v4, p0, Lcom/android/settings/wifi/WifiDialogActivity;->mWifiManager:Landroid/net/wifi/WifiManager;

    invoke-virtual {v4, v1, v2}, Landroid/net/wifi/WifiManager;->connect(Landroid/net/wifi/WifiConfiguration;Landroid/net/wifi/WifiManager$ActionListener;)V
    ...
    invoke-direct {v1, v4}, Lcom/samsung/wifitrackerlib/WifiIssueDetectorUtil;-><init>(Landroid/content/Context;)V

    invoke-virtual {v1, v0}, Lcom/samsung/wifitrackerlib/WifiIssueDetectorUtil;->reportConnectNetwork(Landroid/net/wifi/WifiConfiguration;)V
