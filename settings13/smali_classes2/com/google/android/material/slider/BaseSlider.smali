...
.method private validateMinSeparation()V
    ...
    const-string/jumbo p0, "minSeparation(%s) must be greater or equal and a multiple of stepSize(%s) when using stepSize(%s)"
    ...
    const-string/jumbo p0, "minSeparation(%s) cannot be set as a dimension when using stepSize(%s)"
    ...
    const-string/jumbo v0, "minSeparation(%s) must be greater or equal to 0"
