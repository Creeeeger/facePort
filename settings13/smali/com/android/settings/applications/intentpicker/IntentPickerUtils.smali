...
.method public static synthetic $r8$lambda$s6ZEMXDQFzg-JsxYHb2QGYU8Kp4(Ljava/util/Map$Entry;)Ljava/lang/String;
    .locals 0

    invoke-static {p0}, Lcom/android/settings/applications/intentpicker/IntentPickerUtils;->lambda$getEditableLinksList$3(Ljava/util/Map$Entry;)Ljava/lang/String;
...
.method public static synthetic $r8$lambda$vqWbRbJfBpw7BYiuXo1GkCj87tY(Ljava/util/Map$Entry;)Z
    .locals 0

    invoke-static {p0}, Lcom/android/settings/applications/intentpicker/IntentPickerUtils;->lambda$getEditableLinksList$2(Ljava/util/Map$Entry;)Z
...
.method public static getEditableLinksList(Landroid/content/pm/verify/domain/DomainVerificationManager;Ljava/lang/String;)Ljava/util/List;
    .locals 0
    ...
    new-instance p1, Lcom/android/settings/applications/intentpicker/IntentPickerUtils$$ExternalSyntheticLambda2;

    invoke-direct {p1}, Lcom/android/settings/applications/intentpicker/IntentPickerUtils$$ExternalSyntheticLambda2;-><init>()V
    ...
    new-instance p1, Lcom/android/settings/applications/intentpicker/IntentPickerUtils$$ExternalSyntheticLambda3;

    invoke-direct {p1}, Lcom/android/settings/applications/intentpicker/IntentPickerUtils$$ExternalSyntheticLambda3;-><init>()V
...
.method private static synthetic lambda$getEditableLinksList$2(Ljava/util/Map$Entry;)Z
    .locals 2
...
.method private static synthetic lambda$getEditableLinksList$3(Ljava/util/Map$Entry;)Ljava/lang/String;
    .locals 0
