...
.method private createDetails()V
    ...
    .line 217
    :cond_0
    sget v0, Lcom/android/settings/R$xml;->sec_app_memory_settings:I
    ...
    iget-wide v1, v0, Lcom/android/settings/applications/ProcStatsPackageEntry;->mRunWeight:D

    iget-wide v3, v0, Lcom/android/settings/applications/ProcStatsPackageEntry;->mBgWeight:D
    ...
    .line 231
    :goto_1
    iget-wide v3, p0, Lcom/android/settings/applications/ProcessStatsDetail;->mWeightToRam:D
    ...
    invoke-static {v0, v1, v2, v6}, Lcom/android/settingslib/applications/AppFileSizeFormatter;->formatBytes(Landroid/content/res/Resources;JI)Lcom/android/settingslib/applications/AppFileSizeFormatter$BytesResult;
    ...
    iget-object v4, v0, Lcom/android/settingslib/applications/AppFileSizeFormatter$BytesResult;->value:Ljava/lang/String;

    aput-object v4, v3, v5

    iget-object v0, v0, Lcom/android/settingslib/applications/AppFileSizeFormatter$BytesResult;->units:Ljava/lang/String;
    ...
    invoke-static {p0, v0, v1}, Lcom/android/settingslib/applications/AppFileSizeFormatter;->formatShortFileSize(Landroid/content/Context;J)Ljava/lang/String;
...
.method private fillProcessesSection()V
    ...
    invoke-static {v3, v8, v9}, Lcom/android/settingslib/applications/AppFileSizeFormatter;->formatShortFileSize(Landroid/content/Context;J)Ljava/lang/String;
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-virtual {v1, v3}, Landroid/util/IconDrawableFactory;->getBadgedIcon(Landroid/content/pm/ApplicationInfo;)Landroid/graphics/drawable/Drawable;
    ...
    :cond_3
    iget-object p2, p0, Lcom/android/settings/applications/ProcessStatsDetail;->mPm:Landroid/content/pm/PackageManager;
    ...
    :goto_2
    invoke-virtual {v0, p2}, Lcom/android/settings/widget/EntityHeaderController;->setSummary(Landroid/content/pm/PackageInfo;)Lcom/android/settings/widget/EntityHeaderController;
