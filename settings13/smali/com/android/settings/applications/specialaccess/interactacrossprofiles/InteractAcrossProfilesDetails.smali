...
.field private mInstallBanner:Lcom/samsung/android/settings/widget/SecUnclickablePreference;

.field private mInstallBannerButton:Lcom/samsung/android/settings/widget/SecButtonPreference;
...
.method static bridge synthetic -$$Nest$fgetmDialog(Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails;)Landroidx/appcompat/app/AlertDialog;
    .locals 0

    iget-object p0, p0, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails;->mDialog:Landroidx/appcompat/app/AlertDialog;
...
.method static bridge synthetic -$$Nest$fputmDialog(Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails;Landroidx/appcompat/app/AlertDialog;)V
    .locals 0
...
.method static bridge synthetic -$$Nest$mhandleInstallBannerClick(Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails;)V
    .locals 0
...
.method private disableSwitchPref()V
    ...
    sget v0, Lcom/android/settings/R$string;->interact_across_profiles_switch_disabled:I
...
.method private enableSwitchPref()V
    ...
    sget v0, Lcom/android/settings/R$string;->interact_across_profiles_switch_enabled:I
...
.method private handleSwitchPreferenceClick()V
    ...
    .line 316
    :cond_0
    invoke-direct {p0}, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails;->showConsentDialogSec()V
...
.method private synthetic lambda$refreshUiForNonConfigurableApps$4()Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails;->mAppLabel:Ljava/lang/String;
...
.method private refreshUiForNonConfigurableApps()Z
    ...
    new-instance v4, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails$$ExternalSyntheticLambda0;

    invoke-direct {v4, p0}, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails$$ExternalSyntheticLambda0;-><init>(Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails;)V
    ...
    new-instance v4, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails$$ExternalSyntheticLambda1;

    invoke-direct {v4, p0}, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails$$ExternalSyntheticLambda1;-><init>(Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails;)V
...
.method private showConsentDialogSec()V
    .locals 3
    ...
    sget v1, Lcom/android/settings/R$string;->interact_across_profiles_consent_dialog_title:I
    ...
    sget v1, Lcom/android/settings/R$string;->interact_across_profiles_consent_dialog_summary:I
    ...
    iput-object v0, p0, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails;->mDialog:Landroidx/appcompat/app/AlertDialog;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 132
    sget p1, Lcom/android/settings/R$xml;->sec_interact_across_profiles_permissions_details:I
    ...
    .line 139
    sget p1, Lcom/android/settings/R$string;->interact_across_profiles_summary_1:I

    const-string v0, "interact_across_profiles_summary_1"

    const-string v1, "Settings.CONNECTED_APPS_SHARE_PERMISSIONS_AND_DATA"
    ...
    .line 142
    sget p1, Lcom/android/settings/R$string;->interact_across_profiles_summary_2:I

    const-string v0, "interact_across_profiles_summary_2"

    const-string v1, "Settings.ONLY_CONNECT_TRUSTED_APPS"

    invoke-virtual {p0, v0, v1, p1}, Lcom/android/settings/SettingsPreferenceFragment;->replaceEnterpriseStringSummary(Ljava/lang/String;Ljava/lang/String;I)V

    .line 145
    sget p1, Lcom/android/settings/R$string;->interact_across_profiles_summary_3:I

    const-string v0, "interact_across_profiles_extra_summary"

    const-string v1, "Settings.HOW_TO_DISCONNECT_APPS"
    ...
    .line 153
    iget-object p1, p0, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails;->mSwitchPref:Lcom/android/settingslib/RestrictedSwitchPreference;
    ...
    iput-object p1, p0, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails;->mInstallBanner:Lcom/samsung/android/settings/widget/SecUnclickablePreference;

    const-string p1, "install_app_banner_button"
    ...
    iput-object p1, p0, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails;->mInstallBannerButton:Lcom/samsung/android/settings/widget/SecButtonPreference;

    .line 160
    invoke-virtual {p1}, Lcom/samsung/android/settings/widget/SecButtonPreference;->setDefaultRoundButtonStyle()V

    .line 161
    iget-object p1, p0, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails;->mInstallBannerButton:Lcom/samsung/android/settings/widget/SecButtonPreference;

    sget v0, Lcom/android/settings/R$string;->interact_across_profiles_install_button_text:I

    invoke-virtual {p0, v0}, Landroidx/fragment/app/Fragment;->getString(I)Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p1, v0}, Lcom/samsung/android/settings/widget/SecButtonPreference;->setButtonText(Ljava/lang/String;)V

    .line 162
    iget-object p1, p0, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails;->mInstallBannerButton:Lcom/samsung/android/settings/widget/SecButtonPreference;

    new-instance v0, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails$1;

    invoke-direct {v0, p0}, Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails$1;-><init>(Lcom/android/settings/applications/specialaccess/interactacrossprofiles/InteractAcrossProfilesDetails;)V
